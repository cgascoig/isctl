...
type SoftwarerepositoryCategorySupportConstraintAllOf struct {
	...
	FilteredModels []SoftwarerepositoryConstraintModels `json:"FilteredModels,omitempty" yaml:"FilteredModels,omitempty"`
	...
	ParseFromImageName *bool    `json:"ParseFromImageName,omitempty" yaml:"ParseFromImageName,omitempty"`
