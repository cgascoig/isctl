...
type VnicFcErrorRecoverySettingsAllOf struct {
	...
	IoRetryCount *int64 `json:"IoRetryCount,omitempty" yaml:"IoRetryCount,omitempty"`
	// The number of seconds the adapter waits before aborting the pending command and resending the same IO request.
	IoRetryTimeout *int64 `json:"IoRetryTimeout,omitempty" yaml:"IoRetryTimeout,omitempty"`
	// The number of milliseconds the port should actually be down before it is marked down and fabric connectivity is lost.
	LinkDownTimeout *int64 `json:"LinkDownTimeout,omitempty" yaml:"LinkDownTimeout,omitempty"`
	...
	PortDownTimeout *int64 `json:"PortDownTimeout,omitempty" yaml:"PortDownTimeout,omitempty"`
}
