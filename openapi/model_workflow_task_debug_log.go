...
type WorkflowTaskDebugLog struct {
	...
	TaskDebugLogEntries interface{} `json:"TaskDebugLogEntries,omitempty" yaml:"TaskDebugLogEntries,omitempty"`
	// The unique identifier for task instance.
	TaskInstId   *string                           `json:"TaskInstId,omitempty" yaml:"TaskInstId,omitempty"`
	TaskInfo     *WorkflowTaskInfoRelationship     `json:"TaskInfo,omitempty" yaml:"TaskInfo,omitempty"`
