...
func (dst *CondHclStatusResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "cond.HclStatus.List":
			var result *CondHclStatusList = &CondHclStatusList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.CondHclStatusList = result
			return nil
...
func (src *CondHclStatusResponse) MarshalYAML() ([]byte, error) {
	if src.CondHclStatusList != nil {
		return yaml.Marshal(&src.CondHclStatusList)
	}
