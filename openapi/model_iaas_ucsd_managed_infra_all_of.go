...
type IaasUcsdManagedInfraAllOf struct {
	...
	AdvancedCatalogCount *int64 `json:"AdvancedCatalogCount,omitempty" yaml:"AdvancedCatalogCount,omitempty"`
	// Total bare metal catalogs in UCSD.
	BmCatalogCount *int64 `json:"BmCatalogCount,omitempty" yaml:"BmCatalogCount,omitempty"`
	// Total service container catalogs in UCSD.
	ContainerCatalogCount *int64 `json:"ContainerCatalogCount,omitempty" yaml:"ContainerCatalogCount,omitempty"`
	// Total ESXi hosts in UCSD.
	EsxiHostCount *int64 `json:"EsxiHostCount,omitempty" yaml:"EsxiHostCount,omitempty"`
	// Total external (Ldap) groups in UCSD.
	ExternalGroupCount *int64 `json:"ExternalGroupCount,omitempty" yaml:"ExternalGroupCount,omitempty"`
	// Total HyperV hosts in UCSD.
	HypervHostCount *int64 `json:"HypervHostCount,omitempty" yaml:"HypervHostCount,omitempty"`
	// Total local groups in UCSD.
	LocalGroupCount *int64 `json:"LocalGroupCount,omitempty" yaml:"LocalGroupCount,omitempty"`
	// Total standard catalogs in UCSD.
	StandardCatalogCount *int64 `json:"StandardCatalogCount,omitempty" yaml:"StandardCatalogCount,omitempty"`
	// Total user accounts in UCSD.
	UserCount *int64 `json:"UserCount,omitempty" yaml:"UserCount,omitempty"`
	// Total virtual datacenters in UCSD.
	VdcCount *int64 `json:"VdcCount,omitempty" yaml:"VdcCount,omitempty"`
