...
func (dst *BiosBootDeviceResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "bios.BootDevice.List":
			var result *BiosBootDeviceList = &BiosBootDeviceList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.BiosBootDeviceList = result
			return nil
...
func (src *BiosBootDeviceResponse) MarshalYAML() ([]byte, error) {
	if src.BiosBootDeviceList != nil {
		return yaml.Marshal(&src.BiosBootDeviceList)
	}
