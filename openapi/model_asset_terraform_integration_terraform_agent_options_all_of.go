...
type AssetTerraformIntegrationTerraformAgentOptionsAllOf struct {
	...
	ManagedHosts []string `json:"ManagedHosts,omitempty" yaml:"ManagedHosts,omitempty"`
	// Agent pool name for Terraform Agent platform type.
	TerraformAgentPoolName *string `json:"TerraformAgentPoolName,omitempty" yaml:"TerraformAgentPoolName,omitempty"`
	// Organization for Terraform Agent platform type.
	TerraformOrganization *string `json:"TerraformOrganization,omitempty" yaml:"TerraformOrganization,omitempty"`
}
