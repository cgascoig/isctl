...
type VnicVmqSettings struct {
	...
	MultiQueueSupport *bool `json:"MultiQueueSupport,omitempty" yaml:"MultiQueueSupport,omitempty"`
	...
	NumInterrupts *int64 `json:"NumInterrupts,omitempty" yaml:"NumInterrupts,omitempty"`
	// The number of sub vNICs to be created.
	NumSubVnics *int64 `json:"NumSubVnics,omitempty" yaml:"NumSubVnics,omitempty"`
	...
	NumVmqs *int64 `json:"NumVmqs,omitempty" yaml:"NumVmqs,omitempty"`
	...
	VmmqAdapterPolicy *string `json:"VmmqAdapterPolicy,omitempty" yaml:"VmmqAdapterPolicy,omitempty"`
}
