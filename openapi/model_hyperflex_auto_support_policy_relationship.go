...
func (dst *HyperflexAutoSupportPolicyRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.AutoSupportPolicy":
			var result *HyperflexAutoSupportPolicy = &HyperflexAutoSupportPolicy{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexAutoSupportPolicy = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexAutoSupportPolicyRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexAutoSupportPolicy != nil {
		return yaml.Marshal(&src.HyperflexAutoSupportPolicy)
	}
