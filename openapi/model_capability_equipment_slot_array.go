...
type CapabilityEquipmentSlotArray struct {
	...
	FirstIndex *float32 `json:"FirstIndex,omitempty" yaml:"FirstIndex,omitempty"`
	...
	HorizontalStartOffset *float32 `json:"HorizontalStartOffset,omitempty" yaml:"HorizontalStartOffset,omitempty"`
	// Inline Group Separation information for a Switch/Fabric-Interconnect hardware.
	InlineGroupSeparation *float32 `json:"InlineGroupSeparation,omitempty" yaml:"InlineGroupSeparation,omitempty"`
	// Inline Group Size information for a Switch/Fabric-Interconnect hardware.
	InlineGroupSize *float32 `json:"InlineGroupSize,omitempty" yaml:"InlineGroupSize,omitempty"`
	// Inline Offset information for a Switch/Fabric-Interconnect hardware.
	InlineOffset *float32 `json:"InlineOffset,omitempty" yaml:"InlineOffset,omitempty"`
	...
	NumberOfSlots *int64 `json:"NumberOfSlots,omitempty" yaml:"NumberOfSlots,omitempty"`
	...
	SlotsPerLine *int64 `json:"SlotsPerLine,omitempty" yaml:"SlotsPerLine,omitempty"`
	// Transverse Group Separation information for a Switch/Fabric-Interconnect hardware.
	TransverseGroupSeparation *float32 `json:"TransverseGroupSeparation,omitempty" yaml:"TransverseGroupSeparation,omitempty"`
	// Transverse Group Size information for a Switch/Fabric-Interconnect hardware.
	TransverseGroupSize *float32 `json:"TransverseGroupSize,omitempty" yaml:"TransverseGroupSize,omitempty"`
	// Transverse Offset information for a Switch/Fabric-Interconnect hardware.
	TransverseOffset *float32 `json:"TransverseOffset,omitempty" yaml:"TransverseOffset,omitempty"`
	// Vertical Start Offset information for a Switch/Fabric-Interconnect hardware.
	VerticalStartOffset *float32 `json:"VerticalStartOffset,omitempty" yaml:"VerticalStartOffset,omitempty"`
