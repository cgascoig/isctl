...
type HyperflexConfigResult struct {
	...
	ConfigProgress *string `json:"ConfigProgress,omitempty" yaml:"ConfigProgress,omitempty"`
	...
	ResultEntries *[]HyperflexConfigResultEntryRelationship `json:"ResultEntries,omitempty" yaml:"ResultEntries,omitempty"`
}
