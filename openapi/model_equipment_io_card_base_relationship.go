...
func (dst *EquipmentIoCardBaseRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "equipment.IoCardBase":
			var result *EquipmentIoCardBase = &EquipmentIoCardBase{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentIoCardBase = result
			return nil
		case "mo.MoRef":
...
func (src *EquipmentIoCardBaseRelationship) MarshalYAML() ([]byte, error) {
	if src.EquipmentIoCardBase != nil {
		return yaml.Marshal(&src.EquipmentIoCardBase)
	}
