...
func (dst *BootPxeDeviceResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "boot.PxeDevice.List":
			var result *BootPxeDeviceList = &BootPxeDeviceList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.BootPxeDeviceList = result
			return nil
...
func (src *BootPxeDeviceResponse) MarshalYAML() ([]byte, error) {
	if src.BootPxeDeviceList != nil {
		return yaml.Marshal(&src.BootPxeDeviceList)
	}
