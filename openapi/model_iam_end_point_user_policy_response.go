...
func (dst *IamEndPointUserPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iam.EndPointUserPolicy.List":
			var result *IamEndPointUserPolicyList = &IamEndPointUserPolicyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamEndPointUserPolicyList = result
			return nil
...
func (src *IamEndPointUserPolicyResponse) MarshalYAML() ([]byte, error) {
	if src.IamEndPointUserPolicyList != nil {
		return yaml.Marshal(&src.IamEndPointUserPolicyList)
	}
