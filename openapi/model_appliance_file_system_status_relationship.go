...
func (dst *ApplianceFileSystemStatusRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "appliance.FileSystemStatus":
			var result *ApplianceFileSystemStatus = &ApplianceFileSystemStatus{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ApplianceFileSystemStatus = result
			return nil
		case "mo.MoRef":
...
func (src *ApplianceFileSystemStatusRelationship) MarshalYAML() ([]byte, error) {
	if src.ApplianceFileSystemStatus != nil {
		return yaml.Marshal(&src.ApplianceFileSystemStatus)
	}
