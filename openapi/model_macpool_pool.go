...
type MacpoolPool struct {
	...
	MacBlocks  []MacpoolBlock `json:"MacBlocks,omitempty" yaml:"MacBlocks,omitempty"`
	// An array of relationships to macpoolIdBlock resources.
	BlockHeads   []MacpoolIdBlockRelationship          `json:"BlockHeads,omitempty" yaml:"BlockHeads,omitempty"`
