...
type CapabilityPortRangeAllOf struct {
	...
	EndPortId *int64 `json:"EndPortId,omitempty" yaml:"EndPortId,omitempty"`
	// Ending Slot ID in this range of ports.
	EndSlotId *int64 `json:"EndSlotId,omitempty" yaml:"EndSlotId,omitempty"`
	// Starting Port ID in this range of ports.
	StartPortId *int64 `json:"StartPortId,omitempty" yaml:"StartPortId,omitempty"`
	// Starting Slot ID in this range of ports.
	StartSlotId *int64 `json:"StartSlotId,omitempty" yaml:"StartSlotId,omitempty"`
}
