...
func (dst *IppoolShadowPoolResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "ippool.ShadowPool.List":
			var result *IppoolShadowPoolList = &IppoolShadowPoolList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IppoolShadowPoolList = result
			return nil
...
func (src *IppoolShadowPoolResponse) MarshalYAML() ([]byte, error) {
	if src.IppoolShadowPoolList != nil {
		return yaml.Marshal(&src.IppoolShadowPoolList)
	}
