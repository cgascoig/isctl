...
func (dst *HyperflexSoftwareDistributionComponentRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.SoftwareDistributionComponent":
			var result *HyperflexSoftwareDistributionComponent = &HyperflexSoftwareDistributionComponent{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexSoftwareDistributionComponent = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexSoftwareDistributionComponentRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexSoftwareDistributionComponent != nil {
		return yaml.Marshal(&src.HyperflexSoftwareDistributionComponent)
	}
