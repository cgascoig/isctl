...
type HyperflexHxapVirtualDisk struct {
	...
	SourceVirtualDisk *string                     `json:"SourceVirtualDisk,omitempty" yaml:"SourceVirtualDisk,omitempty"`
	Status            NullableHyperflexDiskStatus `json:"Status,omitempty" yaml:"Status,omitempty"`
