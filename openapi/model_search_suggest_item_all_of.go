...
type SearchSuggestItemAllOf struct {
	...
	CompleteMo *bool `json:"CompleteMo,omitempty" yaml:"CompleteMo,omitempty"`
	...
	SuggestTerm *string `json:"SuggestTerm,omitempty" yaml:"SuggestTerm,omitempty"`
	// Maximum number of results to be returned from external search engine.
	Top *int64 `json:"Top,omitempty" yaml:"Top,omitempty"`
