...
func (dst *ConfigExporterRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "config.Exporter":
			var result *ConfigExporter = &ConfigExporter{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ConfigExporter = result
			return nil
		case "mo.MoRef":
...
func (src *ConfigExporterRelationship) MarshalYAML() ([]byte, error) {
	if src.ConfigExporter != nil {
		return yaml.Marshal(&src.ConfigExporter)
	}
