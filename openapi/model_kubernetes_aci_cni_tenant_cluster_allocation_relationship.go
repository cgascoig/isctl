...
func (dst *KubernetesAciCniTenantClusterAllocationRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "kubernetes.AciCniTenantClusterAllocation":
			var result *KubernetesAciCniTenantClusterAllocation = &KubernetesAciCniTenantClusterAllocation{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesAciCniTenantClusterAllocation = result
			return nil
		case "mo.MoRef":
...
func (src *KubernetesAciCniTenantClusterAllocationRelationship) MarshalYAML() ([]byte, error) {
	if src.KubernetesAciCniTenantClusterAllocation != nil {
		return yaml.Marshal(&src.KubernetesAciCniTenantClusterAllocation)
	}
