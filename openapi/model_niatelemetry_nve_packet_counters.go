...
type NiatelemetryNvePacketCounters struct {
	...
	McastInpkts *int64 `json:"McastInpkts,omitempty" yaml:"McastInpkts,omitempty"`
	// Return mcast outbytes count.
	McastOutbytes *int64 `json:"McastOutbytes,omitempty" yaml:"McastOutbytes,omitempty"`
	// Return ucast in packet count.
	UcastInpkts *int64 `json:"UcastInpkts,omitempty" yaml:"UcastInpkts,omitempty"`
	// Return ucast out packet count.
	UcastOutpkts *int64 `json:"UcastOutpkts,omitempty" yaml:"UcastOutpkts,omitempty"`
}
