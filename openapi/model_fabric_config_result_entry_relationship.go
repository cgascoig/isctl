...
func (dst *FabricConfigResultEntryRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "fabric.ConfigResultEntry":
			var result *FabricConfigResultEntry = &FabricConfigResultEntry{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FabricConfigResultEntry = result
			return nil
		case "mo.MoRef":
...
func (src *FabricConfigResultEntryRelationship) MarshalYAML() ([]byte, error) {
	if src.FabricConfigResultEntry != nil {
		return yaml.Marshal(&src.FabricConfigResultEntry)
	}
