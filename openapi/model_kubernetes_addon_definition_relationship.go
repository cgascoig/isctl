...
func (dst *KubernetesAddonDefinitionRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "kubernetes.AddonDefinition":
			var result *KubernetesAddonDefinition = &KubernetesAddonDefinition{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesAddonDefinition = result
			return nil
		case "mo.MoRef":
...
func (src *KubernetesAddonDefinitionRelationship) MarshalYAML() ([]byte, error) {
	if src.KubernetesAddonDefinition != nil {
		return yaml.Marshal(&src.KubernetesAddonDefinition)
	}
