...
type KubernetesDaemonSetStatus struct {
	...
	NumberAvailable *string `json:"NumberAvailable,omitempty" yaml:"NumberAvailable,omitempty"`
	...
	UpdatedNumberScheduled *string `json:"UpdatedNumberScheduled,omitempty" yaml:"UpdatedNumberScheduled,omitempty"`
}
