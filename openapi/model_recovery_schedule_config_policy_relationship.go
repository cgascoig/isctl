...
func (dst *RecoveryScheduleConfigPolicyRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "mo.MoRef":
			...
			dst.MoMoRef = result
			return nil
		case "recovery.ScheduleConfigPolicy":
			var result *RecoveryScheduleConfigPolicy = &RecoveryScheduleConfigPolicy{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.RecoveryScheduleConfigPolicy = result
			return nil
		default:
...
func (src *RecoveryScheduleConfigPolicyRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.RecoveryScheduleConfigPolicy != nil {
		return yaml.Marshal(&src.RecoveryScheduleConfigPolicy)
	}
