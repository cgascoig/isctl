...
type FabricEthNetworkControlPolicyAllOf struct {
	...
	CdpEnabled *bool `json:"CdpEnabled,omitempty" yaml:"CdpEnabled,omitempty"`
	...
	ForgeMac     *string                    `json:"ForgeMac,omitempty" yaml:"ForgeMac,omitempty"`
	LldpSettings NullableFabricLldpSettings `json:"LldpSettings,omitempty" yaml:"LldpSettings,omitempty"`
	...
	MacRegistrationMode *string `json:"MacRegistrationMode,omitempty" yaml:"MacRegistrationMode,omitempty"`
	...
	UplinkFailAction *string `json:"UplinkFailAction,omitempty" yaml:"UplinkFailAction,omitempty"`
	// An array of relationships to vnicEthNetworkPolicy resources.
	NetworkPolicy []VnicEthNetworkPolicyRelationship    `json:"NetworkPolicy,omitempty" yaml:"NetworkPolicy,omitempty"`
