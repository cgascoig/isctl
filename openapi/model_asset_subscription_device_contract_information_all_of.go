...
type AssetSubscriptionDeviceContractInformationAllOf struct {
	...
	DeviceInformation NullableAssetDeviceInformation `json:"DeviceInformation,omitempty" yaml:"DeviceInformation,omitempty"`
	// Product identifier for the specified Cisco device. It is used to distinguish between HyperFlex and UCS devices.
	DevicePid *string `json:"DevicePid,omitempty" yaml:"DevicePid,omitempty"`
	// Identifies the consumption-based subscription.
	SubscriptionRefId         *string                                     `json:"SubscriptionRefId,omitempty" yaml:"SubscriptionRefId,omitempty"`
	DeviceContractInformation *AssetDeviceContractInformationRelationship `json:"DeviceContractInformation,omitempty" yaml:"DeviceContractInformation,omitempty"`
