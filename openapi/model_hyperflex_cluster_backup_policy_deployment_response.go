...
func (dst *HyperflexClusterBackupPolicyDeploymentResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "hyperflex.ClusterBackupPolicyDeployment.List":
			var result *HyperflexClusterBackupPolicyDeploymentList = &HyperflexClusterBackupPolicyDeploymentList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexClusterBackupPolicyDeploymentList = result
			return nil
...
func (src *HyperflexClusterBackupPolicyDeploymentResponse) MarshalYAML() ([]byte, error) {
	if src.HyperflexClusterBackupPolicyDeploymentList != nil {
		return yaml.Marshal(&src.HyperflexClusterBackupPolicyDeploymentList)
	}
