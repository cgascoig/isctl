...
func (dst *StorageHyperFlexStorageContainerRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "mo.MoRef":
			...
			dst.MoMoRef = result
			return nil
		case "storage.HyperFlexStorageContainer":
			var result *StorageHyperFlexStorageContainer = &StorageHyperFlexStorageContainer{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.StorageHyperFlexStorageContainer = result
			return nil
		default:
...
func (src *StorageHyperFlexStorageContainerRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.StorageHyperFlexStorageContainer != nil {
		return yaml.Marshal(&src.StorageHyperFlexStorageContainer)
	}
