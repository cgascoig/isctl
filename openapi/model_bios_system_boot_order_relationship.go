...
func (dst *BiosSystemBootOrderRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "bios.SystemBootOrder":
			var result *BiosSystemBootOrder = &BiosSystemBootOrder{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.BiosSystemBootOrder = result
			return nil
		case "mo.MoRef":
...
func (src *BiosSystemBootOrderRelationship) MarshalYAML() ([]byte, error) {
	if src.BiosSystemBootOrder != nil {
		return yaml.Marshal(&src.BiosSystemBootOrder)
	}
