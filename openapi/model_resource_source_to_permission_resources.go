...
type ResourceSourceToPermissionResources struct {
	...
	PermissionResources []CmrfCmRf       `json:"PermissionResources,omitempty" yaml:"PermissionResources,omitempty"`
	SourceObject        NullableCmrfCmRf `json:"SourceObject,omitempty" yaml:"SourceObject,omitempty"`
}
