...
type IqnpoolPool struct {
	...
	IqnSuffixBlocks []IqnpoolIqnSuffixBlock `json:"IqnSuffixBlocks,omitempty" yaml:"IqnSuffixBlocks,omitempty"`
	// The prefix for IQN blocks created for this pool.
	Prefix *string `json:"Prefix,omitempty" yaml:"Prefix,omitempty"`
	// An array of relationships to iqnpoolBlock resources.
	BlockHeads   []IqnpoolBlockRelationship            `json:"BlockHeads,omitempty" yaml:"BlockHeads,omitempty"`
