...
type OsGlobalConfigAllOf struct {
	...
	ConfigurationFileName *string `json:"ConfigurationFileName,omitempty" yaml:"ConfigurationFileName,omitempty"`
	...
	InstallTargetType         *string                             `json:"InstallTargetType,omitempty" yaml:"InstallTargetType,omitempty"`
	OperatingSystemParameters NullableOsOperatingSystemParameters `json:"OperatingSystemParameters,omitempty" yaml:"OperatingSystemParameters,omitempty"`
	// The Operating System Image name.
	OsImageName *string `json:"OsImageName,omitempty" yaml:"OsImageName,omitempty"`
	// The name of the Server Configuration Utilities Image.
	ScuImageName *string `json:"ScuImageName,omitempty" yaml:"ScuImageName,omitempty"`
	// The Windows OS edition, this property required only for Windows server.
	WindowsEdition *string `json:"WindowsEdition,omitempty" yaml:"WindowsEdition,omitempty"`
}
