...
type AssetDeviceRegistration struct {
	...
	ParentSignature NullableAssetParentConnectionSignature `json:"ParentSignature,omitempty" yaml:"ParentSignature,omitempty"`
	...
	ParentConnection    *AssetDeviceRegistrationRelationship  `json:"ParentConnection,omitempty" yaml:"ParentConnection,omitempty"`
}
