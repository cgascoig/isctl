...
func (dst *HyperflexSoftwareVersionPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "hyperflex.SoftwareVersionPolicy.List":
			var result *HyperflexSoftwareVersionPolicyList = &HyperflexSoftwareVersionPolicyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexSoftwareVersionPolicyList = result
			return nil
...
func (src *HyperflexSoftwareVersionPolicyResponse) MarshalYAML() ([]byte, error) {
	if src.HyperflexSoftwareVersionPolicyList != nil {
		return yaml.Marshal(&src.HyperflexSoftwareVersionPolicyList)
	}
