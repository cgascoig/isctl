...
func (dst *BootHddDeviceResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "boot.HddDevice.List":
			var result *BootHddDeviceList = &BootHddDeviceList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.BootHddDeviceList = result
			return nil
...
func (src *BootHddDeviceResponse) MarshalYAML() ([]byte, error) {
	if src.BootHddDeviceList != nil {
		return yaml.Marshal(&src.BootHddDeviceList)
	}
