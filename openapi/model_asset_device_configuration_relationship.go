...
func (dst *AssetDeviceConfigurationRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "asset.DeviceConfiguration":
			var result *AssetDeviceConfiguration = &AssetDeviceConfiguration{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.AssetDeviceConfiguration = result
			return nil
		case "mo.MoRef":
...
func (src *AssetDeviceConfigurationRelationship) MarshalYAML() ([]byte, error) {
	if src.AssetDeviceConfiguration != nil {
		return yaml.Marshal(&src.AssetDeviceConfiguration)
	}
