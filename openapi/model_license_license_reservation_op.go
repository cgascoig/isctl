...
type LicenseLicenseReservationOp struct {
	...
	AuthCodeInstalled *bool `json:"AuthCodeInstalled,omitempty" yaml:"AuthCodeInstalled,omitempty"`
	// Confirm code used to complete the license update on smart license account.
	ConfirmCode *string `json:"ConfirmCode,omitempty" yaml:"ConfirmCode,omitempty"`
	// Trigger the generation of request code for specific license reservation.
	GenerateRequestCode *bool `json:"GenerateRequestCode,omitempty" yaml:"GenerateRequestCode,omitempty"`
	// Trigger the generation of return code for specific license reservation.
	GenerateReturnCode *bool `json:"GenerateReturnCode,omitempty" yaml:"GenerateReturnCode,omitempty"`
	// Revervation code used to generate authorization code from CSSM.
	RequestCode *string `json:"RequestCode,omitempty" yaml:"RequestCode,omitempty"`
	// Return code used to return the reserved license to smart license account.
	ReturnCode *string                 `json:"ReturnCode,omitempty" yaml:"ReturnCode,omitempty"`
