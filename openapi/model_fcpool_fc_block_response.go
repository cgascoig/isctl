...
func (dst *FcpoolFcBlockResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "fcpool.FcBlock.List":
			var result *FcpoolFcBlockList = &FcpoolFcBlockList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FcpoolFcBlockList = result
			return nil
...
func (src *FcpoolFcBlockResponse) MarshalYAML() ([]byte, error) {
	if src.FcpoolFcBlockList != nil {
		return yaml.Marshal(&src.FcpoolFcBlockList)
	}
