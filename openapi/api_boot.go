...
func (r apiGetBootDeviceBootSecurityByMoidRequest) Execute() (BootDeviceBootSecurity, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "BootApiService.GetBootDeviceBootSecurityByMoid")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiGetBootDeviceBootSecurityListRequest) Execute() (BootDeviceBootSecurityResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "BootApiService.GetBootDeviceBootSecurityList")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiPatchBootDeviceBootSecurityRequest) Execute() (BootDeviceBootSecurity, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "BootApiService.PatchBootDeviceBootSecurity")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiUpdateBootDeviceBootSecurityRequest) Execute() (BootDeviceBootSecurity, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "BootApiService.UpdateBootDeviceBootSecurity")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
