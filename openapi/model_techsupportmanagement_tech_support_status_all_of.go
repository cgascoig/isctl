...
type TechsupportmanagementTechSupportStatusAllOf struct {
	...
	RelayReason *string `json:"RelayReason,omitempty" yaml:"RelayReason,omitempty"`
	// Status of techsupport status relay. Valid values are NoRelay, Pending, Completed, and Failed.
	RelayStatus *string `json:"RelayStatus,omitempty" yaml:"RelayStatus,omitempty"`
	// The time at which the techsupport request was initiated.
	RequestTs *time.Time `json:"RequestTs,omitempty" yaml:"RequestTs,omitempty"`
	...
	TechsupportDownloadUrl *string                                             `json:"TechsupportDownloadUrl,omitempty" yaml:"TechsupportDownloadUrl,omitempty"`
	...
	OriginResource         *MoBaseMoRelationship                               `json:"OriginResource,omitempty" yaml:"OriginResource,omitempty"`
	TechSupportRequest     *TechsupportmanagementTechSupportBundleRelationship `json:"TechSupportRequest,omitempty" yaml:"TechSupportRequest,omitempty"`
}
