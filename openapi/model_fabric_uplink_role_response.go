...
func (dst *FabricUplinkRoleResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "fabric.UplinkRole.List":
			var result *FabricUplinkRoleList = &FabricUplinkRoleList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FabricUplinkRoleList = result
			return nil
...
func (src *FabricUplinkRoleResponse) MarshalYAML() ([]byte, error) {
	if src.FabricUplinkRoleList != nil {
		return yaml.Marshal(&src.FabricUplinkRoleList)
	}
