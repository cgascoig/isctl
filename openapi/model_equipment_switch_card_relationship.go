...
func (dst *EquipmentSwitchCardRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "equipment.SwitchCard":
			var result *EquipmentSwitchCard = &EquipmentSwitchCard{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentSwitchCard = result
			return nil
		case "mo.MoRef":
...
func (src *EquipmentSwitchCardRelationship) MarshalYAML() ([]byte, error) {
	if src.EquipmentSwitchCard != nil {
		return yaml.Marshal(&src.EquipmentSwitchCard)
	}
