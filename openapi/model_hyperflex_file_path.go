...
type HyperflexFilePath struct {
	...
	DsInfo     NullableHyperflexDatastoreInfo `json:"DsInfo,omitempty" yaml:"DsInfo,omitempty"`
	// Relative file path within the datastore.
	RelativeFilePath *string `json:"RelativeFilePath,omitempty" yaml:"RelativeFilePath,omitempty"`
}
