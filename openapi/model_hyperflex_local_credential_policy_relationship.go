...
func (dst *HyperflexLocalCredentialPolicyRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.LocalCredentialPolicy":
			var result *HyperflexLocalCredentialPolicy = &HyperflexLocalCredentialPolicy{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexLocalCredentialPolicy = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexLocalCredentialPolicyRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexLocalCredentialPolicy != nil {
		return yaml.Marshal(&src.HyperflexLocalCredentialPolicy)
	}
