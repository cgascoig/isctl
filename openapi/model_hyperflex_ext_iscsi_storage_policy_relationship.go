...
func (dst *HyperflexExtIscsiStoragePolicyRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.ExtIscsiStoragePolicy":
			var result *HyperflexExtIscsiStoragePolicy = &HyperflexExtIscsiStoragePolicy{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexExtIscsiStoragePolicy = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexExtIscsiStoragePolicyRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexExtIscsiStoragePolicy != nil {
		return yaml.Marshal(&src.HyperflexExtIscsiStoragePolicy)
	}
