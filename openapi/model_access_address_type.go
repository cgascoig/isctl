...
// AccessAddressType The type of IP address to be configured on the CIMC. Available options are IPv4 and/or IPv6.
type AccessAddressType struct {
	MoBaseComplexType
...
type _AccessAddressType AccessAddressType
...
func (o AccessAddressType) MarshalJSON() ([]byte, error) {
...
func (o *AccessAddressType) UnmarshalJSON(bytes []byte) (err error) {
	type AccessAddressTypeWithoutEmbeddedStruct struct {
		// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
		ClassId string `json:"ClassId"`
		// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
		ObjectType string `json:"ObjectType"`
	...
	varAccessAddressTypeWithoutEmbeddedStruct := AccessAddressTypeWithoutEmbeddedStruct{}

	err = json.Unmarshal(bytes, &varAccessAddressTypeWithoutEmbeddedStruct)
	if err == nil {
		varAccessAddressType := _AccessAddressType{}
		varAccessAddressType.ClassId = varAccessAddressTypeWithoutEmbeddedStruct.ClassId
		varAccessAddressType.ObjectType = varAccessAddressTypeWithoutEmbeddedStruct.ObjectType
		varAccessAddressType.EnableIpV4 = varAccessAddressTypeWithoutEmbeddedStruct.EnableIpV4
		varAccessAddressType.EnableIpV6 = varAccessAddressTypeWithoutEmbeddedStruct.EnableIpV6
		*o = AccessAddressType(varAccessAddressType)
	} else {
		return err
	}
	...
	err = json.Unmarshal(bytes, &varAccessAddressType)
	if err == nil {
		o.MoBaseComplexType = varAccessAddressType.MoBaseComplexType
	} else {
		return err
	}
...
type NullableAccessAddressType struct {
	value *AccessAddressType
	isSet bool
}

func (v NullableAccessAddressType) Get() *AccessAddressType {
	return v.value
}

func (v *NullableAccessAddressType) Set(val *AccessAddressType) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessAddressType) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessAddressType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessAddressType(val *AccessAddressType) *NullableAccessAddressType {
	return &NullableAccessAddressType{value: val, isSet: true}
}

func (v NullableAccessAddressType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessAddressType) UnmarshalJSON(src []byte) error {
	v.isSet = true
