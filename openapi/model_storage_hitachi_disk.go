...
type StorageHitachiDisk struct {
	...
	// Drive type code.
	DriveTypeCode *string `json:"DriveTypeCode,omitempty" yaml:"DriveTypeCode,omitempty"`
	// Parity group number. When the drive does not belong to any parity group, an empty character string is output.
	ParityGroupId *string `json:"ParityGroupId,omitempty" yaml:"ParityGroupId,omitempty"`
	...
	ParityGroup      *StorageHitachiParityGroupRelationship `json:"ParityGroup,omitempty" yaml:"ParityGroup,omitempty"`
