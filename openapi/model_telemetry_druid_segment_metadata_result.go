...
type TelemetryDruidSegmentMetadataResult struct {
	...
	Aggregators *map[string]interface{} `json:"aggregators,omitempty" yaml:"aggregators,omitempty"`
	// query granularity of data stored in segments, may be 'null'
	QueryGranularity *map[string]interface{} `json:"queryGranularity,omitempty" yaml:"queryGranularity,omitempty"`
	...
	NumRows *int32 `json:"numRows,omitempty" yaml:"numRows,omitempty"`
}
