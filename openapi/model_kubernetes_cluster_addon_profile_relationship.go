...
func (dst *KubernetesClusterAddonProfileRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "kubernetes.ClusterAddonProfile":
			var result *KubernetesClusterAddonProfile = &KubernetesClusterAddonProfile{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesClusterAddonProfile = result
			return nil
		case "mo.MoRef":
...
func (src *KubernetesClusterAddonProfileRelationship) MarshalYAML() ([]byte, error) {
	if src.KubernetesClusterAddonProfile != nil {
		return yaml.Marshal(&src.KubernetesClusterAddonProfile)
	}
