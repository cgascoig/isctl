...
func (dst *NiatelemetryDcnmTransceiverDetailsResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		...
		case "mo.TagSummary":
			...
			return nil
		case "niatelemetry.DcnmTransceiverDetails.List":
			var result *NiatelemetryDcnmTransceiverDetailsList = &NiatelemetryDcnmTransceiverDetailsList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.NiatelemetryDcnmTransceiverDetailsList = result
			return nil
		default:
...
func (src *NiatelemetryDcnmTransceiverDetailsResponse) MarshalYAML() ([]byte, error) {
	if src.MoAggregateTransform != nil {
	...
	if src.NiatelemetryDcnmTransceiverDetailsList != nil {
		return yaml.Marshal(&src.NiatelemetryDcnmTransceiverDetailsList)
	}
