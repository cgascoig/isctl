...
func (dst *HyperflexClusterProfileResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "hyperflex.ClusterProfile.List":
			var result *HyperflexClusterProfileList = &HyperflexClusterProfileList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexClusterProfileList = result
			return nil
...
func (src *HyperflexClusterProfileResponse) MarshalYAML() ([]byte, error) {
	if src.HyperflexClusterProfileList != nil {
		return yaml.Marshal(&src.HyperflexClusterProfileList)
	}
