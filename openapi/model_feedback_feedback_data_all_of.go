...
type FeedbackFeedbackDataAllOf struct {
	...
	AlternativeFollowUpEmails *[]string `json:"AlternativeFollowUpEmails,omitempty" yaml:"AlternativeFollowUpEmails,omitempty"`
	...
	FollowUp *bool `json:"FollowUp,omitempty" yaml:"FollowUp,omitempty"`
	// Bunch of last traceId for reproducing user last activity.
	TraceIds *map[string]interface{} `json:"TraceIds,omitempty" yaml:"TraceIds,omitempty"`
