...
type CapabilityPortGroupAggregationDef struct {
	...
	AggregationCap *string `json:"AggregationCap,omitempty" yaml:"AggregationCap,omitempty"`
	// Indicates support for 40G port group capability.
	Hw40GPortGroupCap *bool `json:"Hw40GPortGroupCap,omitempty" yaml:"Hw40GPortGroupCap,omitempty"`
	// The type of port group for which this capability is defined.
	Pgtype *string `json:"Pgtype,omitempty" yaml:"Pgtype,omitempty"`
}
