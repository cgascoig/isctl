...
type KubernetesAciCniTenantClusterAllocationAllOf struct {
	...
	NodeSvcIpSubnet *string `json:"NodeSvcIpSubnet,omitempty" yaml:"NodeSvcIpSubnet,omitempty"`
	// CIDR allocated for pod IPs in this tenant cluster.
	PodIpSubnet *string `json:"PodIpSubnet,omitempty" yaml:"PodIpSubnet,omitempty"`
	// End of VLAN range allocated to this tenant cluster.
	VlanEnd *string `json:"VlanEnd,omitempty" yaml:"VlanEnd,omitempty"`
	// Start of VLAN range allocated to this tenant cluster.
	VlanStart    *string                               `json:"VlanStart,omitempty" yaml:"VlanStart,omitempty"`
