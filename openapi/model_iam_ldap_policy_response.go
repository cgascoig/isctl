...
func (dst *IamLdapPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iam.LdapPolicy.List":
			var result *IamLdapPolicyList = &IamLdapPolicyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamLdapPolicyList = result
			return nil
...
func (src *IamLdapPolicyResponse) MarshalYAML() ([]byte, error) {
	if src.IamLdapPolicyList != nil {
		return yaml.Marshal(&src.IamLdapPolicyList)
	}
