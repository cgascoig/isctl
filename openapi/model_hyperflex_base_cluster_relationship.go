...
func (dst *HyperflexBaseClusterRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.BaseCluster":
			var result *HyperflexBaseCluster = &HyperflexBaseCluster{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexBaseCluster = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexBaseClusterRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexBaseCluster != nil {
		return yaml.Marshal(&src.HyperflexBaseCluster)
	}
