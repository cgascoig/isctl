...
func (dst *FabricLinkControlPolicyRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "fabric.LinkControlPolicy":
			var result *FabricLinkControlPolicy = &FabricLinkControlPolicy{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FabricLinkControlPolicy = result
			return nil
		case "mo.MoRef":
...
func (src *FabricLinkControlPolicyRelationship) MarshalYAML() ([]byte, error) {
	if src.FabricLinkControlPolicy != nil {
		return yaml.Marshal(&src.FabricLinkControlPolicy)
	}
