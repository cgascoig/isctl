...
type InventoryGenericInventoryAllOf struct {
	...
	InventoryGenericInventoryHolder *InventoryGenericInventoryHolderRelationship `json:"InventoryGenericInventoryHolder,omitempty" yaml:"InventoryGenericInventoryHolder,omitempty"`
