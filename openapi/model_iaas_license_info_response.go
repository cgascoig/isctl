...
func (dst *IaasLicenseInfoResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iaas.LicenseInfo.List":
			var result *IaasLicenseInfoList = &IaasLicenseInfoList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IaasLicenseInfoList = result
			return nil
...
func (src *IaasLicenseInfoResponse) MarshalYAML() ([]byte, error) {
	if src.IaasLicenseInfoList != nil {
		return yaml.Marshal(&src.IaasLicenseInfoList)
	}
