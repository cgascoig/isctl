...
func (dst *StorageFlexFlashPhysicalDriveRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "mo.MoRef":
			...
			dst.MoMoRef = result
			return nil
		case "storage.FlexFlashPhysicalDrive":
			var result *StorageFlexFlashPhysicalDrive = &StorageFlexFlashPhysicalDrive{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.StorageFlexFlashPhysicalDrive = result
			return nil
		default:
...
func (src *StorageFlexFlashPhysicalDriveRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.StorageFlexFlashPhysicalDrive != nil {
		return yaml.Marshal(&src.StorageFlexFlashPhysicalDrive)
	}
