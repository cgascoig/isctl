...
func (dst *FirmwareDriverDistributableResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "firmware.DriverDistributable.List":
			var result *FirmwareDriverDistributableList = &FirmwareDriverDistributableList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FirmwareDriverDistributableList = result
			return nil
...
func (src *FirmwareDriverDistributableResponse) MarshalYAML() ([]byte, error) {
	if src.FirmwareDriverDistributableList != nil {
		return yaml.Marshal(&src.FirmwareDriverDistributableList)
	}
