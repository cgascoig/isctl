...
type VnicSanConnectivityPolicyAllOf struct {
	...
	StaticWwnnAddress *string `json:"StaticWwnnAddress,omitempty" yaml:"StaticWwnnAddress,omitempty"`
	...
	WwnnAddressType *string `json:"WwnnAddressType,omitempty" yaml:"WwnnAddressType,omitempty"`
