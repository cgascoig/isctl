...
func (dst *EquipmentSharedIoModuleResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "equipment.SharedIoModule.List":
			var result *EquipmentSharedIoModuleList = &EquipmentSharedIoModuleList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentSharedIoModuleList = result
			return nil
...
func (src *EquipmentSharedIoModuleResponse) MarshalYAML() ([]byte, error) {
	if src.EquipmentSharedIoModuleList != nil {
		return yaml.Marshal(&src.EquipmentSharedIoModuleList)
	}
