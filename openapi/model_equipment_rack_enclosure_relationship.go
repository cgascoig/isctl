...
func (dst *EquipmentRackEnclosureRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "equipment.RackEnclosure":
			var result *EquipmentRackEnclosure = &EquipmentRackEnclosure{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentRackEnclosure = result
			return nil
		case "mo.MoRef":
...
func (src *EquipmentRackEnclosureRelationship) MarshalYAML() ([]byte, error) {
	if src.EquipmentRackEnclosure != nil {
		return yaml.Marshal(&src.EquipmentRackEnclosure)
	}
