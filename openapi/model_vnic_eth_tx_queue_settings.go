...
func (o *VnicEthTxQueueSettings) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err == nil {
		...
		varVnicEthTxQueueSettings.ClassId = varVnicEthTxQueueSettingsWithoutEmbeddedStruct.ClassId
		varVnicEthTxQueueSettings.ObjectType = varVnicEthTxQueueSettingsWithoutEmbeddedStruct.ObjectType
