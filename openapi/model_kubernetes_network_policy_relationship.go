...
func (dst *KubernetesNetworkPolicyRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "kubernetes.NetworkPolicy":
			var result *KubernetesNetworkPolicy = &KubernetesNetworkPolicy{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesNetworkPolicy = result
			return nil
		case "mo.MoRef":
...
func (src *KubernetesNetworkPolicyRelationship) MarshalYAML() ([]byte, error) {
	if src.KubernetesNetworkPolicy != nil {
		return yaml.Marshal(&src.KubernetesNetworkPolicy)
	}
