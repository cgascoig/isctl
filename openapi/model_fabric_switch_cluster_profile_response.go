...
func (dst *FabricSwitchClusterProfileResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "fabric.SwitchClusterProfile.List":
			var result *FabricSwitchClusterProfileList = &FabricSwitchClusterProfileList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FabricSwitchClusterProfileList = result
			return nil
...
func (src *FabricSwitchClusterProfileResponse) MarshalYAML() ([]byte, error) {
	if src.FabricSwitchClusterProfileList != nil {
		return yaml.Marshal(&src.FabricSwitchClusterProfileList)
	}
