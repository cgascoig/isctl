...
func (dst *KubernetesContainerRuntimePolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "kubernetes.ContainerRuntimePolicy.List":
			var result *KubernetesContainerRuntimePolicyList = &KubernetesContainerRuntimePolicyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesContainerRuntimePolicyList = result
			return nil
...
func (src *KubernetesContainerRuntimePolicyResponse) MarshalYAML() ([]byte, error) {
	if src.KubernetesContainerRuntimePolicyList != nil {
		return yaml.Marshal(&src.KubernetesContainerRuntimePolicyList)
	}
