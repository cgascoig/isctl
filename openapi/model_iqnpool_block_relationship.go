...
func (dst *IqnpoolBlockRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "iqnpool.Block":
			var result *IqnpoolBlock = &IqnpoolBlock{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IqnpoolBlock = result
			return nil
		case "mo.MoRef":
...
func (src *IqnpoolBlockRelationship) MarshalYAML() ([]byte, error) {
	if src.IqnpoolBlock != nil {
		return yaml.Marshal(&src.IqnpoolBlock)
	}
