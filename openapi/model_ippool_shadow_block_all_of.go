...
type IppoolShadowBlockAllOf struct {
	...
	IpV4Block *IppoolIpV4Block              `json:"IpV4Block,omitempty" yaml:"IpV4Block,omitempty"`
	IpV6Block *IppoolIpV6Block              `json:"IpV6Block,omitempty" yaml:"IpV6Block,omitempty"`
