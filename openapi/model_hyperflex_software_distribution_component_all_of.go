...
type HyperflexSoftwareDistributionComponentAllOf struct {
	...
	FilesToDownload []string `json:"FilesToDownload,omitempty" yaml:"FilesToDownload,omitempty"`
	// The HyperFlex Software Distribution Component Version.
	Version                     *string                                           `json:"Version,omitempty" yaml:"Version,omitempty"`
	SoftwareDistributionVersion *HyperflexSoftwareDistributionVersionRelationship `json:"SoftwareDistributionVersion,omitempty" yaml:"SoftwareDistributionVersion,omitempty"`
}
