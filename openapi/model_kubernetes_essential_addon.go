...
type KubernetesEssentialAddon struct {
	...
	AddonConfiguration NullableKubernetesAddonConfiguration `json:"AddonConfiguration,omitempty" yaml:"AddonConfiguration,omitempty"`
	AddonDefinition    *MoMoRef                             `json:"AddonDefinition,omitempty" yaml:"AddonDefinition,omitempty"`
