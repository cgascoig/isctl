...
func (dst *SoftwarerepositoryReleaseRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "mo.MoRef":
			...
			dst.MoMoRef = result
			return nil
		case "softwarerepository.Release":
			var result *SoftwarerepositoryRelease = &SoftwarerepositoryRelease{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.SoftwarerepositoryRelease = result
			return nil
		default:
...
func (src *SoftwarerepositoryReleaseRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.SoftwarerepositoryRelease != nil {
		return yaml.Marshal(&src.SoftwarerepositoryRelease)
	}
