...
type KubernetesAddonPolicyAllOf struct {
	...
	SystemManaged *bool `json:"SystemManaged,omitempty" yaml:"SystemManaged,omitempty"`
	// An array of relationships to kubernetesAddon resources.
	Addons []KubernetesAddonRelationship `json:"Addons,omitempty" yaml:"Addons,omitempty"`
