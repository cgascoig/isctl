...
func (dst *FcpoolPoolMemberRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "fcpool.PoolMember":
			var result *FcpoolPoolMember = &FcpoolPoolMember{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FcpoolPoolMember = result
			return nil
		case "mo.MoRef":
...
func (src *FcpoolPoolMemberRelationship) MarshalYAML() ([]byte, error) {
	if src.FcpoolPoolMember != nil {
		return yaml.Marshal(&src.FcpoolPoolMember)
	}
