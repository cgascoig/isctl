...
type ConnectorAuthMessage struct {
	...
	RemoteUserLocale *string `json:"RemoteUserLocale,omitempty" yaml:"RemoteUserLocale,omitempty"`
	// The user name passed to the platform for use in platform audit logs.
	RemoteUserName *string `json:"RemoteUserName,omitempty" yaml:"RemoteUserName,omitempty"`
	// The list of roles to pass to the platform to validate the action against.
	RemoteUserRoles *string `json:"RemoteUserRoles,omitempty" yaml:"RemoteUserRoles,omitempty"`
	// The session Id passed to the platform for use in platforms auditing.
	RemoteUserSessionId *string `json:"RemoteUserSessionId,omitempty" yaml:"RemoteUserSessionId,omitempty"`
}
