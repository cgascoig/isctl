...
func (dst *CondHclStatusRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "cond.HclStatus":
			var result *CondHclStatus = &CondHclStatus{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.CondHclStatus = result
			return nil
		case "mo.MoRef":
...
func (src *CondHclStatusRelationship) MarshalYAML() ([]byte, error) {
	if src.CondHclStatus != nil {
		return yaml.Marshal(&src.CondHclStatus)
	}
