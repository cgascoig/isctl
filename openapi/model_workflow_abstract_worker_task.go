...
type WorkflowAbstractWorkerTask struct {
	WorkflowWorkflowTask `yaml:"WorkflowWorkflowTask,inline"`
	...
	InputParameters *map[string]interface{} `json:"InputParameters,omitempty" yaml:"InputParameters,omitempty"`
