...
type SyslogPolicyAllOf struct {
	...
	LocalClients  []SyslogLocalClientBase               `json:"LocalClients,omitempty" yaml:"LocalClients,omitempty"`
	RemoteClients []SyslogRemoteClientBase              `json:"RemoteClients,omitempty" yaml:"RemoteClients,omitempty"`
