...
func (dst *ApplianceGroupStatusRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "appliance.GroupStatus":
			var result *ApplianceGroupStatus = &ApplianceGroupStatus{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ApplianceGroupStatus = result
			return nil
		case "mo.MoRef":
...
func (src *ApplianceGroupStatusRelationship) MarshalYAML() ([]byte, error) {
	if src.ApplianceGroupStatus != nil {
		return yaml.Marshal(&src.ApplianceGroupStatus)
	}
