...
func (dst *HyperflexHealthCheckPackageChecksumResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "hyperflex.HealthCheckPackageChecksum.List":
			var result *HyperflexHealthCheckPackageChecksumList = &HyperflexHealthCheckPackageChecksumList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexHealthCheckPackageChecksumList = result
			return nil
...
func (src *HyperflexHealthCheckPackageChecksumResponse) MarshalYAML() ([]byte, error) {
	if src.HyperflexHealthCheckPackageChecksumList != nil {
		return yaml.Marshal(&src.HyperflexHealthCheckPackageChecksumList)
	}
