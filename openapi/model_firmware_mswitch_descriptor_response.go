...
func (dst *FirmwareMswitchDescriptorResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "firmware.MswitchDescriptor.List":
			var result *FirmwareMswitchDescriptorList = &FirmwareMswitchDescriptorList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FirmwareMswitchDescriptorList = result
			return nil
...
func (src *FirmwareMswitchDescriptorResponse) MarshalYAML() ([]byte, error) {
	if src.FirmwareMswitchDescriptorList != nil {
		return yaml.Marshal(&src.FirmwareMswitchDescriptorList)
	}
