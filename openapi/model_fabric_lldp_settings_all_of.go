...
type FabricLldpSettingsAllOf struct {
	...
	ReceiveEnabled *bool `json:"ReceiveEnabled,omitempty" yaml:"ReceiveEnabled,omitempty"`
	// Determines if the LLDP frames can be transmitted by an interface on the switch.
	TransmitEnabled *bool `json:"TransmitEnabled,omitempty" yaml:"TransmitEnabled,omitempty"`
}
