...
func (dst *AdapterHostIscsiInterfaceRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "adapter.HostIscsiInterface":
			var result *AdapterHostIscsiInterface = &AdapterHostIscsiInterface{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.AdapterHostIscsiInterface = result
			return nil
		case "mo.MoRef":
...
func (src *AdapterHostIscsiInterfaceRelationship) MarshalYAML() ([]byte, error) {
	if src.AdapterHostIscsiInterface != nil {
		return yaml.Marshal(&src.AdapterHostIscsiInterface)
	}
