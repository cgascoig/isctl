...
type TechsupportmanagementPlatformParamAllOf struct {
	...
	CollectionType *int32 `json:"CollectionType,omitempty" yaml:"CollectionType,omitempty"`
	// Controls whether to include core file in the techsupport bundle.
	IncludeCore *bool `json:"IncludeCore,omitempty" yaml:"IncludeCore,omitempty"`
}
