...
func (dst *IaasMostRunTasksResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iaas.MostRunTasks.List":
			var result *IaasMostRunTasksList = &IaasMostRunTasksList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IaasMostRunTasksList = result
			return nil
...
func (src *IaasMostRunTasksResponse) MarshalYAML() ([]byte, error) {
	if src.IaasMostRunTasksList != nil {
		return yaml.Marshal(&src.IaasMostRunTasksList)
	}
