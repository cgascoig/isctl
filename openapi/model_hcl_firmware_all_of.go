...
type HclFirmwareAllOf struct {
	...
	LatestDriver *bool `json:"LatestDriver,omitempty" yaml:"LatestDriver,omitempty"`
	// True if the firmware is latest recommended firmware.
	LatestFirmware *bool `json:"LatestFirmware,omitempty" yaml:"LatestFirmware,omitempty"`
}
