...
type FabricMulticastPolicyAllOf struct {
	...
	QuerierIpAddress *string `json:"QuerierIpAddress,omitempty" yaml:"QuerierIpAddress,omitempty"`
	// Used to define the IGMP Querier IP address of the peer switch.
	QuerierIpAddressPeer *string `json:"QuerierIpAddressPeer,omitempty" yaml:"QuerierIpAddressPeer,omitempty"`
	...
	QuerierState *string `json:"QuerierState,omitempty" yaml:"QuerierState,omitempty"`
	...
	SnoopingState *string                               `json:"SnoopingState,omitempty" yaml:"SnoopingState,omitempty"`
