...
func (dst *IamCertificateRequestResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iam.CertificateRequest.List":
			var result *IamCertificateRequestList = &IamCertificateRequestList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamCertificateRequestList = result
			return nil
...
func (src *IamCertificateRequestResponse) MarshalYAML() ([]byte, error) {
	if src.IamCertificateRequestList != nil {
		return yaml.Marshal(&src.IamCertificateRequestList)
	}
