...
type HyperflexReplicationStatus struct {
	...
	BytesReplicated *int64 `json:"BytesReplicated,omitempty" yaml:"BytesReplicated,omitempty"`
	...
	PackEntityReference NullableHyperflexEntityReference `json:"PackEntityReference,omitempty" yaml:"PackEntityReference,omitempty"`
	// Completion percentage for the replication job.
	PctComplete *int64                     `json:"PctComplete,omitempty" yaml:"PctComplete,omitempty"`
	RpoStatus   NullableHyperflexRpoStatus `json:"RpoStatus,omitempty" yaml:"RpoStatus,omitempty"`
