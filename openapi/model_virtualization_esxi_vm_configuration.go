...
type VirtualizationEsxiVmConfiguration struct {
	...
	Compute    NullableVirtualizationEsxiVmComputeConfiguration `json:"Compute,omitempty" yaml:"Compute,omitempty"`
	Customspec NullableVirtualizationBaseCustomSpec             `json:"Customspec,omitempty" yaml:"Customspec,omitempty"`
	...
	Network NullableVirtualizationEsxiVmNetworkConfiguration `json:"Network,omitempty" yaml:"Network,omitempty"`
	Storage NullableVirtualizationEsxiVmStorageConfiguration `json:"Storage,omitempty" yaml:"Storage,omitempty"`
