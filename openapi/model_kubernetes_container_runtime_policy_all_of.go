...
type KubernetesContainerRuntimePolicyAllOf struct {
	...
	DockerBridgeNetworkCidr *string                       `json:"DockerBridgeNetworkCidr,omitempty" yaml:"DockerBridgeNetworkCidr,omitempty"`
	DockerHttpProxy         NullableKubernetesProxyConfig `json:"DockerHttpProxy,omitempty" yaml:"DockerHttpProxy,omitempty"`
	DockerHttpsProxy        NullableKubernetesProxyConfig `json:"DockerHttpsProxy,omitempty" yaml:"DockerHttpsProxy,omitempty"`
	DockerNoProxy           []string                      `json:"DockerNoProxy,omitempty" yaml:"DockerNoProxy,omitempty"`
