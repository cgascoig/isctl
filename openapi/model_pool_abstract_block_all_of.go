...
type PoolAbstractBlockAllOf struct {
	...
	FreeBlockCount *int64 `json:"FreeBlockCount,omitempty" yaml:"FreeBlockCount,omitempty"`
	// Moving counter to allocate the next identifier.
	NextIdAllocator *int64 `json:"NextIdAllocator,omitempty" yaml:"NextIdAllocator,omitempty"`
}
