...
func (dst *StoragePureReplicationScheduleResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		...
		case "mo.DocumentCount":
			...
			return nil
		case "storage.PureReplicationSchedule.List":
			var result *StoragePureReplicationScheduleList = &StoragePureReplicationScheduleList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.StoragePureReplicationScheduleList = result
			return nil
		default:
...
func (src *StoragePureReplicationScheduleResponse) MarshalYAML() ([]byte, error) {
	if src.MoDocumentCount != nil {
		return yaml.Marshal(&src.MoDocumentCount)
	}

	if src.StoragePureReplicationScheduleList != nil {
		return yaml.Marshal(&src.StoragePureReplicationScheduleList)
	}
