...
func (dst *StorageFlexFlashControllerPropsRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "mo.MoRef":
			...
			dst.MoMoRef = result
			return nil
		case "storage.FlexFlashControllerProps":
			var result *StorageFlexFlashControllerProps = &StorageFlexFlashControllerProps{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.StorageFlexFlashControllerProps = result
			return nil
		default:
...
func (src *StorageFlexFlashControllerPropsRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.StorageFlexFlashControllerProps != nil {
		return yaml.Marshal(&src.StorageFlexFlashControllerProps)
	}
