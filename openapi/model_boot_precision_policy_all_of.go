...
type BootPrecisionPolicyAllOf struct {
	...
	BootDevices []BootDeviceBase `json:"BootDevices,omitempty" yaml:"BootDevices,omitempty"`
	...
	EnforceUefiSecureBoot *bool                                 `json:"EnforceUefiSecureBoot,omitempty" yaml:"EnforceUefiSecureBoot,omitempty"`
