...
type CapabilityEndpointDescriptorAllOf struct {
	...
	Capabilities []CapabilityCapabilityRelationship `json:"Capabilities,omitempty" yaml:"Capabilities,omitempty"`
	Section      *CapabilitySectionRelationship     `json:"Section,omitempty" yaml:"Section,omitempty"`
}
