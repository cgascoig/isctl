...
type SdwanRouterPolicy struct {
	...
	WanCount *int64 `json:"WanCount,omitempty" yaml:"WanCount,omitempty"`
	...
	WanTerminationType *string                               `json:"WanTerminationType,omitempty" yaml:"WanTerminationType,omitempty"`
	...
	Profiles      []SdwanProfileRelationship                 `json:"Profiles,omitempty" yaml:"Profiles,omitempty"`
	SolutionImage *SoftwareSolutionDistributableRelationship `json:"SolutionImage,omitempty" yaml:"SolutionImage,omitempty"`
}
