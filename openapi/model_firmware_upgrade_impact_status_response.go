...
func (dst *FirmwareUpgradeImpactStatusResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "firmware.UpgradeImpactStatus.List":
			var result *FirmwareUpgradeImpactStatusList = &FirmwareUpgradeImpactStatusList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FirmwareUpgradeImpactStatusList = result
			return nil
...
func (src *FirmwareUpgradeImpactStatusResponse) MarshalYAML() ([]byte, error) {
	if src.FirmwareUpgradeImpactStatusList != nil {
		return yaml.Marshal(&src.FirmwareUpgradeImpactStatusList)
	}
