...
type KubernetesAddonDefinition struct {
	...
	DefaultInstallStrategy *string `json:"DefaultInstallStrategy,omitempty" yaml:"DefaultInstallStrategy,omitempty"`
	...
	DefaultUpgradeStrategy *string `json:"DefaultUpgradeStrategy,omitempty" yaml:"DefaultUpgradeStrategy,omitempty"`
	// Description of the addon component.
