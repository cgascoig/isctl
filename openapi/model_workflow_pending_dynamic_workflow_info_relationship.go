...
func (dst *WorkflowPendingDynamicWorkflowInfoRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "mo.MoRef":
			...
			dst.MoMoRef = result
			return nil
		case "workflow.PendingDynamicWorkflowInfo":
			var result *WorkflowPendingDynamicWorkflowInfo = &WorkflowPendingDynamicWorkflowInfo{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.WorkflowPendingDynamicWorkflowInfo = result
			return nil
		default:
...
func (src *WorkflowPendingDynamicWorkflowInfoRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.WorkflowPendingDynamicWorkflowInfo != nil {
		return yaml.Marshal(&src.WorkflowPendingDynamicWorkflowInfo)
	}
