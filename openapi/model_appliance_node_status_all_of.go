...
type ApplianceNodeStatusAllOf struct {
	...
	CpuUsage *float32 `json:"CpuUsage,omitempty" yaml:"CpuUsage,omitempty"`
	// Percentage of memory currently in use.
	MemUsage *float32 `json:"MemUsage,omitempty" yaml:"MemUsage,omitempty"`
	...
	NodeState *string `json:"NodeState,omitempty" yaml:"NodeState,omitempty"`
	...
	FileSystemStatuses []ApplianceFileSystemStatusRelationship `json:"FileSystemStatuses,omitempty" yaml:"FileSystemStatuses,omitempty"`
	NodeInfo           *ApplianceNodeInfoRelationship          `json:"NodeInfo,omitempty" yaml:"NodeInfo,omitempty"`
