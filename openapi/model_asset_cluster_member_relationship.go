...
func (dst *AssetClusterMemberRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "asset.ClusterMember":
			var result *AssetClusterMember = &AssetClusterMember{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.AssetClusterMember = result
			return nil
		case "mo.MoRef":
...
func (src *AssetClusterMemberRelationship) MarshalYAML() ([]byte, error) {
	if src.AssetClusterMember != nil {
		return yaml.Marshal(&src.AssetClusterMember)
	}
