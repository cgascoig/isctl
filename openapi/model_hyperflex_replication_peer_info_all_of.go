...
type HyperflexReplicationPeerInfoAllOf struct {
	...
	Datastores []HyperflexReplicationPlatDatastorePair `json:"Datastores,omitempty" yaml:"Datastores,omitempty"`
	// Data Cluster IP for the replication peer.
	Dcip *string                          `json:"Dcip,omitempty" yaml:"Dcip,omitempty"`
	Er   NullableHyperflexEntityReference `json:"Er,omitempty" yaml:"Er,omitempty"`
	// Management Cluster IP for the replication peer.
	Mcip  *string                            `json:"Mcip,omitempty" yaml:"Mcip,omitempty"`
	Ports []HyperflexPortTypeToPortNumberMap `json:"Ports,omitempty" yaml:"Ports,omitempty"`
	// Replication Cluster IP for the replication peer.
	ReplCip *string `json:"ReplCip,omitempty" yaml:"ReplCip,omitempty"`
	// Peer Cluster Status for the replication peer.
	Status *string `json:"Status,omitempty" yaml:"Status,omitempty"`
	// Peer Cluster Status Details for the replication peer.
	StatusDetails *string `json:"StatusDetails,omitempty" yaml:"StatusDetails,omitempty"`
}
