...
type WorkflowTemplateFunctionMeta struct {
	...
	Comments   NullableWorkflowComments `json:"Comments,omitempty" yaml:"Comments,omitempty"`
	Inputs     []WorkflowBaseDataType   `json:"Inputs,omitempty" yaml:"Inputs,omitempty"`
	// The flag indicates whether a guided mode template is supported for it or not.
	IsGuidedModeSupported *bool `json:"IsGuidedModeSupported,omitempty" yaml:"IsGuidedModeSupported,omitempty"`
	// The template function name.
	Name    *string                `json:"Name,omitempty" yaml:"Name,omitempty"`
	Outputs []WorkflowBaseDataType `json:"Outputs,omitempty" yaml:"Outputs,omitempty"`
}
