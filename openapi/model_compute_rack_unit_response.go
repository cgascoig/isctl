...
func (dst *ComputeRackUnitResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "compute.RackUnit.List":
			var result *ComputeRackUnitList = &ComputeRackUnitList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ComputeRackUnitList = result
			return nil
...
func (src *ComputeRackUnitResponse) MarshalYAML() ([]byte, error) {
	if src.ComputeRackUnitList != nil {
		return yaml.Marshal(&src.ComputeRackUnitList)
	}
