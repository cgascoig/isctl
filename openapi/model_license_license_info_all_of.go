...
type LicenseLicenseInfoAllOf struct {
	...
	DaysLeft *int64 `json:"DaysLeft,omitempty" yaml:"DaysLeft,omitempty"`
	...
	LicenseCount *int64 `json:"LicenseCount,omitempty" yaml:"LicenseCount,omitempty"`
	...
	TrialAdmin         *bool                                  `json:"TrialAdmin,omitempty" yaml:"TrialAdmin,omitempty"`
