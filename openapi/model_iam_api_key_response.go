...
func (dst *IamApiKeyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iam.ApiKey.List":
			var result *IamApiKeyList = &IamApiKeyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamApiKeyList = result
			return nil
...
func (src *IamApiKeyResponse) MarshalYAML() ([]byte, error) {
	if src.IamApiKeyList != nil {
		return yaml.Marshal(&src.IamApiKeyList)
	}
