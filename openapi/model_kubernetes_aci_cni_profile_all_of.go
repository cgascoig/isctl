...
type KubernetesAciCniProfileAllOf struct {
	...
	AaepName *string `json:"AaepName,omitempty" yaml:"AaepName,omitempty"`
	...
	ExtSvcDynSubnetStart *string `json:"ExtSvcDynSubnetStart,omitempty" yaml:"ExtSvcDynSubnetStart,omitempty"`
	...
	ExtSvcStaticSubnetStart *string `json:"ExtSvcStaticSubnetStart,omitempty" yaml:"ExtSvcStaticSubnetStart,omitempty"`
	// Value of ACI infrastructuere VLAN ID for the ACI fabric.
	InfraVlanId *int64 `json:"InfraVlanId,omitempty" yaml:"InfraVlanId,omitempty"`
	// Name of ACI L3Out network to be used for all Kubernetes clusters using this policy.
	L3OutNetworkName *string `json:"L3OutNetworkName,omitempty" yaml:"L3OutNetworkName,omitempty"`
	// Name of ACI L3Out policy to be used for all Kubernetes clusters using this policy.
	L3OutPolicyName *string `json:"L3OutPolicyName,omitempty" yaml:"L3OutPolicyName,omitempty"`
	// Tenant in ACI used by this L3Out and Common VRF.
	L3OutTenant *string `json:"L3OutTenant,omitempty" yaml:"L3OutTenant,omitempty"`
	// VMM domain within which Kubernetes clusters using this policy are nested.
	NestedVmmDomain *string `json:"NestedVmmDomain,omitempty" yaml:"NestedVmmDomain,omitempty"`
	...
	NodeSvcSubnetStart *string `json:"NodeSvcSubnetStart,omitempty" yaml:"NodeSvcSubnetStart,omitempty"`
	// Ending value of VLAN range used to assign Node VLAN Ids for each Kubernetes cluster using this policy.
	NodeVlanRangeEnd *int64 `json:"NodeVlanRangeEnd,omitempty" yaml:"NodeVlanRangeEnd,omitempty"`
	// Starting value of VLAN range used to assign Node VLAN Ids for each Kubernetes cluster using this policy.
	NodeVlanRangeStart *int64 `json:"NodeVlanRangeStart,omitempty" yaml:"NodeVlanRangeStart,omitempty"`
	// Number of k8s clusters currently using this ACI CNI profile.
	NumberOfKubernetesClusters *int64 `json:"NumberOfKubernetesClusters,omitempty" yaml:"NumberOfKubernetesClusters,omitempty"`
	// Range of IP Multicast addresses to be used by the Opflex protocol for Kubernetes clusters using this policy.
	OpflexMulticastAddressRange *string `json:"OpflexMulticastAddressRange,omitempty" yaml:"OpflexMulticastAddressRange,omitempty"`
	...
	PodSubnetStart *string `json:"PodSubnetStart,omitempty" yaml:"PodSubnetStart,omitempty"`
	...
	SvcSubnetStart *string `json:"SvcSubnetStart,omitempty" yaml:"SvcSubnetStart,omitempty"`
	...
	ClusterAciAllocations []KubernetesAciCniTenantClusterAllocationRelationship `json:"ClusterAciAllocations,omitempty" yaml:"ClusterAciAllocations,omitempty"`
	// An array of relationships to kubernetesClusterProfile resources.
	ClusterProfiles  []KubernetesClusterProfileRelationship `json:"ClusterProfiles,omitempty" yaml:"ClusterProfiles,omitempty"`
