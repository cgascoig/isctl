...
type HyperflexHxapHostVswitch struct {
	VirtualizationBaseVswitch `yaml:"VirtualizationBaseVswitch,inline"`
	...
	Ports    []HyperflexNetworkPort             `json:"Ports,omitempty" yaml:"Ports,omitempty"`
	Cluster  *HyperflexHxapClusterRelationship  `json:"Cluster,omitempty" yaml:"Cluster,omitempty"`
	DvSwitch *HyperflexHxapDvswitchRelationship `json:"DvSwitch,omitempty" yaml:"DvSwitch,omitempty"`
