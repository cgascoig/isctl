...
type WorkflowFileOperations struct {
	...
	FileDownload NullableWorkflowFileDownloadOp `json:"FileDownload,omitempty" yaml:"FileDownload,omitempty"`
	FileTemplate NullableWorkflowFileTemplateOp `json:"FileTemplate,omitempty" yaml:"FileTemplate,omitempty"`
