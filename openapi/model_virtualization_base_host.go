...
type VirtualizationBaseHost struct {
	...
	CpuInfo      NullableVirtualizationCpuInfo `json:"CpuInfo,omitempty" yaml:"CpuInfo,omitempty"`
	HardwareInfo NullableInfraHardwareInfo     `json:"HardwareInfo,omitempty" yaml:"HardwareInfo,omitempty"`
	...
	MemoryCapacity  NullableVirtualizationMemoryCapacity `json:"MemoryCapacity,omitempty" yaml:"MemoryCapacity,omitempty"`
	...
	ProcessorCapacity NullableVirtualizationComputeCapacity `json:"ProcessorCapacity,omitempty" yaml:"ProcessorCapacity,omitempty"`
	ProductInfo       NullableVirtualizationProductInfo     `json:"ProductInfo,omitempty" yaml:"ProductInfo,omitempty"`
