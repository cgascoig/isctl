...
func (dst *KubernetesVirtualMachineInfrastructureProviderResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "kubernetes.VirtualMachineInfrastructureProvider.List":
			var result *KubernetesVirtualMachineInfrastructureProviderList = &KubernetesVirtualMachineInfrastructureProviderList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesVirtualMachineInfrastructureProviderList = result
			return nil
...
func (src *KubernetesVirtualMachineInfrastructureProviderResponse) MarshalYAML() ([]byte, error) {
	if src.KubernetesVirtualMachineInfrastructureProviderList != nil {
		return yaml.Marshal(&src.KubernetesVirtualMachineInfrastructureProviderList)
	}
