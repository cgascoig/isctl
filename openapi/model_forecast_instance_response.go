...
func (dst *ForecastInstanceResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "forecast.Instance.List":
			var result *ForecastInstanceList = &ForecastInstanceList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ForecastInstanceList = result
			return nil
...
func (src *ForecastInstanceResponse) MarshalYAML() ([]byte, error) {
	if src.ForecastInstanceList != nil {
		return yaml.Marshal(&src.ForecastInstanceList)
	}
