...
func (dst *MemoryPersistentMemoryPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "memory.PersistentMemoryPolicy.List":
			var result *MemoryPersistentMemoryPolicyList = &MemoryPersistentMemoryPolicyList{}
...
func (src *MemoryPersistentMemoryPolicyResponse) MarshalYAML() ([]byte, error) {
	if src.MemoryPersistentMemoryPolicyList != nil {
