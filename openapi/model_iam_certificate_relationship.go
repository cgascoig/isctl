...
func (dst *IamCertificateRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "iam.Certificate":
			var result *IamCertificate = &IamCertificate{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamCertificate = result
			return nil
		case "mo.MoRef":
...
func (src *IamCertificateRelationship) MarshalYAML() ([]byte, error) {
	if src.IamCertificate != nil {
		return yaml.Marshal(&src.IamCertificate)
	}
