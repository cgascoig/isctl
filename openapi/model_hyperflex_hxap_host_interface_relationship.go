...
func (dst *HyperflexHxapHostInterfaceRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.HxapHostInterface":
			var result *HyperflexHxapHostInterface = &HyperflexHxapHostInterface{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexHxapHostInterface = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexHxapHostInterfaceRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexHxapHostInterface != nil {
		return yaml.Marshal(&src.HyperflexHxapHostInterface)
	}
