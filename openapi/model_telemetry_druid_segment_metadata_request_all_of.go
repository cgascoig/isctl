...
type TelemetryDruidSegmentMetadataRequestAllOf struct {
	...
	ToInclude *map[string]interface{} `json:"toInclude,omitempty" yaml:"toInclude,omitempty"`
	...
	AnalysisTypes *[]string `json:"analysisTypes,omitempty" yaml:"analysisTypes,omitempty"`
	// If true, and if the \"aggregators\" analysisType is enabled, aggregators will be merged leniently.
	LenientAggregatorMerge *bool `json:"lenientAggregatorMerge,omitempty" yaml:"lenientAggregatorMerge,omitempty"`
}
