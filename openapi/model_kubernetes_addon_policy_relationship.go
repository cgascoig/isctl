...
func (dst *KubernetesAddonPolicyRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "kubernetes.AddonPolicy":
			var result *KubernetesAddonPolicy = &KubernetesAddonPolicy{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesAddonPolicy = result
			return nil
		case "mo.MoRef":
...
func (src *KubernetesAddonPolicyRelationship) MarshalYAML() ([]byte, error) {
	if src.KubernetesAddonPolicy != nil {
		return yaml.Marshal(&src.KubernetesAddonPolicy)
	}
