...
type EquipmentChassisAllOf struct {
	...
	Blades []ComputeBladeRelationship `json:"Blades,omitempty" yaml:"Blades,omitempty"`
	...
	Ioms       []EquipmentIoCardRelationship    `json:"Ioms,omitempty" yaml:"Ioms,omitempty"`
	LocatorLed *EquipmentLocatorLedRelationship `json:"LocatorLed,omitempty" yaml:"LocatorLed,omitempty"`
	PsuControl *EquipmentPsuControlRelationship `json:"PsuControl,omitempty" yaml:"PsuControl,omitempty"`
	...
	Siocs []EquipmentSystemIoControllerRelationship `json:"Siocs,omitempty" yaml:"Siocs,omitempty"`
	...
	VirtualDriveContainer []StorageVirtualDriveContainerRelationship `json:"VirtualDriveContainer,omitempty" yaml:"VirtualDriveContainer,omitempty"`
}
