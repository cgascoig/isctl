...
type FabricUplinkPcRole struct {
	FabricPortChannelRole `yaml:"FabricPortChannelRole,inline"`
	...
	LinkAggregationPolicy *FabricLinkAggregationPolicyRelationship `json:"LinkAggregationPolicy,omitempty" yaml:"LinkAggregationPolicy,omitempty"`
