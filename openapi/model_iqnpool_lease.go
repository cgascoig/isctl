...
type IqnpoolLease struct {
	PoolAbstractLease `yaml:"PoolAbstractLease,inline"`
	...
	IqnAddress       *string                        `json:"IqnAddress,omitempty" yaml:"IqnAddress,omitempty"`
	AssignedToEntity *MoBaseMoRelationship          `json:"AssignedToEntity,omitempty" yaml:"AssignedToEntity,omitempty"`
	Pool             *IqnpoolPoolRelationship       `json:"Pool,omitempty" yaml:"Pool,omitempty"`
	PoolMember       *IqnpoolPoolMemberRelationship `json:"PoolMember,omitempty" yaml:"PoolMember,omitempty"`
	Universe         *IqnpoolUniverseRelationship   `json:"Universe,omitempty" yaml:"Universe,omitempty"`
}
