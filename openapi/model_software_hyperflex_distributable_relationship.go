...
func (dst *SoftwareHyperflexDistributableRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "mo.MoRef":
			...
			dst.MoMoRef = result
			return nil
		case "software.HyperflexDistributable":
			var result *SoftwareHyperflexDistributable = &SoftwareHyperflexDistributable{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.SoftwareHyperflexDistributable = result
			return nil
		default:
...
func (src *SoftwareHyperflexDistributableRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.SoftwareHyperflexDistributable != nil {
		return yaml.Marshal(&src.SoftwareHyperflexDistributable)
	}
