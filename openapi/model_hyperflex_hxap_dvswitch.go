...
type HyperflexHxapDvswitch struct {
	VirtualizationBaseDvswitch `yaml:"VirtualizationBaseDvswitch,inline"`
	...
	DvUplink *string `json:"DvUplink,omitempty" yaml:"DvUplink,omitempty"`
	// The last host that update this object.
	LastHostname *string                           `json:"LastHostname,omitempty" yaml:"LastHostname,omitempty"`
	...
	MemberVswitches []HyperflexHxapHostVswitchRelationship `json:"MemberVswitches,omitempty" yaml:"MemberVswitches,omitempty"`
}
