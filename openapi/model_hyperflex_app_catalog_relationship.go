...
func (dst *HyperflexAppCatalogRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.AppCatalog":
			var result *HyperflexAppCatalog = &HyperflexAppCatalog{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexAppCatalog = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexAppCatalogRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexAppCatalog != nil {
		return yaml.Marshal(&src.HyperflexAppCatalog)
	}
