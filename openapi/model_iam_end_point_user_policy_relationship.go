...
func (dst *IamEndPointUserPolicyRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "iam.EndPointUserPolicy":
			var result *IamEndPointUserPolicy = &IamEndPointUserPolicy{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamEndPointUserPolicy = result
			return nil
		case "mo.MoRef":
...
func (src *IamEndPointUserPolicyRelationship) MarshalYAML() ([]byte, error) {
	if src.IamEndPointUserPolicy != nil {
		return yaml.Marshal(&src.IamEndPointUserPolicy)
	}
