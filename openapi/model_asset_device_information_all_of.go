...
type AssetDeviceInformationAllOf struct {
	...
	DeviceTransactions []AssetDeviceTransaction         `json:"DeviceTransactions,omitempty" yaml:"DeviceTransactions,omitempty"`
	EndCustomer        NullableAssetCustomerInformation `json:"EndCustomer,omitempty" yaml:"EndCustomer,omitempty"`
	...
	MlbOfferType *string `json:"MlbOfferType,omitempty" yaml:"MlbOfferType,omitempty"`
	// Identifier corresponding to MLB Product Name. MLB refers to MultiLine Bundle.
	MlbProductId *int64 `json:"MlbProductId,omitempty" yaml:"MlbProductId,omitempty"`
	...
	MlbProductName *string `json:"MlbProductName,omitempty" yaml:"MlbProductName,omitempty"`
	// Unique identifier of old Cisco device. It is the device ID of old Cisco device, which got replaced by the new device.
	OldDeviceId *string `json:"OldDeviceId,omitempty" yaml:"OldDeviceId,omitempty"`
	// Description of status of old Cisco device, which got replaced by the new device.
	OldDeviceStatusDescription *string `json:"OldDeviceStatusDescription,omitempty" yaml:"OldDeviceStatusDescription,omitempty"`
	...
	OldDeviceStatusId *int32 `json:"OldDeviceStatusId,omitempty" yaml:"OldDeviceStatusId,omitempty"`
	// Instance number of the old device, which got replaced by the new device.
	OldInstanceId *string `json:"OldInstanceId,omitempty" yaml:"OldInstanceId,omitempty"`
	...
	UnitOfMeasure *string `json:"UnitOfMeasure,omitempty" yaml:"UnitOfMeasure,omitempty"`
}
