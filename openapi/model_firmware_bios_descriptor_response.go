...
func (dst *FirmwareBiosDescriptorResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "firmware.BiosDescriptor.List":
			var result *FirmwareBiosDescriptorList = &FirmwareBiosDescriptorList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FirmwareBiosDescriptorList = result
			return nil
...
func (src *FirmwareBiosDescriptorResponse) MarshalYAML() ([]byte, error) {
	if src.FirmwareBiosDescriptorList != nil {
		return yaml.Marshal(&src.FirmwareBiosDescriptorList)
	}
