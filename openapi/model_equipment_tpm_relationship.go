...
func (dst *EquipmentTpmRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "equipment.Tpm":
			var result *EquipmentTpm = &EquipmentTpm{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentTpm = result
			return nil
		case "mo.MoRef":
...
func (src *EquipmentTpmRelationship) MarshalYAML() ([]byte, error) {
	if src.EquipmentTpm != nil {
		return yaml.Marshal(&src.EquipmentTpm)
	}
