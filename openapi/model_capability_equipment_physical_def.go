...
type CapabilityEquipmentPhysicalDef struct {
	...
	Depth *float32 `json:"Depth,omitempty" yaml:"Depth,omitempty"`
	...
	MaxPower *int64 `json:"MaxPower,omitempty" yaml:"MaxPower,omitempty"`
	// Min Power information for a Switch/Fabric-Interconnect.
	MinPower *int64 `json:"MinPower,omitempty" yaml:"MinPower,omitempty"`
	// Nominal Power information for a Switch/Fabric-Interconnect.
	NominalPower *int64 `json:"NominalPower,omitempty" yaml:"NominalPower,omitempty"`
