...
func (dst *ConfigExporterResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "config.Exporter.List":
			var result *ConfigExporterList = &ConfigExporterList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ConfigExporterList = result
			return nil
...
func (src *ConfigExporterResponse) MarshalYAML() ([]byte, error) {
	if src.ConfigExporterList != nil {
		return yaml.Marshal(&src.ConfigExporterList)
	}
