...
func (dst *BootNvmeDeviceResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "boot.NvmeDevice.List":
			var result *BootNvmeDeviceList = &BootNvmeDeviceList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.BootNvmeDeviceList = result
			return nil
...
func (src *BootNvmeDeviceResponse) MarshalYAML() ([]byte, error) {
	if src.BootNvmeDeviceList != nil {
		return yaml.Marshal(&src.BootNvmeDeviceList)
	}
