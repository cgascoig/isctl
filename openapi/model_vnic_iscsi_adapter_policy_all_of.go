...
type VnicIscsiAdapterPolicyAllOf struct {
	...
	DhcpTimeout *int64 `json:"DhcpTimeout,omitempty" yaml:"DhcpTimeout,omitempty"`
	// The number of times to retry the connection in case of a failure during iSCSI LUN discovery.
	LunBusyRetryCount *int64                                `json:"LunBusyRetryCount,omitempty" yaml:"LunBusyRetryCount,omitempty"`
