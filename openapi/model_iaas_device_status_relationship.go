...
func (dst *IaasDeviceStatusRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "iaas.DeviceStatus":
			var result *IaasDeviceStatus = &IaasDeviceStatus{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IaasDeviceStatus = result
			return nil
		case "mo.MoRef":
...
func (src *IaasDeviceStatusRelationship) MarshalYAML() ([]byte, error) {
	if src.IaasDeviceStatus != nil {
		return yaml.Marshal(&src.IaasDeviceStatus)
	}
