...
type KubernetesNetworkPolicy struct {
	...
	CniConfig  NullableKubernetesCniConfig `json:"CniConfig,omitempty" yaml:"CniConfig,omitempty"`
	...
	CniType *string `json:"CniType,omitempty" yaml:"CniType,omitempty"`
	// CIDR block to allocate pod network IP addresses from.
	PodNetworkCidr *string `json:"PodNetworkCidr,omitempty" yaml:"PodNetworkCidr,omitempty"`
