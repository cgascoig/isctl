...
func (dst *FabricEthNetworkControlPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "fabric.EthNetworkControlPolicy.List":
			var result *FabricEthNetworkControlPolicyList = &FabricEthNetworkControlPolicyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FabricEthNetworkControlPolicyList = result
			return nil
...
func (src *FabricEthNetworkControlPolicyResponse) MarshalYAML() ([]byte, error) {
	if src.FabricEthNetworkControlPolicyList != nil {
		return yaml.Marshal(&src.FabricEthNetworkControlPolicyList)
	}
