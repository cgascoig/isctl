...
type IamOAuthToken struct {
	...
	AccessExpirationTime *time.Time `json:"AccessExpirationTime,omitempty" yaml:"AccessExpirationTime,omitempty"`
	...
	ClientIpAddress *string `json:"ClientIpAddress,omitempty" yaml:"ClientIpAddress,omitempty"`
	...
	LastLoginClient *string `json:"LastLoginClient,omitempty" yaml:"LastLoginClient,omitempty"`
	// The last login time for user.
	LastLoginTime *time.Time `json:"LastLoginTime,omitempty" yaml:"LastLoginTime,omitempty"`
	// Token identifier. Not the Access Token itself.
	TokenId         *string                         `json:"TokenId,omitempty" yaml:"TokenId,omitempty"`
	UserMeta        NullableIamClientMeta           `json:"UserMeta,omitempty" yaml:"UserMeta,omitempty"`
	AppRegistration *IamAppRegistrationRelationship `json:"AppRegistration,omitempty" yaml:"AppRegistration,omitempty"`
