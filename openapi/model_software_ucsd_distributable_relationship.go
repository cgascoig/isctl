...
func (dst *SoftwareUcsdDistributableRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "mo.MoRef":
			...
			dst.MoMoRef = result
			return nil
		case "software.UcsdDistributable":
			var result *SoftwareUcsdDistributable = &SoftwareUcsdDistributable{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.SoftwareUcsdDistributable = result
			return nil
		default:
...
func (src *SoftwareUcsdDistributableRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.SoftwareUcsdDistributable != nil {
		return yaml.Marshal(&src.SoftwareUcsdDistributable)
	}
