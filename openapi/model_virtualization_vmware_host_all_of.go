...
type VirtualizationVmwareHostAllOf struct {
	...
	ResourceConsumed    NullableVirtualizationVmwareResourceConsumption `json:"ResourceConsumed,omitempty" yaml:"ResourceConsumed,omitempty"`
	...
	VcenterHostId *string                                     `json:"VcenterHostId,omitempty" yaml:"VcenterHostId,omitempty"`
