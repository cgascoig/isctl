...
type StorageDiskGroup struct {
	...
	DedicatedHotSpares []StoragePhysicalDiskRelationship    `json:"DedicatedHotSpares,omitempty" yaml:"DedicatedHotSpares,omitempty"`
	RegisteredDevice   *AssetDeviceRegistrationRelationship `json:"RegisteredDevice,omitempty" yaml:"RegisteredDevice,omitempty"`
	// An array of relationships to storageSpan resources.
	Spans             []StorageSpanRelationship      `json:"Spans,omitempty" yaml:"Spans,omitempty"`
