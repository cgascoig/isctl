...
type TelemetryDruidSearchRequest struct {
	...
	SearchDimensions *[]string                          `json:"searchDimensions,omitempty" yaml:"searchDimensions,omitempty"`
	Query            *TelemetryDruidAggregateSearchSpec `json:"query,omitempty" yaml:"query,omitempty"`
