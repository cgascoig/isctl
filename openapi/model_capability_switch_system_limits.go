...
type CapabilitySwitchSystemLimits struct {
	...
	MaximumChassisCount *int64 `json:"MaximumChassisCount,omitempty" yaml:"MaximumChassisCount,omitempty"`
	// Maximum UCS Fabric-extenders (FEX) per Switch/Fabric-Interconnect.
	MaximumFexPerDomain *int64 `json:"MaximumFexPerDomain,omitempty" yaml:"MaximumFexPerDomain,omitempty"`
	// Maximum UCS servers per Switch/Fabric-Interconnect.
	MaximumServersPerDomain *int64 `json:"MaximumServersPerDomain,omitempty" yaml:"MaximumServersPerDomain,omitempty"`
}
