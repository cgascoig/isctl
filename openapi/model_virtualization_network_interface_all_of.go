...
type VirtualizationNetworkInterfaceAllOf struct {
	...
	AdaptorType *string `json:"AdaptorType,omitempty" yaml:"AdaptorType,omitempty"`
	// Virtual machine network bridge name.
	Bridge *string `json:"Bridge,omitempty" yaml:"Bridge,omitempty"`
	// Connect the adaptor at virtual machine power on.
	ConnectAtPowerOn *bool `json:"ConnectAtPowerOn,omitempty" yaml:"ConnectAtPowerOn,omitempty"`
	// Enable the direct path I/O.
	DirectPathIo *bool `json:"DirectPathIo,omitempty" yaml:"DirectPathIo,omitempty"`
