...
type SdwanProfile struct {
	...
	RouterNodes    []SdwanRouterNodeRelationship          `json:"RouterNodes,omitempty" yaml:"RouterNodes,omitempty"`
	RouterPolicy   *SdwanRouterPolicyRelationship         `json:"RouterPolicy,omitempty" yaml:"RouterPolicy,omitempty"`
	VmanageAccount *SdwanVmanageAccountPolicyRelationship `json:"VmanageAccount,omitempty" yaml:"VmanageAccount,omitempty"`
}
