...
type EquipmentFexOperation struct {
	...
	AdminLocatorLedAction *string `json:"AdminLocatorLedAction,omitempty" yaml:"AdminLocatorLedAction,omitempty"`
	...
	AdminLocatorLedActionState *string                              `json:"AdminLocatorLedActionState,omitempty" yaml:"AdminLocatorLedActionState,omitempty"`
