...
func (dst *EquipmentFexIdentityResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "equipment.FexIdentity.List":
			var result *EquipmentFexIdentityList = &EquipmentFexIdentityList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentFexIdentityList = result
			return nil
...
func (src *EquipmentFexIdentityResponse) MarshalYAML() ([]byte, error) {
	if src.EquipmentFexIdentityList != nil {
		return yaml.Marshal(&src.EquipmentFexIdentityList)
	}
