...
func (dst *BootDeviceBootModeRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "boot.DeviceBootMode":
			var result *BootDeviceBootMode = &BootDeviceBootMode{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.BootDeviceBootMode = result
			return nil
		case "mo.MoRef":
...
func (src *BootDeviceBootModeRelationship) MarshalYAML() ([]byte, error) {
	if src.BootDeviceBootMode != nil {
		return yaml.Marshal(&src.BootDeviceBootMode)
	}
