...
type NiaapiNewReleaseDetailAllOf struct {
	...
	ReleaseNoteLink *string `json:"ReleaseNoteLink,omitempty" yaml:"ReleaseNoteLink,omitempty"`
	// The link title used to provide a gateway for customer to review the release note.
	ReleaseNoteLinkTitle *string `json:"ReleaseNoteLinkTitle,omitempty" yaml:"ReleaseNoteLinkTitle,omitempty"`
	// The link used to provide a gateway for customer to download the release.
	SoftwareDownloadLink *string `json:"SoftwareDownloadLink,omitempty" yaml:"SoftwareDownloadLink,omitempty"`
	// The link title used to provide a gateway for customer to download the release.
	SoftwareDownloadLinkTitle *string `json:"SoftwareDownloadLinkTitle,omitempty" yaml:"SoftwareDownloadLinkTitle,omitempty"`
