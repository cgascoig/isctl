...
type HyperflexLicenseAllOf struct {
	...
	ComplianceState *string `json:"ComplianceState,omitempty" yaml:"ComplianceState,omitempty"`
	// Out of compliance date of the cluster
	GetOutOfComplianceStartAt *string `json:"GetOutOfComplianceStartAt,omitempty" yaml:"GetOutOfComplianceStartAt,omitempty"`
	// Is the cluster in evalution period?
	InEvaluation         *bool                                            `json:"InEvaluation,omitempty" yaml:"InEvaluation,omitempty"`
	LicenseAuthorization NullableHyperflexHxLicenseAuthorizationDetailsDt `json:"LicenseAuthorization,omitempty" yaml:"LicenseAuthorization,omitempty"`
	LicenseRegistration  NullableHyperflexHxRegistrationDetailsDt         `json:"LicenseRegistration,omitempty" yaml:"LicenseRegistration,omitempty"`
	...
	PlrEnabled *bool `json:"PlrEnabled,omitempty" yaml:"PlrEnabled,omitempty"`
	// Is Smart Licensing Enabled for this cluster?
	SmartLicensingEnabled *bool                                `json:"SmartLicensingEnabled,omitempty" yaml:"SmartLicensingEnabled,omitempty"`
