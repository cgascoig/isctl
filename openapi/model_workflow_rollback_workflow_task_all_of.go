...
type WorkflowRollbackWorkflowTaskAllOf struct {
	...
	RollbackCompleted *bool `json:"RollbackCompleted,omitempty" yaml:"RollbackCompleted,omitempty"`
	// Name of TaskInfo that performs the rollback operation.
	RollbackTaskName *string `json:"RollbackTaskName,omitempty" yaml:"RollbackTaskName,omitempty"`
	...
	TaskInfoMoid *string `json:"TaskInfoMoid,omitempty" yaml:"TaskInfoMoid,omitempty"`
	// Path of rollback task if it is inside sub-workflow.
	TaskPath *string `json:"TaskPath,omitempty" yaml:"TaskPath,omitempty"`
}
