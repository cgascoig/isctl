...
type KubernetesVirtualMachineNodeProfile struct {
	KubernetesNodeProfile `yaml:"KubernetesNodeProfile,inline"`
	...
	IpAddresses    []IppoolIpLeaseRelationship               `json:"IpAddresses,omitempty" yaml:"IpAddresses,omitempty"`
	NodeIp         *IppoolIpLeaseRelationship                `json:"NodeIp,omitempty" yaml:"NodeIp,omitempty"`
	VirtualMachine *VirtualizationVirtualMachineRelationship `json:"VirtualMachine,omitempty" yaml:"VirtualMachine,omitempty"`
}
