...
func (dst *KubernetesSysConfigPolicyRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "kubernetes.SysConfigPolicy":
			var result *KubernetesSysConfigPolicy = &KubernetesSysConfigPolicy{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesSysConfigPolicy = result
			return nil
		case "mo.MoRef":
...
func (src *KubernetesSysConfigPolicyRelationship) MarshalYAML() ([]byte, error) {
	if src.KubernetesSysConfigPolicy != nil {
		return yaml.Marshal(&src.KubernetesSysConfigPolicy)
	}
