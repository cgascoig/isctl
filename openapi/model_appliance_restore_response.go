...
func (dst *ApplianceRestoreResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "appliance.Restore.List":
			var result *ApplianceRestoreList = &ApplianceRestoreList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ApplianceRestoreList = result
			return nil
...
func (src *ApplianceRestoreResponse) MarshalYAML() ([]byte, error) {
	if src.ApplianceRestoreList != nil {
		return yaml.Marshal(&src.ApplianceRestoreList)
	}
