...
type HyperflexHxRegistrationDetailsDtAllOf struct {
	...
	InitialRegistrationDate *string `json:"InitialRegistrationDate,omitempty" yaml:"InitialRegistrationDate,omitempty"`
	// Last License Renewal attempted Date
	LastRenewalAttemptDate *string `json:"LastRenewalAttemptDate,omitempty" yaml:"LastRenewalAttemptDate,omitempty"`
	// Next Attempt Date for License Renewal
	NextRenewalAttemptDate *string `json:"NextRenewalAttemptDate,omitempty" yaml:"NextRenewalAttemptDate,omitempty"`
	// Out of compliance start date
	OutOfComplianceStartDate *string `json:"OutOfComplianceStartDate,omitempty" yaml:"OutOfComplianceStartDate,omitempty"`
	// Date when the registration will expire
	RegistrationExpireDate *string `json:"RegistrationExpireDate,omitempty" yaml:"RegistrationExpireDate,omitempty"`
	// License registration success or failure reason
	RegistrationFailedReason *string `json:"RegistrationFailedReason,omitempty" yaml:"RegistrationFailedReason,omitempty"`
