...
type NiaapiMaintainedRelease struct {
	...
	MaintainedRelease *string `json:"MaintainedRelease,omitempty" yaml:"MaintainedRelease,omitempty"`
	// Software release version string.
	SoftwareRelease *string `json:"SoftwareRelease,omitempty" yaml:"SoftwareRelease,omitempty"`
