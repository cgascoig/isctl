...
func (dst *BootPrecisionPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "boot.PrecisionPolicy.List":
			var result *BootPrecisionPolicyList = &BootPrecisionPolicyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.BootPrecisionPolicyList = result
			return nil
...
func (src *BootPrecisionPolicyResponse) MarshalYAML() ([]byte, error) {
	if src.BootPrecisionPolicyList != nil {
		return yaml.Marshal(&src.BootPrecisionPolicyList)
	}
