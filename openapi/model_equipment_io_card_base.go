...
type EquipmentIoCardBase struct {
	...
	HostPorts      []EtherHostPortRelationship       `json:"HostPorts,omitempty" yaml:"HostPorts,omitempty"`
	MgmtController *ManagementControllerRelationship `json:"MgmtController,omitempty" yaml:"MgmtController,omitempty"`
	// An array of relationships to etherNetworkPort resources.
	NetworkPorts []EtherNetworkPortRelationship `json:"NetworkPorts,omitempty" yaml:"NetworkPorts,omitempty"`
}
