...
func (dst *CapabilityIoCardCapabilityDefResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "capability.IoCardCapabilityDef.List":
			var result *CapabilityIoCardCapabilityDefList = &CapabilityIoCardCapabilityDefList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.CapabilityIoCardCapabilityDefList = result
			return nil
...
func (src *CapabilityIoCardCapabilityDefResponse) MarshalYAML() ([]byte, error) {
	if src.CapabilityIoCardCapabilityDefList != nil {
		return yaml.Marshal(&src.CapabilityIoCardCapabilityDefList)
	}
