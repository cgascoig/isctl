...
func (dst *EtherHostPortResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "ether.HostPort.List":
			var result *EtherHostPortList = &EtherHostPortList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EtherHostPortList = result
			return nil
...
func (src *EtherHostPortResponse) MarshalYAML() ([]byte, error) {
	if src.EtherHostPortList != nil {
		return yaml.Marshal(&src.EtherHostPortList)
	}
