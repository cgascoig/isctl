...
func (dst *HyperflexAlarmRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.Alarm":
			var result *HyperflexAlarm = &HyperflexAlarm{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexAlarm = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexAlarmRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexAlarm != nil {
		return yaml.Marshal(&src.HyperflexAlarm)
	}
