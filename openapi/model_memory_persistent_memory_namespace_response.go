...
func (dst *MemoryPersistentMemoryNamespaceResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "memory.PersistentMemoryNamespace.List":
			var result *MemoryPersistentMemoryNamespaceList = &MemoryPersistentMemoryNamespaceList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.MemoryPersistentMemoryNamespaceList = result
			return nil
...
func (src *MemoryPersistentMemoryNamespaceResponse) MarshalYAML() ([]byte, error) {
	if src.MemoryPersistentMemoryNamespaceList != nil {
		return yaml.Marshal(&src.MemoryPersistentMemoryNamespaceList)
	}
