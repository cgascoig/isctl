...
type CertificatemanagementCertificateBase struct {
	...
	Certificate NullableX509Certificate `json:"Certificate,omitempty" yaml:"Certificate,omitempty"`
	...
	IsPrivatekeySet *bool `json:"IsPrivatekeySet,omitempty" yaml:"IsPrivatekeySet,omitempty"`
