...
type CloudBaseSkuAllOf struct {
	...
	CustomAttributes []CloudCustomAttributes `json:"CustomAttributes,omitempty" yaml:"CustomAttributes,omitempty"`
	...
	IsAutoDiscovered *bool `json:"IsAutoDiscovered,omitempty" yaml:"IsAutoDiscovered,omitempty"`
	...
	ServiceCategory *string `json:"ServiceCategory,omitempty" yaml:"ServiceCategory,omitempty"`
	// Property to identify the family of service that the sku belongs to.
	ServiceFamily *string `json:"ServiceFamily,omitempty" yaml:"ServiceFamily,omitempty"`
	// Any display name for the ServiceCategory if available.
	ServiceName *string                  `json:"ServiceName,omitempty" yaml:"ServiceName,omitempty"`
	Target      *AssetTargetRelationship `json:"Target,omitempty" yaml:"Target,omitempty"`
}
