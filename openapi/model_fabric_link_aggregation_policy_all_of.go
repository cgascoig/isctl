...
type FabricLinkAggregationPolicyAllOf struct {
	...
	LacpRate *string `json:"LacpRate,omitempty" yaml:"LacpRate,omitempty"`
	// Flag tells the switch whether to suspend the port if it didn’t receive LACP PDU.
	SuspendIndividual *bool                                 `json:"SuspendIndividual,omitempty" yaml:"SuspendIndividual,omitempty"`
