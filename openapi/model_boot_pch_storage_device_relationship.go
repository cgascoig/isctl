...
func (dst *BootPchStorageDeviceRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "boot.PchStorageDevice":
			var result *BootPchStorageDevice = &BootPchStorageDevice{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.BootPchStorageDevice = result
			return nil
		case "mo.MoRef":
...
func (src *BootPchStorageDeviceRelationship) MarshalYAML() ([]byte, error) {
	if src.BootPchStorageDevice != nil {
		return yaml.Marshal(&src.BootPchStorageDevice)
	}
