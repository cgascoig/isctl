...
type NiatelemetrySmartLicense struct {
	...
	ActiveMode *string `json:"ActiveMode,omitempty" yaml:"ActiveMode,omitempty"`
	// Authorization status of the smart license.
	AuthStatus *string `json:"AuthStatus,omitempty" yaml:"AuthStatus,omitempty"`
	// License Udi of the smart license.
	LicenseUdi *string `json:"LicenseUdi,omitempty" yaml:"LicenseUdi,omitempty"`
