...
type MemoryAbstractUnit struct {
	...
	Bank *int64 `json:"Bank,omitempty" yaml:"Bank,omitempty"`
	...
	FormFactor *string `json:"FormFactor,omitempty" yaml:"FormFactor,omitempty"`
	...
	Set *int64 `json:"Set,omitempty" yaml:"Set,omitempty"`
