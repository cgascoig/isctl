...
func (dst *ComputeVmediaRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "compute.Vmedia":
			var result *ComputeVmedia = &ComputeVmedia{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ComputeVmedia = result
			return nil
		case "mo.MoRef":
...
func (src *ComputeVmediaRelationship) MarshalYAML() ([]byte, error) {
	if src.ComputeVmedia != nil {
		return yaml.Marshal(&src.ComputeVmedia)
	}
