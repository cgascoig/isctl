...
type StorageVirtualDriveConfigAllOf struct {
	...
	BootDrive *bool `json:"BootDrive,omitempty" yaml:"BootDrive,omitempty"`
	// Disk group policy that has the disk group in which this virtual drive needs to be created.
	DiskGroupName *string `json:"DiskGroupName,omitempty" yaml:"DiskGroupName,omitempty"`
	// Disk group policy that has the disk group in which this virtual drive needs to be created.
	DiskGroupPolicy *string `json:"DiskGroupPolicy,omitempty" yaml:"DiskGroupPolicy,omitempty"`
	...
	ExpandToAvailable *bool `json:"ExpandToAvailable,omitempty" yaml:"ExpandToAvailable,omitempty"`
