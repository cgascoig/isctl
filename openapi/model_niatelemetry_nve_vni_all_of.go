...
type NiatelemetryNveVniAllOf struct {
	...
	CpVniCount *int64 `json:"CpVniCount,omitempty" yaml:"CpVniCount,omitempty"`
	// Return value of cp vni down count.
	CpVniDown *int64 `json:"CpVniDown,omitempty" yaml:"CpVniDown,omitempty"`
	// Return value of cp vni up count.
	CpVniUp *int64 `json:"CpVniUp,omitempty" yaml:"CpVniUp,omitempty"`
	// Return value of dp vni count.
	DpVniCount *int64 `json:"DpVniCount,omitempty" yaml:"DpVniCount,omitempty"`
	// Return value of cp vni down count.
	DpVniDown *int64 `json:"DpVniDown,omitempty" yaml:"DpVniDown,omitempty"`
	// Return value of cp vni up count.
	DpVniUp *int64 `json:"DpVniUp,omitempty" yaml:"DpVniUp,omitempty"`
}
