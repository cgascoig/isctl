...
func (dst *IamLocalUserPasswordPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iam.LocalUserPasswordPolicy.List":
			var result *IamLocalUserPasswordPolicyList = &IamLocalUserPasswordPolicyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamLocalUserPasswordPolicyList = result
			return nil
...
func (src *IamLocalUserPasswordPolicyResponse) MarshalYAML() ([]byte, error) {
	if src.IamLocalUserPasswordPolicyList != nil {
		return yaml.Marshal(&src.IamLocalUserPasswordPolicyList)
	}
