...
func (dst *CapabilitySwitchDescriptorResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "capability.SwitchDescriptor.List":
			var result *CapabilitySwitchDescriptorList = &CapabilitySwitchDescriptorList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.CapabilitySwitchDescriptorList = result
			return nil
...
func (src *CapabilitySwitchDescriptorResponse) MarshalYAML() ([]byte, error) {
	if src.CapabilitySwitchDescriptorList != nil {
		return yaml.Marshal(&src.CapabilitySwitchDescriptorList)
	}
