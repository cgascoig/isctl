...
func (dst *BootVmediaDeviceResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "boot.VmediaDevice.List":
			var result *BootVmediaDeviceList = &BootVmediaDeviceList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.BootVmediaDeviceList = result
			return nil
...
func (src *BootVmediaDeviceResponse) MarshalYAML() ([]byte, error) {
	if src.BootVmediaDeviceList != nil {
		return yaml.Marshal(&src.BootVmediaDeviceList)
	}
