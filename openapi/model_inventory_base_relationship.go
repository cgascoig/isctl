...
func (dst *InventoryBaseRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "inventory.Base":
			var result *InventoryBase = &InventoryBase{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.InventoryBase = result
			return nil
		case "mo.MoRef":
...
func (src *InventoryBaseRelationship) MarshalYAML() ([]byte, error) {
	if src.InventoryBase != nil {
		return yaml.Marshal(&src.InventoryBase)
	}
