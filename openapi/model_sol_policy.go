...
type SolPolicy struct {
	...
	BaudRate *int32 `json:"BaudRate,omitempty" yaml:"BaudRate,omitempty"`
	...
	ComPort *string `json:"ComPort,omitempty" yaml:"ComPort,omitempty"`
	...
	SshPort      *int64                                `json:"SshPort,omitempty" yaml:"SshPort,omitempty"`
