...
func (dst *BootPchStorageDeviceResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "boot.PchStorageDevice.List":
			var result *BootPchStorageDeviceList = &BootPchStorageDeviceList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.BootPchStorageDeviceList = result
			return nil
...
func (src *BootPchStorageDeviceResponse) MarshalYAML() ([]byte, error) {
	if src.BootPchStorageDeviceList != nil {
		return yaml.Marshal(&src.BootPchStorageDeviceList)
	}
