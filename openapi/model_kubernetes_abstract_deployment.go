...
type _KubernetesAbstractDeployment KubernetesAbstractDeployment
...
func NewKubernetesAbstractDeployment(classId string, objectType string) *KubernetesAbstractDeployment {
...
func (o *KubernetesAbstractDeployment) UnmarshalJSON(bytes []byte) (err error) {
	type KubernetesAbstractDeploymentWithoutEmbeddedStruct struct {
	}

	varKubernetesAbstractDeploymentWithoutEmbeddedStruct := KubernetesAbstractDeploymentWithoutEmbeddedStruct{}

	err = json.Unmarshal(bytes, &varKubernetesAbstractDeploymentWithoutEmbeddedStruct)
	if err == nil {
		varKubernetesAbstractDeployment := _KubernetesAbstractDeployment{}
		*o = KubernetesAbstractDeployment(varKubernetesAbstractDeployment)
	} else {
		return err
	}
	...
	err = json.Unmarshal(bytes, &varKubernetesAbstractDeployment)
	if err == nil {
		o.KubernetesKubernetesResource = varKubernetesAbstractDeployment.KubernetesKubernetesResource
	} else {
		return err
	}
