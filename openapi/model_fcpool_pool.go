...
type FcpoolPool struct {
	...
	IdBlocks   []FcpoolBlock `json:"IdBlocks,omitempty" yaml:"IdBlocks,omitempty"`
	...
	BlockHeads   []FcpoolFcBlockRelationship           `json:"BlockHeads,omitempty" yaml:"BlockHeads,omitempty"`
