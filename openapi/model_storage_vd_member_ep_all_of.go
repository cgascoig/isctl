...
type StorageVdMemberEpAllOf struct {
	...
	VdMemberEpId        *int64                               `json:"VdMemberEpId,omitempty" yaml:"VdMemberEpId,omitempty"`
	...
	StorageVirtualDrive *StorageVirtualDriveRelationship     `json:"StorageVirtualDrive,omitempty" yaml:"StorageVirtualDrive,omitempty"`
}
