...
type HyperflexSnapshotPointAllOf struct {
	...
	ReplicationStatus            NullableHyperflexReplicationStatus `json:"ReplicationStatus,omitempty" yaml:"ReplicationStatus,omitempty"`
	SnapshotFiles                NullableHyperflexSnapshotFiles     `json:"SnapshotFiles,omitempty" yaml:"SnapshotFiles,omitempty"`
	SnapshotPointEntityReference NullableHyperflexEntityReference   `json:"SnapshotPointEntityReference,omitempty" yaml:"SnapshotPointEntityReference,omitempty"`
	SnapshotStatus               NullableHyperflexSnapshotStatus    `json:"SnapshotStatus,omitempty" yaml:"SnapshotStatus,omitempty"`
	VmRuntimeInfo                NullableHyperflexVirtualMachine    `json:"VmRuntimeInfo,omitempty" yaml:"VmRuntimeInfo,omitempty"`
}
