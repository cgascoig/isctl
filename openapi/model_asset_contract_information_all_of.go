...
type AssetContractInformationAllOf struct {
	BillTo               *AssetAddressInformation `json:"BillTo,omitempty" yaml:"BillTo,omitempty"`
	BillToGlobalUltimate *AssetGlobalUltimate     `json:"BillToGlobalUltimate,omitempty" yaml:"BillToGlobalUltimate,omitempty"`
