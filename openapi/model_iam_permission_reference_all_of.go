...
type IamPermissionReferenceAllOf struct {
	...
	PermissionIdentifier *string `json:"PermissionIdentifier,omitempty" yaml:"PermissionIdentifier,omitempty"`
	// Name of the permission which user has access to.
	PermissionName *string `json:"PermissionName,omitempty" yaml:"PermissionName,omitempty"`
}
