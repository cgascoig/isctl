...
type MetaDefinitionAllOf struct {
	...
	AccessPrivileges []MetaAccessPrivilege       `json:"AccessPrivileges,omitempty" yaml:"AccessPrivileges,omitempty"`
	AncestorClasses  []string                    `json:"AncestorClasses,omitempty" yaml:"AncestorClasses,omitempty"`
	DisplayNameMetas []MetaDisplayNameDefinition `json:"DisplayNameMetas,omitempty" yaml:"DisplayNameMetas,omitempty"`
	// Boolean flag to specify whether the meta class is a concrete class or not.
	IsConcrete *bool `json:"IsConcrete,omitempty" yaml:"IsConcrete,omitempty"`
	...
	MetaType *string `json:"MetaType,omitempty" yaml:"MetaType,omitempty"`
	...
	ParentClass *string `json:"ParentClass,omitempty" yaml:"ParentClass,omitempty"`
	...
	PermissionSupported *bool                `json:"PermissionSupported,omitempty" yaml:"PermissionSupported,omitempty"`
	Properties          []MetaPropDefinition `json:"Properties,omitempty" yaml:"Properties,omitempty"`
	...
	RbacResource  *bool                        `json:"RbacResource,omitempty" yaml:"RbacResource,omitempty"`
	Relationships []MetaRelationshipDefinition `json:"Relationships,omitempty" yaml:"Relationships,omitempty"`
