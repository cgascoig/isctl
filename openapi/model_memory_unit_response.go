...
func (dst *MemoryUnitResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "memory.Unit.List":
			var result *MemoryUnitList = &MemoryUnitList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.MemoryUnitList = result
			return nil
...
func (src *MemoryUnitResponse) MarshalYAML() ([]byte, error) {
	if src.MemoryUnitList != nil {
		return yaml.Marshal(&src.MemoryUnitList)
	}
