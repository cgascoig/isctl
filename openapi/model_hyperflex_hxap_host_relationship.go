...
func (dst *HyperflexHxapHostRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.HxapHost":
			var result *HyperflexHxapHost = &HyperflexHxapHost{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexHxapHost = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexHxapHostRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexHxapHost != nil {
		return yaml.Marshal(&src.HyperflexHxapHost)
	}
