...
func (dst *KubernetesTrustedRegistriesPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "kubernetes.TrustedRegistriesPolicy.List":
			var result *KubernetesTrustedRegistriesPolicyList = &KubernetesTrustedRegistriesPolicyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesTrustedRegistriesPolicyList = result
			return nil
...
func (src *KubernetesTrustedRegistriesPolicyResponse) MarshalYAML() ([]byte, error) {
	if src.KubernetesTrustedRegistriesPolicyList != nil {
		return yaml.Marshal(&src.KubernetesTrustedRegistriesPolicyList)
	}
