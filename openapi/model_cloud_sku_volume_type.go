...
type CloudSkuVolumeType struct {
	CloudBaseSku `yaml:"CloudBaseSku,inline"`
	// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
	ClassId string `json:"ClassId" yaml:"ClassId"`
	// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
	ObjectType string `json:"ObjectType" yaml:"ObjectType"`
	// The units to measure IOPS.
	IopsUnit *string `json:"IopsUnit,omitempty" yaml:"IopsUnit,omitempty"`
	// Indicates if this volume can be used as a boot volume.
	IsBootable *bool `json:"IsBootable,omitempty" yaml:"IsBootable,omitempty"`
	...
	IsProvisionedIops *bool `json:"IsProvisionedIops,omitempty" yaml:"IsProvisionedIops,omitempty"`
	// The max I/O operations per second that this volume type supports. Read or write numbers does not go beyond this value.
	MaxIops *float64 `json:"MaxIops,omitempty" yaml:"MaxIops,omitempty"`
	// The maximum read IOPS that this volume type supports.
	MaxReadIops *float64 `json:"MaxReadIops,omitempty" yaml:"MaxReadIops,omitempty"`
	// The maximum read throughput limit for this volume type.
	MaxReadThroughput *float64 `json:"MaxReadThroughput,omitempty" yaml:"MaxReadThroughput,omitempty"`
	// The maximum throughput limit for this volume type.
	MaxThroughput *float64 `json:"MaxThroughput,omitempty" yaml:"MaxThroughput,omitempty"`
	// The maximum storage size that this volume type supports.
	MaxVolumeSize *float64 `json:"MaxVolumeSize,omitempty" yaml:"MaxVolumeSize,omitempty"`
	// The maximum write IOPS that this volume type supports.
	MaxWriteIops *float64 `json:"MaxWriteIops,omitempty" yaml:"MaxWriteIops,omitempty"`
	// The maximum write throughput limit for this volume type.
	MaxWriteThroughput *float64 `json:"MaxWriteThroughput,omitempty" yaml:"MaxWriteThroughput,omitempty"`
	// The minimum storage size that this volume type supports.
	MinVolumeSize *float64 `json:"MinVolumeSize,omitempty" yaml:"MinVolumeSize,omitempty"`
	// The units for measuring throughput.
	ThroughputUnit *string `json:"ThroughputUnit,omitempty" yaml:"ThroughputUnit,omitempty"`
	// The volume type like gp2 or st1.
	Type *string `json:"Type,omitempty" yaml:"Type,omitempty"`
	// The units for measuring volume size.
	VolumeSizeUnit *string `json:"VolumeSizeUnit,omitempty" yaml:"VolumeSizeUnit,omitempty"`
}
