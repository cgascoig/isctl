...
type SmtpPolicyAllOf struct {
	...
	SenderEmail *string `json:"SenderEmail,omitempty" yaml:"SenderEmail,omitempty"`
	// Port number used by the SMTP server for outgoing SMTP communication.
	SmtpPort       *int64   `json:"SmtpPort,omitempty" yaml:"SmtpPort,omitempty"`
	SmtpRecipients []string `json:"SmtpRecipients,omitempty" yaml:"SmtpRecipients,omitempty"`
