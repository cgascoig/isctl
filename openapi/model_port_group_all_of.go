...
type PortGroupAllOf struct {
	...
	EthernetPorts []EtherPhysicalPortRelationship `json:"EthernetPorts,omitempty" yaml:"EthernetPorts,omitempty"`
	// An array of relationships to fcPhysicalPort resources.
	FcPorts             []FcPhysicalPortRelationship         `json:"FcPorts,omitempty" yaml:"FcPorts,omitempty"`
	...
	SubGroups []PortSubGroupRelationship `json:"SubGroups,omitempty" yaml:"SubGroups,omitempty"`
}
