...
func (dst *FirmwareEulaResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "firmware.Eula.List":
			var result *FirmwareEulaList = &FirmwareEulaList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FirmwareEulaList = result
			return nil
...
func (src *FirmwareEulaResponse) MarshalYAML() ([]byte, error) {
	if src.FirmwareEulaList != nil {
		return yaml.Marshal(&src.FirmwareEulaList)
	}
