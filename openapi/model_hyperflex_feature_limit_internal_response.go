...
func (dst *HyperflexFeatureLimitInternalResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "hyperflex.FeatureLimitInternal.List":
			var result *HyperflexFeatureLimitInternalList = &HyperflexFeatureLimitInternalList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexFeatureLimitInternalList = result
			return nil
...
func (src *HyperflexFeatureLimitInternalResponse) MarshalYAML() ([]byte, error) {
	if src.HyperflexFeatureLimitInternalList != nil {
		return yaml.Marshal(&src.HyperflexFeatureLimitInternalList)
	}
