...
type StorageHitachiPort struct {
	StorageBasePhysicalPort `yaml:"StorageBasePhysicalPort,inline"`
	// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
	ClassId string `json:"ClassId" yaml:"ClassId"`
	// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
	ObjectType string `json:"ObjectType" yaml:"ObjectType"`
	// Fabric mode of the port. true, Set. false, Not set.
	FabricMode *bool `json:"FabricMode,omitempty" yaml:"FabricMode,omitempty"`
	...
	Ipv6GlobalAddress *string `json:"Ipv6GlobalAddress,omitempty" yaml:"Ipv6GlobalAddress,omitempty"`
	// IPv6 link local address value.
	Ipv6LinkLocalAddress *string `json:"Ipv6LinkLocalAddress,omitempty" yaml:"Ipv6LinkLocalAddress,omitempty"`
	// IPv6 mode.
	IsIpv6Enable *bool `json:"IsIpv6Enable,omitempty" yaml:"IsIpv6Enable,omitempty"`
	// The value set for the port loop ID (AL_PA).
	LoopId *string `json:"LoopId,omitempty" yaml:"LoopId,omitempty"`
	// Topology setting for the port.
	PortConnection *string `json:"PortConnection,omitempty" yaml:"PortConnection,omitempty"`
	// LUN security setting for the port.
	PortLunSecurity *bool `json:"PortLunSecurity,omitempty" yaml:"PortLunSecurity,omitempty"`
	// Port ID (short) of the port.
	ShortportId *string `json:"ShortportId,omitempty" yaml:"ShortportId,omitempty"`
	// Value of MTU for iSCSI communication.
	TcpMtu           *int64                               `json:"TcpMtu,omitempty" yaml:"TcpMtu,omitempty"`
