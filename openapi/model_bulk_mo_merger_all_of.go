...
type BulkMoMergerAllOf struct {
	...
	MergeAction  *string                               `json:"MergeAction,omitempty" yaml:"MergeAction,omitempty"`
	Responses    []BulkRestResult                      `json:"Responses,omitempty" yaml:"Responses,omitempty"`
	Sources      []MoBaseMo                            `json:"Sources,omitempty" yaml:"Sources,omitempty"`
	TargetConfig *MoBaseMo                             `json:"TargetConfig,omitempty" yaml:"TargetConfig,omitempty"`
	Targets      []MoBaseMo                            `json:"Targets,omitempty" yaml:"Targets,omitempty"`
