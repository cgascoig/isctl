...
func (dst *SoftwareHyperflexDistributableResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		...
		case "mo.TagSummary":
			...
			return nil
		case "software.HyperflexDistributable.List":
			var result *SoftwareHyperflexDistributableList = &SoftwareHyperflexDistributableList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.SoftwareHyperflexDistributableList = result
			return nil
		default:
...
func (src *SoftwareHyperflexDistributableResponse) MarshalYAML() ([]byte, error) {
	if src.MoAggregateTransform != nil {
	...
	if src.SoftwareHyperflexDistributableList != nil {
		return yaml.Marshal(&src.SoftwareHyperflexDistributableList)
	}
