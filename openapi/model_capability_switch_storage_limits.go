...
type CapabilitySwitchStorageLimits struct {
	...
	MaximumUserZoneCount *int64 `json:"MaximumUserZoneCount,omitempty" yaml:"MaximumUserZoneCount,omitempty"`
	// Maximum configurable Virtual Fibre Channel interfaces on Switch/Fabric-Interconnect.
	MaximumVirtualFcInterfaces *int64 `json:"MaximumVirtualFcInterfaces,omitempty" yaml:"MaximumVirtualFcInterfaces,omitempty"`
	// Maximum configurable Virtual Fibre Channel interfaces per blade.
	MaximumVirtualFcInterfacesPerBladeServer *int64 `json:"MaximumVirtualFcInterfacesPerBladeServer,omitempty" yaml:"MaximumVirtualFcInterfacesPerBladeServer,omitempty"`
	// Maximum configurable VSANs on Switch/Fabric-Interconnect.
	MaximumVsans *int64 `json:"MaximumVsans,omitempty" yaml:"MaximumVsans,omitempty"`
	// Zone limit per Switch/Fabric-Interconnect.
	MaximumZoneCount *int64 `json:"MaximumZoneCount,omitempty" yaml:"MaximumZoneCount,omitempty"`
}
