...
type HyperflexClusterReplicationNetworkPolicyAllOf struct {
	...
	ReplicationBandwidthMbps *int64                 `json:"ReplicationBandwidthMbps,omitempty" yaml:"ReplicationBandwidthMbps,omitempty"`
	ReplicationIpranges      []HyperflexIpAddrRange `json:"ReplicationIpranges,omitempty" yaml:"ReplicationIpranges,omitempty"`
	// MTU for the Replication network.
	ReplicationMtu  *int64                     `json:"ReplicationMtu,omitempty" yaml:"ReplicationMtu,omitempty"`
	ReplicationVlan NullableHyperflexNamedVlan `json:"ReplicationVlan,omitempty" yaml:"ReplicationVlan,omitempty"`
	...
	IpPoolMoReference *MoBaseMoRelationship                 `json:"IpPoolMoReference,omitempty" yaml:"IpPoolMoReference,omitempty"`
