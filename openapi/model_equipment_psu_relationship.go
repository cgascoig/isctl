...
func (dst *EquipmentPsuRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "equipment.Psu":
			var result *EquipmentPsu = &EquipmentPsu{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentPsu = result
			return nil
		case "mo.MoRef":
...
func (src *EquipmentPsuRelationship) MarshalYAML() ([]byte, error) {
	if src.EquipmentPsu != nil {
		return yaml.Marshal(&src.EquipmentPsu)
	}
