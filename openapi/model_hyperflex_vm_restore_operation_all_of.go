...
type HyperflexVmRestoreOperationAllOf struct {
	...
	PowerOn                *bool                                 `json:"PowerOn,omitempty" yaml:"PowerOn,omitempty"`
	Organization           *OrganizationOrganizationRelationship `json:"Organization,omitempty" yaml:"Organization,omitempty"`
	RestoreEdgeClusterMoid *HyperflexClusterRelationship         `json:"RestoreEdgeClusterMoid,omitempty" yaml:"RestoreEdgeClusterMoid,omitempty"`
	VmBackupInfoMoid       *HyperflexVmBackupInfoRelationship    `json:"VmBackupInfoMoid,omitempty" yaml:"VmBackupInfoMoid,omitempty"`
	VmSnapshotInfoMoid     *HyperflexVmSnapshotInfoRelationship  `json:"VmSnapshotInfoMoid,omitempty" yaml:"VmSnapshotInfoMoid,omitempty"`
}
