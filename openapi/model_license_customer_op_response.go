...
func (dst *LicenseCustomerOpResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "license.CustomerOp.List":
			var result *LicenseCustomerOpList = &LicenseCustomerOpList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.LicenseCustomerOpList = result
			return nil
...
func (src *LicenseCustomerOpResponse) MarshalYAML() ([]byte, error) {
	if src.LicenseCustomerOpList != nil {
		return yaml.Marshal(&src.LicenseCustomerOpList)
	}
