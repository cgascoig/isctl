...
func (dst *KubernetesVirtualMachineInfraConfigPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "kubernetes.VirtualMachineInfraConfigPolicy.List":
			var result *KubernetesVirtualMachineInfraConfigPolicyList = &KubernetesVirtualMachineInfraConfigPolicyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesVirtualMachineInfraConfigPolicyList = result
			return nil
...
func (src *KubernetesVirtualMachineInfraConfigPolicyResponse) MarshalYAML() ([]byte, error) {
	if src.KubernetesVirtualMachineInfraConfigPolicyList != nil {
		return yaml.Marshal(&src.KubernetesVirtualMachineInfraConfigPolicyList)
	}
