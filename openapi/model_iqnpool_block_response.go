...
func (dst *IqnpoolBlockResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iqnpool.Block.List":
			var result *IqnpoolBlockList = &IqnpoolBlockList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IqnpoolBlockList = result
			return nil
...
func (src *IqnpoolBlockResponse) MarshalYAML() ([]byte, error) {
	if src.IqnpoolBlockList != nil {
		return yaml.Marshal(&src.IqnpoolBlockList)
	}
