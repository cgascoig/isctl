...
type FirmwareUnsupportedVersionUpgradeAllOf struct {
	...
	UpgradeStatus    *string                                `json:"UpgradeStatus,omitempty" yaml:"UpgradeStatus,omitempty"`
	...
	PhysicalIdentity *EquipmentPhysicalIdentityRelationship `json:"PhysicalIdentity,omitempty" yaml:"PhysicalIdentity,omitempty"`
}
