...
type WorkflowSshSessionAllOf struct {
	...
	FileTransferToRemote *WorkflowFileTransfer `json:"FileTransferToRemote,omitempty" yaml:"FileTransferToRemote,omitempty"`
	...
	SshCommand       *WorkflowSshCmd    `json:"SshCommand,omitempty" yaml:"SshCommand,omitempty"`
	SshConfiguration *WorkflowSshConfig `json:"SshConfiguration,omitempty" yaml:"SshConfiguration,omitempty"`
}
