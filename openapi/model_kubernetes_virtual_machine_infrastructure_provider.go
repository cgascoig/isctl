...
type KubernetesVirtualMachineInfrastructureProvider struct {
	KubernetesBaseInfrastructureProvider `yaml:"KubernetesBaseInfrastructureProvider,inline"`
	// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
	ClassId string `json:"ClassId" yaml:"ClassId"`
	// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
	ObjectType        string                                                 `json:"ObjectType" yaml:"ObjectType"`
	InfraConfig       NullableKubernetesBaseVirtualMachineInfraConfig        `json:"InfraConfig,omitempty" yaml:"InfraConfig,omitempty"`
	InfraConfigPolicy *KubernetesVirtualMachineInfraConfigPolicyRelationship `json:"InfraConfigPolicy,omitempty" yaml:"InfraConfigPolicy,omitempty"`
	InstanceType      *KubernetesVirtualMachineInstanceTypeRelationship      `json:"InstanceType,omitempty" yaml:"InstanceType,omitempty"`
