...
type VirtualizationVmwareDatastore struct {
	VirtualizationBaseDatastore `yaml:"VirtualizationBaseDatastore,inline"`
	...
	MultipleHostAccess *bool `json:"MultipleHostAccess,omitempty" yaml:"MultipleHostAccess,omitempty"`
	...
	ThinProvisioningSupported *bool `json:"ThinProvisioningSupported,omitempty" yaml:"ThinProvisioningSupported,omitempty"`
	// Space uncommitted in this datastore in bytes.
	UnCommitted *int64 `json:"UnCommitted,omitempty" yaml:"UnCommitted,omitempty"`
