...
func (dst *IamUserPreferenceRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "iam.UserPreference":
			var result *IamUserPreference = &IamUserPreference{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamUserPreference = result
			return nil
		case "mo.MoRef":
...
func (src *IamUserPreferenceRelationship) MarshalYAML() ([]byte, error) {
	if src.IamUserPreference != nil {
		return yaml.Marshal(&src.IamUserPreference)
	}
