...
type IamLocalUserPasswordPolicy struct {
	...
	MinCharDifference *int64 `json:"MinCharDifference,omitempty" yaml:"MinCharDifference,omitempty"`
	// Minimum Days allowed between password change.
	MinDaysBetweenPasswordChange *int64 `json:"MinDaysBetweenPasswordChange,omitempty" yaml:"MinDaysBetweenPasswordChange,omitempty"`
	// Minimum length of password.
	MinLengthPassword *int64 `json:"MinLengthPassword,omitempty" yaml:"MinLengthPassword,omitempty"`
	// Minimum number of required lower case characters.
	MinLowerCase *int64 `json:"MinLowerCase,omitempty" yaml:"MinLowerCase,omitempty"`
	// Minimum number of required numeric characters.
	MinNumeric *int64 `json:"MinNumeric,omitempty" yaml:"MinNumeric,omitempty"`
	// Minimum number of required special characters.
	MinSpecialChar *int64 `json:"MinSpecialChar,omitempty" yaml:"MinSpecialChar,omitempty"`
	// Minimum number of required upper case characters.
	MinUpperCase *int64 `json:"MinUpperCase,omitempty" yaml:"MinUpperCase,omitempty"`
	// Number of previous passwords disallowed.
	NumPreviousPasswordsDisallowed *int64                  `json:"NumPreviousPasswordsDisallowed,omitempty" yaml:"NumPreviousPasswordsDisallowed,omitempty"`
