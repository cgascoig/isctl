...
func (dst *IamUserGroupResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iam.UserGroup.List":
			var result *IamUserGroupList = &IamUserGroupList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamUserGroupList = result
			return nil
...
func (src *IamUserGroupResponse) MarshalYAML() ([]byte, error) {
	if src.IamUserGroupList != nil {
		return yaml.Marshal(&src.IamUserGroupList)
	}
