...
func (dst *HyperflexHealthCheckExecutionSnapshotResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "hyperflex.HealthCheckExecutionSnapshot.List":
			var result *HyperflexHealthCheckExecutionSnapshotList = &HyperflexHealthCheckExecutionSnapshotList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexHealthCheckExecutionSnapshotList = result
			return nil
...
func (src *HyperflexHealthCheckExecutionSnapshotResponse) MarshalYAML() ([]byte, error) {
	if src.HyperflexHealthCheckExecutionSnapshotList != nil {
		return yaml.Marshal(&src.HyperflexHealthCheckExecutionSnapshotList)
	}
