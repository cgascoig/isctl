...
type OsBaseInstallConfig struct {
	...
	Answers              *OsAnswers       `json:"Answers,omitempty" yaml:"Answers,omitempty"`
	...
	OperatingSystemParameters *OsOperatingSystemParameters `json:"OperatingSystemParameters,omitempty" yaml:"OperatingSystemParameters,omitempty"`
}
