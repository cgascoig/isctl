...
func (dst *HyperflexSysConfigPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "hyperflex.SysConfigPolicy.List":
			var result *HyperflexSysConfigPolicyList = &HyperflexSysConfigPolicyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexSysConfigPolicyList = result
			return nil
...
func (src *HyperflexSysConfigPolicyResponse) MarshalYAML() ([]byte, error) {
	if src.HyperflexSysConfigPolicyList != nil {
		return yaml.Marshal(&src.HyperflexSysConfigPolicyList)
	}
