...
func (dst *CapabilityCatalogResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "capability.Catalog.List":
			var result *CapabilityCatalogList = &CapabilityCatalogList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.CapabilityCatalogList = result
			return nil
...
func (src *CapabilityCatalogResponse) MarshalYAML() ([]byte, error) {
	if src.CapabilityCatalogList != nil {
		return yaml.Marshal(&src.CapabilityCatalogList)
	}
