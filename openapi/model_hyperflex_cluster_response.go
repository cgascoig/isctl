...
func (dst *HyperflexClusterResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "hyperflex.Cluster.List":
			var result *HyperflexClusterList = &HyperflexClusterList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexClusterList = result
			return nil
...
func (src *HyperflexClusterResponse) MarshalYAML() ([]byte, error) {
	if src.HyperflexClusterList != nil {
		return yaml.Marshal(&src.HyperflexClusterList)
	}
