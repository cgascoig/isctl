...
func (dst *HyperflexHxdpVersionRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.HxdpVersion":
			var result *HyperflexHxdpVersion = &HyperflexHxdpVersion{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexHxdpVersion = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexHxdpVersionRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexHxdpVersion != nil {
		return yaml.Marshal(&src.HyperflexHxdpVersion)
	}
