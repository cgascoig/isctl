...
type TelemetryDruidQueryContext struct {
	...
	UseCache *bool `json:"useCache,omitempty" yaml:"useCache,omitempty"`
	...
	PopulateCache *bool `json:"populateCache,omitempty" yaml:"populateCache,omitempty"`
	...
	UseResultLevelCache *bool `json:"useResultLevelCache,omitempty" yaml:"useResultLevelCache,omitempty"`
	...
	PopulateResultLevelCache *bool `json:"populateResultLevelCache,omitempty" yaml:"populateResultLevelCache,omitempty"`
	...
	BySegment *bool `json:"bySegment,omitempty" yaml:"bySegment,omitempty"`
	...
	ChunkPeriod *string `json:"chunkPeriod,omitempty" yaml:"chunkPeriod,omitempty"`
	...
	MaxScatterGatherBytes *int32 `json:"maxScatterGatherBytes,omitempty" yaml:"maxScatterGatherBytes,omitempty"`
	...
	MaxQueuedBytes *int32 `json:"maxQueuedBytes,omitempty" yaml:"maxQueuedBytes,omitempty"`
	...
	SerializeDateTimeAsLong *bool `json:"serializeDateTimeAsLong,omitempty" yaml:"serializeDateTimeAsLong,omitempty"`
	// If true, DateTime is serialized as long in the data transportation between Broker and compute process.
	SerializeDateTimeAsLongInner *bool `json:"serializeDateTimeAsLongInner,omitempty" yaml:"serializeDateTimeAsLongInner,omitempty"`
	...
	EnableParallelMerge *bool `json:"enableParallelMerge,omitempty" yaml:"enableParallelMerge,omitempty"`
	// Maximum number of parallel threads to use for parallel result merging on the Broker.
	ParallelMergeParallelism *int32 `json:"parallelMergeParallelism,omitempty" yaml:"parallelMergeParallelism,omitempty"`
	...
	ParallelMergeInitialYieldRows *int32 `json:"parallelMergeInitialYieldRows,omitempty" yaml:"parallelMergeInitialYieldRows,omitempty"`
	// Size of result batches to operate on in ForkJoinPool merge tasks for parallel result merging on the Broker.
	ParallelMergeSmallBatchRows *int32 `json:"parallelMergeSmallBatchRows,omitempty" yaml:"parallelMergeSmallBatchRows,omitempty"`
}
