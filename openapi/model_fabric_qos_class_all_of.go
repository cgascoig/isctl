...
type FabricQosClassAllOf struct {
	...
	BandwidthPercent *int64 `json:"BandwidthPercent,omitempty" yaml:"BandwidthPercent,omitempty"`
	...
	MulticastOptimize *bool `json:"MulticastOptimize,omitempty" yaml:"MulticastOptimize,omitempty"`
	...
	PacketDrop *bool `json:"PacketDrop,omitempty" yaml:"PacketDrop,omitempty"`
