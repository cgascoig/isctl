...
func (dst *IamSessionLimitsResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iam.SessionLimits.List":
			var result *IamSessionLimitsList = &IamSessionLimitsList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamSessionLimitsList = result
			return nil
...
func (src *IamSessionLimitsResponse) MarshalYAML() ([]byte, error) {
	if src.IamSessionLimitsList != nil {
		return yaml.Marshal(&src.IamSessionLimitsList)
	}
