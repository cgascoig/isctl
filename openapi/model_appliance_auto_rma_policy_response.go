...
func (dst *ApplianceAutoRmaPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "appliance.AutoRmaPolicy.List":
			var result *ApplianceAutoRmaPolicyList = &ApplianceAutoRmaPolicyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ApplianceAutoRmaPolicyList = result
			return nil
...
func (src *ApplianceAutoRmaPolicyResponse) MarshalYAML() ([]byte, error) {
	if src.ApplianceAutoRmaPolicyList != nil {
		return yaml.Marshal(&src.ApplianceAutoRmaPolicyList)
	}
