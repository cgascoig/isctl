...
func (dst *IamEndPointPrivilegeResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iam.EndPointPrivilege.List":
			var result *IamEndPointPrivilegeList = &IamEndPointPrivilegeList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamEndPointPrivilegeList = result
			return nil
...
func (src *IamEndPointPrivilegeResponse) MarshalYAML() ([]byte, error) {
	if src.IamEndPointPrivilegeList != nil {
		return yaml.Marshal(&src.IamEndPointPrivilegeList)
	}
