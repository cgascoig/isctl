...
func (dst *CloudSkuInstanceTypeResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "cloud.SkuInstanceType.List":
			var result *CloudSkuInstanceTypeList = &CloudSkuInstanceTypeList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.CloudSkuInstanceTypeList = result
			return nil
...
func (src *CloudSkuInstanceTypeResponse) MarshalYAML() ([]byte, error) {
	if src.CloudSkuInstanceTypeList != nil {
		return yaml.Marshal(&src.CloudSkuInstanceTypeList)
	}
