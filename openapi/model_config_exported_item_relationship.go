...
func (dst *ConfigExportedItemRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "config.ExportedItem":
			var result *ConfigExportedItem = &ConfigExportedItem{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ConfigExportedItem = result
			return nil
		case "mo.MoRef":
...
func (src *ConfigExportedItemRelationship) MarshalYAML() ([]byte, error) {
	if src.ConfigExportedItem != nil {
		return yaml.Marshal(&src.ConfigExportedItem)
	}
