...
func (dst *MemoryPersistentMemoryUnitResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "memory.PersistentMemoryUnit.List":
			var result *MemoryPersistentMemoryUnitList = &MemoryPersistentMemoryUnitList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.MemoryPersistentMemoryUnitList = result
			return nil
...
func (src *MemoryPersistentMemoryUnitResponse) MarshalYAML() ([]byte, error) {
	if src.MemoryPersistentMemoryUnitList != nil {
		return yaml.Marshal(&src.MemoryPersistentMemoryUnitList)
	}
