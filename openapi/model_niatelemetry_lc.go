...
type NiatelemetryLc struct {
	...
	HardwareVersion *string `json:"HardwareVersion,omitempty" yaml:"HardwareVersion,omitempty"`
	...
	OperationalState *string `json:"OperationalState,omitempty" yaml:"OperationalState,omitempty"`
	...
	RedundancyState *string `json:"RedundancyState,omitempty" yaml:"RedundancyState,omitempty"`
