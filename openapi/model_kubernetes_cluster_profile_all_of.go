...
type KubernetesClusterProfileAllOf struct {
	...
	ActionInfo      NullableKubernetesActionInfo                      `json:"ActionInfo,omitempty" yaml:"ActionInfo,omitempty"`
	CertConfig      NullableKubernetesClusterCertificateConfiguration `json:"CertConfig,omitempty" yaml:"CertConfig,omitempty"`
	EssentialAddons []KubernetesEssentialAddon                        `json:"EssentialAddons,omitempty" yaml:"EssentialAddons,omitempty"`
	KubeConfig      NullableKubernetesConfiguration                   `json:"KubeConfig,omitempty" yaml:"KubeConfig,omitempty"`
	...
	ManagedMode      *string                                   `json:"ManagedMode,omitempty" yaml:"ManagedMode,omitempty"`
	ManagementConfig NullableKubernetesClusterManagementConfig `json:"ManagementConfig,omitempty" yaml:"ManagementConfig,omitempty"`
	...
	AciCniProfile     *KubernetesAciCniProfileRelationship `json:"AciCniProfile,omitempty" yaml:"AciCniProfile,omitempty"`
	AssociatedCluster *KubernetesClusterRelationship       `json:"AssociatedCluster,omitempty" yaml:"AssociatedCluster,omitempty"`
	// An array of relationships to ippoolPool resources.
	ClusterIpPools         []IppoolPoolRelationship                      `json:"ClusterIpPools,omitempty" yaml:"ClusterIpPools,omitempty"`
	ContainerRuntimeConfig *KubernetesContainerRuntimePolicyRelationship `json:"ContainerRuntimeConfig,omitempty" yaml:"ContainerRuntimeConfig,omitempty"`
	// An array of relationships to ippoolIpLease resources.
	LoadbalancerIpLeases []IppoolIpLeaseRelationship          `json:"LoadbalancerIpLeases,omitempty" yaml:"LoadbalancerIpLeases,omitempty"`
	MasterVipLease       *IppoolIpLeaseRelationship           `json:"MasterVipLease,omitempty" yaml:"MasterVipLease,omitempty"`
	NetConfig            *KubernetesNetworkPolicyRelationship `json:"NetConfig,omitempty" yaml:"NetConfig,omitempty"`
	// An array of relationships to kubernetesNodeGroupProfile resources.
	NodeGroups        []KubernetesNodeGroupProfileRelationship       `json:"NodeGroups,omitempty" yaml:"NodeGroups,omitempty"`
	Organization      *OrganizationOrganizationRelationship          `json:"Organization,omitempty" yaml:"Organization,omitempty"`
	SysConfig         *KubernetesSysConfigPolicyRelationship         `json:"SysConfig,omitempty" yaml:"SysConfig,omitempty"`
	TrustedRegistries *KubernetesTrustedRegistriesPolicyRelationship `json:"TrustedRegistries,omitempty" yaml:"TrustedRegistries,omitempty"`
