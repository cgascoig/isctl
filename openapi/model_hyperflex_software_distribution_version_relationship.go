...
func (dst *HyperflexSoftwareDistributionVersionRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.SoftwareDistributionVersion":
			var result *HyperflexSoftwareDistributionVersion = &HyperflexSoftwareDistributionVersion{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexSoftwareDistributionVersion = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexSoftwareDistributionVersionRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexSoftwareDistributionVersion != nil {
		return yaml.Marshal(&src.HyperflexSoftwareDistributionVersion)
	}
