...
func (dst *SoftwarerepositoryCategoryMapperResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		...
		case "mo.TagSummary":
			...
			return nil
		case "softwarerepository.CategoryMapper.List":
			var result *SoftwarerepositoryCategoryMapperList = &SoftwarerepositoryCategoryMapperList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.SoftwarerepositoryCategoryMapperList = result
			return nil
		default:
...
func (src *SoftwarerepositoryCategoryMapperResponse) MarshalYAML() ([]byte, error) {
	if src.MoAggregateTransform != nil {
	...
	if src.SoftwarerepositoryCategoryMapperList != nil {
		return yaml.Marshal(&src.SoftwarerepositoryCategoryMapperList)
	}
