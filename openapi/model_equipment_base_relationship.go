...
func (dst *EquipmentBaseRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "equipment.Base":
			var result *EquipmentBase = &EquipmentBase{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentBase = result
			return nil
		case "mo.MoRef":
...
func (src *EquipmentBaseRelationship) MarshalYAML() ([]byte, error) {
	if src.EquipmentBase != nil {
		return yaml.Marshal(&src.EquipmentBase)
	}
