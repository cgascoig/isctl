...
func (dst *BootVmediaDeviceRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "boot.VmediaDevice":
			var result *BootVmediaDevice = &BootVmediaDevice{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.BootVmediaDevice = result
			return nil
		case "mo.MoRef":
...
func (src *BootVmediaDeviceRelationship) MarshalYAML() ([]byte, error) {
	if src.BootVmediaDevice != nil {
		return yaml.Marshal(&src.BootVmediaDevice)
	}
