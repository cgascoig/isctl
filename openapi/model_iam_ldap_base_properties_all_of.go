...
type IamLdapBasePropertiesAllOf struct {
	...
	BindMethod *string `json:"BindMethod,omitempty" yaml:"BindMethod,omitempty"`
	...
	EnableGroupAuthorization *bool `json:"EnableGroupAuthorization,omitempty" yaml:"EnableGroupAuthorization,omitempty"`
	...
	NestedGroupSearchDepth *int64 `json:"NestedGroupSearchDepth,omitempty" yaml:"NestedGroupSearchDepth,omitempty"`
