...
func (dst *KubernetesNodeGroupProfileRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "kubernetes.NodeGroupProfile":
			var result *KubernetesNodeGroupProfile = &KubernetesNodeGroupProfile{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesNodeGroupProfile = result
			return nil
		case "mo.MoRef":
...
func (src *KubernetesNodeGroupProfileRelationship) MarshalYAML() ([]byte, error) {
	if src.KubernetesNodeGroupProfile != nil {
		return yaml.Marshal(&src.KubernetesNodeGroupProfile)
	}
