...
func (dst *InventoryGenericInventoryRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "inventory.GenericInventory":
			var result *InventoryGenericInventory = &InventoryGenericInventory{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.InventoryGenericInventory = result
			return nil
		case "mo.MoRef":
...
func (src *InventoryGenericInventoryRelationship) MarshalYAML() ([]byte, error) {
	if src.InventoryGenericInventory != nil {
		return yaml.Marshal(&src.InventoryGenericInventory)
	}
