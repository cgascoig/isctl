...
func (dst *InventoryDnMoBindingResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "inventory.DnMoBinding.List":
			var result *InventoryDnMoBindingList = &InventoryDnMoBindingList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.InventoryDnMoBindingList = result
			return nil
...
func (src *InventoryDnMoBindingResponse) MarshalYAML() ([]byte, error) {
	if src.InventoryDnMoBindingList != nil {
		return yaml.Marshal(&src.InventoryDnMoBindingList)
	}
