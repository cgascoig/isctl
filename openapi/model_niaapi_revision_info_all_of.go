...
type NiaapiRevisionInfoAllOf struct {
	...
	RevisionComment *string `json:"RevisionComment,omitempty" yaml:"RevisionComment,omitempty"`
	// The Revision No. of this revision.
	RevisionNo *string `json:"RevisionNo,omitempty" yaml:"RevisionNo,omitempty"`
}
