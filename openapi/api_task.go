...
func (r apiCreateTaskHitachiScopedInventoryRequest) Execute() (TaskHitachiScopedInventory, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "TaskApiService.CreateTaskHitachiScopedInventory")
	if err != nil {
...
func (r apiCreateTaskHxapScopedInventoryRequest) Execute() (TaskHxapScopedInventory, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "TaskApiService.CreateTaskHxapScopedInventory")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiCreateTaskNetAppScopedInventoryRequest) Execute() (TaskNetAppScopedInventory, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "TaskApiService.CreateTaskNetAppScopedInventory")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
