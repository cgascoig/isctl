...
func (dst *KubernetesConfigResultEntryRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "kubernetes.ConfigResultEntry":
			var result *KubernetesConfigResultEntry = &KubernetesConfigResultEntry{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesConfigResultEntry = result
			return nil
		case "mo.MoRef":
...
func (src *KubernetesConfigResultEntryRelationship) MarshalYAML() ([]byte, error) {
	if src.KubernetesConfigResultEntry != nil {
		return yaml.Marshal(&src.KubernetesConfigResultEntry)
	}
