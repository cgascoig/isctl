...
func (dst *IamPrivilegeSetRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "iam.PrivilegeSet":
			var result *IamPrivilegeSet = &IamPrivilegeSet{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamPrivilegeSet = result
			return nil
		case "mo.MoRef":
...
func (src *IamPrivilegeSetRelationship) MarshalYAML() ([]byte, error) {
	if src.IamPrivilegeSet != nil {
		return yaml.Marshal(&src.IamPrivilegeSet)
	}
