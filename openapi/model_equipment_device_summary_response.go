...
func (dst *EquipmentDeviceSummaryResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "equipment.DeviceSummary.List":
			var result *EquipmentDeviceSummaryList = &EquipmentDeviceSummaryList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentDeviceSummaryList = result
			return nil
...
func (src *EquipmentDeviceSummaryResponse) MarshalYAML() ([]byte, error) {
	if src.EquipmentDeviceSummaryList != nil {
		return yaml.Marshal(&src.EquipmentDeviceSummaryList)
	}
