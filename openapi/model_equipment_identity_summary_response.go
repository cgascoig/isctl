...
func (dst *EquipmentIdentitySummaryResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "equipment.IdentitySummary.List":
			var result *EquipmentIdentitySummaryList = &EquipmentIdentitySummaryList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentIdentitySummaryList = result
			return nil
...
func (src *EquipmentIdentitySummaryResponse) MarshalYAML() ([]byte, error) {
	if src.EquipmentIdentitySummaryList != nil {
		return yaml.Marshal(&src.EquipmentIdentitySummaryList)
	}
