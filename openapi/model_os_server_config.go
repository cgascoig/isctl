...
type OsServerConfig struct {
	...
	AdditionalParameters []OsPlaceHolder   `json:"AdditionalParameters,omitempty" yaml:"AdditionalParameters,omitempty"`
	Answers              NullableOsAnswers `json:"Answers,omitempty" yaml:"Answers,omitempty"`
	ErrorMsgs            []string          `json:"ErrorMsgs,omitempty" yaml:"ErrorMsgs,omitempty"`
	...
	InstallTarget          *string                 `json:"InstallTarget,omitempty" yaml:"InstallTarget,omitempty"`
	ProcessedInstallTarget NullableOsInstallTarget `json:"ProcessedInstallTarget,omitempty" yaml:"ProcessedInstallTarget,omitempty"`
