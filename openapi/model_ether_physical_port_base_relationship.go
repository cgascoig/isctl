...
func (dst *EtherPhysicalPortBaseRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "ether.PhysicalPortBase":
			var result *EtherPhysicalPortBase = &EtherPhysicalPortBase{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EtherPhysicalPortBase = result
			return nil
		case "mo.MoRef":
...
func (src *EtherPhysicalPortBaseRelationship) MarshalYAML() ([]byte, error) {
	if src.EtherPhysicalPortBase != nil {
		return yaml.Marshal(&src.EtherPhysicalPortBase)
	}
