...
type WorkflowSubWorkflowTask struct {
	WorkflowAbstractWorkerTask `yaml:"WorkflowAbstractWorkerTask,inline"`
	...
	WorkflowDefinitionId *string `json:"WorkflowDefinitionId,omitempty" yaml:"WorkflowDefinitionId,omitempty"`
	// The qualified name of workflow that should be executed as a task.
	WorkflowDefinitionName *string `json:"WorkflowDefinitionName,omitempty" yaml:"WorkflowDefinitionName,omitempty"`
}
