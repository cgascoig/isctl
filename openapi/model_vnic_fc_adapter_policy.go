...
type VnicFcAdapterPolicy struct {
	...
	ErrorDetectionTimeout *int64                              `json:"ErrorDetectionTimeout,omitempty" yaml:"ErrorDetectionTimeout,omitempty"`
	ErrorRecoverySettings NullableVnicFcErrorRecoverySettings `json:"ErrorRecoverySettings,omitempty" yaml:"ErrorRecoverySettings,omitempty"`
	FlogiSettings         NullableVnicFlogiSettings           `json:"FlogiSettings,omitempty" yaml:"FlogiSettings,omitempty"`
	InterruptSettings     NullableVnicFcInterruptSettings     `json:"InterruptSettings,omitempty" yaml:"InterruptSettings,omitempty"`
	...
	IoThrottleCount *int64 `json:"IoThrottleCount,omitempty" yaml:"IoThrottleCount,omitempty"`
	...
	LunCount *int64 `json:"LunCount,omitempty" yaml:"LunCount,omitempty"`
	// The number of commands that the HBA can send and receive in a single transmission per LUN.
	LunQueueDepth *int64                    `json:"LunQueueDepth,omitempty" yaml:"LunQueueDepth,omitempty"`
	PlogiSettings NullableVnicPlogiSettings `json:"PlogiSettings,omitempty" yaml:"PlogiSettings,omitempty"`
	...
	ResourceAllocationTimeout *int64                                `json:"ResourceAllocationTimeout,omitempty" yaml:"ResourceAllocationTimeout,omitempty"`
	RxQueueSettings           NullableVnicFcQueueSettings           `json:"RxQueueSettings,omitempty" yaml:"RxQueueSettings,omitempty"`
	ScsiQueueSettings         NullableVnicScsiQueueSettings         `json:"ScsiQueueSettings,omitempty" yaml:"ScsiQueueSettings,omitempty"`
	TxQueueSettings           NullableVnicFcQueueSettings           `json:"TxQueueSettings,omitempty" yaml:"TxQueueSettings,omitempty"`
