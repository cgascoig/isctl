...
type VnicFcAdapterPolicy struct {
	...
	ErrorRecoverySettings *VnicFcErrorRecoverySettings `json:"ErrorRecoverySettings,omitempty" yaml:"ErrorRecoverySettings,omitempty"`
	FlogiSettings         *VnicFlogiSettings           `json:"FlogiSettings,omitempty" yaml:"FlogiSettings,omitempty"`
	InterruptSettings     *VnicFcInterruptSettings     `json:"InterruptSettings,omitempty" yaml:"InterruptSettings,omitempty"`
	...
	PlogiSettings *VnicPlogiSettings `json:"PlogiSettings,omitempty" yaml:"PlogiSettings,omitempty"`
	...
	RxQueueSettings           *VnicFcQueueSettings                  `json:"RxQueueSettings,omitempty" yaml:"RxQueueSettings,omitempty"`
	ScsiQueueSettings         *VnicScsiQueueSettings                `json:"ScsiQueueSettings,omitempty" yaml:"ScsiQueueSettings,omitempty"`
	TxQueueSettings           *VnicFcQueueSettings                  `json:"TxQueueSettings,omitempty" yaml:"TxQueueSettings,omitempty"`
