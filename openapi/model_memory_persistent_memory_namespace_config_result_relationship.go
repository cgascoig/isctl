...
func (dst *MemoryPersistentMemoryNamespaceConfigResultRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "memory.PersistentMemoryNamespaceConfigResult":
			var result *MemoryPersistentMemoryNamespaceConfigResult = &MemoryPersistentMemoryNamespaceConfigResult{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.MemoryPersistentMemoryNamespaceConfigResult = result
			return nil
		case "mo.MoRef":
...
func (src *MemoryPersistentMemoryNamespaceConfigResultRelationship) MarshalYAML() ([]byte, error) {
	if src.MemoryPersistentMemoryNamespaceConfigResult != nil {
		return yaml.Marshal(&src.MemoryPersistentMemoryNamespaceConfigResult)
	}
