...
type VmediaMapping struct {
	...
	MountProtocol *string `json:"MountProtocol,omitempty" yaml:"MountProtocol,omitempty"`
	...
	SanitizedFileLocation *string `json:"SanitizedFileLocation,omitempty" yaml:"SanitizedFileLocation,omitempty"`
