...
func (dst *VirtualizationVmwareVirtualDiskResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		...
		case "mo.TagSummary":
			...
			return nil
		case "virtualization.VmwareVirtualDisk.List":
			var result *VirtualizationVmwareVirtualDiskList = &VirtualizationVmwareVirtualDiskList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.VirtualizationVmwareVirtualDiskList = result
			return nil
		default:
...
func (src *VirtualizationVmwareVirtualDiskResponse) MarshalYAML() ([]byte, error) {
	if src.MoAggregateTransform != nil {
	...
	if src.VirtualizationVmwareVirtualDiskList != nil {
		return yaml.Marshal(&src.VirtualizationVmwareVirtualDiskList)
	}
