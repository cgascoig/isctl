...
type NiatelemetryNiaInventoryFabricAllOf struct {
	...
	AnycastGwMac *string `json:"AnycastGwMac,omitempty" yaml:"AnycastGwMac,omitempty"`
	// Counts the number of BGP interfaces that are in established state.
	BgpEstablishedInterfaceCount *int64 `json:"BgpEstablishedInterfaceCount,omitempty" yaml:"BgpEstablishedInterfaceCount,omitempty"`
	// Count number of active interfaces on border gateways.
	BgwInterfaceUpCount *int64 `json:"BgwInterfaceUpCount,omitempty" yaml:"BgwInterfaceUpCount,omitempty"`
	// Count number of border gateway spines in the fabric inventory.
	BorderGatewaySpineCount *int64 `json:"BorderGatewaySpineCount,omitempty" yaml:"BorderGatewaySpineCount,omitempty"`
	// Count number of border leafs in the fabric inventory.
	BorderLeafCount *int64 `json:"BorderLeafCount,omitempty" yaml:"BorderLeafCount,omitempty"`
	// Returns the dci subnet range.
	DciSubnetRange *string `json:"DciSubnetRange,omitempty" yaml:"DciSubnetRange,omitempty"`
	// Returns the dci subnet target mask.
	DciSubnetTargetMask *string `json:"DciSubnetTargetMask,omitempty" yaml:"DciSubnetTargetMask,omitempty"`
	// Returns the value of the dcnmtrackerEnabled field.
	DcnmtrackerEnabled *bool `json:"DcnmtrackerEnabled,omitempty" yaml:"DcnmtrackerEnabled,omitempty"`
	// Count number of ebgp evpn active interfaces.
	EbgpEvpnLinkUpCount *int64 `json:"EbgpEvpnLinkUpCount,omitempty" yaml:"EbgpEvpnLinkUpCount,omitempty"`
	// Uniquely identifies a fabric.
	FabricId *string `json:"FabricId,omitempty" yaml:"FabricId,omitempty"`
	// Returns the value of the Name of a fabric.
	FabricName *string `json:"FabricName,omitempty" yaml:"FabricName,omitempty"`
	// Checks if border gateway is present in the fabric inventory.
	IsBgwPresent *bool `json:"IsBgwPresent,omitempty" yaml:"IsBgwPresent,omitempty"`
	// Returns if ngoam is enabled.
	IsNgoamEnabled *bool `json:"IsNgoamEnabled,omitempty" yaml:"IsNgoamEnabled,omitempty"`
	// Returns if the scheduled backup is enabled.
	IsScheduledBackUpEnabled *bool `json:"IsScheduledBackUpEnabled,omitempty" yaml:"IsScheduledBackUpEnabled,omitempty"`
	// Returns total number of leafs in the fabric.
	LeafCount    *int64                    `json:"LeafCount,omitempty" yaml:"LeafCount,omitempty"`
	LogicalLinks []NiatelemetryLogicalLink `json:"LogicalLinks,omitempty" yaml:"LogicalLinks,omitempty"`
	// Returns the count of vnis between sites.
	NxosVniBwSitesCount *int64 `json:"NxosVniBwSitesCount,omitempty" yaml:"NxosVniBwSitesCount,omitempty"`
	// Returns the count of vrfs between sites.
	NxosVrfBwSitesCount *int64 `json:"NxosVrfBwSitesCount,omitempty" yaml:"NxosVrfBwSitesCount,omitempty"`
	// Returns the value of the nxosVrfCount field.
	NxosVrfCount *int64 `json:"NxosVrfCount,omitempty" yaml:"NxosVrfCount,omitempty"`
	...
	VlanVniMappings *string `json:"VlanVniMappings,omitempty" yaml:"VlanVniMappings,omitempty"`
	// Count number of IP addresses configured in the DCNM networks.
	VniIpCount       *int64                               `json:"VniIpCount,omitempty" yaml:"VniIpCount,omitempty"`
