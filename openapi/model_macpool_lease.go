...
type MacpoolLease struct {
	...
	PoolMember       *MacpoolPoolMemberRelationship `json:"PoolMember,omitempty" yaml:"PoolMember,omitempty"`
	Universe         *MacpoolUniverseRelationship   `json:"Universe,omitempty" yaml:"Universe,omitempty"`
}
