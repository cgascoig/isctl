...
type FirmwareUpgradeBaseAllOf struct {
	...
	DirectDownload NullableFirmwareDirectDownload       `json:"DirectDownload,omitempty" yaml:"DirectDownload,omitempty"`
	FileServer     NullableSoftwarerepositoryFileServer `json:"FileServer,omitempty" yaml:"FileServer,omitempty"`
	NetworkShare   NullableFirmwareNetworkShare         `json:"NetworkShare,omitempty" yaml:"NetworkShare,omitempty"`
