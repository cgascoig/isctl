...
func (dst *LicenseCustomerOpRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "license.CustomerOp":
			var result *LicenseCustomerOp = &LicenseCustomerOp{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.LicenseCustomerOp = result
			return nil
		case "mo.MoRef":
...
func (src *LicenseCustomerOpRelationship) MarshalYAML() ([]byte, error) {
	if src.LicenseCustomerOp != nil {
		return yaml.Marshal(&src.LicenseCustomerOp)
	}
