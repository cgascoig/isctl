...
func (dst *TechsupportmanagementTechSupportBundleResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		...
		case "mo.TagSummary":
			...
			return nil
		case "techsupportmanagement.TechSupportBundle.List":
			var result *TechsupportmanagementTechSupportBundleList = &TechsupportmanagementTechSupportBundleList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.TechsupportmanagementTechSupportBundleList = result
			return nil
		default:
...
func (src *TechsupportmanagementTechSupportBundleResponse) MarshalYAML() ([]byte, error) {
	if src.MoAggregateTransform != nil {
	...
	if src.TechsupportmanagementTechSupportBundleList != nil {
		return yaml.Marshal(&src.TechsupportmanagementTechSupportBundleList)
	}
