...
func (dst *HyperflexClusterNetworkPolicyRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.ClusterNetworkPolicy":
			var result *HyperflexClusterNetworkPolicy = &HyperflexClusterNetworkPolicy{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexClusterNetworkPolicy = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexClusterNetworkPolicyRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexClusterNetworkPolicy != nil {
		return yaml.Marshal(&src.HyperflexClusterNetworkPolicy)
	}
