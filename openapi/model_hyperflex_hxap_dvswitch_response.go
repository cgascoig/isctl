...
func (dst *HyperflexHxapDvswitchResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "hyperflex.HxapDvswitch.List":
			var result *HyperflexHxapDvswitchList = &HyperflexHxapDvswitchList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexHxapDvswitchList = result
			return nil
...
func (src *HyperflexHxapDvswitchResponse) MarshalYAML() ([]byte, error) {
	if src.HyperflexHxapDvswitchList != nil {
		return yaml.Marshal(&src.HyperflexHxapDvswitchList)
	}
