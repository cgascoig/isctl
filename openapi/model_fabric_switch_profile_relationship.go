...
func (dst *FabricSwitchProfileRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "fabric.SwitchProfile":
			var result *FabricSwitchProfile = &FabricSwitchProfile{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FabricSwitchProfile = result
			return nil
		case "mo.MoRef":
...
func (src *FabricSwitchProfileRelationship) MarshalYAML() ([]byte, error) {
	if src.FabricSwitchProfile != nil {
		return yaml.Marshal(&src.FabricSwitchProfile)
	}
