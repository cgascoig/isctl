...
type CapabilitySwitchNetworkLimitsAllOf struct {
	...
	MaxCompressedPortVlanCount *int64 `json:"MaxCompressedPortVlanCount,omitempty" yaml:"MaxCompressedPortVlanCount,omitempty"`
	// Maximum configurable VLANs on Switch/Fabric-Interconnect.
	MaxUncompressedPortVlanCount *int64 `json:"MaxUncompressedPortVlanCount,omitempty" yaml:"MaxUncompressedPortVlanCount,omitempty"`
	// Maximum configured and enabled Traffic Monitoring sessions on this Switch/Fabric-Interconnect.
	MaximumActiveTrafficMonitoringSessions *int64 `json:"MaximumActiveTrafficMonitoringSessions,omitempty" yaml:"MaximumActiveTrafficMonitoringSessions,omitempty"`
	// Maximum configurable Ethernet port-channels on Switch/Fabric-Interconnect.
	MaximumEthernetPortChannels *int64 `json:"MaximumEthernetPortChannels,omitempty" yaml:"MaximumEthernetPortChannels,omitempty"`
	// Maximum configurable Ethernet Uplink ports on Switch/Fabric-Interconnect.
	MaximumEthernetUplinkPorts *int64 `json:"MaximumEthernetUplinkPorts,omitempty" yaml:"MaximumEthernetUplinkPorts,omitempty"`
	// Maximum configurable Fibre Channel port-channel member ports on Switch/Fabric-Interconnect.
	MaximumFcPortChannelMembers *int64 `json:"MaximumFcPortChannelMembers,omitempty" yaml:"MaximumFcPortChannelMembers,omitempty"`
	// Maximum configurable Fibre Channel port-channels on Switch/Fabric-Interconnect.
	MaximumFcPortChannels *int64 `json:"MaximumFcPortChannels,omitempty" yaml:"MaximumFcPortChannels,omitempty"`
	// Maximum configurable IGMP Groups on Switch/Fabric-Interconnect.
	MaximumIgmpGroups *int64 `json:"MaximumIgmpGroups,omitempty" yaml:"MaximumIgmpGroups,omitempty"`
	// Maximum configurable ports per each port-channel on Switch/Fabric-Interconnect.
	MaximumPortChannelMembers *int64 `json:"MaximumPortChannelMembers,omitempty" yaml:"MaximumPortChannelMembers,omitempty"`
	// Maximum configurable Primary Private VLANs on Switch/Fabric-Interconnect.
	MaximumPrimaryVlan *int64 `json:"MaximumPrimaryVlan,omitempty" yaml:"MaximumPrimaryVlan,omitempty"`
	// Maximum configurable Secondary Private VLANs on Switch/Fabric-Interconnect.
	MaximumSecondaryVlan *int64 `json:"MaximumSecondaryVlan,omitempty" yaml:"MaximumSecondaryVlan,omitempty"`
	// Maximum configurable Secondary VLANs per each Primary VLAN on Switch/Fabric-Interconnect.
	MaximumSecondaryVlanPerPrimary *int64 `json:"MaximumSecondaryVlanPerPrimary,omitempty" yaml:"MaximumSecondaryVlanPerPrimary,omitempty"`
	// Maximum allowes VIFs on Switch/Fabric-Interconnect.
	MaximumVifs *int64 `json:"MaximumVifs,omitempty" yaml:"MaximumVifs,omitempty"`
	// Maximum configurable VLANs on Switch/Fabric-Interconnect.
	MaximumVlans *int64 `json:"MaximumVlans,omitempty" yaml:"MaximumVlans,omitempty"`
	// Minimum required fans in 'active' state for this Switch/Fabric-Interconnect.
	MinimumActiveFans *int64 `json:"MinimumActiveFans,omitempty" yaml:"MinimumActiveFans,omitempty"`
}
