...
func (dst *ServerConfigChangeDetailRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "mo.MoRef":
			...
			dst.MoMoRef = result
			return nil
		case "server.ConfigChangeDetail":
			var result *ServerConfigChangeDetail = &ServerConfigChangeDetail{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ServerConfigChangeDetail = result
			return nil
		default:
...
func (src *ServerConfigChangeDetailRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.ServerConfigChangeDetail != nil {
		return yaml.Marshal(&src.ServerConfigChangeDetail)
	}
