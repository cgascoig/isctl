...
type WorkflowWorkerTask struct {
	...
	TaskDefinitionId *string `json:"TaskDefinitionId,omitempty" yaml:"TaskDefinitionId,omitempty"`
	// The qualified name of task that should be executed.
	TaskDefinitionName *string `json:"TaskDefinitionName,omitempty" yaml:"TaskDefinitionName,omitempty"`
