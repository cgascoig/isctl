...
func (dst *IpmioverlanPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "ipmioverlan.Policy.List":
			var result *IpmioverlanPolicyList = &IpmioverlanPolicyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IpmioverlanPolicyList = result
			return nil
...
func (src *IpmioverlanPolicyResponse) MarshalYAML() ([]byte, error) {
	if src.IpmioverlanPolicyList != nil {
		return yaml.Marshal(&src.IpmioverlanPolicyList)
	}
