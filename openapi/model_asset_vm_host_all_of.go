...
type AssetVmHostAllOf struct {
	...
	ClusterMoid *string `json:"ClusterMoid,omitempty" yaml:"ClusterMoid,omitempty"`
	...
	Connected *int64 `json:"Connected,omitempty" yaml:"Connected,omitempty"`
	// Reference to virtualization target device ID.
	RegisteredDeviceMoid *string `json:"RegisteredDeviceMoid,omitempty" yaml:"RegisteredDeviceMoid,omitempty"`
}
