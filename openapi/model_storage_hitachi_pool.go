...
type StorageHitachiPool struct {
	StorageBaseDiskPool `yaml:"StorageBaseDiskPool,inline"`
	...
	BlockingModeBlockade *string `json:"BlockingModeBlockade,omitempty" yaml:"BlockingModeBlockade,omitempty"`
	// Setting the protection function for a virtual volume. When the DP pool is full, whether the read and write operations can be performed for the DP volume that uses the target DP pool is output. Yes, read and write operations are not possible. No, read and write operations are possible. -, Thin Image pool or not available.
	BlockingModeFull *string `json:"BlockingModeFull,omitempty" yaml:"BlockingModeFull,omitempty"`
	// The depletion threshold set for the pool (%).
	DepletionThreshold *string `json:"DepletionThreshold,omitempty" yaml:"DepletionThreshold,omitempty"`
	// Whether the pool is shrinking is output.
	IsShrinking *bool `json:"IsShrinking,omitempty" yaml:"IsShrinking,omitempty"`
	...
	MonitoringMode *string `json:"MonitoringMode,omitempty" yaml:"MonitoringMode,omitempty"`
	// Status of monitor information.
	MonitoringStatus *string `json:"MonitoringStatus,omitempty" yaml:"MonitoringStatus,omitempty"`
	...
	PoolActionMode *string `json:"PoolActionMode,omitempty" yaml:"PoolActionMode,omitempty"`
	// Displays the status of the tier relocation processing.
	ProgressOfReplacing *string `json:"ProgressOfReplacing,omitempty" yaml:"ProgressOfReplacing,omitempty"`
	// Total capacity of the reserved page (bytes) of the DP volume that is related to the DP pool.
	TotalReservedCapacity *int64 `json:"TotalReservedCapacity,omitempty" yaml:"TotalReservedCapacity,omitempty"`
	// The warning threshold set for the pool (%).
	WarningThreshold *int64                               `json:"WarningThreshold,omitempty" yaml:"WarningThreshold,omitempty"`
