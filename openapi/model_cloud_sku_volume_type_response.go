...
func (dst *CloudSkuVolumeTypeResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "cloud.SkuVolumeType.List":
			var result *CloudSkuVolumeTypeList = &CloudSkuVolumeTypeList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.CloudSkuVolumeTypeList = result
			return nil
...
func (src *CloudSkuVolumeTypeResponse) MarshalYAML() ([]byte, error) {
	if src.CloudSkuVolumeTypeList != nil {
		return yaml.Marshal(&src.CloudSkuVolumeTypeList)
	}
