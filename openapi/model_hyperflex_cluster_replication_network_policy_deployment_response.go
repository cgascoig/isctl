...
func (dst *HyperflexClusterReplicationNetworkPolicyDeploymentResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "hyperflex.ClusterReplicationNetworkPolicyDeployment.List":
			var result *HyperflexClusterReplicationNetworkPolicyDeploymentList = &HyperflexClusterReplicationNetworkPolicyDeploymentList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexClusterReplicationNetworkPolicyDeploymentList = result
			return nil
...
func (src *HyperflexClusterReplicationNetworkPolicyDeploymentResponse) MarshalYAML() ([]byte, error) {
	if src.HyperflexClusterReplicationNetworkPolicyDeploymentList != nil {
		return yaml.Marshal(&src.HyperflexClusterReplicationNetworkPolicyDeploymentList)
	}
