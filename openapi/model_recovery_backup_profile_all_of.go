...
type RecoveryBackupProfileAllOf struct {
	...
	BackupConfig   *RecoveryBackupConfigPolicyRelationship   `json:"BackupConfig,omitempty" yaml:"BackupConfig,omitempty"`
	...
	ScheduleConfig *RecoveryScheduleConfigPolicyRelationship `json:"ScheduleConfig,omitempty" yaml:"ScheduleConfig,omitempty"`
}
