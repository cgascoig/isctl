...
func (dst *MacpoolUniverseResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "macpool.Universe.List":
			var result *MacpoolUniverseList = &MacpoolUniverseList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.MacpoolUniverseList = result
			return nil
...
func (src *MacpoolUniverseResponse) MarshalYAML() ([]byte, error) {
	if src.MacpoolUniverseList != nil {
		return yaml.Marshal(&src.MacpoolUniverseList)
	}
