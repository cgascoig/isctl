...
type OsInstall struct {
	OsBaseInstallConfig `yaml:"OsBaseInstallConfig,inline"`
	...
	Image             *SoftwarerepositoryOperatingSystemFileRelationship           `json:"Image,omitempty" yaml:"Image,omitempty"`
	Organization      *OrganizationOrganizationRelationship                        `json:"Organization,omitempty" yaml:"Organization,omitempty"`
	OsduImage         *FirmwareServerConfigurationUtilityDistributableRelationship `json:"OsduImage,omitempty" yaml:"OsduImage,omitempty"`
