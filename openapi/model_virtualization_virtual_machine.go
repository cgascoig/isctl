...
type VirtualizationVirtualMachine struct {
	...
	ActionInfo            NullableVirtualizationActionInfo      `json:"ActionInfo,omitempty" yaml:"ActionInfo,omitempty"`
	...
	CloudInitConfig       NullableVirtualizationCloudInitConfig `json:"CloudInitConfig,omitempty" yaml:"CloudInitConfig,omitempty"`
	// Cluster where virtual machine is deployed.
	ClusterEsxi *string `json:"ClusterEsxi,omitempty" yaml:"ClusterEsxi,omitempty"`
	...
	HostEsxi *string `json:"HostEsxi,omitempty" yaml:"HostEsxi,omitempty"`
