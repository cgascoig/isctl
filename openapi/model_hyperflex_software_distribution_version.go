...
type HyperflexSoftwareDistributionVersion struct {
	...
	DistributionComponents    []HyperflexSoftwareDistributionComponentRelationship `json:"DistributionComponents,omitempty" yaml:"DistributionComponents,omitempty"`
	SoftwareDistributionEntry *HyperflexSoftwareDistributionEntryRelationship      `json:"SoftwareDistributionEntry,omitempty" yaml:"SoftwareDistributionEntry,omitempty"`
}
