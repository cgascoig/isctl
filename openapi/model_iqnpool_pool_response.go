...
func (dst *IqnpoolPoolResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iqnpool.Pool.List":
			var result *IqnpoolPoolList = &IqnpoolPoolList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IqnpoolPoolList = result
			return nil
...
func (src *IqnpoolPoolResponse) MarshalYAML() ([]byte, error) {
	if src.IqnpoolPoolList != nil {
		return yaml.Marshal(&src.IqnpoolPoolList)
	}
