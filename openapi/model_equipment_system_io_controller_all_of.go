...
type EquipmentSystemIoControllerAllOf struct {
	...
	ManagingInstance *string `json:"ManagingInstance,omitempty" yaml:"ManagingInstance,omitempty"`
	...
	SystemIoControllerId *int64                               `json:"SystemIoControllerId,omitempty" yaml:"SystemIoControllerId,omitempty"`
	Cmc                  *ManagementControllerRelationship    `json:"Cmc,omitempty" yaml:"Cmc,omitempty"`
	...
	SharedIoModule       *EquipmentSharedIoModuleRelationship `json:"SharedIoModule,omitempty" yaml:"SharedIoModule,omitempty"`
}
