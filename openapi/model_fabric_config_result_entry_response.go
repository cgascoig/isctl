...
func (dst *FabricConfigResultEntryResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "fabric.ConfigResultEntry.List":
			var result *FabricConfigResultEntryList = &FabricConfigResultEntryList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FabricConfigResultEntryList = result
			return nil
...
func (src *FabricConfigResultEntryResponse) MarshalYAML() ([]byte, error) {
	if src.FabricConfigResultEntryList != nil {
		return yaml.Marshal(&src.FabricConfigResultEntryList)
	}
