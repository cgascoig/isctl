...
func (dst *BiosBootModeRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "bios.BootMode":
			var result *BiosBootMode = &BiosBootMode{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.BiosBootMode = result
			return nil
		case "mo.MoRef":
...
func (src *BiosBootModeRelationship) MarshalYAML() ([]byte, error) {
	if src.BiosBootMode != nil {
		return yaml.Marshal(&src.BiosBootMode)
	}
