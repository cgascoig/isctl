...
func (dst *FcpoolPoolMemberResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "fcpool.PoolMember.List":
			var result *FcpoolPoolMemberList = &FcpoolPoolMemberList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FcpoolPoolMemberList = result
			return nil
...
func (src *FcpoolPoolMemberResponse) MarshalYAML() ([]byte, error) {
	if src.FcpoolPoolMemberList != nil {
		return yaml.Marshal(&src.FcpoolPoolMemberList)
	}
