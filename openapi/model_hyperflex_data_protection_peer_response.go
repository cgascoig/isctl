...
func (dst *HyperflexDataProtectionPeerResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "hyperflex.DataProtectionPeer.List":
			var result *HyperflexDataProtectionPeerList = &HyperflexDataProtectionPeerList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexDataProtectionPeerList = result
			return nil
...
func (src *HyperflexDataProtectionPeerResponse) MarshalYAML() ([]byte, error) {
	if src.HyperflexDataProtectionPeerList != nil {
		return yaml.Marshal(&src.HyperflexDataProtectionPeerList)
	}
