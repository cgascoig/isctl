...
func (dst *HyperflexHxapHostVswitchRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.HxapHostVswitch":
			var result *HyperflexHxapHostVswitch = &HyperflexHxapHostVswitch{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexHxapHostVswitch = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexHxapHostVswitchRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexHxapHostVswitch != nil {
		return yaml.Marshal(&src.HyperflexHxapHostVswitch)
	}
