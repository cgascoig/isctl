...
type FabricUdldGlobalSettingsAllOf struct {
	...
	MessageInterval *int64 `json:"MessageInterval,omitempty" yaml:"MessageInterval,omitempty"`
	...
	RecoveryAction *string `json:"RecoveryAction,omitempty" yaml:"RecoveryAction,omitempty"`
}
