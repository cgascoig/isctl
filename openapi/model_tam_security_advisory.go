...
type TamSecurityAdvisory struct {
	...
	BaseScore *float32 `json:"BaseScore,omitempty" yaml:"BaseScore,omitempty"`
	CveIds    []string `json:"CveIds,omitempty" yaml:"CveIds,omitempty"`
	// Date when the security advisory was first published by Cisco.
	DatePublished *time.Time `json:"DatePublished,omitempty" yaml:"DatePublished,omitempty"`
	// Date when the security advisory was last updated by Cisco.
	DateUpdated *time.Time `json:"DateUpdated,omitempty" yaml:"DateUpdated,omitempty"`
	// CVSS version 3 environmental score for the security Advisory.
	EnvironmentalScore *float32 `json:"EnvironmentalScore,omitempty" yaml:"EnvironmentalScore,omitempty"`
