...
func (dst *EquipmentRackEnclosureSlotRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "equipment.RackEnclosureSlot":
			var result *EquipmentRackEnclosureSlot = &EquipmentRackEnclosureSlot{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentRackEnclosureSlot = result
			return nil
		case "mo.MoRef":
...
func (src *EquipmentRackEnclosureSlotRelationship) MarshalYAML() ([]byte, error) {
	if src.EquipmentRackEnclosureSlot != nil {
		return yaml.Marshal(&src.EquipmentRackEnclosureSlot)
	}
