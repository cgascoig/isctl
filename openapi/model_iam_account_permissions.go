...
type IamAccountPermissions struct {
	...
	AccountIdentifier *string `json:"AccountIdentifier,omitempty" yaml:"AccountIdentifier,omitempty"`
	...
	AccountStatus *string                   `json:"AccountStatus,omitempty" yaml:"AccountStatus,omitempty"`
	Permissions   *[]IamPermissionReference `json:"Permissions,omitempty" yaml:"Permissions,omitempty"`
}
