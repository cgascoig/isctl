...
func (dst *IamAppRegistrationRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "iam.AppRegistration":
			var result *IamAppRegistration = &IamAppRegistration{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamAppRegistration = result
			return nil
		case "mo.MoRef":
...
func (src *IamAppRegistrationRelationship) MarshalYAML() ([]byte, error) {
	if src.IamAppRegistration != nil {
		return yaml.Marshal(&src.IamAppRegistration)
	}
