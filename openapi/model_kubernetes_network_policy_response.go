...
func (dst *KubernetesNetworkPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "kubernetes.NetworkPolicy.List":
			var result *KubernetesNetworkPolicyList = &KubernetesNetworkPolicyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesNetworkPolicyList = result
			return nil
...
func (src *KubernetesNetworkPolicyResponse) MarshalYAML() ([]byte, error) {
	if src.KubernetesNetworkPolicyList != nil {
		return yaml.Marshal(&src.KubernetesNetworkPolicyList)
	}
