...
func (dst *FirmwareUnsupportedVersionUpgradeResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "firmware.UnsupportedVersionUpgrade.List":
			var result *FirmwareUnsupportedVersionUpgradeList = &FirmwareUnsupportedVersionUpgradeList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FirmwareUnsupportedVersionUpgradeList = result
			return nil
...
func (src *FirmwareUnsupportedVersionUpgradeResponse) MarshalYAML() ([]byte, error) {
	if src.FirmwareUnsupportedVersionUpgradeList != nil {
		return yaml.Marshal(&src.FirmwareUnsupportedVersionUpgradeList)
	}
