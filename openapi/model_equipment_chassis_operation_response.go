...
func (dst *EquipmentChassisOperationResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "equipment.ChassisOperation.List":
			var result *EquipmentChassisOperationList = &EquipmentChassisOperationList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentChassisOperationList = result
			return nil
...
func (src *EquipmentChassisOperationResponse) MarshalYAML() ([]byte, error) {
	if src.EquipmentChassisOperationList != nil {
		return yaml.Marshal(&src.EquipmentChassisOperationList)
	}
