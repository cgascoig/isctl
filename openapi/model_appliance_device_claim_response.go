...
func (dst *ApplianceDeviceClaimResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "appliance.DeviceClaim.List":
			var result *ApplianceDeviceClaimList = &ApplianceDeviceClaimList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ApplianceDeviceClaimList = result
			return nil
...
func (src *ApplianceDeviceClaimResponse) MarshalYAML() ([]byte, error) {
	if src.ApplianceDeviceClaimList != nil {
		return yaml.Marshal(&src.ApplianceDeviceClaimList)
	}
