...
func (dst *IppoolIpLeaseRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "ippool.IpLease":
			var result *IppoolIpLease = &IppoolIpLease{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IppoolIpLease = result
			return nil
		case "mo.MoRef":
...
func (src *IppoolIpLeaseRelationship) MarshalYAML() ([]byte, error) {
	if src.IppoolIpLease != nil {
		return yaml.Marshal(&src.IppoolIpLease)
	}
