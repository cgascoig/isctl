...
func (dst *FabricLinkAggregationPolicyRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "fabric.LinkAggregationPolicy":
			var result *FabricLinkAggregationPolicy = &FabricLinkAggregationPolicy{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FabricLinkAggregationPolicy = result
			return nil
		case "mo.MoRef":
...
func (src *FabricLinkAggregationPolicyRelationship) MarshalYAML() ([]byte, error) {
	if src.FabricLinkAggregationPolicy != nil {
		return yaml.Marshal(&src.FabricLinkAggregationPolicy)
	}
