...
func (dst *CapabilityEquipmentPhysicalDefResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "capability.EquipmentPhysicalDef.List":
			var result *CapabilityEquipmentPhysicalDefList = &CapabilityEquipmentPhysicalDefList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.CapabilityEquipmentPhysicalDefList = result
			return nil
...
func (src *CapabilityEquipmentPhysicalDefResponse) MarshalYAML() ([]byte, error) {
	if src.CapabilityEquipmentPhysicalDefList != nil {
		return yaml.Marshal(&src.CapabilityEquipmentPhysicalDefList)
	}
