...
func (dst *SoftwarerepositoryReleaseResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		...
		case "mo.TagSummary":
			...
			return nil
		case "softwarerepository.Release.List":
			var result *SoftwarerepositoryReleaseList = &SoftwarerepositoryReleaseList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.SoftwarerepositoryReleaseList = result
			return nil
		default:
...
func (src *SoftwarerepositoryReleaseResponse) MarshalYAML() ([]byte, error) {
	if src.MoAggregateTransform != nil {
	...
	if src.SoftwarerepositoryReleaseList != nil {
		return yaml.Marshal(&src.SoftwarerepositoryReleaseList)
	}
