...
func (dst *HyperflexConfigResultEntryRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.ConfigResultEntry":
			var result *HyperflexConfigResultEntry = &HyperflexConfigResultEntry{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexConfigResultEntry = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexConfigResultEntryRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexConfigResultEntry != nil {
		return yaml.Marshal(&src.HyperflexConfigResultEntry)
	}
