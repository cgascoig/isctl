...
func (dst *KubernetesAddonDefinitionResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "kubernetes.AddonDefinition.List":
			var result *KubernetesAddonDefinitionList = &KubernetesAddonDefinitionList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesAddonDefinitionList = result
			return nil
...
func (src *KubernetesAddonDefinitionResponse) MarshalYAML() ([]byte, error) {
	if src.KubernetesAddonDefinitionList != nil {
		return yaml.Marshal(&src.KubernetesAddonDefinitionList)
	}
