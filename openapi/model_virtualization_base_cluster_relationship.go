...
func (dst *VirtualizationBaseClusterRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "mo.MoRef":
			...
			dst.MoMoRef = result
			return nil
		case "virtualization.BaseCluster":
			var result *VirtualizationBaseCluster = &VirtualizationBaseCluster{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.VirtualizationBaseCluster = result
			return nil
		default:
...
func (src *VirtualizationBaseClusterRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.VirtualizationBaseCluster != nil {
		return yaml.Marshal(&src.VirtualizationBaseCluster)
	}
