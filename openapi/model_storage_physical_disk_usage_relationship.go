...
func (dst *StoragePhysicalDiskUsageRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "mo.MoRef":
			...
			dst.MoMoRef = result
			return nil
		case "storage.PhysicalDiskUsage":
			var result *StoragePhysicalDiskUsage = &StoragePhysicalDiskUsage{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.StoragePhysicalDiskUsage = result
			return nil
		default:
...
func (src *StoragePhysicalDiskUsageRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.StoragePhysicalDiskUsage != nil {
		return yaml.Marshal(&src.StoragePhysicalDiskUsage)
	}
