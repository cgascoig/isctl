...
type RecommendationPhysicalItem struct {
	RecommendationAbstractItem `yaml:"RecommendationAbstractItem,inline"`
	...
	IsNew *bool `json:"IsNew,omitempty" yaml:"IsNew,omitempty"`
	...
	SourceMoid *string `json:"SourceMoid,omitempty" yaml:"SourceMoid,omitempty"`
	...
	CapacityRunway *RecommendationCapacityRunwayRelationship `json:"CapacityRunway,omitempty" yaml:"CapacityRunway,omitempty"`
