...
func (dst *IamOAuthTokenResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iam.OAuthToken.List":
			var result *IamOAuthTokenList = &IamOAuthTokenList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamOAuthTokenList = result
			return nil
...
func (src *IamOAuthTokenResponse) MarshalYAML() ([]byte, error) {
	if src.IamOAuthTokenList != nil {
		return yaml.Marshal(&src.IamOAuthTokenList)
	}
