...
func (dst *BootUefiShellDeviceResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "boot.UefiShellDevice.List":
			var result *BootUefiShellDeviceList = &BootUefiShellDeviceList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.BootUefiShellDeviceList = result
			return nil
...
func (src *BootUefiShellDeviceResponse) MarshalYAML() ([]byte, error) {
	if src.BootUefiShellDeviceList != nil {
		return yaml.Marshal(&src.BootUefiShellDeviceList)
	}
