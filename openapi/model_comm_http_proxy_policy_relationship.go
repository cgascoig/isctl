...
func (dst *CommHttpProxyPolicyRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "comm.HttpProxyPolicy":
			var result *CommHttpProxyPolicy = &CommHttpProxyPolicy{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.CommHttpProxyPolicy = result
			return nil
		case "mo.MoRef":
...
func (src *CommHttpProxyPolicyRelationship) MarshalYAML() ([]byte, error) {
	if src.CommHttpProxyPolicy != nil {
		return yaml.Marshal(&src.CommHttpProxyPolicy)
	}
