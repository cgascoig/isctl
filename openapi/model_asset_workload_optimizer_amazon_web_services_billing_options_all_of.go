...
type AssetWorkloadOptimizerAmazonWebServicesBillingOptionsAllOf struct {
	...
	CostAndUsageReportBucket *string `json:"CostAndUsageReportBucket,omitempty" yaml:"CostAndUsageReportBucket,omitempty"`
	// Report path prefix for the Amazon web service cost and usage report to get cloud service spend.
	CostAndUsageReportPath *string `json:"CostAndUsageReportPath,omitempty" yaml:"CostAndUsageReportPath,omitempty"`
	// Region for S3 bucket that contains the Amazon web service Cost and Usage report to get cloud service spend.
	CostAndUsageReportRegion *string `json:"CostAndUsageReportRegion,omitempty" yaml:"CostAndUsageReportRegion,omitempty"`
}
