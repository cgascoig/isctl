...
type HyperflexSnapshotFilesAllOf struct {
	...
	NameTrackedFiles    []HyperflexFilePath             `json:"NameTrackedFiles,omitempty" yaml:"NameTrackedFiles,omitempty"`
	UuidTrackedDisksMap []HyperflexMapUuidToTrackedDisk `json:"UuidTrackedDisksMap,omitempty" yaml:"UuidTrackedDisksMap,omitempty"`
}
