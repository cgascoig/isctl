...
func (dst *KvmSessionResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "kvm.Session.List":
			var result *KvmSessionList = &KvmSessionList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KvmSessionList = result
			return nil
...
func (src *KvmSessionResponse) MarshalYAML() ([]byte, error) {
	if src.KvmSessionList != nil {
		return yaml.Marshal(&src.KvmSessionList)
	}
