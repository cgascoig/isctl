...
func (dst *HyperflexServerFirmwareVersionEntryResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "hyperflex.ServerFirmwareVersionEntry.List":
			var result *HyperflexServerFirmwareVersionEntryList = &HyperflexServerFirmwareVersionEntryList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexServerFirmwareVersionEntryList = result
			return nil
...
func (src *HyperflexServerFirmwareVersionEntryResponse) MarshalYAML() ([]byte, error) {
	if src.HyperflexServerFirmwareVersionEntryList != nil {
		return yaml.Marshal(&src.HyperflexServerFirmwareVersionEntryList)
	}
