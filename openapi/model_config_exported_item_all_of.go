...
type ConfigExportedItemAllOf struct {
	...
	Exporter      *ConfigExporterRelationship     `json:"Exporter,omitempty" yaml:"Exporter,omitempty"`
	ParentItem    *ConfigExportedItemRelationship `json:"ParentItem,omitempty" yaml:"ParentItem,omitempty"`
	// An array of relationships to configExportedItem resources.
	RelatedItems []ConfigExportedItemRelationship `json:"RelatedItems,omitempty" yaml:"RelatedItems,omitempty"`
}
