...
type ConnectorBaseMessage struct {
	...
	EncryptedAesKey *string `json:"EncryptedAesKey,omitempty" yaml:"EncryptedAesKey,omitempty"`
	...
	SecureProperties interface{} `json:"SecureProperties,omitempty" yaml:"SecureProperties,omitempty"`
}
