...
func (dst *AdapterHostEthInterfaceRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "adapter.HostEthInterface":
			var result *AdapterHostEthInterface = &AdapterHostEthInterface{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.AdapterHostEthInterface = result
			return nil
		case "mo.MoRef":
...
func (src *AdapterHostEthInterfaceRelationship) MarshalYAML() ([]byte, error) {
	if src.AdapterHostEthInterface != nil {
		return yaml.Marshal(&src.AdapterHostEthInterface)
	}
