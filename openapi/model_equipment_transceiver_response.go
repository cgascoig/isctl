...
func (dst *EquipmentTransceiverResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "equipment.Transceiver.List":
			var result *EquipmentTransceiverList = &EquipmentTransceiverList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentTransceiverList = result
			return nil
...
func (src *EquipmentTransceiverResponse) MarshalYAML() ([]byte, error) {
	if src.EquipmentTransceiverList != nil {
		return yaml.Marshal(&src.EquipmentTransceiverList)
	}
