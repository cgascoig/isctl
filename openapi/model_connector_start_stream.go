...
type ConnectorStartStream struct {
	ConnectorStreamMessage `yaml:"ConnectorStreamMessage,inline"`
	...
	ForceRebuild *bool `json:"ForceRebuild,omitempty" yaml:"ForceRebuild,omitempty"`
	...
	PollInterval *int64 `json:"PollInterval,omitempty" yaml:"PollInterval,omitempty"`
	...
	ProtocolVersion *int64 `json:"ProtocolVersion,omitempty" yaml:"ProtocolVersion,omitempty"`
