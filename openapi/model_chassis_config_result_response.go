...
func (dst *ChassisConfigResultResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "chassis.ConfigResult.List" {
		// try to unmarshal JSON data into ChassisConfigResultList
		err = json.Unmarshal(data, &dst.ChassisConfigResultList)
		if err == nil {
			return nil // data stored in dst.ChassisConfigResultList, return on the first match
		} else {
			dst.ChassisConfigResultList = nil
			return fmt.Errorf("Failed to unmarshal ChassisConfigResultResponse as ChassisConfigResultList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ChassisConfigResultResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ChassisConfigResultResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ChassisConfigResultResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src ChassisConfigResultResponse) MarshalJSON() ([]byte, error) {
	if src.ChassisConfigResultList != nil {
		return json.Marshal(&src.ChassisConfigResultList)
	}
...
type NullableChassisConfigResultResponse struct {
	value *ChassisConfigResultResponse
	isSet bool
}

func (v NullableChassisConfigResultResponse) Get() *ChassisConfigResultResponse {
	return v.value
}

func (v *NullableChassisConfigResultResponse) Set(val *ChassisConfigResultResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableChassisConfigResultResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableChassisConfigResultResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChassisConfigResultResponse(val *ChassisConfigResultResponse) *NullableChassisConfigResultResponse {
	return &NullableChassisConfigResultResponse{value: val, isSet: true}
}

func (v NullableChassisConfigResultResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChassisConfigResultResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
