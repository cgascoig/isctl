...
func (dst *ChassisConfigResultResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "chassis.ConfigResult.List":
			var result *ChassisConfigResultList = &ChassisConfigResultList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ChassisConfigResultList = result
			return nil
...
func (src *ChassisConfigResultResponse) MarshalYAML() ([]byte, error) {
	if src.ChassisConfigResultList != nil {
		return yaml.Marshal(&src.ChassisConfigResultList)
	}
