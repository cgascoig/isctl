...
func (dst *ComputeBoardRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "compute.Board":
			var result *ComputeBoard = &ComputeBoard{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ComputeBoard = result
			return nil
		case "mo.MoRef":
...
func (src *ComputeBoardRelationship) MarshalYAML() ([]byte, error) {
	if src.ComputeBoard != nil {
		return yaml.Marshal(&src.ComputeBoard)
	}
