...
func (dst *EquipmentChassisIdentityResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "equipment.ChassisIdentity.List":
			var result *EquipmentChassisIdentityList = &EquipmentChassisIdentityList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentChassisIdentityList = result
			return nil
...
func (src *EquipmentChassisIdentityResponse) MarshalYAML() ([]byte, error) {
	if src.EquipmentChassisIdentityList != nil {
		return yaml.Marshal(&src.EquipmentChassisIdentityList)
	}
