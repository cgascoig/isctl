...
func (dst *BootIscsiDeviceResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "boot.IscsiDevice.List":
			var result *BootIscsiDeviceList = &BootIscsiDeviceList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.BootIscsiDeviceList = result
			return nil
...
func (src *BootIscsiDeviceResponse) MarshalYAML() ([]byte, error) {
	if src.BootIscsiDeviceList != nil {
		return yaml.Marshal(&src.BootIscsiDeviceList)
	}
