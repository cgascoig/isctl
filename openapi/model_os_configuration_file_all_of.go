...
type OsConfigurationFileAllOf struct {
	...
	Placeholders *[]OsPlaceHolder `json:"Placeholders,omitempty" yaml:"Placeholders,omitempty"`
	...
	Catalog   *OsCatalogRelationship `json:"Catalog,omitempty" yaml:"Catalog,omitempty"`
	// An array of relationships to hclOperatingSystem resources.
	Distributions *[]HclOperatingSystemRelationship `json:"Distributions,omitempty" yaml:"Distributions,omitempty"`
}
