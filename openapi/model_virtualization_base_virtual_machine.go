...
type VirtualizationBaseVirtualMachine struct {
	...
	Capacity   NullableInfraHardwareInfo       `json:"Capacity,omitempty" yaml:"Capacity,omitempty"`
	GuestInfo  NullableVirtualizationGuestInfo `json:"GuestInfo,omitempty" yaml:"GuestInfo,omitempty"`
