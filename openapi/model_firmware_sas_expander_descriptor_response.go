...
func (dst *FirmwareSasExpanderDescriptorResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "firmware.SasExpanderDescriptor.List":
			var result *FirmwareSasExpanderDescriptorList = &FirmwareSasExpanderDescriptorList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FirmwareSasExpanderDescriptorList = result
			return nil
...
func (src *FirmwareSasExpanderDescriptorResponse) MarshalYAML() ([]byte, error) {
	if src.FirmwareSasExpanderDescriptorList != nil {
		return yaml.Marshal(&src.FirmwareSasExpanderDescriptorList)
	}
