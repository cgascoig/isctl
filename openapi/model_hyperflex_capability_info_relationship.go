...
func (dst *HyperflexCapabilityInfoRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.CapabilityInfo":
			var result *HyperflexCapabilityInfo = &HyperflexCapabilityInfo{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexCapabilityInfo = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexCapabilityInfoRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexCapabilityInfo != nil {
		return yaml.Marshal(&src.HyperflexCapabilityInfo)
	}
