...
type VnicIscsiBootPolicy struct {
	...
	AutoTargetvendorName *string                      `json:"AutoTargetvendorName,omitempty" yaml:"AutoTargetvendorName,omitempty"`
	Chap                 NullableVnicIscsiAuthProfile `json:"Chap,omitempty" yaml:"Chap,omitempty"`
	...
	InitiatorIpSource *string `json:"InitiatorIpSource,omitempty" yaml:"InitiatorIpSource,omitempty"`
	// Static IP address provided for iSCSI Initiator.
	InitiatorStaticIpV4Address *string                      `json:"InitiatorStaticIpV4Address,omitempty" yaml:"InitiatorStaticIpV4Address,omitempty"`
	InitiatorStaticIpV4Config  NullableIppoolIpV4Config     `json:"InitiatorStaticIpV4Config,omitempty" yaml:"InitiatorStaticIpV4Config,omitempty"`
	MutualChap                 NullableVnicIscsiAuthProfile `json:"MutualChap,omitempty" yaml:"MutualChap,omitempty"`
	...
	TargetSourceType      *string                                  `json:"TargetSourceType,omitempty" yaml:"TargetSourceType,omitempty"`
	InitiatorIpPool       *IppoolPoolRelationship                  `json:"InitiatorIpPool,omitempty" yaml:"InitiatorIpPool,omitempty"`
	IscsiAdapterPolicy    *VnicIscsiAdapterPolicyRelationship      `json:"IscsiAdapterPolicy,omitempty" yaml:"IscsiAdapterPolicy,omitempty"`
	Organization          *OrganizationOrganizationRelationship    `json:"Organization,omitempty" yaml:"Organization,omitempty"`
	PrimaryTargetPolicy   *VnicIscsiStaticTargetPolicyRelationship `json:"PrimaryTargetPolicy,omitempty" yaml:"PrimaryTargetPolicy,omitempty"`
	SecondaryTargetPolicy *VnicIscsiStaticTargetPolicyRelationship `json:"SecondaryTargetPolicy,omitempty" yaml:"SecondaryTargetPolicy,omitempty"`
}
