...
type IamBannerMessageAllOf struct {
	...
	BannerContents *string `json:"BannerContents,omitempty" yaml:"BannerContents,omitempty"`
	// Whether or not to display the banner message.
	BannerDisplay *bool `json:"BannerDisplay,omitempty" yaml:"BannerDisplay,omitempty"`
	// Title of the banner message.
	BannerTitle *string                 `json:"BannerTitle,omitempty" yaml:"BannerTitle,omitempty"`
