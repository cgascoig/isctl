...
func (dst *KubernetesIngressResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "kubernetes.Ingress.List":
			var result *KubernetesIngressList = &KubernetesIngressList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesIngressList = result
			return nil
...
func (src *KubernetesIngressResponse) MarshalYAML() ([]byte, error) {
	if src.KubernetesIngressList != nil {
		return yaml.Marshal(&src.KubernetesIngressList)
	}
