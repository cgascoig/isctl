...
type NiatelemetryLogicalLink struct {
	...
	DbId *int64 `json:"DbId,omitempty" yaml:"DbId,omitempty"`
	// Return value of isPresent attribute.
	IsPresent *bool `json:"IsPresent,omitempty" yaml:"IsPresent,omitempty"`
	// Return value of linkAddr1 attribute.
	LinkAddr1 *string `json:"LinkAddr1,omitempty" yaml:"LinkAddr1,omitempty"`
	// Return value of linkAddr2 attribute.
	LinkAddr2 *string `json:"LinkAddr2,omitempty" yaml:"LinkAddr2,omitempty"`
