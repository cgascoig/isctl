...
type KubernetesNodeGroupProfile struct {
	...
	Currentsize *int64 `json:"Currentsize,omitempty" yaml:"Currentsize,omitempty"`
	...
	Labels      []KubernetesNodeGroupLabel `json:"Labels,omitempty" yaml:"Labels,omitempty"`
	...
	Taints         []KubernetesNodeGroupTaint                        `json:"Taints,omitempty" yaml:"Taints,omitempty"`
	ClusterProfile *KubernetesClusterProfileRelationship             `json:"ClusterProfile,omitempty" yaml:"ClusterProfile,omitempty"`
	InfraProvider  *KubernetesBaseInfrastructureProviderRelationship `json:"InfraProvider,omitempty" yaml:"InfraProvider,omitempty"`
	// An array of relationships to ippoolPool resources.
	IpPools           []IppoolPoolRelationship             `json:"IpPools,omitempty" yaml:"IpPools,omitempty"`
	KubernetesVersion *KubernetesVersionPolicyRelationship `json:"KubernetesVersion,omitempty" yaml:"KubernetesVersion,omitempty"`
	// An array of relationships to kubernetesNodeProfile resources.
	Nodes []KubernetesNodeProfileRelationship `json:"Nodes,omitempty" yaml:"Nodes,omitempty"`
}
