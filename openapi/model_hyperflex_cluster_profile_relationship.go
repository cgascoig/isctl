...
func (dst *HyperflexClusterProfileRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.ClusterProfile":
			var result *HyperflexClusterProfile = &HyperflexClusterProfile{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexClusterProfile = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexClusterProfileRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexClusterProfile != nil {
		return yaml.Marshal(&src.HyperflexClusterProfile)
	}
