...
func (dst *AdapterUnitResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "adapter.Unit.List":
			var result *AdapterUnitList = &AdapterUnitList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.AdapterUnitList = result
			return nil
...
func (src *AdapterUnitResponse) MarshalYAML() ([]byte, error) {
	if src.AdapterUnitList != nil {
		return yaml.Marshal(&src.AdapterUnitList)
	}
