...
func (dst *KubernetesVirtualMachineInfrastructureProviderRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "kubernetes.VirtualMachineInfrastructureProvider":
			var result *KubernetesVirtualMachineInfrastructureProvider = &KubernetesVirtualMachineInfrastructureProvider{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesVirtualMachineInfrastructureProvider = result
			return nil
		case "mo.MoRef":
...
func (src *KubernetesVirtualMachineInfrastructureProviderRelationship) MarshalYAML() ([]byte, error) {
	if src.KubernetesVirtualMachineInfrastructureProvider != nil {
		return yaml.Marshal(&src.KubernetesVirtualMachineInfrastructureProvider)
	}
