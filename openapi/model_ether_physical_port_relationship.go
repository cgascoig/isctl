...
func (dst *EtherPhysicalPortRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "ether.PhysicalPort":
			var result *EtherPhysicalPort = &EtherPhysicalPort{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EtherPhysicalPort = result
			return nil
		case "mo.MoRef":
...
func (src *EtherPhysicalPortRelationship) MarshalYAML() ([]byte, error) {
	if src.EtherPhysicalPort != nil {
		return yaml.Marshal(&src.EtherPhysicalPort)
	}
