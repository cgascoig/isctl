...
func (dst *FabricFlowControlPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "fabric.FlowControlPolicy.List":
			var result *FabricFlowControlPolicyList = &FabricFlowControlPolicyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FabricFlowControlPolicyList = result
			return nil
...
func (src *FabricFlowControlPolicyResponse) MarshalYAML() ([]byte, error) {
	if src.FabricFlowControlPolicyList != nil {
		return yaml.Marshal(&src.FabricFlowControlPolicyList)
	}
