...
type AssetConnectionControlMessageAllOf struct {
	...
	DomainGroup *string `json:"DomainGroup,omitempty" yaml:"DomainGroup,omitempty"`
	// Flag to force any open connections to be evicted. Used in case device has been deleted or blacklisted.
	Evict *bool `json:"Evict,omitempty" yaml:"Evict,omitempty"`
	...
	NewIdentity *string `json:"NewIdentity,omitempty" yaml:"NewIdentity,omitempty"`
