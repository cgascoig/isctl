...
func (dst *StorageEnclosureDiskSlotEpRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "mo.MoRef":
			...
			dst.MoMoRef = result
			return nil
		case "storage.EnclosureDiskSlotEp":
			var result *StorageEnclosureDiskSlotEp = &StorageEnclosureDiskSlotEp{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.StorageEnclosureDiskSlotEp = result
			return nil
		default:
...
func (src *StorageEnclosureDiskSlotEpRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.StorageEnclosureDiskSlotEp != nil {
		return yaml.Marshal(&src.StorageEnclosureDiskSlotEp)
	}
