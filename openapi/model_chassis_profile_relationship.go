...
func (dst *ChassisProfileRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "chassis.Profile":
			var result *ChassisProfile = &ChassisProfile{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ChassisProfile = result
			return nil
		case "mo.MoRef":
...
func (src *ChassisProfileRelationship) MarshalYAML() ([]byte, error) {
	if src.ChassisProfile != nil {
		return yaml.Marshal(&src.ChassisProfile)
	}
