...
func (dst *HyperflexLocalCredentialPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "hyperflex.LocalCredentialPolicy.List":
			var result *HyperflexLocalCredentialPolicyList = &HyperflexLocalCredentialPolicyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexLocalCredentialPolicyList = result
			return nil
...
func (src *HyperflexLocalCredentialPolicyResponse) MarshalYAML() ([]byte, error) {
	if src.HyperflexLocalCredentialPolicyList != nil {
		return yaml.Marshal(&src.HyperflexLocalCredentialPolicyList)
	}
