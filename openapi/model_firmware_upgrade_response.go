...
func (dst *FirmwareUpgradeResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "firmware.Upgrade.List":
			var result *FirmwareUpgradeList = &FirmwareUpgradeList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FirmwareUpgradeList = result
			return nil
...
func (src *FirmwareUpgradeResponse) MarshalYAML() ([]byte, error) {
	if src.FirmwareUpgradeList != nil {
		return yaml.Marshal(&src.FirmwareUpgradeList)
	}
