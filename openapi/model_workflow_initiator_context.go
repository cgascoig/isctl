...
type WorkflowInitiatorContext struct {
	...
	InitiatorMoid *string `json:"InitiatorMoid,omitempty" yaml:"InitiatorMoid,omitempty"`
	...
	InitiatorType *string `json:"InitiatorType,omitempty" yaml:"InitiatorType,omitempty"`
}
