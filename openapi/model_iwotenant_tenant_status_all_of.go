...
type IwotenantTenantStatusAllOf struct {
	...
	DeployStatus *string `json:"DeployStatus,omitempty" yaml:"DeployStatus,omitempty"`
	...
	IwoId *string `json:"IwoId,omitempty" yaml:"IwoId,omitempty"`
	...
	ReferenceTime *time.Time              `json:"ReferenceTime,omitempty" yaml:"ReferenceTime,omitempty"`
