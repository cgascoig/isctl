...
type NiaapiVersionRegexPlatform struct {
	...
	Anyllregex      *string                     `json:"Anyllregex,omitempty" yaml:"Anyllregex,omitempty"`
	Currentlltrain  NullableNiaapiSoftwareRegex `json:"Currentlltrain,omitempty" yaml:"Currentlltrain,omitempty"`
	Latestsltrain   NullableNiaapiSoftwareRegex `json:"Latestsltrain,omitempty" yaml:"Latestsltrain,omitempty"`
	Sltrain         []NiaapiSoftwareRegex       `json:"Sltrain,omitempty" yaml:"Sltrain,omitempty"`
	Upcominglltrain NullableNiaapiSoftwareRegex `json:"Upcominglltrain,omitempty" yaml:"Upcominglltrain,omitempty"`
}
