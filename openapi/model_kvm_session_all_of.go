...
type KvmSessionAllOf struct {
	...
	OneTimePassword *string `json:"OneTimePassword,omitempty" yaml:"OneTimePassword,omitempty"`
	// Indicates if KVM SSO is supported on the server.
	SsoSupported *bool `json:"SsoSupported,omitempty" yaml:"SsoSupported,omitempty"`
	...
	Tunnel   *KvmTunnelRelationship               `json:"Tunnel,omitempty" yaml:"Tunnel,omitempty"`
}
