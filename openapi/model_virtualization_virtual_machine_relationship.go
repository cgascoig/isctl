...
func (dst *VirtualizationVirtualMachineRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "virtualization.VirtualMachine":
			var result *VirtualizationVirtualMachine = &VirtualizationVirtualMachine{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.VirtualizationVirtualMachine = result
			return nil
		default:
...
func (src *VirtualizationVirtualMachineRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.VirtualizationVirtualMachine != nil {
		return yaml.Marshal(&src.VirtualizationVirtualMachine)
	}
