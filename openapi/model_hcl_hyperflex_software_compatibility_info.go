...
type HclHyperflexSoftwareCompatibilityInfo struct {
	...
	Constraints *[]HclConstraint `json:"Constraints,omitempty" yaml:"Constraints,omitempty"`
	...
	ServerFwVersion *string                          `json:"ServerFwVersion,omitempty" yaml:"ServerFwVersion,omitempty"`
