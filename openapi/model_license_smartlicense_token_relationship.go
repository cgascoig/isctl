...
func (dst *LicenseSmartlicenseTokenRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "license.SmartlicenseToken":
			var result *LicenseSmartlicenseToken = &LicenseSmartlicenseToken{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.LicenseSmartlicenseToken = result
			return nil
		case "mo.MoRef":
...
func (src *LicenseSmartlicenseTokenRelationship) MarshalYAML() ([]byte, error) {
	if src.LicenseSmartlicenseToken != nil {
		return yaml.Marshal(&src.LicenseSmartlicenseToken)
	}
