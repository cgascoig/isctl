...
func (dst *AssetTargetResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "asset.Target.List":
			var result *AssetTargetList = &AssetTargetList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.AssetTargetList = result
			return nil
...
func (src *AssetTargetResponse) MarshalYAML() ([]byte, error) {
	if src.AssetTargetList != nil {
		return yaml.Marshal(&src.AssetTargetList)
	}
