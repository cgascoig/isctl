...
func (dst *LicenseLicenseReservationOpRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "license.LicenseReservationOp":
			var result *LicenseLicenseReservationOp = &LicenseLicenseReservationOp{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.LicenseLicenseReservationOp = result
			return nil
		case "mo.MoRef":
...
func (src *LicenseLicenseReservationOpRelationship) MarshalYAML() ([]byte, error) {
	if src.LicenseLicenseReservationOp != nil {
		return yaml.Marshal(&src.LicenseLicenseReservationOp)
	}
