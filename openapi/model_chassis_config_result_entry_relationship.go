...
func (dst *ChassisConfigResultEntryRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "chassis.ConfigResultEntry":
			var result *ChassisConfigResultEntry = &ChassisConfigResultEntry{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ChassisConfigResultEntry = result
			return nil
		case "mo.MoRef":
...
func (src *ChassisConfigResultEntryRelationship) MarshalYAML() ([]byte, error) {
	if src.ChassisConfigResultEntry != nil {
		return yaml.Marshal(&src.ChassisConfigResultEntry)
	}
