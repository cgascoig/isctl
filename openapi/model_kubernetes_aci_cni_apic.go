...
type KubernetesAciCniApic struct {
	...
	AssetApicMoid *string `json:"AssetApicMoid,omitempty" yaml:"AssetApicMoid,omitempty"`
	// The number of ACI CNI profiles configured for this APIC.
	NumAciCniProfiles *int64 `json:"NumAciCniProfiles,omitempty" yaml:"NumAciCniProfiles,omitempty"`
	// An array of relationships to kubernetesAciCniProfile resources.
	AciCniProfiles   []KubernetesAciCniProfileRelationship `json:"AciCniProfiles,omitempty" yaml:"AciCniProfiles,omitempty"`
