...
type NiatelemetryEpgAllOf struct {
	...
	IntraEpgHyperv *string `json:"IntraEpgHyperv,omitempty" yaml:"IntraEpgHyperv,omitempty"`
	...
	StaticPathAttachmentCount *int64 `json:"StaticPathAttachmentCount,omitempty" yaml:"StaticPathAttachmentCount,omitempty"`
	// Logical Operators for attribute based microsegmentation in a hypervisor.
	UsegHypervCount  *int64                               `json:"UsegHypervCount,omitempty" yaml:"UsegHypervCount,omitempty"`
