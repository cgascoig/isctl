...
func (dst *CapabilityPsuDescriptorResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "capability.PsuDescriptor.List":
			var result *CapabilityPsuDescriptorList = &CapabilityPsuDescriptorList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.CapabilityPsuDescriptorList = result
			return nil
...
func (src *CapabilityPsuDescriptorResponse) MarshalYAML() ([]byte, error) {
	if src.CapabilityPsuDescriptorList != nil {
		return yaml.Marshal(&src.CapabilityPsuDescriptorList)
	}
