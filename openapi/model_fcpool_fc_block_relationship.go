...
func (dst *FcpoolFcBlockRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "fcpool.FcBlock":
			var result *FcpoolFcBlock = &FcpoolFcBlock{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FcpoolFcBlock = result
			return nil
		case "mo.MoRef":
...
func (src *FcpoolFcBlockRelationship) MarshalYAML() ([]byte, error) {
	if src.FcpoolFcBlock != nil {
		return yaml.Marshal(&src.FcpoolFcBlock)
	}
