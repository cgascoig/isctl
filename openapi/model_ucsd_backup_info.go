...
type UcsdBackupInfo struct {
	RecoveryAbstractBackupInfo `yaml:"RecoveryAbstractBackupInfo,inline"`
	...
	BackupFileName *string `json:"BackupFileName,omitempty" yaml:"BackupFileName,omitempty"`
	...
	BackupServerIp *string `json:"BackupServerIp,omitempty" yaml:"BackupServerIp,omitempty"`
	// Size of the backup image in bytes.
	BackupSize *int64              `json:"BackupSize,omitempty" yaml:"BackupSize,omitempty"`
	Connectors []UcsdConnectorPack `json:"Connectors,omitempty" yaml:"Connectors,omitempty"`
	...
	IsPurged *bool `json:"IsPurged,omitempty" yaml:"IsPurged,omitempty"`
	...
	PercentageCompletion *int64 `json:"PercentageCompletion,omitempty" yaml:"PercentageCompletion,omitempty"`
	...
	StageCompletion *string `json:"StageCompletion,omitempty" yaml:"StageCompletion,omitempty"`
