...
type KubernetesEsxiVirtualMachineInfraConfig struct {
	KubernetesBaseVirtualMachineInfraConfig `yaml:"KubernetesBaseVirtualMachineInfraConfig,inline"`
	...
	IsPassphraseSet *bool `json:"IsPassphraseSet,omitempty" yaml:"IsPassphraseSet,omitempty"`
