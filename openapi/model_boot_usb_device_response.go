...
func (dst *BootUsbDeviceResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "boot.UsbDevice.List":
			var result *BootUsbDeviceList = &BootUsbDeviceList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.BootUsbDeviceList = result
			return nil
...
func (src *BootUsbDeviceResponse) MarshalYAML() ([]byte, error) {
	if src.BootUsbDeviceList != nil {
		return yaml.Marshal(&src.BootUsbDeviceList)
	}
