...
func (dst *ChassisConfigChangeDetailRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "chassis.ConfigChangeDetail":
			var result *ChassisConfigChangeDetail = &ChassisConfigChangeDetail{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ChassisConfigChangeDetail = result
			return nil
		case "mo.MoRef":
...
func (src *ChassisConfigChangeDetailRelationship) MarshalYAML() ([]byte, error) {
	if src.ChassisConfigChangeDetail != nil {
		return yaml.Marshal(&src.ChassisConfigChangeDetail)
	}
