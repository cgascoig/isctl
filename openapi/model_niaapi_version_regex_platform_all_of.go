...
type NiaapiVersionRegexPlatformAllOf struct {
	...
	Currentlltrain  *NiaapiSoftwareRegex   `json:"Currentlltrain,omitempty" yaml:"Currentlltrain,omitempty"`
	Latestsltrain   *NiaapiSoftwareRegex   `json:"Latestsltrain,omitempty" yaml:"Latestsltrain,omitempty"`
	Sltrain         *[]NiaapiSoftwareRegex `json:"Sltrain,omitempty" yaml:"Sltrain,omitempty"`
	Upcominglltrain *NiaapiSoftwareRegex   `json:"Upcominglltrain,omitempty" yaml:"Upcominglltrain,omitempty"`
}
