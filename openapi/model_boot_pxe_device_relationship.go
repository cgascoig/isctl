...
func (dst *BootPxeDeviceRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "boot.PxeDevice":
			var result *BootPxeDevice = &BootPxeDevice{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.BootPxeDevice = result
			return nil
		case "mo.MoRef":
...
func (src *BootPxeDeviceRelationship) MarshalYAML() ([]byte, error) {
	if src.BootPxeDevice != nil {
		return yaml.Marshal(&src.BootPxeDevice)
	}
