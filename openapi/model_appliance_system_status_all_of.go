...
type ApplianceSystemStatusAllOf struct {
	...
	AppStatuses []ApplianceAppStatusRelationship `json:"AppStatuses,omitempty" yaml:"AppStatuses,omitempty"`
	// An array of relationships to applianceGroupStatus resources.
	GroupStatuses    []ApplianceGroupStatusRelationship   `json:"GroupStatuses,omitempty" yaml:"GroupStatuses,omitempty"`
	RegisteredDevice *AssetDeviceRegistrationRelationship `json:"RegisteredDevice,omitempty" yaml:"RegisteredDevice,omitempty"`
	SystemInfo       *ApplianceSystemInfoRelationship     `json:"SystemInfo,omitempty" yaml:"SystemInfo,omitempty"`
}
