...
func (dst *CommHttpProxyPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "comm.HttpProxyPolicy.List":
			var result *CommHttpProxyPolicyList = &CommHttpProxyPolicyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.CommHttpProxyPolicyList = result
			return nil
...
func (src *CommHttpProxyPolicyResponse) MarshalYAML() ([]byte, error) {
	if src.CommHttpProxyPolicyList != nil {
		return yaml.Marshal(&src.CommHttpProxyPolicyList)
	}
