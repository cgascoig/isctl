...
func (dst *BootIscsiDeviceRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "boot.IscsiDevice":
			var result *BootIscsiDevice = &BootIscsiDevice{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.BootIscsiDevice = result
			return nil
		case "mo.MoRef":
...
func (src *BootIscsiDeviceRelationship) MarshalYAML() ([]byte, error) {
	if src.BootIscsiDevice != nil {
		return yaml.Marshal(&src.BootIscsiDevice)
	}
