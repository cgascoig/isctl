...
func (dst *StoragePhysicalDiskExtensionRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "mo.MoRef":
			...
			dst.MoMoRef = result
			return nil
		case "storage.PhysicalDiskExtension":
			var result *StoragePhysicalDiskExtension = &StoragePhysicalDiskExtension{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.StoragePhysicalDiskExtension = result
			return nil
		default:
...
func (src *StoragePhysicalDiskExtensionRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.StoragePhysicalDiskExtension != nil {
		return yaml.Marshal(&src.StoragePhysicalDiskExtension)
	}
