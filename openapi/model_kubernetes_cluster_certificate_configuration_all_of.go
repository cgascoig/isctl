...
type KubernetesClusterCertificateConfigurationAllOf struct {
	...
	EtcdCert          *string  `json:"EtcdCert,omitempty" yaml:"EtcdCert,omitempty"`
	EtcdEncryptionKey []string `json:"EtcdEncryptionKey,omitempty" yaml:"EtcdEncryptionKey,omitempty"`
	// Private key for the etcd cluster.
	EtcdKey *string `json:"EtcdKey,omitempty" yaml:"EtcdKey,omitempty"`
	// Certificate for the front proxy to support Kubernetes API aggregators.
	FrontProxyCert *string `json:"FrontProxyCert,omitempty" yaml:"FrontProxyCert,omitempty"`
	...
	SaPrivateKey *string `json:"SaPrivateKey,omitempty" yaml:"SaPrivateKey,omitempty"`
	...
	SaPublicKey *string `json:"SaPublicKey,omitempty" yaml:"SaPublicKey,omitempty"`
}
