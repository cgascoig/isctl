...
type SnmpPolicy struct {
	...
	CommunityAccess *string `json:"CommunityAccess,omitempty" yaml:"CommunityAccess,omitempty"`
	...
	TrapCommunity *string                               `json:"TrapCommunity,omitempty" yaml:"TrapCommunity,omitempty"`
