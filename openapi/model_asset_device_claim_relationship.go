...
func (dst *AssetDeviceClaimRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "asset.DeviceClaim":
			var result *AssetDeviceClaim = &AssetDeviceClaim{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.AssetDeviceClaim = result
			return nil
		case "mo.MoRef":
...
func (src *AssetDeviceClaimRelationship) MarshalYAML() ([]byte, error) {
	if src.AssetDeviceClaim != nil {
		return yaml.Marshal(&src.AssetDeviceClaim)
	}
