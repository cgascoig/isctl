...
func (dst *RecoveryAbstractBackupInfoRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "mo.MoRef":
			...
			dst.MoMoRef = result
			return nil
		case "recovery.AbstractBackupInfo":
			var result *RecoveryAbstractBackupInfo = &RecoveryAbstractBackupInfo{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.RecoveryAbstractBackupInfo = result
			return nil
		default:
...
func (src *RecoveryAbstractBackupInfoRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.RecoveryAbstractBackupInfo != nil {
		return yaml.Marshal(&src.RecoveryAbstractBackupInfo)
	}
