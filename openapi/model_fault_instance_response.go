...
func (dst *FaultInstanceResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "fault.Instance.List":
			var result *FaultInstanceList = &FaultInstanceList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FaultInstanceList = result
			return nil
...
func (src *FaultInstanceResponse) MarshalYAML() ([]byte, error) {
	if src.FaultInstanceList != nil {
		return yaml.Marshal(&src.FaultInstanceList)
	}
