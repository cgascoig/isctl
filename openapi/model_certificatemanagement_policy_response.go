...
func (dst *CertificatemanagementPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "certificatemanagement.Policy.List":
			var result *CertificatemanagementPolicyList = &CertificatemanagementPolicyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.CertificatemanagementPolicyList = result
			return nil
...
func (src *CertificatemanagementPolicyResponse) MarshalYAML() ([]byte, error) {
	if src.CertificatemanagementPolicyList != nil {
		return yaml.Marshal(&src.CertificatemanagementPolicyList)
	}
