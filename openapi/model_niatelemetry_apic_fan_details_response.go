...
func MoAggregateTransformAsNiatelemetryApicFanDetailsResponse(v *MoAggregateTransform) NiatelemetryApicFanDetailsResponse {
	return NiatelemetryApicFanDetailsResponse{MoAggregateTransform: v}
}
...
func MoDocumentCountAsNiatelemetryApicFanDetailsResponse(v *MoDocumentCount) NiatelemetryApicFanDetailsResponse {
	return NiatelemetryApicFanDetailsResponse{MoDocumentCount: v}
}
...
func MoTagSummaryAsNiatelemetryApicFanDetailsResponse(v *MoTagSummary) NiatelemetryApicFanDetailsResponse {
	return NiatelemetryApicFanDetailsResponse{MoTagSummary: v}
}
...
func NiatelemetryApicFanDetailsListAsNiatelemetryApicFanDetailsResponse(v *NiatelemetryApicFanDetailsList) NiatelemetryApicFanDetailsResponse {
	return NiatelemetryApicFanDetailsResponse{NiatelemetryApicFanDetailsList: v}
}
...
func (dst *NiatelemetryApicFanDetailsResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		...
		case "mo.TagSummary":
			...
			return nil
		case "niatelemetry.ApicFanDetails.List":
			var result *NiatelemetryApicFanDetailsList = &NiatelemetryApicFanDetailsList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.NiatelemetryApicFanDetailsList = result
			return nil
		default:
...
func (src *NiatelemetryApicFanDetailsResponse) MarshalYAML() ([]byte, error) {
	if src.MoAggregateTransform != nil {
	...
	if src.NiatelemetryApicFanDetailsList != nil {
		return yaml.Marshal(&src.NiatelemetryApicFanDetailsList)
	}
