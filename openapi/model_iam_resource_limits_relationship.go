...
func (dst *IamResourceLimitsRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "iam.ResourceLimits":
			var result *IamResourceLimits = &IamResourceLimits{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamResourceLimits = result
			return nil
		case "mo.MoRef":
...
func (src *IamResourceLimitsRelationship) MarshalYAML() ([]byte, error) {
	if src.IamResourceLimits != nil {
		return yaml.Marshal(&src.IamResourceLimits)
	}
