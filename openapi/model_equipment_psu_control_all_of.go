...
type EquipmentPsuControlAllOf struct {
	...
	InputPowerState *string `json:"InputPowerState,omitempty" yaml:"InputPowerState,omitempty"`
	...
	OperQualifier *string `json:"OperQualifier,omitempty" yaml:"OperQualifier,omitempty"`
	...
	OutputPowerState *string `json:"OutputPowerState,omitempty" yaml:"OutputPowerState,omitempty"`
	// This field identifies the redundancy state of the psus.
	Redundancy          *string                              `json:"Redundancy,omitempty" yaml:"Redundancy,omitempty"`
