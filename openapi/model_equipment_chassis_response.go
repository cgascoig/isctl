...
func (dst *EquipmentChassisResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "equipment.Chassis.List":
			var result *EquipmentChassisList = &EquipmentChassisList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentChassisList = result
			return nil
...
func (src *EquipmentChassisResponse) MarshalYAML() ([]byte, error) {
	if src.EquipmentChassisList != nil {
		return yaml.Marshal(&src.EquipmentChassisList)
	}
