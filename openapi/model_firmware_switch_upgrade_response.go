...
func (dst *FirmwareSwitchUpgradeResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "firmware.SwitchUpgrade.List":
			var result *FirmwareSwitchUpgradeList = &FirmwareSwitchUpgradeList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FirmwareSwitchUpgradeList = result
			return nil
...
func (src *FirmwareSwitchUpgradeResponse) MarshalYAML() ([]byte, error) {
	if src.FirmwareSwitchUpgradeList != nil {
		return yaml.Marshal(&src.FirmwareSwitchUpgradeList)
	}
