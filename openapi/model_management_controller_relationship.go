...
func (dst *ManagementControllerRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "management.Controller":
			var result *ManagementController = &ManagementController{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ManagementController = result
			return nil
		case "mo.MoRef":
...
func (src *ManagementControllerRelationship) MarshalYAML() ([]byte, error) {
	if src.ManagementController != nil {
		return yaml.Marshal(&src.ManagementController)
	}
