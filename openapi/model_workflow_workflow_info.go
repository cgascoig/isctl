...
type WorkflowWorkflowInfo struct {
	...
	UserActionRequired *bool `json:"UserActionRequired,omitempty" yaml:"UserActionRequired,omitempty"`
	...
	WorkflowCtx NullableWorkflowWorkflowCtx `json:"WorkflowCtx,omitempty" yaml:"WorkflowCtx,omitempty"`
	...
	Var2ClusterProfile         *HyperflexClusterProfileRelationship            `json:"_2_ClusterProfile,omitempty" yaml:"_2_ClusterProfile,omitempty"`
