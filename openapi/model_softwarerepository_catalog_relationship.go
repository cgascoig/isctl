...
func (dst *SoftwarerepositoryCatalogRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "mo.MoRef":
			...
			dst.MoMoRef = result
			return nil
		case "softwarerepository.Catalog":
			var result *SoftwarerepositoryCatalog = &SoftwarerepositoryCatalog{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.SoftwarerepositoryCatalog = result
			return nil
		default:
...
func (src *SoftwarerepositoryCatalogRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.SoftwarerepositoryCatalog != nil {
		return yaml.Marshal(&src.SoftwarerepositoryCatalog)
	}
