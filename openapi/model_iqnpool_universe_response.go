...
func (dst *IqnpoolUniverseResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iqnpool.Universe.List":
			var result *IqnpoolUniverseList = &IqnpoolUniverseList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IqnpoolUniverseList = result
			return nil
...
func (src *IqnpoolUniverseResponse) MarshalYAML() ([]byte, error) {
	if src.IqnpoolUniverseList != nil {
		return yaml.Marshal(&src.IqnpoolUniverseList)
	}
