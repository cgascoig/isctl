...
type EtherPortChannel struct {
	...
	AccessVlan *string `json:"AccessVlan,omitempty" yaml:"AccessVlan,omitempty"`
	...
	NativeVlan *string `json:"NativeVlan,omitempty" yaml:"NativeVlan,omitempty"`
	...
	EquipmentSwitchCard *EquipmentSwitchCardRelationship     `json:"EquipmentSwitchCard,omitempty" yaml:"EquipmentSwitchCard,omitempty"`
