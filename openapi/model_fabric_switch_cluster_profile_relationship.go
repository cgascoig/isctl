...
func (dst *FabricSwitchClusterProfileRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "fabric.SwitchClusterProfile":
			var result *FabricSwitchClusterProfile = &FabricSwitchClusterProfile{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FabricSwitchClusterProfile = result
			return nil
		case "mo.MoRef":
...
func (src *FabricSwitchClusterProfileRelationship) MarshalYAML() ([]byte, error) {
	if src.FabricSwitchClusterProfile != nil {
		return yaml.Marshal(&src.FabricSwitchClusterProfile)
	}
