...
type ChassisProfileAllOf struct {
	...
	AssignedChassis   *EquipmentChassisRelationship `json:"AssignedChassis,omitempty" yaml:"AssignedChassis,omitempty"`
	AssociatedChassis *EquipmentChassisRelationship `json:"AssociatedChassis,omitempty" yaml:"AssociatedChassis,omitempty"`
	// An array of relationships to chassisConfigChangeDetail resources.
	ConfigChangeDetails []ChassisConfigChangeDetailRelationship `json:"ConfigChangeDetails,omitempty" yaml:"ConfigChangeDetails,omitempty"`
	ConfigResult        *ChassisConfigResultRelationship        `json:"ConfigResult,omitempty" yaml:"ConfigResult,omitempty"`
	// An array of relationships to chassisIomProfile resources.
	IomProfiles  []ChassisIomProfileRelationship       `json:"IomProfiles,omitempty" yaml:"IomProfiles,omitempty"`
