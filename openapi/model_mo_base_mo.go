...
type MoBaseMo struct {
	...
	AccountMoid *string `json:"AccountMoid,omitempty" yaml:"AccountMoid,omitempty"`
	// The time when this managed object was created.
	CreateTime *time.Time `json:"CreateTime,omitempty" yaml:"CreateTime,omitempty"`
	// The DomainGroup ID for this managed object.
	DomainGroupMoid *string `json:"DomainGroupMoid,omitempty" yaml:"DomainGroupMoid,omitempty"`
	...
	SharedScope                         *string                                               `json:"SharedScope,omitempty" yaml:"SharedScope,omitempty"`
	Tags                                []MoTag                                               `json:"Tags,omitempty" yaml:"Tags,omitempty"`
	VersionContext                      NullableMoVersionContext                              `json:"VersionContext,omitempty" yaml:"VersionContext,omitempty"`
	Var0ClusterReplicationNetworkPolicy *HyperflexClusterReplicationNetworkPolicyRelationship `json:"_0_ClusterReplicationNetworkPolicy,omitempty" yaml:"_0_ClusterReplicationNetworkPolicy,omitempty"`
