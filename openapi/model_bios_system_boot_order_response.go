...
func (dst *BiosSystemBootOrderResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "bios.SystemBootOrder.List":
			var result *BiosSystemBootOrderList = &BiosSystemBootOrderList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.BiosSystemBootOrderList = result
			return nil
...
func (src *BiosSystemBootOrderResponse) MarshalYAML() ([]byte, error) {
	if src.BiosSystemBootOrderList != nil {
		return yaml.Marshal(&src.BiosSystemBootOrderList)
	}
