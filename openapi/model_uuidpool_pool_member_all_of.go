...
type UuidpoolPoolMemberAllOf struct {
	...
	BlockHead        *UuidpoolBlockRelationship     `json:"BlockHead,omitempty" yaml:"BlockHead,omitempty"`
	Peer             *UuidpoolUuidLeaseRelationship `json:"Peer,omitempty" yaml:"Peer,omitempty"`
