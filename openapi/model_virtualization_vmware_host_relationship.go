...
func (dst *VirtualizationVmwareHostRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "mo.MoRef":
			...
			dst.MoMoRef = result
			return nil
		case "virtualization.VmwareHost":
			var result *VirtualizationVmwareHost = &VirtualizationVmwareHost{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.VirtualizationVmwareHost = result
			return nil
		default:
...
func (src *VirtualizationVmwareHostRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.VirtualizationVmwareHost != nil {
		return yaml.Marshal(&src.VirtualizationVmwareHost)
	}
