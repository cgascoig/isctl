...
func (dst *KvmTunnelResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "kvm.Tunnel.List":
			var result *KvmTunnelList = &KvmTunnelList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KvmTunnelList = result
			return nil
...
func (src *KvmTunnelResponse) MarshalYAML() ([]byte, error) {
	if src.KvmTunnelList != nil {
		return yaml.Marshal(&src.KvmTunnelList)
	}
