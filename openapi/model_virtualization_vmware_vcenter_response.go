...
func (dst *VirtualizationVmwareVcenterResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		...
		case "mo.DocumentCount":
			...
			return nil
		case "virtualization.VmwareVcenter.List":
			var result *VirtualizationVmwareVcenterList = &VirtualizationVmwareVcenterList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.VirtualizationVmwareVcenterList = result
			return nil
		default:
...
func (src *VirtualizationVmwareVcenterResponse) MarshalYAML() ([]byte, error) {
	if src.MoDocumentCount != nil {
		return yaml.Marshal(&src.MoDocumentCount)
	}

	if src.VirtualizationVmwareVcenterList != nil {
		return yaml.Marshal(&src.VirtualizationVmwareVcenterList)
	}
