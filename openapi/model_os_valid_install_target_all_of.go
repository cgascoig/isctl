...
type OsValidInstallTargetAllOf struct {
	...
	M2Jbod             []OsPhysicalDiskResponse `json:"M2Jbod,omitempty" yaml:"M2Jbod,omitempty"`
	M2VirtualDrives    []OsVirtualDriveResponse `json:"M2VirtualDrives,omitempty" yaml:"M2VirtualDrives,omitempty"`
	MraidJbod          []OsPhysicalDiskResponse `json:"MraidJbod,omitempty" yaml:"MraidJbod,omitempty"`
	MraidVirtualDrives []OsVirtualDriveResponse `json:"MraidVirtualDrives,omitempty" yaml:"MraidVirtualDrives,omitempty"`
