...
func (dst *StoragePureProtectionGroupSnapshotRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "mo.MoRef":
			...
			dst.MoMoRef = result
			return nil
		case "storage.PureProtectionGroupSnapshot":
			var result *StoragePureProtectionGroupSnapshot = &StoragePureProtectionGroupSnapshot{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.StoragePureProtectionGroupSnapshot = result
			return nil
		default:
...
func (src *StoragePureProtectionGroupSnapshotRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.StoragePureProtectionGroupSnapshot != nil {
		return yaml.Marshal(&src.StoragePureProtectionGroupSnapshot)
	}
