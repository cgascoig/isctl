...
func (dst *KubernetesCatalogResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "kubernetes.Catalog.List":
			var result *KubernetesCatalogList = &KubernetesCatalogList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesCatalogList = result
			return nil
...
func (src *KubernetesCatalogResponse) MarshalYAML() ([]byte, error) {
	if src.KubernetesCatalogList != nil {
		return yaml.Marshal(&src.KubernetesCatalogList)
	}
