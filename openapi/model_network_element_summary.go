...
type NetworkElementSummary struct {
	ViewsView `yaml:"ViewsView,inline"`
	...
	NumEtherPorts *int64 `json:"NumEtherPorts,omitempty" yaml:"NumEtherPorts,omitempty"`
	// Total number of configured Ethernet ports.
	NumEtherPortsConfigured *int64 `json:"NumEtherPortsConfigured,omitempty" yaml:"NumEtherPortsConfigured,omitempty"`
	// Total number of Ethernet ports which are UP.
	NumEtherPortsLinkUp *int64 `json:"NumEtherPortsLinkUp,omitempty" yaml:"NumEtherPortsLinkUp,omitempty"`
	// Total number of expansion modules.
	NumExpansionModules *int64 `json:"NumExpansionModules,omitempty" yaml:"NumExpansionModules,omitempty"`
	// Total number of FC ports.
	NumFcPorts *int64 `json:"NumFcPorts,omitempty" yaml:"NumFcPorts,omitempty"`
