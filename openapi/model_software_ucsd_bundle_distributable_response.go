...
func (dst *SoftwareUcsdBundleDistributableResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		...
		case "mo.TagSummary":
			...
			return nil
		case "software.UcsdBundleDistributable.List":
			var result *SoftwareUcsdBundleDistributableList = &SoftwareUcsdBundleDistributableList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.SoftwareUcsdBundleDistributableList = result
			return nil
		default:
...
func (src *SoftwareUcsdBundleDistributableResponse) MarshalYAML() ([]byte, error) {
	if src.MoAggregateTransform != nil {
	...
	if src.SoftwareUcsdBundleDistributableList != nil {
		return yaml.Marshal(&src.SoftwareUcsdBundleDistributableList)
	}
