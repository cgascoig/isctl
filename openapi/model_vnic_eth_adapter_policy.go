...
type VnicEthAdapterPolicy struct {
	...
	ArfsSettings            NullableVnicArfsSettings            `json:"ArfsSettings,omitempty" yaml:"ArfsSettings,omitempty"`
	CompletionQueueSettings NullableVnicCompletionQueueSettings `json:"CompletionQueueSettings,omitempty" yaml:"CompletionQueueSettings,omitempty"`
	...
	InterruptSettings NullableVnicEthInterruptSettings `json:"InterruptSettings,omitempty" yaml:"InterruptSettings,omitempty"`
	NvgreSettings     NullableVnicNvgreSettings        `json:"NvgreSettings,omitempty" yaml:"NvgreSettings,omitempty"`
	RoceSettings      NullableVnicRoceSettings         `json:"RoceSettings,omitempty" yaml:"RoceSettings,omitempty"`
	RssHashSettings   NullableVnicRssHashSettings      `json:"RssHashSettings,omitempty" yaml:"RssHashSettings,omitempty"`
	...
	RxQueueSettings    NullableVnicEthRxQueueSettings `json:"RxQueueSettings,omitempty" yaml:"RxQueueSettings,omitempty"`
	TcpOffloadSettings NullableVnicTcpOffloadSettings `json:"TcpOffloadSettings,omitempty" yaml:"TcpOffloadSettings,omitempty"`
	TxQueueSettings    NullableVnicEthTxQueueSettings `json:"TxQueueSettings,omitempty" yaml:"TxQueueSettings,omitempty"`
	...
	VxlanSettings         NullableVnicVxlanSettings             `json:"VxlanSettings,omitempty" yaml:"VxlanSettings,omitempty"`
