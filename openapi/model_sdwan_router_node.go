...
type SdwanRouterNode struct {
	...
	DeviceTemplate *string `json:"DeviceTemplate,omitempty" yaml:"DeviceTemplate,omitempty"`
	// Name of the router node object.
	Name                 *string                         `json:"Name,omitempty" yaml:"Name,omitempty"`
	NetworkConfiguration []SdwanNetworkConfigurationType `json:"NetworkConfiguration,omitempty" yaml:"NetworkConfiguration,omitempty"`
	TemplateInputs       []SdwanTemplateInputsType       `json:"TemplateInputs,omitempty" yaml:"TemplateInputs,omitempty"`
	...
	Profile      *SdwanProfileRelationship             `json:"Profile,omitempty" yaml:"Profile,omitempty"`
	ServerNode   *AssetDeviceRegistrationRelationship  `json:"ServerNode,omitempty" yaml:"ServerNode,omitempty"`
}
