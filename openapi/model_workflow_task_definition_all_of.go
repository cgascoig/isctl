...
type WorkflowTaskDefinitionAllOf struct {
	...
	InternalProperties NullableWorkflowInternalProperties `json:"InternalProperties,omitempty" yaml:"InternalProperties,omitempty"`
	...
	Properties    NullableWorkflowProperties `json:"Properties,omitempty" yaml:"Properties,omitempty"`
	RollbackTasks []WorkflowRollbackTask     `json:"RollbackTasks,omitempty" yaml:"RollbackTasks,omitempty"`
	...
	SecurePropAccess *bool `json:"SecurePropAccess,omitempty" yaml:"SecurePropAccess,omitempty"`
	...
	ImplementedTasks []WorkflowTaskDefinitionRelationship `json:"ImplementedTasks,omitempty" yaml:"ImplementedTasks,omitempty"`
	InterfaceTask    *WorkflowTaskDefinitionRelationship  `json:"InterfaceTask,omitempty" yaml:"InterfaceTask,omitempty"`
	TaskMetadata     *WorkflowTaskMetadataRelationship    `json:"TaskMetadata,omitempty" yaml:"TaskMetadata,omitempty"`
}
