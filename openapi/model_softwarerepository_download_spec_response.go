...
func (dst *SoftwarerepositoryDownloadSpecResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		...
		case "mo.TagSummary":
			...
			return nil
		case "softwarerepository.DownloadSpec.List":
			var result *SoftwarerepositoryDownloadSpecList = &SoftwarerepositoryDownloadSpecList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.SoftwarerepositoryDownloadSpecList = result
			return nil
		default:
...
func (src *SoftwarerepositoryDownloadSpecResponse) MarshalYAML() ([]byte, error) {
	if src.MoAggregateTransform != nil {
	...
	if src.SoftwarerepositoryDownloadSpecList != nil {
		return yaml.Marshal(&src.SoftwarerepositoryDownloadSpecList)
	}
