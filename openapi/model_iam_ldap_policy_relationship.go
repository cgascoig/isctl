...
func (dst *IamLdapPolicyRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "iam.LdapPolicy":
			var result *IamLdapPolicy = &IamLdapPolicy{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamLdapPolicy = result
			return nil
		case "mo.MoRef":
...
func (src *IamLdapPolicyRelationship) MarshalYAML() ([]byte, error) {
	if src.IamLdapPolicy != nil {
		return yaml.Marshal(&src.IamLdapPolicy)
	}
