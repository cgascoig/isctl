...
func (dst *AssetSubscriptionDeviceContractInformationResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "asset.SubscriptionDeviceContractInformation.List":
			var result *AssetSubscriptionDeviceContractInformationList = &AssetSubscriptionDeviceContractInformationList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.AssetSubscriptionDeviceContractInformationList = result
			return nil
...
func (src *AssetSubscriptionDeviceContractInformationResponse) MarshalYAML() ([]byte, error) {
	if src.AssetSubscriptionDeviceContractInformationList != nil {
		return yaml.Marshal(&src.AssetSubscriptionDeviceContractInformationList)
	}
