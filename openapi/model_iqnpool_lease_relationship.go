...
func (dst *IqnpoolLeaseRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "iqnpool.Lease":
			var result *IqnpoolLease = &IqnpoolLease{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IqnpoolLease = result
			return nil
		case "mo.MoRef":
...
func (src *IqnpoolLeaseRelationship) MarshalYAML() ([]byte, error) {
	if src.IqnpoolLease != nil {
		return yaml.Marshal(&src.IqnpoolLease)
	}
