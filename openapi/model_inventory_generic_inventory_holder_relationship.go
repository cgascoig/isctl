...
func (dst *InventoryGenericInventoryHolderRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "inventory.GenericInventoryHolder":
			var result *InventoryGenericInventoryHolder = &InventoryGenericInventoryHolder{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.InventoryGenericInventoryHolder = result
			return nil
		case "mo.MoRef":
...
func (src *InventoryGenericInventoryHolderRelationship) MarshalYAML() ([]byte, error) {
	if src.InventoryGenericInventoryHolder != nil {
		return yaml.Marshal(&src.InventoryGenericInventoryHolder)
	}
