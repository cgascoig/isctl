...
func (dst *LicenseAccountLicenseDataRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "license.AccountLicenseData":
			var result *LicenseAccountLicenseData = &LicenseAccountLicenseData{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.LicenseAccountLicenseData = result
			return nil
		case "mo.MoRef":
...
func (src *LicenseAccountLicenseDataRelationship) MarshalYAML() ([]byte, error) {
	if src.LicenseAccountLicenseData != nil {
		return yaml.Marshal(&src.LicenseAccountLicenseData)
	}
