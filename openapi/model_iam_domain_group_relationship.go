...
func (dst *IamDomainGroupRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "iam.DomainGroup":
			var result *IamDomainGroup = &IamDomainGroup{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamDomainGroup = result
			return nil
		case "mo.MoRef":
...
func (src *IamDomainGroupRelationship) MarshalYAML() ([]byte, error) {
	if src.IamDomainGroup != nil {
		return yaml.Marshal(&src.IamDomainGroup)
	}
