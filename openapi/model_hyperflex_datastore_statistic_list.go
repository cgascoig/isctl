...
func (o *HyperflexDatastoreStatisticList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varHyperflexDatastoreStatisticListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varHyperflexDatastoreStatisticList)
	if err == nil {
