...
func (dst *IamUserGroupRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "iam.UserGroup":
			var result *IamUserGroup = &IamUserGroup{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamUserGroup = result
			return nil
		case "mo.MoRef":
...
func (src *IamUserGroupRelationship) MarshalYAML() ([]byte, error) {
	if src.IamUserGroup != nil {
		return yaml.Marshal(&src.IamUserGroup)
	}
