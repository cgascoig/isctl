...
func (dst *EquipmentIoExpanderResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "equipment.IoExpander.List":
			var result *EquipmentIoExpanderList = &EquipmentIoExpanderList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentIoExpanderList = result
			return nil
...
func (src *EquipmentIoExpanderResponse) MarshalYAML() ([]byte, error) {
	if src.EquipmentIoExpanderList != nil {
		return yaml.Marshal(&src.EquipmentIoExpanderList)
	}
