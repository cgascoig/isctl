...
type NiatelemetryInterfaceAllOf struct {
	...
	InterfaceDownCount *int64 `json:"InterfaceDownCount,omitempty" yaml:"InterfaceDownCount,omitempty"`
	// Return value of number of interafces up.
	InterfaceUpCount *int64 `json:"InterfaceUpCount,omitempty" yaml:"InterfaceUpCount,omitempty"`
}
