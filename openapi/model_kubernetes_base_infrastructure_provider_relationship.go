...
func (dst *KubernetesBaseInfrastructureProviderRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "kubernetes.BaseInfrastructureProvider":
			var result *KubernetesBaseInfrastructureProvider = &KubernetesBaseInfrastructureProvider{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesBaseInfrastructureProvider = result
			return nil
		case "mo.MoRef":
...
func (src *KubernetesBaseInfrastructureProviderRelationship) MarshalYAML() ([]byte, error) {
	if src.KubernetesBaseInfrastructureProvider != nil {
		return yaml.Marshal(&src.KubernetesBaseInfrastructureProvider)
	}
