...
type CloudRegionsAllOf struct {
	...
	AlternateNames []string `json:"AlternateNames,omitempty" yaml:"AlternateNames,omitempty"`
	// The default zone for this region.
	DefaultZone *string `json:"DefaultZone,omitempty" yaml:"DefaultZone,omitempty"`
	...
	IsBillingOnly *bool `json:"IsBillingOnly,omitempty" yaml:"IsBillingOnly,omitempty"`
