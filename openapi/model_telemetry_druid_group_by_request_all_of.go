...
type TelemetryDruidGroupByRequestAllOf struct {
	...
	LimitSpec   *TelemetryDruidDefaultLimitSpec `json:"limitSpec,omitempty" yaml:"limitSpec,omitempty"`
	Having      *TelemetryDruidHavingFilter     `json:"having,omitempty" yaml:"having,omitempty"`
	...
	SubtotalsSpec *map[string]interface{}     `json:"subtotalsSpec,omitempty" yaml:"subtotalsSpec,omitempty"`
