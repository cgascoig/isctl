...
func (dst *VirtualizationBaseVirtualDiskRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "mo.MoRef":
			...
			dst.MoMoRef = result
			return nil
		case "virtualization.BaseVirtualDisk":
			var result *VirtualizationBaseVirtualDisk = &VirtualizationBaseVirtualDisk{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.VirtualizationBaseVirtualDisk = result
			return nil
		default:
...
func (src *VirtualizationBaseVirtualDiskRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.VirtualizationBaseVirtualDisk != nil {
		return yaml.Marshal(&src.VirtualizationBaseVirtualDisk)
	}
