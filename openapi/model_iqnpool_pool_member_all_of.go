...
type IqnpoolPoolMemberAllOf struct {
	...
	BlockHead        *IqnpoolBlockRelationship `json:"BlockHead,omitempty" yaml:"BlockHead,omitempty"`
	Peer             *IqnpoolLeaseRelationship `json:"Peer,omitempty" yaml:"Peer,omitempty"`
