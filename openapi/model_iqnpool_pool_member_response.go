...
func (dst *IqnpoolPoolMemberResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iqnpool.PoolMember.List":
			var result *IqnpoolPoolMemberList = &IqnpoolPoolMemberList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IqnpoolPoolMemberList = result
			return nil
...
func (src *IqnpoolPoolMemberResponse) MarshalYAML() ([]byte, error) {
	if src.IqnpoolPoolMemberList != nil {
		return yaml.Marshal(&src.IqnpoolPoolMemberList)
	}
