...
type IamDomainGroupAllOf struct {
	...
	Partition1 *int64 `json:"Partition1,omitempty" yaml:"Partition1,omitempty"`
	...
	Partition2 *int64 `json:"Partition2,omitempty" yaml:"Partition2,omitempty"`
	...
	Partition3 *int64 `json:"Partition3,omitempty" yaml:"Partition3,omitempty"`
