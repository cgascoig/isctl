...
func (dst *AdapterHostFcInterfaceRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "adapter.HostFcInterface":
			var result *AdapterHostFcInterface = &AdapterHostFcInterface{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.AdapterHostFcInterface = result
			return nil
		case "mo.MoRef":
...
func (src *AdapterHostFcInterfaceRelationship) MarshalYAML() ([]byte, error) {
	if src.AdapterHostFcInterface != nil {
		return yaml.Marshal(&src.AdapterHostFcInterface)
	}
