...
func (dst *IamAccountResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iam.Account.List":
			var result *IamAccountList = &IamAccountList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamAccountList = result
			return nil
...
func (src *IamAccountResponse) MarshalYAML() ([]byte, error) {
	if src.IamAccountList != nil {
		return yaml.Marshal(&src.IamAccountList)
	}
