...
func (dst *MetaDefinitionResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "meta.Definition.List":
			var result *MetaDefinitionList = &MetaDefinitionList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.MetaDefinitionList = result
			return nil
...
func (src *MetaDefinitionResponse) MarshalYAML() ([]byte, error) {
	if src.MetaDefinitionList != nil {
		return yaml.Marshal(&src.MetaDefinitionList)
	}
