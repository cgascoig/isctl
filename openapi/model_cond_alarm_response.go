...
func (dst *CondAlarmResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "cond.Alarm.List":
			var result *CondAlarmList = &CondAlarmList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.CondAlarmList = result
			return nil
...
func (src *CondAlarmResponse) MarshalYAML() ([]byte, error) {
	if src.CondAlarmList != nil {
		return yaml.Marshal(&src.CondAlarmList)
	}
