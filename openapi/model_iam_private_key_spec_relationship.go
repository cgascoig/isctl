...
func (dst *IamPrivateKeySpecRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "iam.PrivateKeySpec":
			var result *IamPrivateKeySpec = &IamPrivateKeySpec{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamPrivateKeySpec = result
			return nil
		case "mo.MoRef":
...
func (src *IamPrivateKeySpecRelationship) MarshalYAML() ([]byte, error) {
	if src.IamPrivateKeySpec != nil {
		return yaml.Marshal(&src.IamPrivateKeySpec)
	}
