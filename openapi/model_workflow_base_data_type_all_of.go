...
type WorkflowBaseDataTypeAllOf struct {
	...
	Default    NullableWorkflowDefaultValue `json:"Default,omitempty" yaml:"Default,omitempty"`
	// Provide a detailed description of the data type.
	Description *string                     `json:"Description,omitempty" yaml:"Description,omitempty"`
	DisplayMeta NullableWorkflowDisplayMeta `json:"DisplayMeta,omitempty" yaml:"DisplayMeta,omitempty"`
