...
func (dst *EquipmentFruRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "equipment.Fru":
			var result *EquipmentFru = &EquipmentFru{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentFru = result
			return nil
		case "mo.MoRef":
...
func (src *EquipmentFruRelationship) MarshalYAML() ([]byte, error) {
	if src.EquipmentFru != nil {
		return yaml.Marshal(&src.EquipmentFru)
	}
