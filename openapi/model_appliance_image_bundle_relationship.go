...
func (dst *ApplianceImageBundleRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "appliance.ImageBundle":
			var result *ApplianceImageBundle = &ApplianceImageBundle{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ApplianceImageBundle = result
			return nil
		case "mo.MoRef":
...
func (src *ApplianceImageBundleRelationship) MarshalYAML() ([]byte, error) {
	if src.ApplianceImageBundle != nil {
		return yaml.Marshal(&src.ApplianceImageBundle)
	}
