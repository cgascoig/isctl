...
func (dst *MemoryPersistentMemoryUnitRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "memory.PersistentMemoryUnit":
			var result *MemoryPersistentMemoryUnit = &MemoryPersistentMemoryUnit{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.MemoryPersistentMemoryUnit = result
			return nil
		case "mo.MoRef":
...
func (src *MemoryPersistentMemoryUnitRelationship) MarshalYAML() ([]byte, error) {
	if src.MemoryPersistentMemoryUnit != nil {
		return yaml.Marshal(&src.MemoryPersistentMemoryUnit)
	}
