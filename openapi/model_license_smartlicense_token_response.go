...
func (dst *LicenseSmartlicenseTokenResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "license.SmartlicenseToken.List":
			var result *LicenseSmartlicenseTokenList = &LicenseSmartlicenseTokenList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.LicenseSmartlicenseTokenList = result
			return nil
...
func (src *LicenseSmartlicenseTokenResponse) MarshalYAML() ([]byte, error) {
	if src.LicenseSmartlicenseTokenList != nil {
		return yaml.Marshal(&src.LicenseSmartlicenseTokenList)
	}
