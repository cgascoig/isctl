...
func (dst *IaasLicenseInfoRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "iaas.LicenseInfo":
			var result *IaasLicenseInfo = &IaasLicenseInfo{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IaasLicenseInfo = result
			return nil
		case "mo.MoRef":
...
func (src *IaasLicenseInfoRelationship) MarshalYAML() ([]byte, error) {
	if src.IaasLicenseInfo != nil {
		return yaml.Marshal(&src.IaasLicenseInfo)
	}
