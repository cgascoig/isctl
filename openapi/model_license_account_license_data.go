...
type LicenseAccountLicenseData struct {
	...
	AgentData *string `json:"AgentData,omitempty" yaml:"AgentData,omitempty"`
	// Authorization expiration time.
	AuthExpireTime *string `json:"AuthExpireTime,omitempty" yaml:"AuthExpireTime,omitempty"`
	// Intial authorization time.
	AuthInitialTime *string `json:"AuthInitialTime,omitempty" yaml:"AuthInitialTime,omitempty"`
	...
	LicenseTechSupportInfo *string `json:"LicenseTechSupportInfo,omitempty" yaml:"LicenseTechSupportInfo,omitempty"`
	// Registration exipiration time.
	RegisterExpireTime *string `json:"RegisterExpireTime,omitempty" yaml:"RegisterExpireTime,omitempty"`
	// Initial time of registration.
	RegisterInitialTime *string `json:"RegisterInitialTime,omitempty" yaml:"RegisterInitialTime,omitempty"`
	// Next time for the license registration.
	RegisterNextTime *string `json:"RegisterNextTime,omitempty" yaml:"RegisterNextTime,omitempty"`
	// Registration status of a smart-agent.
	RegistrationStatus *string `json:"RegistrationStatus,omitempty" yaml:"RegistrationStatus,omitempty"`
	// License renewal failure message.
	RenewFailureString *string `json:"RenewFailureString,omitempty" yaml:"RenewFailureString,omitempty"`
	// Name of the smart account.
	SmartAccount *string `json:"SmartAccount,omitempty" yaml:"SmartAccount,omitempty"`
	...
	VirtualAccount  *string                             `json:"VirtualAccount,omitempty" yaml:"VirtualAccount,omitempty"`
	...
	IwoCustomerOp   *LicenseIwoCustomerOpRelationship   `json:"IwoCustomerOp,omitempty" yaml:"IwoCustomerOp,omitempty"`
	IwoLicenseCount *LicenseIwoLicenseCountRelationship `json:"IwoLicenseCount,omitempty" yaml:"IwoLicenseCount,omitempty"`
