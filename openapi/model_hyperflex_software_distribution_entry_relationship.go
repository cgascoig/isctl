...
func (dst *HyperflexSoftwareDistributionEntryRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.SoftwareDistributionEntry":
			var result *HyperflexSoftwareDistributionEntry = &HyperflexSoftwareDistributionEntry{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexSoftwareDistributionEntry = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexSoftwareDistributionEntryRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexSoftwareDistributionEntry != nil {
		return yaml.Marshal(&src.HyperflexSoftwareDistributionEntry)
	}
