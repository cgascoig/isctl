...
func (dst *CapabilityPortGroupAggregationDefResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "capability.PortGroupAggregationDef.List":
			var result *CapabilityPortGroupAggregationDefList = &CapabilityPortGroupAggregationDefList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.CapabilityPortGroupAggregationDefList = result
			return nil
...
func (src *CapabilityPortGroupAggregationDefResponse) MarshalYAML() ([]byte, error) {
	if src.CapabilityPortGroupAggregationDefList != nil {
		return yaml.Marshal(&src.CapabilityPortGroupAggregationDefList)
	}
