...
func (dst *HyperflexHxapHostVswitchResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "hyperflex.HxapHostVswitch.List":
			var result *HyperflexHxapHostVswitchList = &HyperflexHxapHostVswitchList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexHxapHostVswitchList = result
			return nil
...
func (src *HyperflexHxapHostVswitchResponse) MarshalYAML() ([]byte, error) {
	if src.HyperflexHxapHostVswitchList != nil {
		return yaml.Marshal(&src.HyperflexHxapHostVswitchList)
	}
