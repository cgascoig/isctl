...
func (dst *IamResourceRolesResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iam.ResourceRoles.List":
			var result *IamResourceRolesList = &IamResourceRolesList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamResourceRolesList = result
			return nil
...
func (src *IamResourceRolesResponse) MarshalYAML() ([]byte, error) {
	if src.IamResourceRolesList != nil {
		return yaml.Marshal(&src.IamResourceRolesList)
	}
