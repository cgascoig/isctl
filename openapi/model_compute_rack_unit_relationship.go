...
func (dst *ComputeRackUnitRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "compute.RackUnit":
			var result *ComputeRackUnit = &ComputeRackUnit{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ComputeRackUnit = result
			return nil
		case "mo.MoRef":
...
func (src *ComputeRackUnitRelationship) MarshalYAML() ([]byte, error) {
	if src.ComputeRackUnit != nil {
		return yaml.Marshal(&src.ComputeRackUnit)
	}
