...
func (dst *EquipmentRackEnclosureResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "equipment.RackEnclosure.List":
			var result *EquipmentRackEnclosureList = &EquipmentRackEnclosureList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentRackEnclosureList = result
			return nil
...
func (src *EquipmentRackEnclosureResponse) MarshalYAML() ([]byte, error) {
	if src.EquipmentRackEnclosureList != nil {
		return yaml.Marshal(&src.EquipmentRackEnclosureList)
	}
