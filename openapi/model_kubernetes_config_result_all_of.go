...
type KubernetesConfigResultAllOf struct {
	...
	Profile    *KubernetesNodeProfileRelationship `json:"Profile,omitempty" yaml:"Profile,omitempty"`
	// An array of relationships to kubernetesConfigResultEntry resources.
	ResultEntries []KubernetesConfigResultEntryRelationship `json:"ResultEntries,omitempty" yaml:"ResultEntries,omitempty"`
}
