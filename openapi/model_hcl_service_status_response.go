...
func (dst *HclServiceStatusResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "hcl.ServiceStatus.List":
			var result *HclServiceStatusList = &HclServiceStatusList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HclServiceStatusList = result
			return nil
...
func (src *HclServiceStatusResponse) MarshalYAML() ([]byte, error) {
	if src.HclServiceStatusList != nil {
		return yaml.Marshal(&src.HclServiceStatusList)
	}
