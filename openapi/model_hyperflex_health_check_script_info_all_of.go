...
type HyperflexHealthCheckScriptInfoAllOf struct {
	...
	AggregateScriptName *string `json:"AggregateScriptName,omitempty" yaml:"AggregateScriptName,omitempty"`
	// HyperFlex Data Platform version running on the target device.
	HyperflexVersion *string `json:"HyperflexVersion,omitempty" yaml:"HyperflexVersion,omitempty"`
	// Location of the health check script's execution on the HyperFlex device.
	ScriptExecuteLocation *string `json:"ScriptExecuteLocation,omitempty" yaml:"ScriptExecuteLocation,omitempty"`
	// Input for the health check script execution.
	ScriptInput *string `json:"ScriptInput,omitempty" yaml:"ScriptInput,omitempty"`
	// Name of the health check script to be executed.
	ScriptName *string `json:"ScriptName,omitempty" yaml:"ScriptName,omitempty"`
