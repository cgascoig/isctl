...
type AdapterAdapterConfigAllOf struct {
	...
	DceInterfaceSettings []AdapterDceInterfaceSettings      `json:"DceInterfaceSettings,omitempty" yaml:"DceInterfaceSettings,omitempty"`
	EthSettings          NullableAdapterEthSettings         `json:"EthSettings,omitempty" yaml:"EthSettings,omitempty"`
	FcSettings           NullableAdapterFcSettings          `json:"FcSettings,omitempty" yaml:"FcSettings,omitempty"`
	PortChannelSettings  NullableAdapterPortChannelSettings `json:"PortChannelSettings,omitempty" yaml:"PortChannelSettings,omitempty"`
