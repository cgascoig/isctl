...
type AdapterAdapterConfigAllOf struct {
	...
	EthSettings          *AdapterEthSettings            `json:"EthSettings,omitempty" yaml:"EthSettings,omitempty"`
	FcSettings           *AdapterFcSettings             `json:"FcSettings,omitempty" yaml:"FcSettings,omitempty"`
	PortChannelSettings  *AdapterPortChannelSettings    `json:"PortChannelSettings,omitempty" yaml:"PortChannelSettings,omitempty"`
