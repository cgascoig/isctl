...
func (dst *IamCertificateRequestRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "iam.CertificateRequest":
			var result *IamCertificateRequest = &IamCertificateRequest{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamCertificateRequest = result
			return nil
		case "mo.MoRef":
...
func (src *IamCertificateRequestRelationship) MarshalYAML() ([]byte, error) {
	if src.IamCertificateRequest != nil {
		return yaml.Marshal(&src.IamCertificateRequest)
	}
