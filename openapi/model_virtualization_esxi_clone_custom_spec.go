...
type VirtualizationEsxiCloneCustomSpec struct {
	VirtualizationBaseCustomSpec `yaml:"VirtualizationBaseCustomSpec,inline"`
	...
	ExtraConfig interface{} `json:"ExtraConfig,omitempty" yaml:"ExtraConfig,omitempty"`
	// Specify the OVA Environment specification which can be configured on virtual machine.
	OvaEnvSpec interface{} `json:"OvaEnvSpec,omitempty" yaml:"OvaEnvSpec,omitempty"`
}
