...
func (dst *FabricPortModeResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "fabric.PortMode.List":
			var result *FabricPortModeList = &FabricPortModeList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FabricPortModeList = result
			return nil
...
func (src *FabricPortModeResponse) MarshalYAML() ([]byte, error) {
	if src.FabricPortModeList != nil {
		return yaml.Marshal(&src.FabricPortModeList)
	}
