...
func (dst *TechsupportmanagementTechSupportBundleRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "mo.MoRef":
			...
			dst.MoMoRef = result
			return nil
		case "techsupportmanagement.TechSupportBundle":
			var result *TechsupportmanagementTechSupportBundle = &TechsupportmanagementTechSupportBundle{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.TechsupportmanagementTechSupportBundle = result
			return nil
		default:
...
func (src *TechsupportmanagementTechSupportBundleRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.TechsupportmanagementTechSupportBundle != nil {
		return yaml.Marshal(&src.TechsupportmanagementTechSupportBundle)
	}
