...
type HyperflexHxapDvUplink struct {
	VirtualizationBaseNetwork `yaml:"VirtualizationBaseNetwork,inline"`
	// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
	ClassId string `json:"ClassId" yaml:"ClassId"`
	// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
	ObjectType    string                     `json:"ObjectType" yaml:"ObjectType"`
	BondState     NullableHyperflexBondState `json:"BondState,omitempty" yaml:"BondState,omitempty"`
	NetInterfaces []string                   `json:"NetInterfaces,omitempty" yaml:"NetInterfaces,omitempty"`
	...
	MemberHosts []HyperflexHxapHostRelationship `json:"MemberHosts,omitempty" yaml:"MemberHosts,omitempty"`
	// An array of relationships to hyperflexHxapHostInterface resources.
	MemberUplinks []HyperflexHxapHostInterfaceRelationship `json:"MemberUplinks,omitempty" yaml:"MemberUplinks,omitempty"`
}
