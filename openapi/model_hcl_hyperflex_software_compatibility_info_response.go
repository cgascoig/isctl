...
func (dst *HclHyperflexSoftwareCompatibilityInfoResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "hcl.HyperflexSoftwareCompatibilityInfo.List":
			var result *HclHyperflexSoftwareCompatibilityInfoList = &HclHyperflexSoftwareCompatibilityInfoList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HclHyperflexSoftwareCompatibilityInfoList = result
			return nil
...
func (src *HclHyperflexSoftwareCompatibilityInfoResponse) MarshalYAML() ([]byte, error) {
	if src.HclHyperflexSoftwareCompatibilityInfoList != nil {
		return yaml.Marshal(&src.HclHyperflexSoftwareCompatibilityInfoList)
	}
