...
func (dst *SoftwarerepositoryCategorySupportConstraintResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		...
		case "mo.TagSummary":
			...
			return nil
		case "softwarerepository.CategorySupportConstraint.List":
			var result *SoftwarerepositoryCategorySupportConstraintList = &SoftwarerepositoryCategorySupportConstraintList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.SoftwarerepositoryCategorySupportConstraintList = result
			return nil
		default:
...
func (src *SoftwarerepositoryCategorySupportConstraintResponse) MarshalYAML() ([]byte, error) {
	if src.MoAggregateTransform != nil {
	...
	if src.SoftwarerepositoryCategorySupportConstraintList != nil {
		return yaml.Marshal(&src.SoftwarerepositoryCategorySupportConstraintList)
	}
