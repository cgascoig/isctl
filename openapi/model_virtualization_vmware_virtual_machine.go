...
type VirtualizationVmwareVirtualMachine struct {
	VirtualizationBaseVirtualMachine `yaml:"VirtualizationBaseVirtualMachine,inline"`
	...
	CpuShares        NullableVirtualizationVmwareVmCpuShareInfo  `json:"CpuShares,omitempty" yaml:"CpuShares,omitempty"`
	CpuSocketInfo    NullableVirtualizationVmwareVmCpuSocketInfo `json:"CpuSocketInfo,omitempty" yaml:"CpuSocketInfo,omitempty"`
	...
	DiskCommitInfo NullableVirtualizationVmwareVmDiskCommitInfo `json:"DiskCommitInfo,omitempty" yaml:"DiskCommitInfo,omitempty"`
	...
	MemShares  NullableVirtualizationVmwareVmMemoryShareInfo `json:"MemShares,omitempty" yaml:"MemShares,omitempty"`
	...
	RemoteDisplayInfo NullableVirtualizationVmwareRemoteDisplayInfo `json:"RemoteDisplayInfo,omitempty" yaml:"RemoteDisplayInfo,omitempty"`
	...
	ResourcePoolOwner *string `json:"ResourcePoolOwner,omitempty" yaml:"ResourcePoolOwner,omitempty"`
	// The parent of the current resource pool to which this VM belongs.
	ResourcePoolParent *string `json:"ResourcePoolParent,omitempty" yaml:"ResourcePoolParent,omitempty"`
	// Indicates if guest tools are running on this VM. Could be set to guestToolNotRunning or guestToolsRunning.
	ToolRunningStatus *string `json:"ToolRunningStatus,omitempty" yaml:"ToolRunningStatus,omitempty"`
	// The version of the guest tools, usually not specified.
	ToolsVersion *string `json:"ToolsVersion,omitempty" yaml:"ToolsVersion,omitempty"`
	VirtualDisks []int64 `json:"VirtualDisks,omitempty" yaml:"VirtualDisks,omitempty"`
	// Shows the number of disks assigned to this VM.
	VmDiskCount *int64 `json:"VmDiskCount,omitempty" yaml:"VmDiskCount,omitempty"`
	// The operational state of the VM. Could be Available, Provisioned, Maintenance mode, Deleting, etc.
	VmOverallStatus *string `json:"VmOverallStatus,omitempty" yaml:"VmOverallStatus,omitempty"`
	// Path to the vmx file of the VM. Example - [datastore3] VCSA-134/VCSA-134.vmx.
	VmPath *string `json:"VmPath,omitempty" yaml:"VmPath,omitempty"`
	...
	VmVnicCount *int64 `json:"VmVnicCount,omitempty" yaml:"VmVnicCount,omitempty"`
	// Information related to the guest info's VNIC virtual device. It is a comma-separated list.
	VnicDeviceConfigId *string                                     `json:"VnicDeviceConfigId,omitempty" yaml:"VnicDeviceConfigId,omitempty"`
	...
	ParentFolder *VirtualizationVmwareFolderRelationship     `json:"ParentFolder,omitempty" yaml:"ParentFolder,omitempty"`
}
