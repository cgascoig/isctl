...
type NiatelemetryMsoSiteDetails struct {
	...
	IsCloudSecEnabled *string `json:"IsCloudSecEnabled,omitempty" yaml:"IsCloudSecEnabled,omitempty"`
	// Number of leafs per site in Multi-Site Orchestrator.
	NumberOfLeafsPerSiteInMso *int64 `json:"NumberOfLeafsPerSiteInMso,omitempty" yaml:"NumberOfLeafsPerSiteInMso,omitempty"`
	// Number of pods per site in Multi-Site Orchestrator.
	NumberOfPodsPerSiteInMso *int64 `json:"NumberOfPodsPerSiteInMso,omitempty" yaml:"NumberOfPodsPerSiteInMso,omitempty"`
	// Number of spines per site in Multi-Site Orchestrator.
	NumberOfSpinesPerSiteInMso *int64 `json:"NumberOfSpinesPerSiteInMso,omitempty" yaml:"NumberOfSpinesPerSiteInMso,omitempty"`
	...
	SiteVersion      *string                              `json:"SiteVersion,omitempty" yaml:"SiteVersion,omitempty"`
