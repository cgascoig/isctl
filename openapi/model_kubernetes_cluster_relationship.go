...
func (dst *KubernetesClusterRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "kubernetes.Cluster":
			var result *KubernetesCluster = &KubernetesCluster{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesCluster = result
			return nil
		case "mo.MoRef":
...
func (src *KubernetesClusterRelationship) MarshalYAML() ([]byte, error) {
	if src.KubernetesCluster != nil {
		return yaml.Marshal(&src.KubernetesCluster)
	}
