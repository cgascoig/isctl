...
func (dst *ConnectorpackConnectorPackUpgradeResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "connectorpack.ConnectorPackUpgrade.List":
			var result *ConnectorpackConnectorPackUpgradeList = &ConnectorpackConnectorPackUpgradeList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ConnectorpackConnectorPackUpgradeList = result
			return nil
...
func (src *ConnectorpackConnectorPackUpgradeResponse) MarshalYAML() ([]byte, error) {
	if src.ConnectorpackConnectorPackUpgradeList != nil {
		return yaml.Marshal(&src.ConnectorpackConnectorPackUpgradeList)
	}
