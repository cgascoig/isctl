...
type StorageBaseHostAllOf struct {
	...
	Initiators  []StorageBaseInitiator `json:"Initiators,omitempty" yaml:"Initiators,omitempty"`
	// Name of the host in storage array.
	Name *string `json:"Name,omitempty" yaml:"Name,omitempty"`
	// Operating system running on the host.
	OsType             *string                     `json:"OsType,omitempty" yaml:"OsType,omitempty"`
	StorageUtilization NullableStorageBaseCapacity `json:"StorageUtilization,omitempty" yaml:"StorageUtilization,omitempty"`
}
