...
type ResourceSourceToPermissionResourcesAllOf struct {
	...
	PermissionResources []MoMoRef `json:"PermissionResources,omitempty" yaml:"PermissionResources,omitempty"`
	SourceObject        *MoMoRef  `json:"SourceObject,omitempty" yaml:"SourceObject,omitempty"`
}
