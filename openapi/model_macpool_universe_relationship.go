...
func (dst *MacpoolUniverseRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "macpool.Universe":
			var result *MacpoolUniverse = &MacpoolUniverse{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.MacpoolUniverse = result
			return nil
		case "mo.MoRef":
...
func (src *MacpoolUniverseRelationship) MarshalYAML() ([]byte, error) {
	if src.MacpoolUniverse != nil {
		return yaml.Marshal(&src.MacpoolUniverse)
	}
