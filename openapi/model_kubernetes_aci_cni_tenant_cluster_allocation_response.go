...
func (dst *KubernetesAciCniTenantClusterAllocationResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "kubernetes.AciCniTenantClusterAllocation.List":
			var result *KubernetesAciCniTenantClusterAllocationList = &KubernetesAciCniTenantClusterAllocationList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesAciCniTenantClusterAllocationList = result
			return nil
...
func (src *KubernetesAciCniTenantClusterAllocationResponse) MarshalYAML() ([]byte, error) {
	if src.KubernetesAciCniTenantClusterAllocationList != nil {
		return yaml.Marshal(&src.KubernetesAciCniTenantClusterAllocationList)
	}
