...
type StorageHitachiArray struct {
	...
	Ctl1Ip *string `json:"Ctl1Ip,omitempty" yaml:"Ctl1Ip,omitempty"`
	// GUM (Gateway for Unified Management) version of the controller 1.
	Ctl1MicroVersion *string `json:"Ctl1MicroVersion,omitempty" yaml:"Ctl1MicroVersion,omitempty"`
	// IP address of controller 2 of the storage system.
	Ctl2Ip *string `json:"Ctl2Ip,omitempty" yaml:"Ctl2Ip,omitempty"`
	// GUM (Gateway for Unified Management) version of the controller 2.
	Ctl2MicroVersion *string `json:"Ctl2MicroVersion,omitempty" yaml:"Ctl2MicroVersion,omitempty"`
	// Storage device ID.
	DeviceId *string `json:"DeviceId,omitempty" yaml:"DeviceId,omitempty"`
	// IP address of the SVP.
	SvpIp *string `json:"SvpIp,omitempty" yaml:"SvpIp,omitempty"`
	// Controller operated by the REST API.
	TargetCtl        *string                              `json:"TargetCtl,omitempty" yaml:"TargetCtl,omitempty"`
