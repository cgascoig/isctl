...
type CloudSkuInstanceType struct {
	...
	ArchitectureType *string `json:"ArchitectureType,omitempty" yaml:"ArchitectureType,omitempty"`
	...
	CpuUnit *string `json:"CpuUnit,omitempty" yaml:"CpuUnit,omitempty"`
	// Does the instanceType support CUDA architecture.
	CudaSupport *bool `json:"CudaSupport,omitempty" yaml:"CudaSupport,omitempty"`
	// Total size of local storage for this instance type.
	LocalStorageSize *float32 `json:"LocalStorageSize,omitempty" yaml:"LocalStorageSize,omitempty"`
	...
	LocalStorageSizeUnit *string `json:"LocalStorageSizeUnit,omitempty" yaml:"LocalStorageSizeUnit,omitempty"`
	// The RAM size for this instance type.
	MemorySize *float32 `json:"MemorySize,omitempty" yaml:"MemorySize,omitempty"`
	...
	MemorySizeUnit *string `json:"MemorySizeUnit,omitempty" yaml:"MemorySizeUnit,omitempty"`
	// Network performance of this instance type.
	NetworkPerformance *string `json:"NetworkPerformance,omitempty" yaml:"NetworkPerformance,omitempty"`
	// The number of CPUs in this instance type.
	NumOfCpus *int64 `json:"NumOfCpus,omitempty" yaml:"NumOfCpus,omitempty"`
	// Maximum number of NICs supported by this instance type.
	NumOfNics *int64 `json:"NumOfNics,omitempty" yaml:"NumOfNics,omitempty"`
}
