...
type HyperflexHxapEventAllOf struct {
	...
	FirstTime *string `json:"FirstTime,omitempty" yaml:"FirstTime,omitempty"`
	// Internally generated identity (UUID) of this event.
	Identity *string `json:"Identity,omitempty" yaml:"Identity,omitempty"`
	// Last timestamp of the event occurrence.
	LastTime *string `json:"LastTime,omitempty" yaml:"LastTime,omitempty"`
	...
	OwnerUuid *string `json:"OwnerUuid,omitempty" yaml:"OwnerUuid,omitempty"`
