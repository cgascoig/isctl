...
func (dst *FabricConfigResultRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "fabric.ConfigResult":
			var result *FabricConfigResult = &FabricConfigResult{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FabricConfigResult = result
			return nil
		case "mo.MoRef":
...
func (src *FabricConfigResultRelationship) MarshalYAML() ([]byte, error) {
	if src.FabricConfigResult != nil {
		return yaml.Marshal(&src.FabricConfigResult)
	}
