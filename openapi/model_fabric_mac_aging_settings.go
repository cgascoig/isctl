...
type FabricMacAgingSettings struct {
	...
	MacAgingOption *string `json:"MacAgingOption,omitempty" yaml:"MacAgingOption,omitempty"`
	// Define the MAC address aging time in seconds. This field is valid when the \"Custom\" MAC address aging option is selected.
	MacAgingTime *int32 `json:"MacAgingTime,omitempty" yaml:"MacAgingTime,omitempty"`
}
