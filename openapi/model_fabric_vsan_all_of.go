...
type FabricVsanAllOf struct {
	...
	DefaultZoning *string `json:"DefaultZoning,omitempty" yaml:"DefaultZoning,omitempty"`
	// Logical grouping mode for fc ports.
	FcZoneSharingMode *string `json:"FcZoneSharingMode,omitempty" yaml:"FcZoneSharingMode,omitempty"`
	// FCOE Vlan associated to the VSAN configuration.
	FcoeVlan *int64 `json:"FcoeVlan,omitempty" yaml:"FcoeVlan,omitempty"`
	...
	FcNetworkPolicy *FabricFcNetworkPolicyRelationship `json:"FcNetworkPolicy,omitempty" yaml:"FcNetworkPolicy,omitempty"`
}
