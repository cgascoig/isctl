...
type VnicFcIf struct {
	...
	StaticWwpnAddress *string `json:"StaticWwpnAddress,omitempty" yaml:"StaticWwpnAddress,omitempty"`
	...
	WwpnAddressType       *string                                  `json:"WwpnAddressType,omitempty" yaml:"WwpnAddressType,omitempty"`
