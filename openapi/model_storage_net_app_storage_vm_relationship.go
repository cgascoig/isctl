...
func (dst *StorageNetAppStorageVmRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "mo.MoRef":
			...
			dst.MoMoRef = result
			return nil
		case "storage.NetAppStorageVm":
			var result *StorageNetAppStorageVm = &StorageNetAppStorageVm{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.StorageNetAppStorageVm = result
			return nil
		default:
...
func (src *StorageNetAppStorageVmRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.StorageNetAppStorageVm != nil {
		return yaml.Marshal(&src.StorageNetAppStorageVm)
	}
