...
func (dst *AssetDeviceRegistrationRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "asset.DeviceRegistration":
			var result *AssetDeviceRegistration = &AssetDeviceRegistration{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.AssetDeviceRegistration = result
			return nil
		case "mo.MoRef":
...
func (src *AssetDeviceRegistrationRelationship) MarshalYAML() ([]byte, error) {
	if src.AssetDeviceRegistration != nil {
		return yaml.Marshal(&src.AssetDeviceRegistration)
	}
