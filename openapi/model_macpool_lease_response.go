...
func (dst *MacpoolLeaseResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "macpool.Lease.List":
			var result *MacpoolLeaseList = &MacpoolLeaseList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.MacpoolLeaseList = result
			return nil
...
func (src *MacpoolLeaseResponse) MarshalYAML() ([]byte, error) {
	if src.MacpoolLeaseList != nil {
		return yaml.Marshal(&src.MacpoolLeaseList)
	}
