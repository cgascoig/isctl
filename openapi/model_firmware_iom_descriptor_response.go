...
func (dst *FirmwareIomDescriptorResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "firmware.IomDescriptor.List":
			var result *FirmwareIomDescriptorList = &FirmwareIomDescriptorList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FirmwareIomDescriptorList = result
			return nil
...
func (src *FirmwareIomDescriptorResponse) MarshalYAML() ([]byte, error) {
	if src.FirmwareIomDescriptorList != nil {
		return yaml.Marshal(&src.FirmwareIomDescriptorList)
	}
