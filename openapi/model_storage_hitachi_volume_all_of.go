...
type StorageHitachiVolumeAllOf struct {
	...
	ClprId *int64 `json:"ClprId,omitempty" yaml:"ClprId,omitempty"`
	...
	DataReductionMode *string `json:"DataReductionMode,omitempty" yaml:"DataReductionMode,omitempty"`
	...
	DataReductionStatus *string `json:"DataReductionStatus,omitempty" yaml:"DataReductionStatus,omitempty"`
	...
	EmulationType *string `json:"EmulationType,omitempty" yaml:"EmulationType,omitempty"`
	// Whether pages are reserved by the FullAllocation functionality.
	IsFullAllocationEnabled *bool `json:"IsFullAllocationEnabled,omitempty" yaml:"IsFullAllocationEnabled,omitempty"`
	// Label of the volume, as configured in the storage array.
	Label *string `json:"Label,omitempty" yaml:"Label,omitempty"`
	// Number of paths set for the volume.
	NumOfPaths     *int64   `json:"NumOfPaths,omitempty" yaml:"NumOfPaths,omitempty"`
	ParityGroupIds []string `json:"ParityGroupIds,omitempty" yaml:"ParityGroupIds,omitempty"`
	// ID of the pool with which the volume is associated.
	PoolId *string `json:"PoolId,omitempty" yaml:"PoolId,omitempty"`
	...
	RaidType *string `json:"RaidType,omitempty" yaml:"RaidType,omitempty"`
	...
	ParityGroups     []StorageHitachiParityGroupRelationship `json:"ParityGroups,omitempty" yaml:"ParityGroups,omitempty"`
	Pool             *StorageHitachiPoolRelationship         `json:"Pool,omitempty" yaml:"Pool,omitempty"`
