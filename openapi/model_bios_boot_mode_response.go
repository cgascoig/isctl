...
func (dst *BiosBootModeResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "bios.BootMode.List":
			var result *BiosBootModeList = &BiosBootModeList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.BiosBootModeList = result
			return nil
...
func (src *BiosBootModeResponse) MarshalYAML() ([]byte, error) {
	if src.BiosBootModeList != nil {
		return yaml.Marshal(&src.BiosBootModeList)
	}
