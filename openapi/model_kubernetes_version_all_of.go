...
type KubernetesVersionAllOf struct {
	...
	BootIso                     *SoftwareSolutionDistributableRelationship `json:"BootIso,omitempty" yaml:"BootIso,omitempty"`
	Catalog                     *KubernetesCatalogRelationship             `json:"Catalog,omitempty" yaml:"Catalog,omitempty"`
	OvaImageTemplate            *SoftwareSolutionDistributableRelationship `json:"OvaImageTemplate,omitempty" yaml:"OvaImageTemplate,omitempty"`
	Qcow2NodeTemplate           *SoftwareSolutionDistributableRelationship `json:"Qcow2NodeTemplate,omitempty" yaml:"Qcow2NodeTemplate,omitempty"`
	Qcow2VirtualMachineTemplate *SoftwareSolutionDistributableRelationship `json:"Qcow2VirtualMachineTemplate,omitempty" yaml:"Qcow2VirtualMachineTemplate,omitempty"`
}
