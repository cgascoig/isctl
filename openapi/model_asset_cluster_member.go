...
type AssetClusterMember struct {
	AssetDeviceConnection `yaml:"AssetDeviceConnection,inline"`
	...
	LockedLeader *bool `json:"LockedLeader,omitempty" yaml:"LockedLeader,omitempty"`
	...
	MemberIdentity *string `json:"MemberIdentity,omitempty" yaml:"MemberIdentity,omitempty"`
	// The member idenity of the cluster member through which this device is connected if applicable.
	ParentClusterMemberIdentity *string                              `json:"ParentClusterMemberIdentity,omitempty" yaml:"ParentClusterMemberIdentity,omitempty"`
	Sudi                        NullableAssetSudiInfo                `json:"Sudi,omitempty" yaml:"Sudi,omitempty"`
