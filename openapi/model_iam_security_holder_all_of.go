...
type IamSecurityHolderAllOf struct {
	...
	IpRulesConfiguration *IamIpAccessManagementRelationship `json:"IpRulesConfiguration,omitempty" yaml:"IpRulesConfiguration,omitempty"`
	// An array of relationships to iamResourcePermission resources.
	ResourcePermissions []IamResourcePermissionRelationship `json:"ResourcePermissions,omitempty" yaml:"ResourcePermissions,omitempty"`
}
