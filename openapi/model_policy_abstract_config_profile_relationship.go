...
func (dst *PolicyAbstractConfigProfileRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "mo.MoRef":
			...
			dst.MoMoRef = result
			return nil
		case "policy.AbstractConfigProfile":
			var result *PolicyAbstractConfigProfile = &PolicyAbstractConfigProfile{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.PolicyAbstractConfigProfile = result
			return nil
		default:
...
func (src *PolicyAbstractConfigProfileRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.PolicyAbstractConfigProfile != nil {
		return yaml.Marshal(&src.PolicyAbstractConfigProfile)
	}
