...
func (dst *MacpoolPoolMemberResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "macpool.PoolMember.List":
			var result *MacpoolPoolMemberList = &MacpoolPoolMemberList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.MacpoolPoolMemberList = result
			return nil
...
func (src *MacpoolPoolMemberResponse) MarshalYAML() ([]byte, error) {
	if src.MacpoolPoolMemberList != nil {
		return yaml.Marshal(&src.MacpoolPoolMemberList)
	}
