...
type ApplianceAppStatusAllOf struct {
	...
	ApiStatuses []ApplianceApiStatus `json:"ApiStatuses,omitempty" yaml:"ApiStatuses,omitempty"`
	// Unique label to identify the application.
	AppLabel *string `json:"AppLabel,omitempty" yaml:"AppLabel,omitempty"`
	...
	ReadyCount *int64 `json:"ReadyCount,omitempty" yaml:"ReadyCount,omitempty"`
	...
	RestartCount1Hour *int64 `json:"RestartCount1Hour,omitempty" yaml:"RestartCount1Hour,omitempty"`
	// Number of instance restarts in the last 24 hours.
	RestartCount24Hours *int64 `json:"RestartCount24Hours,omitempty" yaml:"RestartCount24Hours,omitempty"`
	// Number of instance restarts in the last 5 minutes.
	RestartCount5Mins *int64 `json:"RestartCount5Mins,omitempty" yaml:"RestartCount5Mins,omitempty"`
	// Total number of restarts since last deployment.
	RestartCountTotal *int64 `json:"RestartCountTotal,omitempty" yaml:"RestartCountTotal,omitempty"`
	// Number of replicas running. The number of instances of the application currently running.
	RunningCount *int64                             `json:"RunningCount,omitempty" yaml:"RunningCount,omitempty"`
	StatusChecks []ApplianceStatusCheck             `json:"StatusChecks,omitempty" yaml:"StatusChecks,omitempty"`
	GroupStatus  *ApplianceGroupStatusRelationship  `json:"GroupStatus,omitempty" yaml:"GroupStatus,omitempty"`
	SystemStatus *ApplianceSystemStatusRelationship `json:"SystemStatus,omitempty" yaml:"SystemStatus,omitempty"`
}
