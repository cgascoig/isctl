...
func (dst *HyperflexConfigResultResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "hyperflex.ConfigResult.List":
			var result *HyperflexConfigResultList = &HyperflexConfigResultList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexConfigResultList = result
			return nil
...
func (src *HyperflexConfigResultResponse) MarshalYAML() ([]byte, error) {
	if src.HyperflexConfigResultList != nil {
		return yaml.Marshal(&src.HyperflexConfigResultList)
	}
