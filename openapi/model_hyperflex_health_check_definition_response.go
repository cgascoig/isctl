...
func (dst *HyperflexHealthCheckDefinitionResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "hyperflex.HealthCheckDefinition.List":
			var result *HyperflexHealthCheckDefinitionList = &HyperflexHealthCheckDefinitionList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexHealthCheckDefinitionList = result
			return nil
...
func (src *HyperflexHealthCheckDefinitionResponse) MarshalYAML() ([]byte, error) {
	if src.HyperflexHealthCheckDefinitionList != nil {
		return yaml.Marshal(&src.HyperflexHealthCheckDefinitionList)
	}
