...
func (dst *IaasServiceRequestResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iaas.ServiceRequest.List":
			var result *IaasServiceRequestList = &IaasServiceRequestList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IaasServiceRequestList = result
			return nil
...
func (src *IaasServiceRequestResponse) MarshalYAML() ([]byte, error) {
	if src.IaasServiceRequestList != nil {
		return yaml.Marshal(&src.IaasServiceRequestList)
	}
