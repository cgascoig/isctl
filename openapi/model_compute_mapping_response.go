...
func (dst *ComputeMappingResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "compute.Mapping.List":
			var result *ComputeMappingList = &ComputeMappingList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ComputeMappingList = result
			return nil
...
func (src *ComputeMappingResponse) MarshalYAML() ([]byte, error) {
	if src.ComputeMappingList != nil {
		return yaml.Marshal(&src.ComputeMappingList)
	}
