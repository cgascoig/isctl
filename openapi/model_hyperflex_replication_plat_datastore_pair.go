...
type HyperflexReplicationPlatDatastorePair struct {
	...
	Ads        NullableHyperflexReplicationPlatDatastore `json:"Ads,omitempty" yaml:"Ads,omitempty"`
	// Boolean representing if this is a backup only pair.
	BackupOnly *bool                                     `json:"BackupOnly,omitempty" yaml:"BackupOnly,omitempty"`
	Bds        NullableHyperflexReplicationPlatDatastore `json:"Bds,omitempty" yaml:"Bds,omitempty"`
	...
	ReplicationIntervalInMinutes *int64                                    `json:"ReplicationIntervalInMinutes,omitempty" yaml:"ReplicationIntervalInMinutes,omitempty"`
	Sourceds                     NullableHyperflexReplicationPlatDatastore `json:"Sourceds,omitempty" yaml:"Sourceds,omitempty"`
	// HyperFlex datastore pair is used for storage only.
	StorageOnly *bool `json:"StorageOnly,omitempty" yaml:"StorageOnly,omitempty"`
}
