...
func (dst *FirmwareRunningFirmwareRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "firmware.RunningFirmware":
			var result *FirmwareRunningFirmware = &FirmwareRunningFirmware{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FirmwareRunningFirmware = result
			return nil
		case "mo.MoRef":
...
func (src *FirmwareRunningFirmwareRelationship) MarshalYAML() ([]byte, error) {
	if src.FirmwareRunningFirmware != nil {
		return yaml.Marshal(&src.FirmwareRunningFirmware)
	}
