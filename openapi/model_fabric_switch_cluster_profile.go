...
type FabricSwitchClusterProfile struct {
	...
	ConfigContext NullablePolicyConfigContext `json:"ConfigContext,omitempty" yaml:"ConfigContext,omitempty"`
	// Number of switch profiles that are part of this cluster profile.
	SwitchProfilesCount *int64                                `json:"SwitchProfilesCount,omitempty" yaml:"SwitchProfilesCount,omitempty"`
	...
	SwitchProfiles []FabricSwitchProfileRelationship `json:"SwitchProfiles,omitempty" yaml:"SwitchProfiles,omitempty"`
}
