...
type RecoveryScheduleConfigPolicy struct {
	...
	Schedule   NullableRecoveryBackupSchedule `json:"Schedule,omitempty" yaml:"Schedule,omitempty"`
	// An array of relationships to recoveryBackupProfile resources.
	BackupProfiles []RecoveryBackupProfileRelationship   `json:"BackupProfiles,omitempty" yaml:"BackupProfiles,omitempty"`
