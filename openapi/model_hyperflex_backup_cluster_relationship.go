...
func (dst *HyperflexBackupClusterRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.BackupCluster":
			var result *HyperflexBackupCluster = &HyperflexBackupCluster{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexBackupCluster = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexBackupClusterRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexBackupCluster != nil {
		return yaml.Marshal(&src.HyperflexBackupCluster)
	}
