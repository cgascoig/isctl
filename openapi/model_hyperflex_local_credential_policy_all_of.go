...
type HyperflexLocalCredentialPolicyAllOf struct {
	...
	IsHxdpRootPwdSet *bool `json:"IsHxdpRootPwdSet,omitempty" yaml:"IsHxdpRootPwdSet,omitempty"`
	// Indicates whether the value of the 'hypervisorAdminPwd' property has been set.
	IsHypervisorAdminPwdSet *bool `json:"IsHypervisorAdminPwdSet,omitempty" yaml:"IsHypervisorAdminPwdSet,omitempty"`
