...
func (dst *FabricUplinkPcRoleResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "fabric.UplinkPcRole.List":
			var result *FabricUplinkPcRoleList = &FabricUplinkPcRoleList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FabricUplinkPcRoleList = result
			return nil
...
func (src *FabricUplinkPcRoleResponse) MarshalYAML() ([]byte, error) {
	if src.FabricUplinkPcRoleList != nil {
		return yaml.Marshal(&src.FabricUplinkPcRoleList)
	}
