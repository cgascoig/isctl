...
type FabricPortModeAllOf struct {
	...
	CustomMode *string `json:"CustomMode,omitempty" yaml:"CustomMode,omitempty"`
	// Ending range of the Port Identifier.
	PortIdEnd *int64 `json:"PortIdEnd,omitempty" yaml:"PortIdEnd,omitempty"`
	// Starting range of the Port Identifier.
	PortIdStart *int64 `json:"PortIdStart,omitempty" yaml:"PortIdStart,omitempty"`
