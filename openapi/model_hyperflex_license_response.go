...
func (dst *HyperflexLicenseResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "hyperflex.License.List":
			var result *HyperflexLicenseList = &HyperflexLicenseList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexLicenseList = result
			return nil
...
func (src *HyperflexLicenseResponse) MarshalYAML() ([]byte, error) {
	if src.HyperflexLicenseList != nil {
		return yaml.Marshal(&src.HyperflexLicenseList)
	}
