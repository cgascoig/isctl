...
func (dst *KubernetesAddonRepositoryResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "kubernetes.AddonRepository.List":
			var result *KubernetesAddonRepositoryList = &KubernetesAddonRepositoryList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesAddonRepositoryList = result
			return nil
...
func (src *KubernetesAddonRepositoryResponse) MarshalYAML() ([]byte, error) {
	if src.KubernetesAddonRepositoryList != nil {
		return yaml.Marshal(&src.KubernetesAddonRepositoryList)
	}
