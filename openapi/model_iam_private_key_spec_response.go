...
func (dst *IamPrivateKeySpecResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iam.PrivateKeySpec.List":
			var result *IamPrivateKeySpecList = &IamPrivateKeySpecList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamPrivateKeySpecList = result
			return nil
...
func (src *IamPrivateKeySpecResponse) MarshalYAML() ([]byte, error) {
	if src.IamPrivateKeySpecList != nil {
		return yaml.Marshal(&src.IamPrivateKeySpecList)
	}
