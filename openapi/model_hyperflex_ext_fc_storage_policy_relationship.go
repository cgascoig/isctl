...
func (dst *HyperflexExtFcStoragePolicyRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.ExtFcStoragePolicy":
			var result *HyperflexExtFcStoragePolicy = &HyperflexExtFcStoragePolicy{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexExtFcStoragePolicy = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexExtFcStoragePolicyRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexExtFcStoragePolicy != nil {
		return yaml.Marshal(&src.HyperflexExtFcStoragePolicy)
	}
