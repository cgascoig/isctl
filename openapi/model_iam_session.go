...
type IamSession struct {
	...
	AccountPermissions []IamAccountPermissions `json:"AccountPermissions,omitempty" yaml:"AccountPermissions,omitempty"`
	...
	IdleTimeExpiration *time.Time `json:"IdleTimeExpiration,omitempty" yaml:"IdleTimeExpiration,omitempty"`
