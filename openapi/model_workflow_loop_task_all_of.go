...
type WorkflowLoopTaskAllOf struct {
	...
	LoopStartTask *string `json:"LoopStartTask,omitempty" yaml:"LoopStartTask,omitempty"`
	...
	NumberOfBatches *int64 `json:"NumberOfBatches,omitempty" yaml:"NumberOfBatches,omitempty"`
