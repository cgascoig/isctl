...
type MemoryPersistentMemoryConfigResult struct {
	...
	ConfigErrorDesc *string `json:"ConfigErrorDesc,omitempty" yaml:"ConfigErrorDesc,omitempty"`
	// Result of a previously applied Persistent Memory configuration on a server.
	ConfigResult *string `json:"ConfigResult,omitempty" yaml:"ConfigResult,omitempty"`
