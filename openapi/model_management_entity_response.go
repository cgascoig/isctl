...
func (dst *ManagementEntityResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "management.Entity.List":
			var result *ManagementEntityList = &ManagementEntityList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ManagementEntityList = result
			return nil
...
func (src *ManagementEntityResponse) MarshalYAML() ([]byte, error) {
	if src.ManagementEntityList != nil {
		return yaml.Marshal(&src.ManagementEntityList)
	}
