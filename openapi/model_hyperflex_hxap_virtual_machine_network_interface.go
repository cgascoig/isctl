...
type HyperflexHxapVirtualMachineNetworkInterface struct {
	VirtualizationBaseVirtualNetworkInterfaceCard `yaml:"VirtualizationBaseVirtualNetworkInterfaceCard,inline"`
	...
	PrimaryIpAddress *string `json:"PrimaryIpAddress,omitempty" yaml:"PrimaryIpAddress,omitempty"`
	...
	VirtualMachineName *string                                  `json:"VirtualMachineName,omitempty" yaml:"VirtualMachineName,omitempty"`
	Cluster            *HyperflexHxapClusterRelationship        `json:"Cluster,omitempty" yaml:"Cluster,omitempty"`
	Network            *HyperflexHxapNetworkRelationship        `json:"Network,omitempty" yaml:"Network,omitempty"`
	VirtualMachine     *HyperflexHxapVirtualMachineRelationship `json:"VirtualMachine,omitempty" yaml:"VirtualMachine,omitempty"`
}
