...
func (dst *BootUefiShellDeviceRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "boot.UefiShellDevice":
			var result *BootUefiShellDevice = &BootUefiShellDevice{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.BootUefiShellDevice = result
			return nil
		case "mo.MoRef":
...
func (src *BootUefiShellDeviceRelationship) MarshalYAML() ([]byte, error) {
	if src.BootUefiShellDevice != nil {
		return yaml.Marshal(&src.BootUefiShellDevice)
	}
