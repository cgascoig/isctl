...
func (dst *ComputePhysicalRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "compute.Physical":
			var result *ComputePhysical = &ComputePhysical{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ComputePhysical = result
			return nil
		case "mo.MoRef":
...
func (src *ComputePhysicalRelationship) MarshalYAML() ([]byte, error) {
	if src.ComputePhysical != nil {
		return yaml.Marshal(&src.ComputePhysical)
	}
