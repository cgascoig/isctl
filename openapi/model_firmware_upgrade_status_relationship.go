...
func (dst *FirmwareUpgradeStatusRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "firmware.UpgradeStatus":
			var result *FirmwareUpgradeStatus = &FirmwareUpgradeStatus{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FirmwareUpgradeStatus = result
			return nil
		case "mo.MoRef":
...
func (src *FirmwareUpgradeStatusRelationship) MarshalYAML() ([]byte, error) {
	if src.FirmwareUpgradeStatus != nil {
		return yaml.Marshal(&src.FirmwareUpgradeStatus)
	}
