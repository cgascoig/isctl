...
func (dst *StorageFlexFlashControllerPropsResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		...
		case "mo.TagSummary":
			...
			return nil
		case "storage.FlexFlashControllerProps.List":
			var result *StorageFlexFlashControllerPropsList = &StorageFlexFlashControllerPropsList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.StorageFlexFlashControllerPropsList = result
			return nil
		default:
...
func (src *StorageFlexFlashControllerPropsResponse) MarshalYAML() ([]byte, error) {
	if src.MoAggregateTransform != nil {
	...
	if src.StorageFlexFlashControllerPropsList != nil {
		return yaml.Marshal(&src.StorageFlexFlashControllerPropsList)
	}
