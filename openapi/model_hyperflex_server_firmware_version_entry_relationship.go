...
func (dst *HyperflexServerFirmwareVersionEntryRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.ServerFirmwareVersionEntry":
			var result *HyperflexServerFirmwareVersionEntry = &HyperflexServerFirmwareVersionEntry{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexServerFirmwareVersionEntry = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexServerFirmwareVersionEntryRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexServerFirmwareVersionEntry != nil {
		return yaml.Marshal(&src.HyperflexServerFirmwareVersionEntry)
	}
