...
func (dst *CapabilitySiocModuleDescriptorResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "capability.SiocModuleDescriptor.List":
			var result *CapabilitySiocModuleDescriptorList = &CapabilitySiocModuleDescriptorList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.CapabilitySiocModuleDescriptorList = result
			return nil
...
func (src *CapabilitySiocModuleDescriptorResponse) MarshalYAML() ([]byte, error) {
	if src.CapabilitySiocModuleDescriptorList != nil {
		return yaml.Marshal(&src.CapabilitySiocModuleDescriptorList)
	}
