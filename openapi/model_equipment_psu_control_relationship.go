...
func (dst *EquipmentPsuControlRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "equipment.PsuControl":
			var result *EquipmentPsuControl = &EquipmentPsuControl{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentPsuControl = result
			return nil
		case "mo.MoRef":
...
func (src *EquipmentPsuControlRelationship) MarshalYAML() ([]byte, error) {
	if src.EquipmentPsuControl != nil {
		return yaml.Marshal(&src.EquipmentPsuControl)
	}
