...
func (dst *EtherNetworkPortResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "ether.NetworkPort.List":
			var result *EtherNetworkPortList = &EtherNetworkPortList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EtherNetworkPortList = result
			return nil
...
func (src *EtherNetworkPortResponse) MarshalYAML() ([]byte, error) {
	if src.EtherNetworkPortList != nil {
		return yaml.Marshal(&src.EtherNetworkPortList)
	}
