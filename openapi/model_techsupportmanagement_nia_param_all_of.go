...
type TechsupportmanagementNiaParamAllOf struct {
	...
	CollectionLevel *int32 `json:"CollectionLevel,omitempty" yaml:"CollectionLevel,omitempty"`
	...
	ForceFresh    *bool     `json:"ForceFresh,omitempty" yaml:"ForceFresh,omitempty"`
	Pids          *[]string `json:"Pids,omitempty" yaml:"Pids,omitempty"`
	SerialNumbers *[]string `json:"SerialNumbers,omitempty" yaml:"SerialNumbers,omitempty"`
}
