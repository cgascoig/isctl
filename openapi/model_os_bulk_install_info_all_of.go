...
type OsBulkInstallInfoAllOf struct {
	...
	GlobalConfig NullableOsGlobalConfig `json:"GlobalConfig,omitempty" yaml:"GlobalConfig,omitempty"`
	// Indicates whether the value of the 'fileContent' property has been set.
	IsFileContentSet *bool `json:"IsFileContentSet,omitempty" yaml:"IsFileContentSet,omitempty"`
	...
	ServerConfigs     []OsServerConfig                                             `json:"ServerConfigs,omitempty" yaml:"ServerConfigs,omitempty"`
	ValidationInfos   []OsValidationInformation                                    `json:"ValidationInfos,omitempty" yaml:"ValidationInfos,omitempty"`
	ConfigurationFile *OsConfigurationFileRelationship                             `json:"ConfigurationFile,omitempty" yaml:"ConfigurationFile,omitempty"`
	Organization      *OrganizationOrganizationRelationship                        `json:"Organization,omitempty" yaml:"Organization,omitempty"`
	OsImage           *SoftwarerepositoryOperatingSystemFileRelationship           `json:"OsImage,omitempty" yaml:"OsImage,omitempty"`
	ScuImage          *FirmwareServerConfigurationUtilityDistributableRelationship `json:"ScuImage,omitempty" yaml:"ScuImage,omitempty"`
	// An array of relationships to computePhysical resources.
	Servers []ComputePhysicalRelationship `json:"Servers,omitempty" yaml:"Servers,omitempty"`
}
