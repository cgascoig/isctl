...
func (dst *EquipmentLocatorLedRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "equipment.LocatorLed":
			var result *EquipmentLocatorLed = &EquipmentLocatorLed{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentLocatorLed = result
			return nil
		case "mo.MoRef":
...
func (src *EquipmentLocatorLedRelationship) MarshalYAML() ([]byte, error) {
	if src.EquipmentLocatorLed != nil {
		return yaml.Marshal(&src.EquipmentLocatorLed)
	}
