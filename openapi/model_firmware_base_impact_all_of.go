...
type FirmwareBaseImpactAllOf struct {
	...
	ComputationError *string `json:"ComputationError,omitempty" yaml:"ComputationError,omitempty"`
	...
	ComputationStatusDetail *string `json:"ComputationStatusDetail,omitempty" yaml:"ComputationStatusDetail,omitempty"`
	...
	ImpactType *string `json:"ImpactType,omitempty" yaml:"ImpactType,omitempty"`
	// The model details of the component.
	Model *string `json:"Model,omitempty" yaml:"Model,omitempty"`
	// The target firmware version of the component.
	TargetFirmwareVersion *string `json:"TargetFirmwareVersion,omitempty" yaml:"TargetFirmwareVersion,omitempty"`
	...
	VersionImpact *string `json:"VersionImpact,omitempty" yaml:"VersionImpact,omitempty"`
}
