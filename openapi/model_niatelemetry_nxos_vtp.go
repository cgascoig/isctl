...
type NiatelemetryNxosVtp struct {
	...
	OperMode *string `json:"OperMode,omitempty" yaml:"OperMode,omitempty"`
	// Returns the status pruning mode of vtp.
	PruningMode *string `json:"PruningMode,omitempty" yaml:"PruningMode,omitempty"`
	// Returns the running version of vtp.
	RunningVersion *string `json:"RunningVersion,omitempty" yaml:"RunningVersion,omitempty"`
	// Returns the status of trap in vtp.
	TrapEnabled *string `json:"TrapEnabled,omitempty" yaml:"TrapEnabled,omitempty"`
	// Returns the status of v2 mode of vtp.
	V2Mode *string `json:"V2Mode,omitempty" yaml:"V2Mode,omitempty"`
