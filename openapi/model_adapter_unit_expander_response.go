...
func (dst *AdapterUnitExpanderResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "adapter.UnitExpander.List":
			var result *AdapterUnitExpanderList = &AdapterUnitExpanderList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.AdapterUnitExpanderList = result
			return nil
...
func (src *AdapterUnitExpanderResponse) MarshalYAML() ([]byte, error) {
	if src.AdapterUnitExpanderList != nil {
		return yaml.Marshal(&src.AdapterUnitExpanderList)
	}
