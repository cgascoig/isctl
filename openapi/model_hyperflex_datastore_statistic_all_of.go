...
type HyperflexDatastoreStatisticAllOf struct {
	...
	AccessibilitySummary *string `json:"AccessibilitySummary,omitempty" yaml:"AccessibilitySummary,omitempty"`
	...
	DatastoreStatus *string                                      `json:"DatastoreStatus,omitempty" yaml:"DatastoreStatus,omitempty"`
	Dsconfig        NullableHyperflexHxPlatformDatastoreConfigDt `json:"Dsconfig,omitempty" yaml:"Dsconfig,omitempty"`
	// Free capacity of the datastore in bytes.
	FreeCapacityInBytes *int64                         `json:"FreeCapacityInBytes,omitempty" yaml:"FreeCapacityInBytes,omitempty"`
	HostMountStatus     []HyperflexHxHostMountStatusDt `json:"HostMountStatus,omitempty" yaml:"HostMountStatus,omitempty"`
	// Timestamp the datastore object was last accessed.
	LastAccessTime *string `json:"LastAccessTime,omitempty" yaml:"LastAccessTime,omitempty"`
	...
	MountSummary *string `json:"MountSummary,omitempty" yaml:"MountSummary,omitempty"`
	// UUID of the parent datastore object.
	ParentUuid *string                   `json:"ParentUuid,omitempty" yaml:"ParentUuid,omitempty"`
	Site       NullableHyperflexHxSiteDt `json:"Site,omitempty" yaml:"Site,omitempty"`
	// Total capacity of the datastore object.
	TotalCapacityInBytes *int64 `json:"TotalCapacityInBytes,omitempty" yaml:"TotalCapacityInBytes,omitempty"`
	...
	UnsharedUsedBytes *int64 `json:"UnsharedUsedBytes,omitempty" yaml:"UnsharedUsedBytes,omitempty"`
	// UUID for the datastore object.
	Uuid               *string                                  `json:"Uuid,omitempty" yaml:"Uuid,omitempty"`
	DataProtectionPeer *HyperflexDataProtectionPeerRelationship `json:"DataProtectionPeer,omitempty" yaml:"DataProtectionPeer,omitempty"`
}
