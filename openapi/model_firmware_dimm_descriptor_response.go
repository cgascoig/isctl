...
func (dst *FirmwareDimmDescriptorResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "firmware.DimmDescriptor.List":
			var result *FirmwareDimmDescriptorList = &FirmwareDimmDescriptorList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FirmwareDimmDescriptorList = result
			return nil
...
func (src *FirmwareDimmDescriptorResponse) MarshalYAML() ([]byte, error) {
	if src.FirmwareDimmDescriptorList != nil {
		return yaml.Marshal(&src.FirmwareDimmDescriptorList)
	}
