...
func (dst *KubernetesClusterAddonProfileResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "kubernetes.ClusterAddonProfile.List":
			var result *KubernetesClusterAddonProfileList = &KubernetesClusterAddonProfileList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesClusterAddonProfileList = result
			return nil
...
func (src *KubernetesClusterAddonProfileResponse) MarshalYAML() ([]byte, error) {
	if src.KubernetesClusterAddonProfileList != nil {
		return yaml.Marshal(&src.KubernetesClusterAddonProfileList)
	}
