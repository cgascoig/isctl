...
func (dst *IamIpAccessManagementRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "iam.IpAccessManagement":
			var result *IamIpAccessManagement = &IamIpAccessManagement{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamIpAccessManagement = result
			return nil
		case "mo.MoRef":
...
func (src *IamIpAccessManagementRelationship) MarshalYAML() ([]byte, error) {
	if src.IamIpAccessManagement != nil {
		return yaml.Marshal(&src.IamIpAccessManagement)
	}
