...
func (dst *LicenseLicenseInfoResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "license.LicenseInfo.List":
			var result *LicenseLicenseInfoList = &LicenseLicenseInfoList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.LicenseLicenseInfoList = result
			return nil
...
func (src *LicenseLicenseInfoResponse) MarshalYAML() ([]byte, error) {
	if src.LicenseLicenseInfoList != nil {
		return yaml.Marshal(&src.LicenseLicenseInfoList)
	}
