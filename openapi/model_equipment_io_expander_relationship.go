...
func (dst *EquipmentIoExpanderRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "equipment.IoExpander":
			var result *EquipmentIoExpander = &EquipmentIoExpander{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentIoExpander = result
			return nil
		case "mo.MoRef":
...
func (src *EquipmentIoExpanderRelationship) MarshalYAML() ([]byte, error) {
	if src.EquipmentIoExpander != nil {
		return yaml.Marshal(&src.EquipmentIoExpander)
	}
