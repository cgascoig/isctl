...
func (dst *MemoryPersistentMemoryNamespaceRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "memory.PersistentMemoryNamespace":
			var result *MemoryPersistentMemoryNamespace = &MemoryPersistentMemoryNamespace{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.MemoryPersistentMemoryNamespace = result
			return nil
		case "mo.MoRef":
...
func (src *MemoryPersistentMemoryNamespaceRelationship) MarshalYAML() ([]byte, error) {
	if src.MemoryPersistentMemoryNamespace != nil {
		return yaml.Marshal(&src.MemoryPersistentMemoryNamespace)
	}
