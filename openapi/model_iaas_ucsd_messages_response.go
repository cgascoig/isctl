...
func (dst *IaasUcsdMessagesResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iaas.UcsdMessages.List":
			var result *IaasUcsdMessagesList = &IaasUcsdMessagesList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IaasUcsdMessagesList = result
			return nil
...
func (src *IaasUcsdMessagesResponse) MarshalYAML() ([]byte, error) {
	if src.IaasUcsdMessagesList != nil {
		return yaml.Marshal(&src.IaasUcsdMessagesList)
	}
