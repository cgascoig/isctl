...
func (dst *FirmwareUpgradeImpactStatusRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "firmware.UpgradeImpactStatus":
			var result *FirmwareUpgradeImpactStatus = &FirmwareUpgradeImpactStatus{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FirmwareUpgradeImpactStatus = result
			return nil
		case "mo.MoRef":
...
func (src *FirmwareUpgradeImpactStatusRelationship) MarshalYAML() ([]byte, error) {
	if src.FirmwareUpgradeImpactStatus != nil {
		return yaml.Marshal(&src.FirmwareUpgradeImpactStatus)
	}
