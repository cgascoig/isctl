...
type HclConstraintAllOf struct {
	...
	ConstraintName *string `json:"ConstraintName,omitempty" yaml:"ConstraintName,omitempty"`
	// Value of the applicable compatibility constraint. Could either be a string value or a regex.
	ConstraintValue *string `json:"ConstraintValue,omitempty" yaml:"ConstraintValue,omitempty"`
}
