...
func (dst *FabricSwitchControlPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "fabric.SwitchControlPolicy.List":
			var result *FabricSwitchControlPolicyList = &FabricSwitchControlPolicyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FabricSwitchControlPolicyList = result
			return nil
...
func (src *FabricSwitchControlPolicyResponse) MarshalYAML() ([]byte, error) {
	if src.FabricSwitchControlPolicyList != nil {
		return yaml.Marshal(&src.FabricSwitchControlPolicyList)
	}
