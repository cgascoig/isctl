...
func (dst *ManagementInterfaceRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "management.Interface":
			var result *ManagementInterface = &ManagementInterface{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ManagementInterface = result
			return nil
		case "mo.MoRef":
...
func (src *ManagementInterfaceRelationship) MarshalYAML() ([]byte, error) {
	if src.ManagementInterface != nil {
		return yaml.Marshal(&src.ManagementInterface)
	}
