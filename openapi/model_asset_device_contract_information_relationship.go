...
func (dst *AssetDeviceContractInformationRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "asset.DeviceContractInformation":
			var result *AssetDeviceContractInformation = &AssetDeviceContractInformation{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.AssetDeviceContractInformation = result
			return nil
		case "mo.MoRef":
...
func (src *AssetDeviceContractInformationRelationship) MarshalYAML() ([]byte, error) {
	if src.AssetDeviceContractInformation != nil {
		return yaml.Marshal(&src.AssetDeviceContractInformation)
	}
