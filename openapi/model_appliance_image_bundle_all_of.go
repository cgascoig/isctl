...
type ApplianceImageBundleAllOf struct {
	...
	AnsiblePackages []OnpremImagePackage `json:"AnsiblePackages,omitempty" yaml:"AnsiblePackages,omitempty"`
	...
	DcPackages    []OnpremImagePackage `json:"DcPackages,omitempty" yaml:"DcPackages,omitempty"`
	DebugPackages []OnpremImagePackage `json:"DebugPackages,omitempty" yaml:"DebugPackages,omitempty"`
	// Short description of the software upgrade bundle.
	Description      *string              `json:"Description,omitempty" yaml:"Description,omitempty"`
	EndpointPackages []OnpremImagePackage `json:"EndpointPackages,omitempty" yaml:"EndpointPackages,omitempty"`
	...
	HasError      *bool                `json:"HasError,omitempty" yaml:"HasError,omitempty"`
	InfraPackages []OnpremImagePackage `json:"InfraPackages,omitempty" yaml:"InfraPackages,omitempty"`
	InitPackages  []OnpremImagePackage `json:"InitPackages,omitempty" yaml:"InitPackages,omitempty"`
	...
	ReleaseTime     *time.Time           `json:"ReleaseTime,omitempty" yaml:"ReleaseTime,omitempty"`
	ServicePackages []OnpremImagePackage `json:"ServicePackages,omitempty" yaml:"ServicePackages,omitempty"`
	...
	SystemPackages []OnpremImagePackage `json:"SystemPackages,omitempty" yaml:"SystemPackages,omitempty"`
	UiPackages     []OnpremImagePackage `json:"UiPackages,omitempty" yaml:"UiPackages,omitempty"`
	// End date of the software upgrade process.
	UpgradeEndTime *time.Time `json:"UpgradeEndTime,omitempty" yaml:"UpgradeEndTime,omitempty"`
	...
	UpgradeGracePeriod *int64 `json:"UpgradeGracePeriod,omitempty" yaml:"UpgradeGracePeriod,omitempty"`
	// Duration (in minutes) for which services will be disrupted.
	UpgradeImpactDuration *int64 `json:"UpgradeImpactDuration,omitempty" yaml:"UpgradeImpactDuration,omitempty"`
	...
	UpgradeImpactEnum *string `json:"UpgradeImpactEnum,omitempty" yaml:"UpgradeImpactEnum,omitempty"`
	// Start date of the software upgrade process.
	UpgradeStartTime *time.Time `json:"UpgradeStartTime,omitempty" yaml:"UpgradeStartTime,omitempty"`
