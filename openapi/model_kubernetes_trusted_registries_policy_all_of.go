...
type KubernetesTrustedRegistriesPolicyAllOf struct {
	...
	RootCaRegistries   []string `json:"RootCaRegistries,omitempty" yaml:"RootCaRegistries,omitempty"`
	UnsignedRegistries []string `json:"UnsignedRegistries,omitempty" yaml:"UnsignedRegistries,omitempty"`
