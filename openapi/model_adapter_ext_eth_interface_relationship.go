...
func (dst *AdapterExtEthInterfaceRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "adapter.ExtEthInterface":
			var result *AdapterExtEthInterface = &AdapterExtEthInterface{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.AdapterExtEthInterface = result
			return nil
		case "mo.MoRef":
...
func (src *AdapterExtEthInterfaceRelationship) MarshalYAML() ([]byte, error) {
	if src.AdapterExtEthInterface != nil {
		return yaml.Marshal(&src.AdapterExtEthInterface)
	}
