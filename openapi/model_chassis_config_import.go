...
type ChassisConfigImport struct {
	...
	PolicyPrefix *string  `json:"PolicyPrefix,omitempty" yaml:"PolicyPrefix,omitempty"`
	...
	Chassis        *EquipmentChassisRelationship         `json:"Chassis,omitempty" yaml:"Chassis,omitempty"`
	ChassisProfile *ChassisProfileRelationship           `json:"ChassisProfile,omitempty" yaml:"ChassisProfile,omitempty"`
