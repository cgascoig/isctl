...
func (dst *IppoolShadowBlockRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "ippool.ShadowBlock":
			var result *IppoolShadowBlock = &IppoolShadowBlock{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IppoolShadowBlock = result
			return nil
		case "mo.MoRef":
...
func (src *IppoolShadowBlockRelationship) MarshalYAML() ([]byte, error) {
	if src.IppoolShadowBlock != nil {
		return yaml.Marshal(&src.IppoolShadowBlock)
	}
