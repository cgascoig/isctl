...
type HyperflexHxapVirtualMachine struct {
	...
	AffinitySelectors []InfraMetaData `json:"AffinitySelectors,omitempty" yaml:"AffinitySelectors,omitempty"`
	// Denotes age or life time of the VM in nano seconds.
	Age                   *string           `json:"Age,omitempty" yaml:"Age,omitempty"`
	AntiAffinitySelectors []InfraMetaData   `json:"AntiAffinitySelectors,omitempty" yaml:"AntiAffinitySelectors,omitempty"`
	Disks                 []HyperflexVmDisk `json:"Disks,omitempty" yaml:"Disks,omitempty"`
	...
	GraphicConsoleUrl *string                `json:"GraphicConsoleUrl,omitempty" yaml:"GraphicConsoleUrl,omitempty"`
	Interfaces        []HyperflexVmInterface `json:"Interfaces,omitempty" yaml:"Interfaces,omitempty"`
	...
	Cluster *HyperflexHxapClusterRelationship `json:"Cluster,omitempty" yaml:"Cluster,omitempty"`
	Host    *HyperflexHxapHostRelationship    `json:"Host,omitempty" yaml:"Host,omitempty"`
}
