...
func IwotenantTenantStatusListAsIwotenantTenantStatusResponse(v *IwotenantTenantStatusList) IwotenantTenantStatusResponse {
	return IwotenantTenantStatusResponse{IwotenantTenantStatusList: v}
}
...
func MoAggregateTransformAsIwotenantTenantStatusResponse(v *MoAggregateTransform) IwotenantTenantStatusResponse {
	return IwotenantTenantStatusResponse{MoAggregateTransform: v}
}
...
func MoDocumentCountAsIwotenantTenantStatusResponse(v *MoDocumentCount) IwotenantTenantStatusResponse {
	return IwotenantTenantStatusResponse{MoDocumentCount: v}
}
...
func MoTagSummaryAsIwotenantTenantStatusResponse(v *MoTagSummary) IwotenantTenantStatusResponse {
	return IwotenantTenantStatusResponse{MoTagSummary: v}
}
...
func (dst *IwotenantTenantStatusResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iwotenant.TenantStatus.List":
			var result *IwotenantTenantStatusList = &IwotenantTenantStatusList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IwotenantTenantStatusList = result
			return nil
...
func (src *IwotenantTenantStatusResponse) MarshalYAML() ([]byte, error) {
	if src.IwotenantTenantStatusList != nil {
		return yaml.Marshal(&src.IwotenantTenantStatusList)
	}
