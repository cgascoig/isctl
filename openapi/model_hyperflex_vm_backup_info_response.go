...
func (dst *HyperflexVmBackupInfoResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "hyperflex.VmBackupInfo.List":
			var result *HyperflexVmBackupInfoList = &HyperflexVmBackupInfoList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexVmBackupInfoList = result
			return nil
...
func (src *HyperflexVmBackupInfoResponse) MarshalYAML() ([]byte, error) {
	if src.HyperflexVmBackupInfoList != nil {
		return yaml.Marshal(&src.HyperflexVmBackupInfoList)
	}
