...
type RecoveryBackupScheduleAllOf struct {
	...
	ExecutionTime *time.Time `json:"ExecutionTime,omitempty" yaml:"ExecutionTime,omitempty"`
	...
	FrequencyUnit *string `json:"FrequencyUnit,omitempty" yaml:"FrequencyUnit,omitempty"`
	// The frequency, in hours, at which the backup schedule runs. * `8` -  * `4` -  * `12` -  * `16` -  * `20` -
	Hours *int32 `json:"Hours,omitempty" yaml:"Hours,omitempty"`
}
