...
func (dst *FabricMulticastPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "fabric.MulticastPolicy.List":
			var result *FabricMulticastPolicyList = &FabricMulticastPolicyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FabricMulticastPolicyList = result
			return nil
...
func (src *FabricMulticastPolicyResponse) MarshalYAML() ([]byte, error) {
	if src.FabricMulticastPolicyList != nil {
		return yaml.Marshal(&src.FabricMulticastPolicyList)
	}
