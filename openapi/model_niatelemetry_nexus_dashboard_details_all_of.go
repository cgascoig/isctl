...
type NiatelemetryNexusDashboardDetailsAllOf struct {
	...
	NexusDashboardName *string `json:"NexusDashboardName,omitempty" yaml:"NexusDashboardName,omitempty"`
	// Serial number of NexusDashboard.
	NexusDashboardSerialNumber *string                              `json:"NexusDashboardSerialNumber,omitempty" yaml:"NexusDashboardSerialNumber,omitempty"`
