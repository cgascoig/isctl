...
type TamAdvisoryDefinitionAllOf struct {
	...
	AdvisoryDetails NullableTamBaseAdvisoryDetails `json:"AdvisoryDetails,omitempty" yaml:"AdvisoryDetails,omitempty"`
	...
	S3DataSources  []TamS3DataSource `json:"S3DataSources,omitempty" yaml:"S3DataSources,omitempty"`
