...
func (dst *FabricEthNetworkPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "fabric.EthNetworkPolicy.List":
			var result *FabricEthNetworkPolicyList = &FabricEthNetworkPolicyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FabricEthNetworkPolicyList = result
			return nil
...
func (src *FabricEthNetworkPolicyResponse) MarshalYAML() ([]byte, error) {
	if src.FabricEthNetworkPolicyList != nil {
		return yaml.Marshal(&src.FabricEthNetworkPolicyList)
	}
