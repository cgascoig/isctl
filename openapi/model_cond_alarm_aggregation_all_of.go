...
type CondAlarmAggregationAllOf struct {
	...
	InfoAlarmsCount *int64 `json:"InfoAlarmsCount,omitempty" yaml:"InfoAlarmsCount,omitempty"`
	...
	WarningAlarmsCount     *int64                `json:"WarningAlarmsCount,omitempty" yaml:"WarningAlarmsCount,omitempty"`
	AlarmAggregationSource *MoBaseMoRelationship `json:"AlarmAggregationSource,omitempty" yaml:"AlarmAggregationSource,omitempty"`
}
