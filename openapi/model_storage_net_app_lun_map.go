...
type StorageNetAppLunMap struct {
	StorageBaseHostLun `yaml:"StorageBaseHostLun,inline"`
	...
	Host   []StorageNetAppInitiatorGroupRelationship `json:"Host,omitempty" yaml:"Host,omitempty"`
	Tenant *StorageNetAppStorageVmRelationship       `json:"Tenant,omitempty" yaml:"Tenant,omitempty"`
	Volume *StorageNetAppLunRelationship             `json:"Volume,omitempty" yaml:"Volume,omitempty"`
}
