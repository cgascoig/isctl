...
func (dst *ComputeBladeRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "compute.Blade":
			var result *ComputeBlade = &ComputeBlade{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ComputeBlade = result
			return nil
		case "mo.MoRef":
...
func (src *ComputeBladeRelationship) MarshalYAML() ([]byte, error) {
	if src.ComputeBlade != nil {
		return yaml.Marshal(&src.ComputeBlade)
	}
