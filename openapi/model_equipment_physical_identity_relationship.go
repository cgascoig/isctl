...
func (dst *EquipmentPhysicalIdentityRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "equipment.PhysicalIdentity":
			var result *EquipmentPhysicalIdentity = &EquipmentPhysicalIdentity{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentPhysicalIdentity = result
			return nil
		case "mo.MoRef":
...
func (src *EquipmentPhysicalIdentityRelationship) MarshalYAML() ([]byte, error) {
	if src.EquipmentPhysicalIdentity != nil {
		return yaml.Marshal(&src.EquipmentPhysicalIdentity)
	}
