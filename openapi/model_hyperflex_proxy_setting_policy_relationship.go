...
func (dst *HyperflexProxySettingPolicyRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.ProxySettingPolicy":
			var result *HyperflexProxySettingPolicy = &HyperflexProxySettingPolicy{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexProxySettingPolicy = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexProxySettingPolicyRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexProxySettingPolicy != nil {
		return yaml.Marshal(&src.HyperflexProxySettingPolicy)
	}
