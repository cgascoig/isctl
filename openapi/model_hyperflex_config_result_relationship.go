...
func (dst *HyperflexConfigResultRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.ConfigResult":
			var result *HyperflexConfigResult = &HyperflexConfigResult{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexConfigResult = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexConfigResultRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexConfigResult != nil {
		return yaml.Marshal(&src.HyperflexConfigResult)
	}
