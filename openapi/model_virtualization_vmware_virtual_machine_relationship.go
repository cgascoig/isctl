...
func (dst *VirtualizationVmwareVirtualMachineRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "mo.MoRef":
			...
			dst.MoMoRef = result
			return nil
		case "virtualization.VmwareVirtualMachine":
			var result *VirtualizationVmwareVirtualMachine = &VirtualizationVmwareVirtualMachine{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.VirtualizationVmwareVirtualMachine = result
			return nil
		default:
...
func (src *VirtualizationVmwareVirtualMachineRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.VirtualizationVmwareVirtualMachine != nil {
		return yaml.Marshal(&src.VirtualizationVmwareVirtualMachine)
	}
