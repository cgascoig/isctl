...
func (dst *IamLdapGroupRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "iam.LdapGroup":
			var result *IamLdapGroup = &IamLdapGroup{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamLdapGroup = result
			return nil
		case "mo.MoRef":
...
func (src *IamLdapGroupRelationship) MarshalYAML() ([]byte, error) {
	if src.IamLdapGroup != nil {
		return yaml.Marshal(&src.IamLdapGroup)
	}
