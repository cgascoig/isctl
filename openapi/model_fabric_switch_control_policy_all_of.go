...
type FabricSwitchControlPolicyAllOf struct {
	...
	MacAgingSettings NullableFabricMacAgingSettings   `json:"MacAgingSettings,omitempty" yaml:"MacAgingSettings,omitempty"`
	UdldSettings     NullableFabricUdldGlobalSettings `json:"UdldSettings,omitempty" yaml:"UdldSettings,omitempty"`
	// To enable or disable the VLAN port count optimization.
	VlanPortOptimizationEnabled *bool                                 `json:"VlanPortOptimizationEnabled,omitempty" yaml:"VlanPortOptimizationEnabled,omitempty"`
