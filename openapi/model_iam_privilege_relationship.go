...
func (dst *IamPrivilegeRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "iam.Privilege":
			var result *IamPrivilege = &IamPrivilege{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamPrivilege = result
			return nil
		case "mo.MoRef":
...
func (src *IamPrivilegeRelationship) MarshalYAML() ([]byte, error) {
	if src.IamPrivilege != nil {
		return yaml.Marshal(&src.IamPrivilege)
	}
