...
func (dst *KubernetesContainerRuntimePolicyRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "kubernetes.ContainerRuntimePolicy":
			var result *KubernetesContainerRuntimePolicy = &KubernetesContainerRuntimePolicy{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesContainerRuntimePolicy = result
			return nil
		case "mo.MoRef":
...
func (src *KubernetesContainerRuntimePolicyRelationship) MarshalYAML() ([]byte, error) {
	if src.KubernetesContainerRuntimePolicy != nil {
		return yaml.Marshal(&src.KubernetesContainerRuntimePolicy)
	}
