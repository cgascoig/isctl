...
func (dst *SoftwarerepositoryCategoryMapperModelResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		...
		case "mo.TagSummary":
			...
			return nil
		case "softwarerepository.CategoryMapperModel.List":
			var result *SoftwarerepositoryCategoryMapperModelList = &SoftwarerepositoryCategoryMapperModelList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.SoftwarerepositoryCategoryMapperModelList = result
			return nil
		default:
...
func (src *SoftwarerepositoryCategoryMapperModelResponse) MarshalYAML() ([]byte, error) {
	if src.MoAggregateTransform != nil {
	...
	if src.SoftwarerepositoryCategoryMapperModelList != nil {
		return yaml.Marshal(&src.SoftwarerepositoryCategoryMapperModelList)
	}
