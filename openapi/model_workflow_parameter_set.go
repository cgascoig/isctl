...
type WorkflowParameterSet struct {
	...
	ControlParameter *string  `json:"ControlParameter,omitempty" yaml:"ControlParameter,omitempty"`
	EnableParameters []string `json:"EnableParameters,omitempty" yaml:"EnableParameters,omitempty"`
