...
type NiaapiNiaMetadata struct {
	...
	Content    []NiaapiDetail `json:"Content,omitempty" yaml:"Content,omitempty"`
	...
	MetadataChksum *string `json:"MetadataChksum,omitempty" yaml:"MetadataChksum,omitempty"`
	// The Filename of this Metadata package.
	MetadataFilename *string `json:"MetadataFilename,omitempty" yaml:"MetadataFilename,omitempty"`
