...
func (dst *EquipmentChassisRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "equipment.Chassis":
			var result *EquipmentChassis = &EquipmentChassis{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentChassis = result
			return nil
		case "mo.MoRef":
...
func (src *EquipmentChassisRelationship) MarshalYAML() ([]byte, error) {
	if src.EquipmentChassis != nil {
		return yaml.Marshal(&src.EquipmentChassis)
	}
