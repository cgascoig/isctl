...
type StorageHitachiHost struct {
	...
	HostGroupId *string `json:"HostGroupId,omitempty" yaml:"HostGroupId,omitempty"`
	// Host group number for this host.
	HostGroupNumber *int64  `json:"HostGroupNumber,omitempty" yaml:"HostGroupNumber,omitempty"`
	HostModeOptions []int64 `json:"HostModeOptions,omitempty" yaml:"HostModeOptions,omitempty"`
	// Mutual CHAP setting that is Enabled or Disabled.
	IsChapMutual *bool `json:"IsChapMutual,omitempty" yaml:"IsChapMutual,omitempty"`
	// IQN (iSCSI qualified name). Can be up to 255 characters long.
	IscsiName *string `json:"IscsiName,omitempty" yaml:"IscsiName,omitempty"`
