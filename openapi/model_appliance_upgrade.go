...
type ApplianceUpgrade struct {
	...
	CurrentPhase    NullableOnpremUpgradePhase `json:"CurrentPhase,omitempty" yaml:"CurrentPhase,omitempty"`
	...
	IsUserTriggered *bool    `json:"IsUserTriggered,omitempty" yaml:"IsUserTriggered,omitempty"`
