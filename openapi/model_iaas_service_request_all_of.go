...
type IaasServiceRequestAllOf struct {
	...
	InitiatingUser *string `json:"InitiatingUser,omitempty" yaml:"InitiatingUser,omitempty"`
	// Service request end time.
	RequestEndTime *string `json:"RequestEndTime,omitempty" yaml:"RequestEndTime,omitempty"`
	// Service request id of an SR.
	RequestId *string `json:"RequestId,omitempty" yaml:"RequestId,omitempty"`
	// Service request start time.
	RequestStartTime *string `json:"RequestStartTime,omitempty" yaml:"RequestStartTime,omitempty"`
	...
	WorkflowSteps    *[]IaasWorkflowSteps                 `json:"WorkflowSteps,omitempty" yaml:"WorkflowSteps,omitempty"`
