...
type WorkflowTemplateEvaluation struct {
	...
	ExpectedOutputDataType NullableWorkflowBaseDataType `json:"ExpectedOutputDataType,omitempty" yaml:"ExpectedOutputDataType,omitempty"`
	...
	PreviewTemplate *string                       `json:"PreviewTemplate,omitempty" yaml:"PreviewTemplate,omitempty"`
	Stages          []TemplateTransformationStage `json:"Stages,omitempty" yaml:"Stages,omitempty"`
