...
func (dst *IqnpoolPoolMemberRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "iqnpool.PoolMember":
			var result *IqnpoolPoolMember = &IqnpoolPoolMember{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IqnpoolPoolMember = result
			return nil
		case "mo.MoRef":
...
func (src *IqnpoolPoolMemberRelationship) MarshalYAML() ([]byte, error) {
	if src.IqnpoolPoolMember != nil {
		return yaml.Marshal(&src.IqnpoolPoolMember)
	}
