...
type HyperflexStPlatformClusterHealingInfoAllOf struct {
	EstimatedCompletionTimeInSeconds *int64                  `json:"EstimatedCompletionTimeInSeconds,omitempty" yaml:"EstimatedCompletionTimeInSeconds,omitempty"`
	InProgress                       *bool                   `json:"InProgress,omitempty" yaml:"InProgress,omitempty"`
	Messages                         *[]string               `json:"Messages,omitempty" yaml:"Messages,omitempty"`
	MessagesIterator                 *map[string]interface{} `json:"MessagesIterator,omitempty" yaml:"MessagesIterator,omitempty"`
	MessagesSize                     *int64                  `json:"MessagesSize,omitempty" yaml:"MessagesSize,omitempty"`
	PercentComplete                  *int64                  `json:"PercentComplete,omitempty" yaml:"PercentComplete,omitempty"`
}
