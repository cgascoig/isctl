...
func (dst *InventoryDeviceInfoRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "inventory.DeviceInfo":
			var result *InventoryDeviceInfo = &InventoryDeviceInfo{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.InventoryDeviceInfo = result
			return nil
		case "mo.MoRef":
...
func (src *InventoryDeviceInfoRelationship) MarshalYAML() ([]byte, error) {
	if src.InventoryDeviceInfo != nil {
		return yaml.Marshal(&src.InventoryDeviceInfo)
	}
