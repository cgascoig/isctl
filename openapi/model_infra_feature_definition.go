...
// InfraFeatureDefinition Feature parameters specified for the account.
type InfraFeatureDefinition struct {
...
func (o InfraFeatureDefinition) MarshalJSON() ([]byte, error) {
...
type NullableInfraFeatureDefinition struct {
	value *InfraFeatureDefinition
	isSet bool
}

func (v NullableInfraFeatureDefinition) Get() *InfraFeatureDefinition {
	return v.value
}

func (v *NullableInfraFeatureDefinition) Set(val *InfraFeatureDefinition) {
	v.value = val
	v.isSet = true
}

func (v NullableInfraFeatureDefinition) IsSet() bool {
	return v.isSet
}

func (v *NullableInfraFeatureDefinition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInfraFeatureDefinition(val *InfraFeatureDefinition) *NullableInfraFeatureDefinition {
	return &NullableInfraFeatureDefinition{value: val, isSet: true}
}

func (v NullableInfraFeatureDefinition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInfraFeatureDefinition) UnmarshalJSON(src []byte) error {
	v.isSet = true
