...
type AssetDeviceConnectionAllOf struct {
	...
	ApiVersion *int64 `json:"ApiVersion,omitempty" yaml:"ApiVersion,omitempty"`
	...
	AppPartitionNumber *int64 `json:"AppPartitionNumber,omitempty" yaml:"AppPartitionNumber,omitempty"`
	...
	ConnectionReason *string `json:"ConnectionReason,omitempty" yaml:"ConnectionReason,omitempty"`
	...
	ConnectionStatusLastChangeTime *time.Time `json:"ConnectionStatusLastChangeTime,omitempty" yaml:"ConnectionStatusLastChangeTime,omitempty"`
	...
	DeviceExternalIpAddress *string `json:"DeviceExternalIpAddress,omitempty" yaml:"DeviceExternalIpAddress,omitempty"`
	// The name of the app which will proxy the messages to the device connector.
	ProxyApp *string `json:"ProxyApp,omitempty" yaml:"ProxyApp,omitempty"`
}
