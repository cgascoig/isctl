...
func (dst *ChassisIomProfileResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "chassis.IomProfile.List":
			var result *ChassisIomProfileList = &ChassisIomProfileList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ChassisIomProfileList = result
			return nil
...
func (src *ChassisIomProfileResponse) MarshalYAML() ([]byte, error) {
	if src.ChassisIomProfileList != nil {
		return yaml.Marshal(&src.ChassisIomProfileList)
	}
