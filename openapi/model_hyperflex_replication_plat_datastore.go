...
type HyperflexReplicationPlatDatastore struct {
	...
	ClusterEr   NullableHyperflexEntityReference `json:"ClusterEr,omitempty" yaml:"ClusterEr,omitempty"`
	DatastoreEr NullableHyperflexEntityReference `json:"DatastoreEr,omitempty" yaml:"DatastoreEr,omitempty"`
}
