...
type AssetWorkloadOptimizerHypervOptionsAllOf struct {
	...
	DiscoverHostCluster *bool `json:"DiscoverHostCluster,omitempty" yaml:"DiscoverHostCluster,omitempty"`
	...
	FullDomainName *string `json:"FullDomainName,omitempty" yaml:"FullDomainName,omitempty"`
}
