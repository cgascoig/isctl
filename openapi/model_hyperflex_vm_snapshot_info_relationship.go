...
func (dst *HyperflexVmSnapshotInfoRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.VmSnapshotInfo":
			var result *HyperflexVmSnapshotInfo = &HyperflexVmSnapshotInfo{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexVmSnapshotInfo = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexVmSnapshotInfoRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexVmSnapshotInfo != nil {
		return yaml.Marshal(&src.HyperflexVmSnapshotInfo)
	}
