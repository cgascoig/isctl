...
func (dst *CapabilityIoCardManufacturingDefResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "capability.IoCardManufacturingDef.List":
			var result *CapabilityIoCardManufacturingDefList = &CapabilityIoCardManufacturingDefList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.CapabilityIoCardManufacturingDefList = result
			return nil
...
func (src *CapabilityIoCardManufacturingDefResponse) MarshalYAML() ([]byte, error) {
	if src.CapabilityIoCardManufacturingDefList != nil {
		return yaml.Marshal(&src.CapabilityIoCardManufacturingDefList)
	}
