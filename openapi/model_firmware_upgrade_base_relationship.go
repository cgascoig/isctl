...
func (dst *FirmwareUpgradeBaseRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "firmware.UpgradeBase":
			var result *FirmwareUpgradeBase = &FirmwareUpgradeBase{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FirmwareUpgradeBase = result
			return nil
		case "mo.MoRef":
...
func (src *FirmwareUpgradeBaseRelationship) MarshalYAML() ([]byte, error) {
	if src.FirmwareUpgradeBase != nil {
		return yaml.Marshal(&src.FirmwareUpgradeBase)
	}
