...
func (dst *CondAlarmAggregationResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "cond.AlarmAggregation.List":
			var result *CondAlarmAggregationList = &CondAlarmAggregationList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.CondAlarmAggregationList = result
			return nil
...
func (src *CondAlarmAggregationResponse) MarshalYAML() ([]byte, error) {
	if src.CondAlarmAggregationList != nil {
		return yaml.Marshal(&src.CondAlarmAggregationList)
	}
