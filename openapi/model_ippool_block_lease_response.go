...
func (dst *IppoolBlockLeaseResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "ippool.BlockLease.List":
			var result *IppoolBlockLeaseList = &IppoolBlockLeaseList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IppoolBlockLeaseList = result
			return nil
...
func (src *IppoolBlockLeaseResponse) MarshalYAML() ([]byte, error) {
	if src.IppoolBlockLeaseList != nil {
		return yaml.Marshal(&src.IppoolBlockLeaseList)
	}
