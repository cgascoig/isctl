...
func (dst *LsServiceProfileResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "ls.ServiceProfile.List":
			var result *LsServiceProfileList = &LsServiceProfileList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.LsServiceProfileList = result
			return nil
...
func (src *LsServiceProfileResponse) MarshalYAML() ([]byte, error) {
	if src.LsServiceProfileList != nil {
		return yaml.Marshal(&src.LsServiceProfileList)
	}
