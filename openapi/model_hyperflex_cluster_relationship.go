...
func (dst *HyperflexClusterRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.Cluster":
			var result *HyperflexCluster = &HyperflexCluster{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexCluster = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexClusterRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexCluster != nil {
		return yaml.Marshal(&src.HyperflexCluster)
	}
