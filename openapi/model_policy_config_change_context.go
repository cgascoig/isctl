...
type PolicyConfigChangeContext struct {
	...
	ConfigChangeError *string `json:"ConfigChangeError,omitempty" yaml:"ConfigChangeError,omitempty"`
	...
	ConfigChangeState    *string                     `json:"ConfigChangeState,omitempty" yaml:"ConfigChangeState,omitempty"`
	InitialConfigContext NullablePolicyConfigContext `json:"InitialConfigContext,omitempty" yaml:"InitialConfigContext,omitempty"`
}
