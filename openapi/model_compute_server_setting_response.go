...
func (dst *ComputeServerSettingResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "compute.ServerSetting.List":
			var result *ComputeServerSettingList = &ComputeServerSettingList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ComputeServerSettingList = result
			return nil
...
func (src *ComputeServerSettingResponse) MarshalYAML() ([]byte, error) {
	if src.ComputeServerSettingList != nil {
		return yaml.Marshal(&src.ComputeServerSettingList)
	}
