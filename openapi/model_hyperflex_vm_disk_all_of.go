...
type HyperflexVmDiskAllOf struct {
	...
	BootOrder *int64 `json:"BootOrder,omitempty" yaml:"BootOrder,omitempty"`
	...
	VirtualDisk NullableHyperflexVdiskConfig `json:"VirtualDisk,omitempty" yaml:"VirtualDisk,omitempty"`
	// Virtual disk reference name.
	VirtualDiskReference *string `json:"VirtualDiskReference,omitempty" yaml:"VirtualDiskReference,omitempty"`
}
