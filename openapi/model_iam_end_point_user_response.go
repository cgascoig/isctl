...
func (dst *IamEndPointUserResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iam.EndPointUser.List":
			var result *IamEndPointUserList = &IamEndPointUserList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamEndPointUserList = result
			return nil
...
func (src *IamEndPointUserResponse) MarshalYAML() ([]byte, error) {
	if src.IamEndPointUserList != nil {
		return yaml.Marshal(&src.IamEndPointUserList)
	}
