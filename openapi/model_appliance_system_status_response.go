...
func (dst *ApplianceSystemStatusResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "appliance.SystemStatus.List":
			var result *ApplianceSystemStatusList = &ApplianceSystemStatusList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ApplianceSystemStatusList = result
			return nil
...
func (src *ApplianceSystemStatusResponse) MarshalYAML() ([]byte, error) {
	if src.ApplianceSystemStatusList != nil {
		return yaml.Marshal(&src.ApplianceSystemStatusList)
	}
