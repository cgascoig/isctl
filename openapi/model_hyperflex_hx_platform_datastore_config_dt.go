...
type HyperflexHxPlatformDatastoreConfigDt struct {
	...
	NumMirrors *int64 `json:"NumMirrors,omitempty" yaml:"NumMirrors,omitempty"`
	// Number of stripes to be used for large files in datastore.
	NumStripesForLargeFiles *int64 `json:"NumStripesForLargeFiles,omitempty" yaml:"NumStripesForLargeFiles,omitempty"`
	...
	SystemDatastore *bool `json:"SystemDatastore,omitempty" yaml:"SystemDatastore,omitempty"`
}
