...
func (dst *GraphicsControllerRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "graphics.Controller":
			var result *GraphicsController = &GraphicsController{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.GraphicsController = result
			return nil
		case "mo.MoRef":
...
func (src *GraphicsControllerRelationship) MarshalYAML() ([]byte, error) {
	if src.GraphicsController != nil {
		return yaml.Marshal(&src.GraphicsController)
	}
