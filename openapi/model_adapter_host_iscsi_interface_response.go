...
func (dst *AdapterHostIscsiInterfaceResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "adapter.HostIscsiInterface.List":
			var result *AdapterHostIscsiInterfaceList = &AdapterHostIscsiInterfaceList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.AdapterHostIscsiInterfaceList = result
			return nil
...
func (src *AdapterHostIscsiInterfaceResponse) MarshalYAML() ([]byte, error) {
	if src.AdapterHostIscsiInterfaceList != nil {
		return yaml.Marshal(&src.AdapterHostIscsiInterfaceList)
	}
