...
type IamEndPointPasswordPropertiesAllOf struct {
	...
	EnablePasswordExpiry *bool `json:"EnablePasswordExpiry,omitempty" yaml:"EnablePasswordExpiry,omitempty"`
	...
	EnforceStrongPassword *bool `json:"EnforceStrongPassword,omitempty" yaml:"EnforceStrongPassword,omitempty"`
	...
	ForceSendPassword *bool `json:"ForceSendPassword,omitempty" yaml:"ForceSendPassword,omitempty"`
	...
	NotificationPeriod *int64 `json:"NotificationPeriod,omitempty" yaml:"NotificationPeriod,omitempty"`
	// Set time period for password expiration. Value should be greater than notification period and grace period.
	PasswordExpiryDuration *int64 `json:"PasswordExpiryDuration,omitempty" yaml:"PasswordExpiryDuration,omitempty"`
	// Tracks password change history. Specifies in number of instances, that the new password was already used.
	PasswordHistory *int64 `json:"PasswordHistory,omitempty" yaml:"PasswordHistory,omitempty"`
}
