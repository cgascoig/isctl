...
type HyperflexVmSnapshotInfo struct {
	...
	ClusterIdSnapMap []HyperflexMapClusterIdToStSnapshotPoint `json:"ClusterIdSnapMap,omitempty" yaml:"ClusterIdSnapMap,omitempty"`
	ErrorStack       NullableHyperflexErrorStack              `json:"ErrorStack,omitempty" yaml:"ErrorStack,omitempty"`
	...
	ParentSnapshot NullableHyperflexEntityReference `json:"ParentSnapshot,omitempty" yaml:"ParentSnapshot,omitempty"`
	...
	ReplicationStatus *string `json:"ReplicationStatus,omitempty" yaml:"ReplicationStatus,omitempty"`
	...
	SnapshotStatus *string `json:"SnapshotStatus,omitempty" yaml:"SnapshotStatus,omitempty"`
	// Timestamp the snapshot was created on the source cluster.
	SourceTimestamp           *int64                             `json:"SourceTimestamp,omitempty" yaml:"SourceTimestamp,omitempty"`
	VmEntityReference         NullableHyperflexEntityReference   `json:"VmEntityReference,omitempty" yaml:"VmEntityReference,omitempty"`
	VmSnapshotEntityReference NullableHyperflexEntityReference   `json:"VmSnapshotEntityReference,omitempty" yaml:"VmSnapshotEntityReference,omitempty"`
	...
	VmBackupInfo              *HyperflexVmBackupInfoRelationship `json:"VmBackupInfo,omitempty" yaml:"VmBackupInfo,omitempty"`
}
