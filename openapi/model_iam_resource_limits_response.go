...
func (dst *IamResourceLimitsResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iam.ResourceLimits.List":
			var result *IamResourceLimitsList = &IamResourceLimitsList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamResourceLimitsList = result
			return nil
...
func (src *IamResourceLimitsResponse) MarshalYAML() ([]byte, error) {
	if src.IamResourceLimitsList != nil {
		return yaml.Marshal(&src.IamResourceLimitsList)
	}
