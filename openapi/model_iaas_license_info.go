...
type IaasLicenseInfo struct {
	...
	LicenseExpirationDate *string                `json:"LicenseExpirationDate,omitempty" yaml:"LicenseExpirationDate,omitempty"`
	LicenseKeysInfo       *[]IaasLicenseKeysInfo `json:"LicenseKeysInfo,omitempty" yaml:"LicenseKeysInfo,omitempty"`
	...
	LicenseUtilizationInfo *[]IaasLicenseUtilizationInfo `json:"LicenseUtilizationInfo,omitempty" yaml:"LicenseUtilizationInfo,omitempty"`
