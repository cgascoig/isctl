...
type NiatelemetryNexusDashboardControllerDetails struct {
	...
	SiteHealth *int64 `json:"SiteHealth,omitempty" yaml:"SiteHealth,omitempty"`
	...
	VersionOfController *string                              `json:"VersionOfController,omitempty" yaml:"VersionOfController,omitempty"`
