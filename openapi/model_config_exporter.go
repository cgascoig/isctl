...
type ConfigExporter struct {
	...
	DownloadPath *string       `json:"DownloadPath,omitempty" yaml:"DownloadPath,omitempty"`
	Items        []ConfigMoRef `json:"Items,omitempty" yaml:"Items,omitempty"`
	...
	ExportedItems []ConfigExportedItemRelationship      `json:"ExportedItems,omitempty" yaml:"ExportedItems,omitempty"`
