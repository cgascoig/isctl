...
func (dst *HyperflexDataProtectionPeerRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.DataProtectionPeer":
			var result *HyperflexDataProtectionPeer = &HyperflexDataProtectionPeer{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexDataProtectionPeer = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexDataProtectionPeerRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexDataProtectionPeer != nil {
		return yaml.Marshal(&src.HyperflexDataProtectionPeer)
	}
