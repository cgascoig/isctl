...
func (dst *ChassisProfileResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "chassis.Profile.List":
			var result *ChassisProfileList = &ChassisProfileList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ChassisProfileList = result
			return nil
...
func (src *ChassisProfileResponse) MarshalYAML() ([]byte, error) {
	if src.ChassisProfileList != nil {
		return yaml.Marshal(&src.ChassisProfileList)
	}
