...
func (dst *FabricServerRoleResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "fabric.ServerRole.List":
			var result *FabricServerRoleList = &FabricServerRoleList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FabricServerRoleList = result
			return nil
...
func (src *FabricServerRoleResponse) MarshalYAML() ([]byte, error) {
	if src.FabricServerRoleList != nil {
		return yaml.Marshal(&src.FabricServerRoleList)
	}
