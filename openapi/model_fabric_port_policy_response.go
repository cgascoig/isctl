...
func (dst *FabricPortPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "fabric.PortPolicy.List":
			var result *FabricPortPolicyList = &FabricPortPolicyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FabricPortPolicyList = result
			return nil
...
func (src *FabricPortPolicyResponse) MarshalYAML() ([]byte, error) {
	if src.FabricPortPolicyList != nil {
		return yaml.Marshal(&src.FabricPortPolicyList)
	}
