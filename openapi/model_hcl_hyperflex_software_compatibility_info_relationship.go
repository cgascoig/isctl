...
func (dst *HclHyperflexSoftwareCompatibilityInfoRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hcl.HyperflexSoftwareCompatibilityInfo":
			var result *HclHyperflexSoftwareCompatibilityInfo = &HclHyperflexSoftwareCompatibilityInfo{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HclHyperflexSoftwareCompatibilityInfo = result
			return nil
		case "mo.MoRef":
...
func (src *HclHyperflexSoftwareCompatibilityInfoRelationship) MarshalYAML() ([]byte, error) {
	if src.HclHyperflexSoftwareCompatibilityInfo != nil {
		return yaml.Marshal(&src.HclHyperflexSoftwareCompatibilityInfo)
	}
