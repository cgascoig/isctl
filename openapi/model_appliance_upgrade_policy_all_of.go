...
type ApplianceUpgradePolicyAllOf struct {
	...
	BlackoutDatesEnabled *bool `json:"BlackoutDatesEnabled,omitempty" yaml:"BlackoutDatesEnabled,omitempty"`
	...
	EnableMetaDataSync *bool                   `json:"EnableMetaDataSync,omitempty" yaml:"EnableMetaDataSync,omitempty"`
