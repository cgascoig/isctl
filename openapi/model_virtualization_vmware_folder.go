...
type VirtualizationVmwareFolder struct {
	VirtualizationBaseFolder `yaml:"VirtualizationBaseFolder,inline"`
	...
	TypeofFolder      *string                                     `json:"TypeofFolder,omitempty" yaml:"TypeofFolder,omitempty"`
	Datacenter        *VirtualizationVmwareDatacenterRelationship `json:"Datacenter,omitempty" yaml:"Datacenter,omitempty"`
	HypervisorManager *VirtualizationVmwareVcenterRelationship    `json:"HypervisorManager,omitempty" yaml:"HypervisorManager,omitempty"`
	VmwareFolder      *VirtualizationVmwareFolderRelationship     `json:"VmwareFolder,omitempty" yaml:"VmwareFolder,omitempty"`
}
