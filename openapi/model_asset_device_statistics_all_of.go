...
type AssetDeviceStatisticsAllOf struct {
	...
	MembershipRatio *float32            `json:"MembershipRatio,omitempty" yaml:"MembershipRatio,omitempty"`
	VmHost          NullableAssetVmHost `json:"VmHost,omitempty" yaml:"VmHost,omitempty"`
}
