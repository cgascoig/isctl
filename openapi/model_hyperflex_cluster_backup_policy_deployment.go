...
type HyperflexClusterBackupPolicyDeployment struct {
	...
	BackupDataStoreName *string `json:"BackupDataStoreName,omitempty" yaml:"BackupDataStoreName,omitempty"`
	// Replication data store size in backupDataStoreSizeUnit.
	BackupDataStoreSize *int64 `json:"BackupDataStoreSize,omitempty" yaml:"BackupDataStoreSize,omitempty"`
	// Replication data store size.
	BackupDataStoreSizeUnit *string `json:"BackupDataStoreSizeUnit,omitempty" yaml:"BackupDataStoreSizeUnit,omitempty"`
	...
	PolicyMoid *string `json:"PolicyMoid,omitempty" yaml:"PolicyMoid,omitempty"`
	...
	ReplicationPairNamePrefix *string                              `json:"ReplicationPairNamePrefix,omitempty" yaml:"ReplicationPairNamePrefix,omitempty"`
	ReplicationSchedule       NullableHyperflexReplicationSchedule `json:"ReplicationSchedule,omitempty" yaml:"ReplicationSchedule,omitempty"`
	// Number of snapshots that will be retained as part of the Multi Point in Time support.
	SnapshotRetentionCount *int64 `json:"SnapshotRetentionCount,omitempty" yaml:"SnapshotRetentionCount,omitempty"`
	// True if policy was detached from source Hyperflex Cluster.
	SourceDetached *bool `json:"SourceDetached,omitempty" yaml:"SourceDetached,omitempty"`
	// Unique source cluster request ID allowing retry of the same logical request following a transient communication failure.
	SourceRequestId *string `json:"SourceRequestId,omitempty" yaml:"SourceRequestId,omitempty"`
	// Uuid of the source Hyperflex Cluster.
	SourceUuid *string `json:"SourceUuid,omitempty" yaml:"SourceUuid,omitempty"`
	// True if policy was detached from target Hyperflex Cluster.
	TargetDetached *bool `json:"TargetDetached,omitempty" yaml:"TargetDetached,omitempty"`
	// Unique target cluster request ID allowing retry of the same logical request following a transient communication failure.
	TargetRequestId *string `json:"TargetRequestId,omitempty" yaml:"TargetRequestId,omitempty"`
	// Uuid of the target Hyperflex Cluster.
	TargetUuid    *string                               `json:"TargetUuid,omitempty" yaml:"TargetUuid,omitempty"`
	BackupTarget  *HyperflexClusterRelationship         `json:"BackupTarget,omitempty" yaml:"BackupTarget,omitempty"`
	Organization  *OrganizationOrganizationRelationship `json:"Organization,omitempty" yaml:"Organization,omitempty"`
	SourceCluster *HyperflexClusterRelationship         `json:"SourceCluster,omitempty" yaml:"SourceCluster,omitempty"`
}
