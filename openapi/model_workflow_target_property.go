...
type WorkflowTargetProperty struct {
	...
	ConnectorAttribute   *string  `json:"ConnectorAttribute,omitempty" yaml:"ConnectorAttribute,omitempty"`
	ConstraintAttributes []string `json:"ConstraintAttributes,omitempty" yaml:"ConstraintAttributes,omitempty"`
	DisplayAttributes    []string `json:"DisplayAttributes,omitempty" yaml:"DisplayAttributes,omitempty"`
	...
	SupportedObjects []string `json:"SupportedObjects,omitempty" yaml:"SupportedObjects,omitempty"`
}
