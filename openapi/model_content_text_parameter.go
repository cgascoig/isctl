...
type ContentTextParameter struct {
	ContentBaseParameter `yaml:"ContentBaseParameter,inline"`
	...
	IsDelimiter *bool `json:"IsDelimiter,omitempty" yaml:"IsDelimiter,omitempty"`
	...
	IsNextCaptureOnSameLine *bool `json:"IsNextCaptureOnSameLine,omitempty" yaml:"IsNextCaptureOnSameLine,omitempty"`
	// Regular expression of the line containing the data to be extracted from text content.
	RegexLine *string `json:"RegexLine,omitempty" yaml:"RegexLine,omitempty"`
}
