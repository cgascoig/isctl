...
func (dst *IamBannerMessageResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iam.BannerMessage.List":
			var result *IamBannerMessageList = &IamBannerMessageList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamBannerMessageList = result
			return nil
...
func (src *IamBannerMessageResponse) MarshalYAML() ([]byte, error) {
	if src.IamBannerMessageList != nil {
		return yaml.Marshal(&src.IamBannerMessageList)
	}
