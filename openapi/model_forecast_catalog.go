...
type ForecastCatalog struct {
	...
	SchedTime *string `json:"SchedTime,omitempty" yaml:"SchedTime,omitempty"`
	...
	Definition []ForecastDefinitionRelationship `json:"Definition,omitempty" yaml:"Definition,omitempty"`
}
