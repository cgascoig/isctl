...
type RecoveryConfigResultAllOf struct {
	Var0OnDemandBackup *RecoveryOnDemandBackupRelationship `json:"_0_OnDemandBackup,omitempty" yaml:"_0_OnDemandBackup,omitempty"`
	BackupProfile      *RecoveryBackupProfileRelationship  `json:"BackupProfile,omitempty" yaml:"BackupProfile,omitempty"`
	// An array of relationships to recoveryConfigResultEntry resources.
	ResultEntries *[]RecoveryConfigResultEntryRelationship `json:"ResultEntries,omitempty" yaml:"ResultEntries,omitempty"`
}
