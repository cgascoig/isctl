...
func (dst *FabricConfigResultResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "fabric.ConfigResult.List":
			var result *FabricConfigResultList = &FabricConfigResultList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FabricConfigResultList = result
			return nil
...
func (src *FabricConfigResultResponse) MarshalYAML() ([]byte, error) {
	if src.FabricConfigResultList != nil {
		return yaml.Marshal(&src.FabricConfigResultList)
	}
