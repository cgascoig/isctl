...
type ResourcePerTypeCombinedSelectorAllOf struct {
	...
	CombinedSelector *string `json:"CombinedSelector,omitempty" yaml:"CombinedSelector,omitempty"`
	// If true, then resources are added using just object type without filter.
	EmptyFilter *bool `json:"EmptyFilter,omitempty" yaml:"EmptyFilter,omitempty"`
	// The ObjectType on which the selectors are defined. Used to efficiently query resource groups for a given ObjectType.
	SelectorObjectType *string `json:"SelectorObjectType,omitempty" yaml:"SelectorObjectType,omitempty"`
}
