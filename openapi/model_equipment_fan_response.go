...
func (dst *EquipmentFanResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "equipment.Fan.List":
			var result *EquipmentFanList = &EquipmentFanList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentFanList = result
			return nil
...
func (src *EquipmentFanResponse) MarshalYAML() ([]byte, error) {
	if src.EquipmentFanList != nil {
		return yaml.Marshal(&src.EquipmentFanList)
	}
