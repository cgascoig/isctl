...
func (dst *AdapterConfigPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "adapter.ConfigPolicy.List":
			var result *AdapterConfigPolicyList = &AdapterConfigPolicyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.AdapterConfigPolicyList = result
			return nil
...
func (src *AdapterConfigPolicyResponse) MarshalYAML() ([]byte, error) {
	if src.AdapterConfigPolicyList != nil {
		return yaml.Marshal(&src.AdapterConfigPolicyList)
	}
