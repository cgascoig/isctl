...
func (dst *HyperflexNodeConfigPolicyRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.NodeConfigPolicy":
			var result *HyperflexNodeConfigPolicy = &HyperflexNodeConfigPolicy{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexNodeConfigPolicy = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexNodeConfigPolicyRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexNodeConfigPolicy != nil {
		return yaml.Marshal(&src.HyperflexNodeConfigPolicy)
	}
