...
type StorageVirtualDriveExtensionAllOf struct {
	...
	OperDeviceId *string `json:"OperDeviceId,omitempty" yaml:"OperDeviceId,omitempty"`
	...
	VirtualDriveDn *string `json:"VirtualDriveDn,omitempty" yaml:"VirtualDriveDn,omitempty"`
