...
func (dst *StorageHyperFlexStorageContainerResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		...
		case "mo.TagSummary":
			...
			return nil
		case "storage.HyperFlexStorageContainer.List":
			var result *StorageHyperFlexStorageContainerList = &StorageHyperFlexStorageContainerList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.StorageHyperFlexStorageContainerList = result
			return nil
		default:
...
func (src *StorageHyperFlexStorageContainerResponse) MarshalYAML() ([]byte, error) {
	if src.MoAggregateTransform != nil {
	...
	if src.StorageHyperFlexStorageContainerList != nil {
		return yaml.Marshal(&src.StorageHyperFlexStorageContainerList)
	}
