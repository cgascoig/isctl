...
type HyperflexProtectionInfoAllOf struct {
	...
	VmCurrentProtectionInfo        NullableHyperflexSnapshotInfoBrief      `json:"VmCurrentProtectionInfo,omitempty" yaml:"VmCurrentProtectionInfo,omitempty"`
	VmLastSuccessfulProtectionInfo NullableHyperflexSnapshotInfoBrief      `json:"VmLastSuccessfulProtectionInfo,omitempty" yaml:"VmLastSuccessfulProtectionInfo,omitempty"`
	VmSpaceUsage                   NullableHyperflexVmProtectionSpaceUsage `json:"VmSpaceUsage,omitempty" yaml:"VmSpaceUsage,omitempty"`
}
