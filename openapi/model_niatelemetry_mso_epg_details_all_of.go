...
type NiatelemetryMsoEpgDetailsAllOf struct {
	...
	DeployedSites *string `json:"DeployedSites,omitempty" yaml:"DeployedSites,omitempty"`
	// Name of EPG in Multi-Site Orchestrator.
	EpgName *string `json:"EpgName,omitempty" yaml:"EpgName,omitempty"`
	// Is the EPG local to the Multi-Site Orchestrator.
	IsLocal *string `json:"IsLocal,omitempty" yaml:"IsLocal,omitempty"`
