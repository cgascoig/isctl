...
func (dst *EquipmentFexRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "equipment.Fex":
			var result *EquipmentFex = &EquipmentFex{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentFex = result
			return nil
		case "mo.MoRef":
...
func (src *EquipmentFexRelationship) MarshalYAML() ([]byte, error) {
	if src.EquipmentFex != nil {
		return yaml.Marshal(&src.EquipmentFex)
	}
