...
type FabricFlowControlPolicy struct {
	...
	PriorityFlowControlMode *string `json:"PriorityFlowControlMode,omitempty" yaml:"PriorityFlowControlMode,omitempty"`
	...
	ReceiveDirection *string `json:"ReceiveDirection,omitempty" yaml:"ReceiveDirection,omitempty"`
	...
	SendDirection *string                               `json:"SendDirection,omitempty" yaml:"SendDirection,omitempty"`
