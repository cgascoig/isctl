...
type IamLdapPolicy struct {
	...
	BaseProperties NullableIamLdapBaseProperties `json:"BaseProperties,omitempty" yaml:"BaseProperties,omitempty"`
	DnsParameters  NullableIamLdapDnsParameters  `json:"DnsParameters,omitempty" yaml:"DnsParameters,omitempty"`
