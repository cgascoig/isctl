...
type HyperflexClusterNetworkPolicy struct {
	...
	KvmIpRange     *HyperflexIpAddrRange        `json:"KvmIpRange,omitempty" yaml:"KvmIpRange,omitempty"`
	MacPrefixRange *HyperflexMacAddrPrefixRange `json:"MacPrefixRange,omitempty" yaml:"MacPrefixRange,omitempty"`
	MgmtVlan       *HyperflexNamedVlan          `json:"MgmtVlan,omitempty" yaml:"MgmtVlan,omitempty"`
	...
	VmMigrationVlan *HyperflexNamedVlan   `json:"VmMigrationVlan,omitempty" yaml:"VmMigrationVlan,omitempty"`
