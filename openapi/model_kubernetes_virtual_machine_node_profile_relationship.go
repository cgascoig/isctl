...
func (dst *KubernetesVirtualMachineNodeProfileRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "kubernetes.VirtualMachineNodeProfile":
			var result *KubernetesVirtualMachineNodeProfile = &KubernetesVirtualMachineNodeProfile{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesVirtualMachineNodeProfile = result
			return nil
		case "mo.MoRef":
...
func (src *KubernetesVirtualMachineNodeProfileRelationship) MarshalYAML() ([]byte, error) {
	if src.KubernetesVirtualMachineNodeProfile != nil {
		return yaml.Marshal(&src.KubernetesVirtualMachineNodeProfile)
	}
