...
func (dst *IaasUcsdManagedInfraResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iaas.UcsdManagedInfra.List":
			var result *IaasUcsdManagedInfraList = &IaasUcsdManagedInfraList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IaasUcsdManagedInfraList = result
			return nil
...
func (src *IaasUcsdManagedInfraResponse) MarshalYAML() ([]byte, error) {
	if src.IaasUcsdManagedInfraList != nil {
		return yaml.Marshal(&src.IaasUcsdManagedInfraList)
	}
