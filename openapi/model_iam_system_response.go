...
func (dst *IamSystemResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iam.System.List":
			var result *IamSystemList = &IamSystemList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamSystemList = result
			return nil
...
func (src *IamSystemResponse) MarshalYAML() ([]byte, error) {
	if src.IamSystemList != nil {
		return yaml.Marshal(&src.IamSystemList)
	}
