...
func (dst *ChassisConfigResultEntryResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "chassis.ConfigResultEntry.List":
			var result *ChassisConfigResultEntryList = &ChassisConfigResultEntryList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ChassisConfigResultEntryList = result
			return nil
...
func (src *ChassisConfigResultEntryResponse) MarshalYAML() ([]byte, error) {
	if src.ChassisConfigResultEntryList != nil {
		return yaml.Marshal(&src.ChassisConfigResultEntryList)
	}
