...
func (dst *NiaapiApicLatestMaintainedReleaseResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		...
		case "mo.TagSummary":
			...
			return nil
		case "niaapi.ApicLatestMaintainedRelease.List":
			var result *NiaapiApicLatestMaintainedReleaseList = &NiaapiApicLatestMaintainedReleaseList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.NiaapiApicLatestMaintainedReleaseList = result
			return nil
		default:
...
func (src *NiaapiApicLatestMaintainedReleaseResponse) MarshalYAML() ([]byte, error) {
	if src.MoAggregateTransform != nil {
	...
	if src.NiaapiApicLatestMaintainedReleaseList != nil {
		return yaml.Marshal(&src.NiaapiApicLatestMaintainedReleaseList)
	}
