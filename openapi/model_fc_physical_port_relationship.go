...
func (dst *FcPhysicalPortRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "fc.PhysicalPort":
			var result *FcPhysicalPort = &FcPhysicalPort{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FcPhysicalPort = result
			return nil
		case "mo.MoRef":
...
func (src *FcPhysicalPortRelationship) MarshalYAML() ([]byte, error) {
	if src.FcPhysicalPort != nil {
		return yaml.Marshal(&src.FcPhysicalPort)
	}
