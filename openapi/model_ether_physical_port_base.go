...
type EtherPhysicalPortBase struct {
	...
	OperSpeed *string `json:"OperSpeed,omitempty" yaml:"OperSpeed,omitempty"`
	...
	PortChannelId *int64 `json:"PortChannelId,omitempty" yaml:"PortChannelId,omitempty"`
	// Defines the transport type for this port (ethernet OR fc).
	PortType *string `json:"PortType,omitempty" yaml:"PortType,omitempty"`
	...
	AcknowledgedPeerInterface *PortInterfaceBaseRelationship `json:"AcknowledgedPeerInterface,omitempty" yaml:"AcknowledgedPeerInterface,omitempty"`
	PeerInterface             *PortInterfaceBaseRelationship `json:"PeerInterface,omitempty" yaml:"PeerInterface,omitempty"`
}
