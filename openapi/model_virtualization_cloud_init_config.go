...
type VirtualizationCloudInitConfig struct {
	...
	ConfigType *string `json:"ConfigType,omitempty" yaml:"ConfigType,omitempty"`
	...
	NetworkDataBase64Encoded *bool `json:"NetworkDataBase64Encoded,omitempty" yaml:"NetworkDataBase64Encoded,omitempty"`
	...
	UserDataBase64Encoded *bool `json:"UserDataBase64Encoded,omitempty" yaml:"UserDataBase64Encoded,omitempty"`
}
