...
type ConnectorStartStreamFromDevice struct {
	...
	MemberStream *bool `json:"MemberStream,omitempty" yaml:"MemberStream,omitempty"`
	// Any extra configuration needed to open/identify a stream.
	StreamConfig interface{} `json:"StreamConfig,omitempty" yaml:"StreamConfig,omitempty"`
