...
type StorageNetAppStorageVm struct {
	StorageBaseTenant `yaml:"StorageBaseTenant,inline"`
	...
	CifsEnabled *bool `json:"CifsEnabled,omitempty" yaml:"CifsEnabled,omitempty"`
	// Status for Fibre Channel Protocol ( FCP ) allowed to run on Vservers.
	FcpEnabled *bool `json:"FcpEnabled,omitempty" yaml:"FcpEnabled,omitempty"`
	// Status for iSCSI protocol allowed to run on Vservers.
	IscsiEnabled *bool `json:"IscsiEnabled,omitempty" yaml:"IscsiEnabled,omitempty"`
	...
	NvmeEnabled *bool                             `json:"NvmeEnabled,omitempty" yaml:"NvmeEnabled,omitempty"`
