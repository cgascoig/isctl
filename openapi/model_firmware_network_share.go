...
type FirmwareNetworkShare struct {
	...
	CifsServer NullableFirmwareCifsServer `json:"CifsServer,omitempty" yaml:"CifsServer,omitempty"`
	HttpServer NullableFirmwareHttpServer `json:"HttpServer,omitempty" yaml:"HttpServer,omitempty"`
	...
	NfsServer NullableFirmwareNfsServer `json:"NfsServer,omitempty" yaml:"NfsServer,omitempty"`
