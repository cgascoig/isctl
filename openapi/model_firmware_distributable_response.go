...
func (dst *FirmwareDistributableResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "firmware.Distributable.List":
			var result *FirmwareDistributableList = &FirmwareDistributableList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FirmwareDistributableList = result
			return nil
...
func (src *FirmwareDistributableResponse) MarshalYAML() ([]byte, error) {
	if src.FirmwareDistributableList != nil {
		return yaml.Marshal(&src.FirmwareDistributableList)
	}
