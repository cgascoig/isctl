...
func (dst *SoftwarerepositoryOperatingSystemFileRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "mo.MoRef":
			...
			dst.MoMoRef = result
			return nil
		case "softwarerepository.OperatingSystemFile":
			var result *SoftwarerepositoryOperatingSystemFile = &SoftwarerepositoryOperatingSystemFile{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.SoftwarerepositoryOperatingSystemFile = result
			return nil
		default:
...
func (src *SoftwarerepositoryOperatingSystemFileRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.SoftwarerepositoryOperatingSystemFile != nil {
		return yaml.Marshal(&src.SoftwarerepositoryOperatingSystemFile)
	}
