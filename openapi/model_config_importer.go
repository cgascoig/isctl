...
type ConfigImporter struct {
	...
	ImportSource *string `json:"ImportSource,omitempty" yaml:"ImportSource,omitempty"`
	// An identifier for the importer instance.
	Name *string `json:"Name,omitempty" yaml:"Name,omitempty"`
	// Specifies whether integrity checks must be skipped.
	SkipIntegrityChecks *bool `json:"SkipIntegrityChecks,omitempty" yaml:"SkipIntegrityChecks,omitempty"`
	...
	ImportedItems []ConfigImportedItemRelationship      `json:"ImportedItems,omitempty" yaml:"ImportedItems,omitempty"`
