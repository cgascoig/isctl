...
type StorageFlexFlashControllerProps struct {
	...
	CardsManageable *string `json:"CardsManageable,omitempty" yaml:"CardsManageable,omitempty"`
	// Mode configured on the flex flash controller.
	ConfiguredMode *string `json:"ConfiguredMode,omitempty" yaml:"ConfiguredMode,omitempty"`
	...
	FwVersion *string `json:"FwVersion,omitempty" yaml:"FwVersion,omitempty"`
	// Internal state of the flex flash controller.
	InternalState *string `json:"InternalState,omitempty" yaml:"InternalState,omitempty"`
	// Operating mode of flex flash controller.
	OperatingMode *string `json:"OperatingMode,omitempty" yaml:"OperatingMode,omitempty"`
	// Number of connected physical drives to a specific Flex flash controller.
	PhysicalDriveCount *string `json:"PhysicalDriveCount,omitempty" yaml:"PhysicalDriveCount,omitempty"`
	...
	StartupFwVersion *string `json:"StartupFwVersion,omitempty" yaml:"StartupFwVersion,omitempty"`
	// Number of virtual drives for a specific Flex flash controller.
	VirtualDriveCount          *string                                 `json:"VirtualDriveCount,omitempty" yaml:"VirtualDriveCount,omitempty"`
