...
type HyperflexClusterStoragePolicy struct {
	...
	LogicalAvalabilityZoneConfig NullableHyperflexLogicalAvailabilityZone `json:"LogicalAvalabilityZoneConfig,omitempty" yaml:"LogicalAvalabilityZoneConfig,omitempty"`
