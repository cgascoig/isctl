...
type HclHardwareCompatibilityProfileAllOf struct {
	...
	DriverIsoUrl *string `json:"DriverIsoUrl,omitempty" yaml:"DriverIsoUrl,omitempty"`
	...
	ProcessorModel *string      `json:"ProcessorModel,omitempty" yaml:"ProcessorModel,omitempty"`
	Products       []HclProduct `json:"Products,omitempty" yaml:"Products,omitempty"`
	// Model of the server as returned by UCSM/CIMC XML API.
	ServerModel *string `json:"ServerModel,omitempty" yaml:"ServerModel,omitempty"`
	// Revision of the server model.
	ServerRevision *string `json:"ServerRevision,omitempty" yaml:"ServerRevision,omitempty"`
	// Version of the UCS software.
	UcsVersion *string `json:"UcsVersion,omitempty" yaml:"UcsVersion,omitempty"`
