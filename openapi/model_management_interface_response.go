...
func (dst *ManagementInterfaceResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "management.Interface.List":
			var result *ManagementInterfaceList = &ManagementInterfaceList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ManagementInterfaceList = result
			return nil
...
func (src *ManagementInterfaceResponse) MarshalYAML() ([]byte, error) {
	if src.ManagementInterfaceList != nil {
		return yaml.Marshal(&src.ManagementInterfaceList)
	}
