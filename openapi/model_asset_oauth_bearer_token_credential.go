...
type AssetOauthBearerTokenCredential struct {
	AssetCredential `yaml:"AssetCredential,inline"`
	...
	IsTokenSet *bool `json:"IsTokenSet,omitempty" yaml:"IsTokenSet,omitempty"`
	...
	ScopeValue *string `json:"ScopeValue,omitempty" yaml:"ScopeValue,omitempty"`
