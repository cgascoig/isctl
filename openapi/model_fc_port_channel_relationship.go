...
func (dst *FcPortChannelRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "fc.PortChannel":
			var result *FcPortChannel = &FcPortChannel{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FcPortChannel = result
			return nil
		case "mo.MoRef":
...
func (src *FcPortChannelRelationship) MarshalYAML() ([]byte, error) {
	if src.FcPortChannel != nil {
		return yaml.Marshal(&src.FcPortChannel)
	}
