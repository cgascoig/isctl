...
func (dst *CapabilityPsuManufacturingDefResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "capability.PsuManufacturingDef.List":
			var result *CapabilityPsuManufacturingDefList = &CapabilityPsuManufacturingDefList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.CapabilityPsuManufacturingDefList = result
			return nil
...
func (src *CapabilityPsuManufacturingDefResponse) MarshalYAML() ([]byte, error) {
	if src.CapabilityPsuManufacturingDefList != nil {
		return yaml.Marshal(&src.CapabilityPsuManufacturingDefList)
	}
