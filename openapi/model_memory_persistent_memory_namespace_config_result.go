...
type MemoryPersistentMemoryNamespaceConfigResult struct {
	...
	ConfigStatus *string `json:"ConfigStatus,omitempty" yaml:"ConfigStatus,omitempty"`
	...
	MemoryPersistentMemoryConfigResult *MemoryPersistentMemoryConfigResultRelationship `json:"MemoryPersistentMemoryConfigResult,omitempty" yaml:"MemoryPersistentMemoryConfigResult,omitempty"`
