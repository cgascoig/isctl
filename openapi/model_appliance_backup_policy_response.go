...
func (dst *ApplianceBackupPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "appliance.BackupPolicy.List":
			var result *ApplianceBackupPolicyList = &ApplianceBackupPolicyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ApplianceBackupPolicyList = result
			return nil
...
func (src *ApplianceBackupPolicyResponse) MarshalYAML() ([]byte, error) {
	if src.ApplianceBackupPolicyList != nil {
		return yaml.Marshal(&src.ApplianceBackupPolicyList)
	}
