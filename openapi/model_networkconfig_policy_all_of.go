...
type NetworkconfigPolicyAllOf struct {
	...
	// IP address of the secondary DNS server.
	AlternateIpv6dnsServer *string `json:"AlternateIpv6dnsServer,omitempty" yaml:"AlternateIpv6dnsServer,omitempty"`
	...
	DynamicDnsDomain *string `json:"DynamicDnsDomain,omitempty" yaml:"DynamicDnsDomain,omitempty"`
	// If enabled, updates the resource records to the DNS from Cisco IMC.
	EnableDynamicDns *bool `json:"EnableDynamicDns,omitempty" yaml:"EnableDynamicDns,omitempty"`
	...
	EnableIpv4dnsFromDhcp *bool `json:"EnableIpv4dnsFromDhcp,omitempty" yaml:"EnableIpv4dnsFromDhcp,omitempty"`
	...
	EnableIpv6dnsFromDhcp *bool `json:"EnableIpv6dnsFromDhcp,omitempty" yaml:"EnableIpv6dnsFromDhcp,omitempty"`
	// IP address of the primary DNS server.
	PreferredIpv4dnsServer *string `json:"PreferredIpv4dnsServer,omitempty" yaml:"PreferredIpv4dnsServer,omitempty"`
	// IP address of the primary DNS server.
	PreferredIpv6dnsServer *string                               `json:"PreferredIpv6dnsServer,omitempty" yaml:"PreferredIpv6dnsServer,omitempty"`
