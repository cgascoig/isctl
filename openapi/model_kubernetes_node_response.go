...
func (dst *KubernetesNodeResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "kubernetes.Node.List":
			var result *KubernetesNodeList = &KubernetesNodeList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesNodeList = result
			return nil
...
func (src *KubernetesNodeResponse) MarshalYAML() ([]byte, error) {
	if src.KubernetesNodeList != nil {
		return yaml.Marshal(&src.KubernetesNodeList)
	}
