...
func (dst *GraphicsCardRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "graphics.Card":
			var result *GraphicsCard = &GraphicsCard{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.GraphicsCard = result
			return nil
		case "mo.MoRef":
...
func (src *GraphicsCardRelationship) MarshalYAML() ([]byte, error) {
	if src.GraphicsCard != nil {
		return yaml.Marshal(&src.GraphicsCard)
	}
