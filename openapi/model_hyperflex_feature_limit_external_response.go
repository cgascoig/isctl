...
func (dst *HyperflexFeatureLimitExternalResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "hyperflex.FeatureLimitExternal.List":
			var result *HyperflexFeatureLimitExternalList = &HyperflexFeatureLimitExternalList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexFeatureLimitExternalList = result
			return nil
...
func (src *HyperflexFeatureLimitExternalResponse) MarshalYAML() ([]byte, error) {
	if src.HyperflexFeatureLimitExternalList != nil {
		return yaml.Marshal(&src.HyperflexFeatureLimitExternalList)
	}
