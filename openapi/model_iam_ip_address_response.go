...
func (dst *IamIpAddressResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iam.IpAddress.List":
			var result *IamIpAddressList = &IamIpAddressList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamIpAddressList = result
			return nil
...
func (src *IamIpAddressResponse) MarshalYAML() ([]byte, error) {
	if src.IamIpAddressList != nil {
		return yaml.Marshal(&src.IamIpAddressList)
	}
