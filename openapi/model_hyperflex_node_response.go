...
func (dst *HyperflexNodeResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "hyperflex.Node.List":
			var result *HyperflexNodeList = &HyperflexNodeList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexNodeList = result
			return nil
...
func (src *HyperflexNodeResponse) MarshalYAML() ([]byte, error) {
	if src.HyperflexNodeList != nil {
		return yaml.Marshal(&src.HyperflexNodeList)
	}
