...
func (dst *KubernetesClusterProfileRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "kubernetes.ClusterProfile":
			var result *KubernetesClusterProfile = &KubernetesClusterProfile{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesClusterProfile = result
			return nil
		case "mo.MoRef":
...
func (src *KubernetesClusterProfileRelationship) MarshalYAML() ([]byte, error) {
	if src.KubernetesClusterProfile != nil {
		return yaml.Marshal(&src.KubernetesClusterProfile)
	}
