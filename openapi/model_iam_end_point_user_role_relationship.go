...
func (dst *IamEndPointUserRoleRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "iam.EndPointUserRole":
			var result *IamEndPointUserRole = &IamEndPointUserRole{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamEndPointUserRole = result
			return nil
		case "mo.MoRef":
...
func (src *IamEndPointUserRoleRelationship) MarshalYAML() ([]byte, error) {
	if src.IamEndPointUserRole != nil {
		return yaml.Marshal(&src.IamEndPointUserRole)
	}
