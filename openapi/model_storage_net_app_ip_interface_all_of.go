...
type StorageNetAppIpInterfaceAllOf struct {
	...
	HomeNode *string `json:"HomeNode,omitempty" yaml:"HomeNode,omitempty"`
	// Name of home port of IP interface.
	HomePort *string `json:"HomePort,omitempty" yaml:"HomePort,omitempty"`
	...
	ServicePolicyName *string `json:"ServicePolicyName,omitempty" yaml:"ServicePolicyName,omitempty"`
	// Services of IP interface.
	ServicePolicyUuid *string  `json:"ServicePolicyUuid,omitempty" yaml:"ServicePolicyUuid,omitempty"`
	...
	ArrayController    *StorageNetAppNodeRelationship         `json:"ArrayController,omitempty" yaml:"ArrayController,omitempty"`
	NetAppEthernetPort *StorageNetAppEthernetPortRelationship `json:"NetAppEthernetPort,omitempty" yaml:"NetAppEthernetPort,omitempty"`
