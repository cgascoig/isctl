...
func (dst *FabricConfigChangeDetailRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "fabric.ConfigChangeDetail":
			var result *FabricConfigChangeDetail = &FabricConfigChangeDetail{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FabricConfigChangeDetail = result
			return nil
		case "mo.MoRef":
...
func (src *FabricConfigChangeDetailRelationship) MarshalYAML() ([]byte, error) {
	if src.FabricConfigChangeDetail != nil {
		return yaml.Marshal(&src.FabricConfigChangeDetail)
	}
