...
type ApplianceDeviceCertificateAllOf struct {
	...
	CaCertificateExpiryTime *time.Time `json:"CaCertificateExpiryTime,omitempty" yaml:"CaCertificateExpiryTime,omitempty"`
	// The date time allocated till cert renewal will be executed. This time used here will be based on cert renewal plan.
	CertificateRenewalExpiryTime *time.Time                  `json:"CertificateRenewalExpiryTime,omitempty" yaml:"CertificateRenewalExpiryTime,omitempty"`
	CompletedPhases              []ApplianceCertRenewalPhase `json:"CompletedPhases,omitempty" yaml:"CompletedPhases,omitempty"`
	// The operation configuration MOId.
	ConfigurationMoId *string                           `json:"ConfigurationMoId,omitempty" yaml:"ConfigurationMoId,omitempty"`
	CurrentPhase      NullableApplianceCertRenewalPhase `json:"CurrentPhase,omitempty" yaml:"CurrentPhase,omitempty"`
	...
	LastSuccessPollTime *time.Time `json:"LastSuccessPollTime,omitempty" yaml:"LastSuccessPollTime,omitempty"`
