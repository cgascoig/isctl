...
type HyperflexBaseCluster struct {
	VirtualizationBaseCluster `yaml:"VirtualizationBaseCluster,inline"`
	...
	ClusterPurpose *string `json:"ClusterPurpose,omitempty" yaml:"ClusterPurpose,omitempty"`
	...
	StorageCapacity *int64 `json:"StorageCapacity,omitempty" yaml:"StorageCapacity,omitempty"`
	// The number of storage nodes that belong to this cluster.
	StorageNodeCount *int64 `json:"StorageNodeCount,omitempty" yaml:"StorageNodeCount,omitempty"`
	// The storage utilization is computed based on total capacity and current capacity utilization.
	StorageUtilization *float32 `json:"StorageUtilization,omitempty" yaml:"StorageUtilization,omitempty"`
	...
	AssociatedProfile          *PolicyAbstractProfileRelationship `json:"AssociatedProfile,omitempty" yaml:"AssociatedProfile,omitempty"`
	// An array of relationships to hyperflexBaseCluster resources.
	ChildClusters []HyperflexBaseClusterRelationship `json:"ChildClusters,omitempty" yaml:"ChildClusters,omitempty"`
	ParentCluster *HyperflexBaseClusterRelationship  `json:"ParentCluster,omitempty" yaml:"ParentCluster,omitempty"`
}
