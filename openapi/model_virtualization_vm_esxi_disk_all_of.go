...
type VirtualizationVmEsxiDiskAllOf struct {
	...
	StorageAllocation *string `json:"StorageAllocation,omitempty" yaml:"StorageAllocation,omitempty"`
	// Controller name of the disk, if not specified uses the default one.
	StorageController *string `json:"StorageController,omitempty" yaml:"StorageController,omitempty"`
}
