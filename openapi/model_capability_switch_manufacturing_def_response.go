...
func (dst *CapabilitySwitchManufacturingDefResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "capability.SwitchManufacturingDef.List":
			var result *CapabilitySwitchManufacturingDefList = &CapabilitySwitchManufacturingDefList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.CapabilitySwitchManufacturingDefList = result
			return nil
...
func (src *CapabilitySwitchManufacturingDefResponse) MarshalYAML() ([]byte, error) {
	if src.CapabilitySwitchManufacturingDefList != nil {
		return yaml.Marshal(&src.CapabilitySwitchManufacturingDefList)
	}
