...
type IaasMostRunTasksAllOf struct {
	...
	TaskCategory *string `json:"TaskCategory,omitempty" yaml:"TaskCategory,omitempty"`
	// Number of times this task has executed.
	TaskExecutionCount *int64 `json:"TaskExecutionCount,omitempty" yaml:"TaskExecutionCount,omitempty"`
