...
func (dst *KubernetesDaemonSetResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "kubernetes.DaemonSet.List":
			var result *KubernetesDaemonSetList = &KubernetesDaemonSetList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesDaemonSetList = result
			return nil
...
func (src *KubernetesDaemonSetResponse) MarshalYAML() ([]byte, error) {
	if src.KubernetesDaemonSetList != nil {
		return yaml.Marshal(&src.KubernetesDaemonSetList)
	}
