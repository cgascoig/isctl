...
func (dst *KubernetesVirtualMachineInfraConfigPolicyRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "kubernetes.VirtualMachineInfraConfigPolicy":
			var result *KubernetesVirtualMachineInfraConfigPolicy = &KubernetesVirtualMachineInfraConfigPolicy{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesVirtualMachineInfraConfigPolicy = result
			return nil
		case "mo.MoRef":
...
func (src *KubernetesVirtualMachineInfraConfigPolicyRelationship) MarshalYAML() ([]byte, error) {
	if src.KubernetesVirtualMachineInfraConfigPolicy != nil {
		return yaml.Marshal(&src.KubernetesVirtualMachineInfraConfigPolicy)
	}
