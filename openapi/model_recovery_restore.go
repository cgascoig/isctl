...
type RecoveryRestore struct {
	...
	ConfigParams NullableRecoveryConfigParams            `json:"ConfigParams,omitempty" yaml:"ConfigParams,omitempty"`
	BackupInfo   *RecoveryAbstractBackupInfoRelationship `json:"BackupInfo,omitempty" yaml:"BackupInfo,omitempty"`
