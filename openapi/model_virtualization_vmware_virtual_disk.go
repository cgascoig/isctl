...
type VirtualizationVmwareVirtualDisk struct {
	VirtualizationBaseVirtualDisk `yaml:"VirtualizationBaseVirtualDisk,inline"`
	...
	CompatibilityMode *string `json:"CompatibilityMode,omitempty" yaml:"CompatibilityMode,omitempty"`
	// Key of the controller on which the disk is created.
	ControllerKey *int64 `json:"ControllerKey,omitempty" yaml:"ControllerKey,omitempty"`
	...
	DiskMode *string `json:"DiskMode,omitempty" yaml:"DiskMode,omitempty"`
	...
	Shares NullableVirtualizationVmwareSharesInfo `json:"Shares,omitempty" yaml:"Shares,omitempty"`
	...
	StorageAllocationType *string `json:"StorageAllocationType,omitempty" yaml:"StorageAllocationType,omitempty"`
	// Unit number of the disk on its controller.
	UnitNumber *int64 `json:"UnitNumber,omitempty" yaml:"UnitNumber,omitempty"`
	// UUID assigned by vCenter to every disk.
	Uuid *string `json:"Uuid,omitempty" yaml:"Uuid,omitempty"`
	// Identity of the virtual disk object as the first class entity.
	VdiskId *string `json:"VdiskId,omitempty" yaml:"VdiskId,omitempty"`
	// Vendor of the storage device.
	Vendor *string `json:"Vendor,omitempty" yaml:"Vendor,omitempty"`
	// Path of the virtual disk.
	VirtualDiskPath *string `json:"VirtualDiskPath,omitempty" yaml:"VirtualDiskPath,omitempty"`
	// Identity of the virtual machine where the virtual disk is created.
	VmIdentity     *string                                         `json:"VmIdentity,omitempty" yaml:"VmIdentity,omitempty"`
	Datastore      *VirtualizationVmwareDatastoreRelationship      `json:"Datastore,omitempty" yaml:"Datastore,omitempty"`
	VirtualMachine *VirtualizationVmwareVirtualMachineRelationship `json:"VirtualMachine,omitempty" yaml:"VirtualMachine,omitempty"`
}
