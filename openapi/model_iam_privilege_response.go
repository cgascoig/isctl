...
func (dst *IamPrivilegeResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "iam.Privilege.List":
			var result *IamPrivilegeList = &IamPrivilegeList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamPrivilegeList = result
			return nil
...
func (src *IamPrivilegeResponse) MarshalYAML() ([]byte, error) {
	if src.IamPrivilegeList != nil {
		return yaml.Marshal(&src.IamPrivilegeList)
	}
