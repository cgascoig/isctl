...
type KubernetesNode struct {
	KubernetesAbstractNode `yaml:"KubernetesAbstractNode,inline"`
	// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
	ClassId string `json:"ClassId" yaml:"ClassId"`
	// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
	ObjectType       string                               `json:"ObjectType" yaml:"ObjectType"`
	NodeAddresses    []KubernetesNodeAddress              `json:"NodeAddresses,omitempty" yaml:"NodeAddresses,omitempty"`
	NodeInfo         NullableKubernetesNodeInfo           `json:"NodeInfo,omitempty" yaml:"NodeInfo,omitempty"`
	NodeSpec         NullableKubernetesNodeSpec           `json:"NodeSpec,omitempty" yaml:"NodeSpec,omitempty"`
	NodeStatuses     []KubernetesNodeStatus               `json:"NodeStatuses,omitempty" yaml:"NodeStatuses,omitempty"`
