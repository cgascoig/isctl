...
func (r apiCreateServerProfileTemplateRequest) Execute() (ServerProfileTemplate, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ServerApiService.CreateServerProfileTemplate")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiDeleteServerProfileTemplateRequest) Execute() (*_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ServerApiService.DeleteServerProfileTemplate")
	if err != nil {
		return nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiGetServerProfileTemplateByMoidRequest) Execute() (ServerProfileTemplate, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ServerApiService.GetServerProfileTemplateByMoid")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiGetServerProfileTemplateListRequest) Execute() (ServerProfileTemplateResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ServerApiService.GetServerProfileTemplateList")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiPatchServerProfileTemplateRequest) Execute() (ServerProfileTemplate, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ServerApiService.PatchServerProfileTemplate")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiUpdateServerProfileTemplateRequest) Execute() (ServerProfileTemplate, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ServerApiService.UpdateServerProfileTemplate")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
