...
type HyperflexHxapHost struct {
	...
	ChassisVersion *string `json:"ChassisVersion,omitempty" yaml:"ChassisVersion,omitempty"`
	...
	InternalIpAddress *string `json:"InternalIpAddress,omitempty" yaml:"InternalIpAddress,omitempty"`
	...
	MasterRole       *bool                                  `json:"MasterRole,omitempty" yaml:"MasterRole,omitempty"`
	...
	PhysicalServer *ComputePhysicalRelationship      `json:"PhysicalServer,omitempty" yaml:"PhysicalServer,omitempty"`
}
