...
type NiaapiFieldNoticeAllOf struct {
	...
	Bugid *string `json:"Bugid,omitempty" yaml:"Bugid,omitempty"`
	// Field notice Description.
	FieldNoticeDesc *string `json:"FieldNoticeDesc,omitempty" yaml:"FieldNoticeDesc,omitempty"`
	// Fieldnotice Id of this notice.
	FieldNoticeId *string `json:"FieldNoticeId,omitempty" yaml:"FieldNoticeId,omitempty"`
	// Field notice URL link to the notice webpage.
	FieldNoticeUrl *string `json:"FieldNoticeUrl,omitempty" yaml:"FieldNoticeUrl,omitempty"`
	...
	Hwpid        *string               `json:"Hwpid,omitempty" yaml:"Hwpid,omitempty"`
	RevisionInfo *[]NiaapiRevisionInfo `json:"RevisionInfo,omitempty" yaml:"RevisionInfo,omitempty"`
	// Software Release number for affected versions.
	SwRelease *string `json:"SwRelease,omitempty" yaml:"SwRelease,omitempty"`
	// URL of workaround of this notice.
	WorkaroundUrl *string `json:"WorkaroundUrl,omitempty" yaml:"WorkaroundUrl,omitempty"`
}
