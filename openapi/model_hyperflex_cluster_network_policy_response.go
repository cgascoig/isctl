...
func (dst *HyperflexClusterNetworkPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "hyperflex.ClusterNetworkPolicy.List":
			var result *HyperflexClusterNetworkPolicyList = &HyperflexClusterNetworkPolicyList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexClusterNetworkPolicyList = result
			return nil
...
func (src *HyperflexClusterNetworkPolicyResponse) MarshalYAML() ([]byte, error) {
	if src.HyperflexClusterNetworkPolicyList != nil {
		return yaml.Marshal(&src.HyperflexClusterNetworkPolicyList)
	}
