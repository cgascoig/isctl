...
type IppoolShadowPool struct {
	PoolAbstractPool `yaml:"PoolAbstractPool,inline"`
	// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
	ClassId string `json:"ClassId" yaml:"ClassId"`
	// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
	ObjectType string                   `json:"ObjectType" yaml:"ObjectType"`
	IpV4Blocks []IppoolIpV4Block        `json:"IpV4Blocks,omitempty" yaml:"IpV4Blocks,omitempty"`
	IpV4Config NullableIppoolIpV4Config `json:"IpV4Config,omitempty" yaml:"IpV4Config,omitempty"`
	IpV6Blocks []IppoolIpV6Block        `json:"IpV6Blocks,omitempty" yaml:"IpV6Blocks,omitempty"`
	...
	IpBlockHeads []IppoolShadowBlockRelationship `json:"IpBlockHeads,omitempty" yaml:"IpBlockHeads,omitempty"`
