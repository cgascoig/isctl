...
type FabricSwitchProfile struct {
	...
	AssignedSwitch   *NetworkElementRelationship `json:"AssignedSwitch,omitempty" yaml:"AssignedSwitch,omitempty"`
	AssociatedSwitch *NetworkElementRelationship `json:"AssociatedSwitch,omitempty" yaml:"AssociatedSwitch,omitempty"`
	// An array of relationships to fabricConfigChangeDetail resources.
	ConfigChangeDetails []FabricConfigChangeDetailRelationship `json:"ConfigChangeDetails,omitempty" yaml:"ConfigChangeDetails,omitempty"`
	ConfigResult        *FabricConfigResultRelationship        `json:"ConfigResult,omitempty" yaml:"ConfigResult,omitempty"`
	...
	SwitchClusterProfile *FabricSwitchClusterProfileRelationship `json:"SwitchClusterProfile,omitempty" yaml:"SwitchClusterProfile,omitempty"`
}
