...
type AssetDeviceTransaction struct {
	...
	StatusId *int32 `json:"StatusId,omitempty" yaml:"StatusId,omitempty"`
	// Timestamp field reported by Cisco Install Base.
	Timestamp *string `json:"Timestamp,omitempty" yaml:"Timestamp,omitempty"`
	// Transaction batch ID reported by Cisco Install Base.
	TransactionBatchId *int64 `json:"TransactionBatchId,omitempty" yaml:"TransactionBatchId,omitempty"`
	// Transaction Date reported by Cisco Install Base.
	TransactionDate *string `json:"TransactionDate,omitempty" yaml:"TransactionDate,omitempty"`
	// Transaction sequence reported by Cisco Install Base.
	TransactionSequence *int64 `json:"TransactionSequence,omitempty" yaml:"TransactionSequence,omitempty"`
}
