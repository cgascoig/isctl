...
func (dst *CondHclStatusJobResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "cond.HclStatusJob.List":
			var result *CondHclStatusJobList = &CondHclStatusJobList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.CondHclStatusJobList = result
			return nil
...
func (src *CondHclStatusJobResponse) MarshalYAML() ([]byte, error) {
	if src.CondHclStatusJobList != nil {
		return yaml.Marshal(&src.CondHclStatusJobList)
	}
