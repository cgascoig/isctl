...
func (dst *KubernetesVersionResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "kubernetes.Version.List":
			var result *KubernetesVersionList = &KubernetesVersionList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesVersionList = result
			return nil
...
func (src *KubernetesVersionResponse) MarshalYAML() ([]byte, error) {
	if src.KubernetesVersionList != nil {
		return yaml.Marshal(&src.KubernetesVersionList)
	}
