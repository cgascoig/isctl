...
func (dst *FirmwareDistributableMetaResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "firmware.DistributableMeta.List":
			var result *FirmwareDistributableMetaList = &FirmwareDistributableMetaList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.FirmwareDistributableMetaList = result
			return nil
...
func (src *FirmwareDistributableMetaResponse) MarshalYAML() ([]byte, error) {
	if src.FirmwareDistributableMetaList != nil {
		return yaml.Marshal(&src.FirmwareDistributableMetaList)
	}
