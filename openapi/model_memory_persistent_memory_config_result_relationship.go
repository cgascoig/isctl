...
func (dst *MemoryPersistentMemoryConfigResultRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "memory.PersistentMemoryConfigResult":
			var result *MemoryPersistentMemoryConfigResult = &MemoryPersistentMemoryConfigResult{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.MemoryPersistentMemoryConfigResult = result
			return nil
		case "mo.MoRef":
...
func (src *MemoryPersistentMemoryConfigResultRelationship) MarshalYAML() ([]byte, error) {
	if src.MemoryPersistentMemoryConfigResult != nil {
		return yaml.Marshal(&src.MemoryPersistentMemoryConfigResult)
	}
