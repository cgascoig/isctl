...
type NiaapiSoftwareEolAllOf struct {
	...
	AffectedVersions *string `json:"AffectedVersions,omitempty" yaml:"AffectedVersions,omitempty"`
	...
	SoftwareEolUrl *string `json:"SoftwareEolUrl,omitempty" yaml:"SoftwareEolUrl,omitempty"`
}
