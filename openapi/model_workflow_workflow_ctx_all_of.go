...
type WorkflowWorkflowCtxAllOf struct {
	...
	InitiatorCtx  NullableWorkflowInitiatorContext `json:"InitiatorCtx,omitempty" yaml:"InitiatorCtx,omitempty"`
	TargetCtxList []WorkflowTargetContext          `json:"TargetCtxList,omitempty" yaml:"TargetCtxList,omitempty"`
	// The name of workflowMeta of the workflow running.
	WorkflowMetaName *string `json:"WorkflowMetaName,omitempty" yaml:"WorkflowMetaName,omitempty"`
	// The subtype of the workflow.
	WorkflowSubtype *string `json:"WorkflowSubtype,omitempty" yaml:"WorkflowSubtype,omitempty"`
