...
type NetworkVlanPortInfoAllOf struct {
	...
	AccessVlanPortCount *int64 `json:"AccessVlanPortCount,omitempty" yaml:"AccessVlanPortCount,omitempty"`
	// The number of available VLAN border ports on a Fabric Interconnect.
	BorderVlanPortCount *int64 `json:"BorderVlanPortCount,omitempty" yaml:"BorderVlanPortCount,omitempty"`
	// The number of compressed VLAN Group count on a Fabric Interconnect calculated by VLAN port group library.
	CompressedOptimizationSetsValue *int64 `json:"CompressedOptimizationSetsValue,omitempty" yaml:"CompressedOptimizationSetsValue,omitempty"`
	// The number of compressed VLAN ports on a Fabric Interconnect.
	CompressedVlanPortCount *string `json:"CompressedVlanPortCount,omitempty" yaml:"CompressedVlanPortCount,omitempty"`
	// The number of compressed VLAN port count on a Fabric Interconnect calculated by VLAN port group library.
	CompressedVlanPortCountValue *int64 `json:"CompressedVlanPortCountValue,omitempty" yaml:"CompressedVlanPortCountValue,omitempty"`
	// The total number of VLAN ports on a Fabric Interconnect.
	TotalVlanPortCount *int64 `json:"TotalVlanPortCount,omitempty" yaml:"TotalVlanPortCount,omitempty"`
	// The number of uncompressed VLAN ports on a Fabric Interconnect.
	UncompressedVlanPortCount *string `json:"UncompressedVlanPortCount,omitempty" yaml:"UncompressedVlanPortCount,omitempty"`
	// The number of uncompressed VLAN port count on a Fabric Interconnect calculated by VLAN port group library.
	UncompressedVlanPortCountValue *int64 `json:"UncompressedVlanPortCountValue,omitempty" yaml:"UncompressedVlanPortCountValue,omitempty"`
	// The maximum number of VLAN ports allowed on a Fabric Interconnect.
	VlanPortLimit       *int64                               `json:"VlanPortLimit,omitempty" yaml:"VlanPortLimit,omitempty"`
