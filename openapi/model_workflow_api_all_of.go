...
type WorkflowApiAllOf struct {
	...
	ErrorContentType *string `json:"ErrorContentType,omitempty" yaml:"ErrorContentType,omitempty"`
	...
	ResponseSpec interface{} `json:"ResponseSpec,omitempty" yaml:"ResponseSpec,omitempty"`
