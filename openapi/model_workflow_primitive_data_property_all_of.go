...
type WorkflowPrimitiveDataPropertyAllOf struct {
	...
	Constraints       NullableWorkflowConstraints   `json:"Constraints,omitempty" yaml:"Constraints,omitempty"`
	InventorySelector []WorkflowMoReferenceProperty `json:"InventorySelector,omitempty" yaml:"InventorySelector,omitempty"`
