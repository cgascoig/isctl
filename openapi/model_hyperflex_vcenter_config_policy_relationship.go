...
func (dst *HyperflexVcenterConfigPolicyRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.VcenterConfigPolicy":
			var result *HyperflexVcenterConfigPolicy = &HyperflexVcenterConfigPolicy{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexVcenterConfigPolicy = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexVcenterConfigPolicyRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexVcenterConfigPolicy != nil {
		return yaml.Marshal(&src.HyperflexVcenterConfigPolicy)
	}
