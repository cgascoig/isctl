...
func (r apiGetIwotenantTenantStatusByMoidRequest) Execute() (IwotenantTenantStatus, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "IwotenantApiService.GetIwotenantTenantStatusByMoid")
	if err != nil {
...
func (r apiGetIwotenantTenantStatusListRequest) Execute() (IwotenantTenantStatusResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "IwotenantApiService.GetIwotenantTenantStatusList")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
