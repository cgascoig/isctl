...
func (dst *CapabilityCapabilityRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "capability.Capability":
			var result *CapabilityCapability = &CapabilityCapability{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.CapabilityCapability = result
			return nil
		case "mo.MoRef":
...
func (src *CapabilityCapabilityRelationship) MarshalYAML() ([]byte, error) {
	if src.CapabilityCapability != nil {
		return yaml.Marshal(&src.CapabilityCapability)
	}
