...
func (dst *KubernetesVersionPolicyRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "kubernetes.VersionPolicy":
			var result *KubernetesVersionPolicy = &KubernetesVersionPolicy{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesVersionPolicy = result
			return nil
		case "mo.MoRef":
...
func (src *KubernetesVersionPolicyRelationship) MarshalYAML() ([]byte, error) {
	if src.KubernetesVersionPolicy != nil {
		return yaml.Marshal(&src.KubernetesVersionPolicy)
	}
