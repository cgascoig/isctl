...
type LicenseCustomerOp struct {
	...
	EnableTrial *bool `json:"EnableTrial,omitempty" yaml:"EnableTrial,omitempty"`
	// The default Trial or Grace period customer is entitled to.
	EvaluationPeriod *int64 `json:"EvaluationPeriod,omitempty" yaml:"EvaluationPeriod,omitempty"`
	// The number of days the trial Trial or Grace period is extended. The trial or grace period can be extended once.
	ExtraEvaluation *int64 `json:"ExtraEvaluation,omitempty" yaml:"ExtraEvaluation,omitempty"`
	// Trigger renew authorization.
	RenewAuthorization *bool `json:"RenewAuthorization,omitempty" yaml:"RenewAuthorization,omitempty"`
	// Trigger renew registration.
	RenewIdCertificate *bool `json:"RenewIdCertificate,omitempty" yaml:"RenewIdCertificate,omitempty"`
	// Trigger show tech support feature.
	ShowAgentTechSupport *bool                                  `json:"ShowAgentTechSupport,omitempty" yaml:"ShowAgentTechSupport,omitempty"`
	AccountLicenseData   *LicenseAccountLicenseDataRelationship `json:"AccountLicenseData,omitempty" yaml:"AccountLicenseData,omitempty"`
}
