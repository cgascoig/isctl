...
type NiatelemetryNxosBgpMvpnAllOf struct {
	...
	CapablePeers *int64 `json:"CapablePeers,omitempty" yaml:"CapablePeers,omitempty"`
	// Return count of BGP MVPN configured peers.
	ConfiguredPeers *int64 `json:"ConfiguredPeers,omitempty" yaml:"ConfiguredPeers,omitempty"`
	// Return value of BGP MVPN memory used.
	MemoryUsed *int64 `json:"MemoryUsed,omitempty" yaml:"MemoryUsed,omitempty"`
	// Return value of BGP MVPN cluster list.
	NumberOfClusterLists *int64 `json:"NumberOfClusterLists,omitempty" yaml:"NumberOfClusterLists,omitempty"`
	// Return count of BGP MVPN communities.
	NumberOfCommunities *int64 `json:"NumberOfCommunities,omitempty" yaml:"NumberOfCommunities,omitempty"`
	// Return value of BGP MVPN table version.
	TableVersion *int64 `json:"TableVersion,omitempty" yaml:"TableVersion,omitempty"`
	// Return count of BGP MVPN networks.
	TotalNetworks *int64 `json:"TotalNetworks,omitempty" yaml:"TotalNetworks,omitempty"`
	// Return count of BGP MVPN paths.
	TotalPaths *int64 `json:"TotalPaths,omitempty" yaml:"TotalPaths,omitempty"`
}
