...
func (dst *StoragePureProtectionGroupSnapshotResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		...
		case "mo.TagSummary":
			...
			return nil
		case "storage.PureProtectionGroupSnapshot.List":
			var result *StoragePureProtectionGroupSnapshotList = &StoragePureProtectionGroupSnapshotList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.StoragePureProtectionGroupSnapshotList = result
			return nil
		default:
...
func (src *StoragePureProtectionGroupSnapshotResponse) MarshalYAML() ([]byte, error) {
	if src.MoAggregateTransform != nil {
	...
	if src.StoragePureProtectionGroupSnapshotList != nil {
		return yaml.Marshal(&src.StoragePureProtectionGroupSnapshotList)
	}
