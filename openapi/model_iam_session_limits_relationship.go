...
func (dst *IamSessionLimitsRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "iam.SessionLimits":
			var result *IamSessionLimits = &IamSessionLimits{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IamSessionLimits = result
			return nil
		case "mo.MoRef":
...
func (src *IamSessionLimitsRelationship) MarshalYAML() ([]byte, error) {
	if src.IamSessionLimits != nil {
		return yaml.Marshal(&src.IamSessionLimits)
	}
