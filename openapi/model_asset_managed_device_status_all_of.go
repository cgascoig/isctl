...
type AssetManagedDeviceStatusAllOf struct {
	...
	CloudPort *int64 `json:"CloudPort,omitempty" yaml:"CloudPort,omitempty"`
	// Maintains the reason for the failure of connection to the Device in case of connection failure.
	ConnectionFailureReason *string `json:"ConnectionFailureReason,omitempty" yaml:"ConnectionFailureReason,omitempty"`
	...
	ProcessId *int64 `json:"ProcessId,omitempty" yaml:"ProcessId,omitempty"`
