...
func (dst *IaasConnectorPackRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "iaas.ConnectorPack":
			var result *IaasConnectorPack = &IaasConnectorPack{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IaasConnectorPack = result
			return nil
		case "mo.MoRef":
...
func (src *IaasConnectorPackRelationship) MarshalYAML() ([]byte, error) {
	if src.IaasConnectorPack != nil {
		return yaml.Marshal(&src.IaasConnectorPack)
	}
