...
type MemoryPersistentMemoryRegionAllOf struct {
	...
	FreeCapacity *string `json:"FreeCapacity,omitempty" yaml:"FreeCapacity,omitempty"`
	...
	InterleavedSetId *string `json:"InterleavedSetId,omitempty" yaml:"InterleavedSetId,omitempty"`
	// Set of locator IDs that are included in the Persistent Memory Region.
	LocaterIds *string `json:"LocaterIds,omitempty" yaml:"LocaterIds,omitempty"`
	...
	PersistentMemoryNamespaces []MemoryPersistentMemoryNamespaceRelationship `json:"PersistentMemoryNamespaces,omitempty" yaml:"PersistentMemoryNamespaces,omitempty"`
