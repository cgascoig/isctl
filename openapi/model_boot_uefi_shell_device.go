...
// BootUefiShellDevice UefiShell Boot Device configured on the server.
type BootUefiShellDevice struct {
...
type _BootUefiShellDevice BootUefiShellDevice
...
func (o BootUefiShellDevice) MarshalJSON() ([]byte, error) {
...
func (o *BootUefiShellDevice) UnmarshalJSON(bytes []byte) (err error) {
	type BootUefiShellDeviceWithoutEmbeddedStruct struct {
		// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
		ClassId string `json:"ClassId"`
		// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
		ObjectType          string                               `json:"ObjectType"`
	...
	varBootUefiShellDeviceWithoutEmbeddedStruct := BootUefiShellDeviceWithoutEmbeddedStruct{}

	err = json.Unmarshal(bytes, &varBootUefiShellDeviceWithoutEmbeddedStruct)
	if err == nil {
		varBootUefiShellDevice := _BootUefiShellDevice{}
		varBootUefiShellDevice.ClassId = varBootUefiShellDeviceWithoutEmbeddedStruct.ClassId
		varBootUefiShellDevice.ObjectType = varBootUefiShellDeviceWithoutEmbeddedStruct.ObjectType
		varBootUefiShellDevice.ComputePhysical = varBootUefiShellDeviceWithoutEmbeddedStruct.ComputePhysical
		varBootUefiShellDevice.InventoryDeviceInfo = varBootUefiShellDeviceWithoutEmbeddedStruct.InventoryDeviceInfo
		varBootUefiShellDevice.RegisteredDevice = varBootUefiShellDeviceWithoutEmbeddedStruct.RegisteredDevice
		*o = BootUefiShellDevice(varBootUefiShellDevice)
	} else {
		return err
	}
	...
	err = json.Unmarshal(bytes, &varBootUefiShellDevice)
	if err == nil {
		o.BootConfiguredDevice = varBootUefiShellDevice.BootConfiguredDevice
	} else {
		return err
	}
...
type NullableBootUefiShellDevice struct {
	value *BootUefiShellDevice
	isSet bool
}

func (v NullableBootUefiShellDevice) Get() *BootUefiShellDevice {
	return v.value
}

func (v *NullableBootUefiShellDevice) Set(val *BootUefiShellDevice) {
	v.value = val
	v.isSet = true
}

func (v NullableBootUefiShellDevice) IsSet() bool {
	return v.isSet
}

func (v *NullableBootUefiShellDevice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBootUefiShellDevice(val *BootUefiShellDevice) *NullableBootUefiShellDevice {
	return &NullableBootUefiShellDevice{value: val, isSet: true}
}

func (v NullableBootUefiShellDevice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBootUefiShellDevice) UnmarshalJSON(src []byte) error {
	v.isSet = true
