...
func (dst *ForecastCatalogResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "forecast.Catalog.List":
			var result *ForecastCatalogList = &ForecastCatalogList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ForecastCatalogList = result
			return nil
...
func (src *ForecastCatalogResponse) MarshalYAML() ([]byte, error) {
	if src.ForecastCatalogList != nil {
		return yaml.Marshal(&src.ForecastCatalogList)
	}
