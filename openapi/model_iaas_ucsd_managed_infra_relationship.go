...
func (dst *IaasUcsdManagedInfraRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "iaas.UcsdManagedInfra":
			var result *IaasUcsdManagedInfra = &IaasUcsdManagedInfra{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IaasUcsdManagedInfra = result
			return nil
		case "mo.MoRef":
...
func (src *IaasUcsdManagedInfraRelationship) MarshalYAML() ([]byte, error) {
	if src.IaasUcsdManagedInfra != nil {
		return yaml.Marshal(&src.IaasUcsdManagedInfra)
	}
