...
func (dst *IppoolPoolResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "ippool.Pool.List":
			var result *IppoolPoolList = &IppoolPoolList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.IppoolPoolList = result
			return nil
...
func (src *IppoolPoolResponse) MarshalYAML() ([]byte, error) {
	if src.IppoolPoolList != nil {
		return yaml.Marshal(&src.IppoolPoolList)
	}
