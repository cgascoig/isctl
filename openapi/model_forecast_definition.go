...
type ForecastDefinition struct {
	...
	AlertThresholdInPercentage *int64 `json:"AlertThresholdInPercentage,omitempty" yaml:"AlertThresholdInPercentage,omitempty"`
	...
	MinNumOfDaysOfData *int64 `json:"MinNumOfDaysOfData,omitempty" yaml:"MinNumOfDaysOfData,omitempty"`
	...
	NumOfDaysOfHistoricalData *int64 `json:"NumOfDaysOfHistoricalData,omitempty" yaml:"NumOfDaysOfHistoricalData,omitempty"`
	...
	Catalog      *ForecastCatalogRelationship `json:"Catalog,omitempty" yaml:"Catalog,omitempty"`
}
