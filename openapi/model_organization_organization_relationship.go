...
func (dst *OrganizationOrganizationRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		...
		case "organization.Organization":
			var result *OrganizationOrganization = &OrganizationOrganization{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.OrganizationOrganization = result
			return nil
		default:
...
func (src *OrganizationOrganizationRelationship) MarshalYAML() ([]byte, error) {
	if src.MoMoRef != nil {
		return yaml.Marshal(&src.MoMoRef)
	}

	if src.OrganizationOrganization != nil {
		return yaml.Marshal(&src.OrganizationOrganization)
	}
