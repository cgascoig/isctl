...
type WorkflowAssociatedRolesAllOf struct {
	...
	TaskNames     []string                  `json:"TaskNames,omitempty" yaml:"TaskNames,omitempty"`
	WorkflowRoles []WorkflowAssociatedRoles `json:"WorkflowRoles,omitempty" yaml:"WorkflowRoles,omitempty"`
}
