...
type ApplianceNodeInfo struct {
	...
	NodeIpV4Config NullableCommIpV4Interface `json:"NodeIpV4Config,omitempty" yaml:"NodeIpV4Config,omitempty"`
	NodeIpV6Config NullableCommIpV6Interface `json:"NodeIpV6Config,omitempty" yaml:"NodeIpV6Config,omitempty"`
