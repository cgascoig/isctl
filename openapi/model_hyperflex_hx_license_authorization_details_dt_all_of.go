...
type HyperflexHxLicenseAuthorizationDetailsDtAllOf struct {
	...
	CommunicationDeadlineDate *string `json:"CommunicationDeadlineDate,omitempty" yaml:"CommunicationDeadlineDate,omitempty"`
	// Evaluation period expired date
	EvaluationPeriodExpiredAt *string `json:"EvaluationPeriodExpiredAt,omitempty" yaml:"EvaluationPeriodExpiredAt,omitempty"`
	// Remaining evaluation period
	EvaluationPeriodRemaining *string `json:"EvaluationPeriodRemaining,omitempty" yaml:"EvaluationPeriodRemaining,omitempty"`
	// Last Communication Attempt Date
	LastCommunicationAttemptDate *string `json:"LastCommunicationAttemptDate,omitempty" yaml:"LastCommunicationAttemptDate,omitempty"`
	// Timestamp of Next Communication Attempt
	NextCommunicationAttemptDate *string `json:"NextCommunicationAttemptDate,omitempty" yaml:"NextCommunicationAttemptDate,omitempty"`
