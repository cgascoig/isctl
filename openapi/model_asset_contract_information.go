...
type AssetContractInformation struct {
	...
	BillTo               NullableAssetAddressInformation `json:"BillTo,omitempty" yaml:"BillTo,omitempty"`
	BillToGlobalUltimate NullableAssetGlobalUltimate     `json:"BillToGlobalUltimate,omitempty" yaml:"BillToGlobalUltimate,omitempty"`
	// Contract number for the Cisco support contract purchased for the Cisco device.
	ContractNumber *string `json:"ContractNumber,omitempty" yaml:"ContractNumber,omitempty"`
	// Contract status as per the Cisco Contract APIx.
	LineStatus *string `json:"LineStatus,omitempty" yaml:"LineStatus,omitempty"`
}
