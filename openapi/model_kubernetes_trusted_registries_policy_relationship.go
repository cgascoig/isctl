...
func (dst *KubernetesTrustedRegistriesPolicyRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "kubernetes.TrustedRegistriesPolicy":
			var result *KubernetesTrustedRegistriesPolicy = &KubernetesTrustedRegistriesPolicy{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesTrustedRegistriesPolicy = result
			return nil
		case "mo.MoRef":
...
func (src *KubernetesTrustedRegistriesPolicyRelationship) MarshalYAML() ([]byte, error) {
	if src.KubernetesTrustedRegistriesPolicy != nil {
		return yaml.Marshal(&src.KubernetesTrustedRegistriesPolicy)
	}
