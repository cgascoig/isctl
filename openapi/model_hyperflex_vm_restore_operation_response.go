...
func HyperflexVmRestoreOperationListAsHyperflexVmRestoreOperationResponse(v *HyperflexVmRestoreOperationList) HyperflexVmRestoreOperationResponse {
	return HyperflexVmRestoreOperationResponse{HyperflexVmRestoreOperationList: v}
}
...
func MoAggregateTransformAsHyperflexVmRestoreOperationResponse(v *MoAggregateTransform) HyperflexVmRestoreOperationResponse {
	return HyperflexVmRestoreOperationResponse{MoAggregateTransform: v}
}
...
func MoDocumentCountAsHyperflexVmRestoreOperationResponse(v *MoDocumentCount) HyperflexVmRestoreOperationResponse {
	return HyperflexVmRestoreOperationResponse{MoDocumentCount: v}
}
...
func MoTagSummaryAsHyperflexVmRestoreOperationResponse(v *MoTagSummary) HyperflexVmRestoreOperationResponse {
	return HyperflexVmRestoreOperationResponse{MoTagSummary: v}
}
...
func (dst *HyperflexVmRestoreOperationResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "hyperflex.VmRestoreOperation.List":
			var result *HyperflexVmRestoreOperationList = &HyperflexVmRestoreOperationList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexVmRestoreOperationList = result
			return nil
...
func (src *HyperflexVmRestoreOperationResponse) MarshalYAML() ([]byte, error) {
	if src.HyperflexVmRestoreOperationList != nil {
		return yaml.Marshal(&src.HyperflexVmRestoreOperationList)
	}
