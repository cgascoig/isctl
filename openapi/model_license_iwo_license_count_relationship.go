...
func (dst *LicenseIwoLicenseCountRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "license.IwoLicenseCount":
			var result *LicenseIwoLicenseCount = &LicenseIwoLicenseCount{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.LicenseIwoLicenseCount = result
			return nil
		case "mo.MoRef":
...
func (src *LicenseIwoLicenseCountRelationship) MarshalYAML() ([]byte, error) {
	if src.LicenseIwoLicenseCount != nil {
		return yaml.Marshal(&src.LicenseIwoLicenseCount)
	}
