...
type FirmwareNetworkShareAllOf struct {
	CifsServer *FirmwareCifsServer `json:"CifsServer,omitempty" yaml:"CifsServer,omitempty"`
	...
	NfsServer *FirmwareNfsServer `json:"NfsServer,omitempty" yaml:"NfsServer,omitempty"`
