...
func (dst *KubernetesConfigResultEntryResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "kubernetes.ConfigResultEntry.List":
			var result *KubernetesConfigResultEntryList = &KubernetesConfigResultEntryList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.KubernetesConfigResultEntryList = result
			return nil
...
func (src *KubernetesConfigResultEntryResponse) MarshalYAML() ([]byte, error) {
	if src.KubernetesConfigResultEntryList != nil {
		return yaml.Marshal(&src.KubernetesConfigResultEntryList)
	}
