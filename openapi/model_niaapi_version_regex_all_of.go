...
type NiaapiVersionRegexAllOf struct {
	...
	Apic       NullableNiaapiVersionRegexPlatform `json:"Apic,omitempty" yaml:"Apic,omitempty"`
	Dcnm       NullableNiaapiVersionRegexPlatform `json:"Dcnm,omitempty" yaml:"Dcnm,omitempty"`
