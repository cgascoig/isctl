...
func (dst *EquipmentIoCardRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "equipment.IoCard":
			var result *EquipmentIoCard = &EquipmentIoCard{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.EquipmentIoCard = result
			return nil
		case "mo.MoRef":
...
func (src *EquipmentIoCardRelationship) MarshalYAML() ([]byte, error) {
	if src.EquipmentIoCard != nil {
		return yaml.Marshal(&src.EquipmentIoCard)
	}
