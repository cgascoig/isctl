...
**ObjectType** | Pointer to **string** | The fully-qualified name of the instantiated, concrete type. The value should be the same as the &#39;ClassId&#39; property. The enum values provides the list of concrete types that can be instantiated from this abstract type. | [default to "hyperflex.HxapVirtualMachineNetworkInterface"]
...
### NewVirtualizationBaseVirtualNetworkInterfaceCard
...
### NewVirtualizationBaseVirtualNetworkInterfaceCardWithDefaults
