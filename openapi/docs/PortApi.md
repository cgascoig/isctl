...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.PortApi.PatchPortGroup(context.Background(), moid, portGroup).IfMatch(ifMatch).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.PortApi.PatchPortMacBinding(context.Background(), moid, portMacBinding).IfMatch(ifMatch).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.PortApi.PatchPortSubGroup(context.Background(), moid, portSubGroup).IfMatch(ifMatch).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.PortApi.UpdatePortGroup(context.Background(), moid, portGroup).IfMatch(ifMatch).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.PortApi.UpdatePortMacBinding(context.Background(), moid, portMacBinding).IfMatch(ifMatch).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.PortApi.UpdatePortSubGroup(context.Background(), moid, portSubGroup).IfMatch(ifMatch).Execute()
    if err != nil {
