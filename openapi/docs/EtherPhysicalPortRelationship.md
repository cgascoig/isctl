...
`func (o *EtherPhysicalPortRelationship) GetSelector() string`

GetSelector returns the Selector field if non-nil, zero value otherwise.

### GetSelectorOk

`func (o *EtherPhysicalPortRelationship) GetSelectorOk() (*string, bool)`
...
`func (o *EtherPhysicalPortRelationship) SetSelector(v string)`

SetSelector sets Selector field to given value.

### HasSelector

`func (o *EtherPhysicalPortRelationship) HasSelector() bool`

HasSelector returns a boolean if a field has been set.

### GetLink

`func (o *EtherPhysicalPortRelationship) GetLink() string`

GetLink returns the Link field if non-nil, zero value otherwise.

### GetLinkOk

`func (o *EtherPhysicalPortRelationship) GetLinkOk() (*string, bool)`
...
`func (o *EtherPhysicalPortRelationship) SetLink(v string)`

SetLink sets Link field to given value.

### HasLink

`func (o *EtherPhysicalPortRelationship) HasLink() bool`
