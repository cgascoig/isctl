...
func main() {
    ...
    resp, r, err := api_client.LicenseApi.CreateLicenseIwoLicenseCount(context.Background(), licenseIwoLicenseCount).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
    if err != nil {
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    licenseAccountLicenseData := openapiclient.license.AccountLicenseData{ClassId: "ClassId_example", ObjectType: "ObjectType_example", AccountMoid: "AccountMoid_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Moid: "Moid_example", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, AccountId: "AccountId_example", AgentData: "AgentData_example", AuthExpireTime: "AuthExpireTime_example", AuthInitialTime: "AuthInitialTime_example", AuthNextTime: "AuthNextTime_example", Category: "Category_example", DefaultLicenseType: "DefaultLicenseType_example", ErrorDesc: "ErrorDesc_example", Group: "Group_example", HighestCompliantLicenseTier: "HighestCompliantLicenseTier_example", LastSync: "TODO", LastUpdatedTime: "TODO", LicenseState: "LicenseState_example", LicenseTechSupportInfo: "LicenseTechSupportInfo_example", RegisterExpireTime: "RegisterExpireTime_example", RegisterInitialTime: "RegisterInitialTime_example", RegisterNextTime: "RegisterNextTime_example", RegistrationStatus: "RegistrationStatus_example", RenewFailureString: "RenewFailureString_example", SmartAccount: "SmartAccount_example", SyncStatus: "SyncStatus_example", VirtualAccount: "VirtualAccount_example", Account: , CustomerOp: , IwoCustomerOp: , IwoLicenseCount: , Licenseinfos: []LicenseLicenseInfoRelationship{), SmartlicenseToken: } // LicenseAccountLicenseData | The 'license.AccountLicenseData' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    licenseCustomerOp := openapiclient.license.CustomerOp{ClassId: "ClassId_example", ObjectType: "ObjectType_example", AccountMoid: "AccountMoid_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Moid: "Moid_example", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, ActiveAdmin: false, AllDevicesToDefaultTier: false, DeregisterDevice: false, EnableTrial: false, EvaluationPeriod: int64(123), ExtraEvaluation: int64(123), RenewAuthorization: false, RenewIdCertificate: false, ShowAgentTechSupport: false, AccountLicenseData: } // LicenseCustomerOp | The 'license.CustomerOp' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    licenseIwoCustomerOp := openapiclient.license.IwoCustomerOp{ClassId: "ClassId_example", ObjectType: "ObjectType_example", AccountMoid: "AccountMoid_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Moid: "Moid_example", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, ActiveAdmin: false, ActiveLicenseType: "ActiveLicenseType_example", EnableTrial: false, EvaluationPeriod: int64(123), ExtraEvaluation: int64(123), AccountLicenseData: } // LicenseIwoCustomerOp | The 'license.IwoCustomerOp' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.LicenseApi.PatchLicenseIwoCustomerOp(context.Background(), moid, licenseIwoCustomerOp).IfMatch(ifMatch).Execute()
    if err != nil {
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    licenseIwoLicenseCount := openapiclient.license.IwoLicenseCount{ClassId: "ClassId_example", ObjectType: "ObjectType_example", AccountMoid: "AccountMoid_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Moid: "Moid_example", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, VmLicenseCount: int64(123), AccountLicenseData: } // LicenseIwoLicenseCount | The 'license.IwoLicenseCount' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.LicenseApi.PatchLicenseIwoLicenseCount(context.Background(), moid, licenseIwoLicenseCount).IfMatch(ifMatch).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.LicenseApi.UpdateLicenseIwoCustomerOp(context.Background(), moid, licenseIwoCustomerOp).IfMatch(ifMatch).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.LicenseApi.UpdateLicenseIwoLicenseCount(context.Background(), moid, licenseIwoLicenseCount).IfMatch(ifMatch).Execute()
    if err != nil {
