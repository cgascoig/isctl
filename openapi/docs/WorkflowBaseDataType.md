...
**Default** | Pointer to [**NullableWorkflowDefaultValue**](workflow.DefaultValue.md) |  | [optional] 
**Description** | Pointer to **string** | Provide a detailed description of the data type. | [optional] 
**DisplayMeta** | Pointer to [**NullableWorkflowDisplayMeta**](workflow.DisplayMeta.md) |  | [optional] 
