...
------------- | ------------- | -------------
[**CreateInfraAccountExperience**](InfraApi.md#CreateInfraAccountExperience) | **Post** /infra/AccountExperiences | Create a &#39;infra.AccountExperience&#39; resource.
[**DeleteInfraAccountExperience**](InfraApi.md#DeleteInfraAccountExperience) | **Delete** /infra/AccountExperiences/{Moid} | Delete a &#39;infra.AccountExperience&#39; resource.
[**GetInfraAccountExperienceByMoid**](InfraApi.md#GetInfraAccountExperienceByMoid) | **Get** /infra/AccountExperiences/{Moid} | Read a &#39;infra.AccountExperience&#39; resource.
[**GetInfraAccountExperienceList**](InfraApi.md#GetInfraAccountExperienceList) | **Get** /infra/AccountExperiences | Read a &#39;infra.AccountExperience&#39; resource.
[**PatchInfraAccountExperience**](InfraApi.md#PatchInfraAccountExperience) | **Patch** /infra/AccountExperiences/{Moid} | Update a &#39;infra.AccountExperience&#39; resource.
[**UpdateInfraAccountExperience**](InfraApi.md#UpdateInfraAccountExperience) | **Post** /infra/AccountExperiences/{Moid} | Update a &#39;infra.AccountExperience&#39; resource.



## CreateInfraAccountExperience

> InfraAccountExperience CreateInfraAccountExperience(ctx).InfraAccountExperience(infraAccountExperience).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()

Create a 'infra.AccountExperience' resource.
...
func main() {
    ...
    resp, r, err := api_client.InfraApi.CreateInfraAccountExperience(context.Background(), infraAccountExperience).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `InfraApi.CreateInfraAccountExperience``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `CreateInfraAccountExperience`: InfraAccountExperience
    fmt.Fprintf(os.Stdout, "Response from `InfraApi.CreateInfraAccountExperience`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCreateInfraAccountExperienceRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **infraAccountExperience** | [**InfraAccountExperience**](InfraAccountExperience.md) | The &#39;infra.AccountExperience&#39; resource to create. | 
 **ifMatch** | **string** | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | 
 **ifNoneMatch** | **string** | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn&#39;t happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource&#39;s ETag doesn&#39;t match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don&#39;t have to be identical byte for byte. | 

### Return type

[**InfraAccountExperience**](infra.AccountExperience.md)
...
## DeleteInfraAccountExperience

> DeleteInfraAccountExperience(ctx, moid).Execute()

Delete a 'infra.AccountExperience' resource.
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.InfraApi.DeleteInfraAccountExperience(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `InfraApi.DeleteInfraAccountExperience``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
Other parameters are passed through a pointer to a apiDeleteInfraAccountExperienceRequest struct via the builder pattern
...
## GetInfraAccountExperienceByMoid

> InfraAccountExperience GetInfraAccountExperienceByMoid(ctx, moid).Execute()

Read a 'infra.AccountExperience' resource.
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.InfraApi.GetInfraAccountExperienceByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `InfraApi.GetInfraAccountExperienceByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetInfraAccountExperienceByMoid`: InfraAccountExperience
    fmt.Fprintf(os.Stdout, "Response from `InfraApi.GetInfraAccountExperienceByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetInfraAccountExperienceByMoidRequest struct via the builder pattern
...
## GetInfraAccountExperienceList

> InfraAccountExperienceResponse GetInfraAccountExperienceList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.InfraApi.GetInfraAccountExperienceList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `InfraApi.GetInfraAccountExperienceList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetInfraAccountExperienceList`: InfraAccountExperienceResponse
    fmt.Fprintf(os.Stdout, "Response from `InfraApi.GetInfraAccountExperienceList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetInfraAccountExperienceListRequest struct via the builder pattern
...
[**InfraAccountExperienceResponse**](infra.AccountExperience.Response.md)
...
## PatchInfraAccountExperience

> InfraAccountExperience PatchInfraAccountExperience(ctx, moid).InfraAccountExperience(infraAccountExperience).IfMatch(ifMatch).Execute()

Update a 'infra.AccountExperience' resource.
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    infraAccountExperience := openapiclient.infra.AccountExperience{AccountMoid: "AccountMoid_example", ClassId: "ClassId_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Moid: "Moid_example", ObjectType: "ObjectType_example", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, Features: []InfraFeatureDefinition{openapiclient.infra.FeatureDefinition{ClassId: "ClassId_example", ObjectType: "ObjectType_example", Feature: "Feature_example"}), Account: } // InfraAccountExperience | The 'infra.AccountExperience' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.InfraApi.PatchInfraAccountExperience(context.Background(), moid, infraAccountExperience).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `InfraApi.PatchInfraAccountExperience``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PatchInfraAccountExperience`: InfraAccountExperience
    fmt.Fprintf(os.Stdout, "Response from `InfraApi.PatchInfraAccountExperience`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchInfraAccountExperienceRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **infraAccountExperience** | [**InfraAccountExperience**](InfraAccountExperience.md) | The &#39;infra.AccountExperience&#39; resource to update. | 
 **ifMatch** | **string** | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | 
...
## UpdateInfraAccountExperience

> InfraAccountExperience UpdateInfraAccountExperience(ctx, moid).InfraAccountExperience(infraAccountExperience).IfMatch(ifMatch).Execute()
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    infraAccountExperience :=  // InfraAccountExperience | The 'infra.AccountExperience' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.InfraApi.UpdateInfraAccountExperience(context.Background(), moid, infraAccountExperience).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `InfraApi.UpdateInfraAccountExperience``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdateInfraAccountExperience`: InfraAccountExperience
    fmt.Fprintf(os.Stdout, "Response from `InfraApi.UpdateInfraAccountExperience`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateInfraAccountExperienceRequest struct via the builder pattern
