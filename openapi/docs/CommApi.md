...
func main() {
    ...
    resp, r, err := api_client.CommApi.CreateCommHttpProxyPolicy(context.Background(), commHttpProxyPolicy).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.CommApi.PatchCommHttpProxyPolicy(context.Background(), moid, commHttpProxyPolicy).IfMatch(ifMatch).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.CommApi.UpdateCommHttpProxyPolicy(context.Background(), moid, commHttpProxyPolicy).IfMatch(ifMatch).Execute()
    if err != nil {
