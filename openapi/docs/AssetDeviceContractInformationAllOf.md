...
**DeviceType** | Pointer to **string** | Type used to classify the device in Cisco Intersight. Currently supported values are Server and FabricInterconnect. This will be expanded to support more types in future. | [optional] [readonly] [default to "None"]
...
**PlatformType** | Pointer to **string** | The platform type of the Cisco device. | [optional] [readonly] [default to ""]
...
**StateContract** | Pointer to **string** | Internal property used for triggering and tracking actions for contract information. | [optional] [default to "Update"]
