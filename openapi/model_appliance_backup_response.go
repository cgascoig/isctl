...
func (dst *ApplianceBackupResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		switch v {
		case "appliance.Backup.List":
			var result *ApplianceBackupList = &ApplianceBackupList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.ApplianceBackupList = result
			return nil
...
func (src *ApplianceBackupResponse) MarshalYAML() ([]byte, error) {
	if src.ApplianceBackupList != nil {
		return yaml.Marshal(&src.ApplianceBackupList)
	}
