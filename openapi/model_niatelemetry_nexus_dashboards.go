...
type NiatelemetryNexusDashboards struct {
	...
	NumberOfSchemasInMso *int64 `json:"NumberOfSchemasInMso,omitempty" yaml:"NumberOfSchemasInMso,omitempty"`
	// Number of sites in Multi-Site Orchestrator.
	NumberOfSitesInMso *int64 `json:"NumberOfSitesInMso,omitempty" yaml:"NumberOfSitesInMso,omitempty"`
	...
	NumberOfTenantsInMso *int64 `json:"NumberOfTenantsInMso,omitempty" yaml:"NumberOfTenantsInMso,omitempty"`
	...
	TypeOfSiteInMso  *string                              `json:"TypeOfSiteInMso,omitempty" yaml:"TypeOfSiteInMso,omitempty"`
