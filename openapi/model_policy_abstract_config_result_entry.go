...
type PolicyAbstractConfigResultEntry struct {
	...
	CompletedTime *string                           `json:"CompletedTime,omitempty" yaml:"CompletedTime,omitempty"`
	Context       NullablePolicyConfigResultContext `json:"Context,omitempty" yaml:"Context,omitempty"`
