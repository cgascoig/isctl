...
func (dst *HyperflexHxapVirtualMachineRelationship) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ClassId"]; ok {
		switch v {
		case "hyperflex.HxapVirtualMachine":
			var result *HyperflexHxapVirtualMachine = &HyperflexHxapVirtualMachine{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.HyperflexHxapVirtualMachine = result
			return nil
		case "mo.MoRef":
...
func (src *HyperflexHxapVirtualMachineRelationship) MarshalYAML() ([]byte, error) {
	if src.HyperflexHxapVirtualMachine != nil {
		return yaml.Marshal(&src.HyperflexHxapVirtualMachine)
	}
