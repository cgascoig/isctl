...
type ManagementInterface struct {
	...
	Ipv4Gateway *string `json:"Ipv4Gateway,omitempty" yaml:"Ipv4Gateway,omitempty"`
	// IPv4 Netmask for the interface.
	Ipv4Mask *string `json:"Ipv4Mask,omitempty" yaml:"Ipv4Mask,omitempty"`
	...
	Ipv6Prefix *int64 `json:"Ipv6Prefix,omitempty" yaml:"Ipv6Prefix,omitempty"`
	...
	UemConnStatus *string `json:"UemConnStatus,omitempty" yaml:"UemConnStatus,omitempty"`
