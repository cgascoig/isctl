...
func (dst *NiatelemetryNexusDashboardControllerDetailsResponse) UnmarshalJSON(data []byte) error {
	...
	if v, ok := unmarshaled["ObjectType"]; ok {
		...
		case "mo.TagSummary":
			...
			return nil
		case "niatelemetry.NexusDashboardControllerDetails.List":
			var result *NiatelemetryNexusDashboardControllerDetailsList = &NiatelemetryNexusDashboardControllerDetailsList{}
			err = json.Unmarshal(data, result)
			if err != nil {
				return err
			}
			dst.NiatelemetryNexusDashboardControllerDetailsList = result
			return nil
		default:
...
func (src *NiatelemetryNexusDashboardControllerDetailsResponse) MarshalYAML() ([]byte, error) {
	if src.MoAggregateTransform != nil {
	...
	if src.NiatelemetryNexusDashboardControllerDetailsList != nil {
		return yaml.Marshal(&src.NiatelemetryNexusDashboardControllerDetailsList)
	}
